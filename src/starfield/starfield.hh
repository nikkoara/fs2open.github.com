...
// make a bitmap or sun instance as unusable (doesn't free anything but does
// prevent rendering)
...
void stars_set_background_model (
    const char* model_name, const char* texture_name,
...
// for SEXP stuff so that we can mark a bitmap as being used regardless of
// whether or not there is an instance for it yet
...
#endif // FREESPACE2_STARFIELD_STARFIELD_HH
