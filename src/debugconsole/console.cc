...
void dc_init(void)
{
        ...
        dc_font = font::FONT1;
        row_height = ((int(font::get_current_font()->getHeight())) * 3) / 2; // Row/Line height, in pixels
        ...
        dc_scroll_x = 0;
        dc_scroll_y = 0;
        DCOLS = (gr_screen.center_w / col_width) - 1; // Subtract as needed. Windowed mode has some quirks with the
                                                      // resolution
