 ...
 *
 *  @brief This file contains the "built-in" commands for the debug console,
 * and is listed by the 'help' and '?' commands
 *
 *  @details
 *  All other debug commands should be in their respective files and added to
 * the console with the DCF macro. For further documentation, please see
 * console.h
 */
...
// =================== class debug_command ===================
debug_command::debug_command () : name (""), help (""), func (NULL){};

debug_command::debug_command (
    const char* _name, const char* _help, void (*_func) ())
...
DCF (help, "Displays the help list.") {
    ...
    dc_printf (
        " Typing 'help function_name' will give the short help on the "
        "function.\n");
    dc_printf (
        " Some functions may have detailed help, try passing \"help\" or "
        "\"--help\" to them.");
    dc_printf (
        " F3 selects last command line. Up and Down arrow keys scroll through "
        "the command history\n");
    dc_printf ("\n");
