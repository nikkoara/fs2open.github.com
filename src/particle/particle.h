 ...
 *
 * A non-persistent particle will be managed more efficiently than a persistent
 * particle but it will not be possible to keep a reference to the particle.
 * This should be used whenever the a particle handle is not required (which
 ...
 * explicitly creating a particle_info structure.
 ...
 *
 * A persistent particle is handled differently from a standard particle. It is
 * possible to hold a weak or strong reference to a persistent particle which
 * allows to track where the particle is and also allows to change particle
