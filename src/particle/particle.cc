        ...
        particle_emitter *pe, ParticleType type, int optional_data, float range)
{
        ...
        for (i = 0; i < n; i++) {
                ...
                normal.xyz.x = pe->normal.xyz.x + (fs2::prng::randf(0) * 2.0f - 1.0f) * pe->normal_variance;
                normal.xyz.y = pe->normal.xyz.y + (fs2::prng::randf(0) * 2.0f - 1.0f) * pe->normal_variance;
                normal.xyz.z = pe->normal.xyz.z + (fs2::prng::randf(0) * 2.0f - 1.0f) * pe->normal_variance;
