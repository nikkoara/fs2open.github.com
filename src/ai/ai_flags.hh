...
#ifndef FREESPACE2_AI_AI_FLAGS_HH
#define FREESPACE2_AI_AI_FLAGS_HH
...
FLAG_LIST(Goal_Flags){
        ...
        Subsys_needs_fixup,  // when set, the subsystem index (for a destroy
                             // subsystem goal) is invalid and must be gotten from
                             // the subsys name stored in docker.name field!!
        Goal_override,       // paired with AIG_TYPE_DYNAMIC to mean this goal overrides
                             // any other goal
...
#endif // FREESPACE2_AI_AI_FLAGS_HH
