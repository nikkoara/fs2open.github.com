...
static const int NUM_RETAIL_GAMEPLAY_SOUNDS =
    192; // indices 0-191, from retail sounds.tbl
static EnhancedSoundData Default_sound_priorities[NUM_RETAIL_GAMEPLAY_SOUNDS] = {
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MUST_PLAY,
        1), // SND_MISSILE_TRACKING           = 0,  //!< Missle tracking to
            // acquire a lock (looped)
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MUST_PLAY, 1), // SND_MISSILE_LOCK = 1,  //!<
                                             // Missle lock (non-looping)
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MUST_PLAY, 1), // SND_PRIMARY_CYCLE = 2, //!<
                                             // cycle primary weapon
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MUST_PLAY, 1), // SND_SECONDARY_CYCLE = 3,
                                             // //!< cycle secondary weapon
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MUST_PLAY,
        1), // SND_ENGINE                     = 4,  //!< engine sound (as
            // heard in cockpit)
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MUST_PLAY,
        1), // SND_CARGO_REVEAL               = 5,  //!< cargo revealed
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MUST_PLAY,
        3), // SND_DEATH_ROLL                 = 6,  //!< ship death roll
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MUST_PLAY,
        2), // SND_SHIP_EXPLODE_1             = 7,  //!< ship explosion 1
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MUST_PLAY,
        1), // SND_TARGET_ACQUIRE             = 8,  //!< target acquried
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MUST_PLAY, 1), // SND_ENERGY_ADJUST = 9, //!<
                                             // energy level change success
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MUST_PLAY,
        1), // SND_ENERGY_ADJUST_FAIL         = 10, //!< energy level
            // change fail
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MUST_PLAY, 1), // SND_ENERGY_TRANS = 11, //!<
                                             // energy transfer success
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MUST_PLAY, 1), // SND_ENERGY_TRANS_FAIL = 12,
                                             // //!< energy transfer fail
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MUST_PLAY,
        1), // SND_FULL_THROTTLE              = 13, //!< set full throttle
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MUST_PLAY,
        1), // SND_ZERO_THROTTLE              = 14, //!< set zero throttle
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MUST_PLAY,
        1), // SND_THROTTLE_UP                = 15, //!< set 1/3 or 2/3
            // throttle (up)
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MUST_PLAY,
        1), // SND_THROTTLE_DOWN              = 16, //!< set 1/3 or 2/3
            // throttle (down)
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_HIGH, 4), // SND_DOCK_APPROACH              =
                                        // 17, //!< dock approach retros
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_HIGH,
        4), // SND_DOCK_ATTACH                = 18, //!< dock attach
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_HIGH,
        4), // SND_DOCK_DETACH                = 19, //!< dock detach
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_HIGH,
        4), // SND_DOCK_DEPART                = 20, //!< dock depart retros
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MEDIUM,
        3), // SND_ABURN_ENGAGE               = 21, //!< afterburner engage
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MEDIUM,
        3), // SND_ABURN_LOOP                 = 22, //!< afterburner burn
            // sound (looped)
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MUST_PLAY,
        3), // SND_VAPORIZED                  = 23, //!< Destroyed by a
            // beam (vaporized)
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MEDIUM,
        2), // SND_ABURN_FAIL                 = 24, //!< afterburner fail
            // (no fuel when aburn pressed)
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_HIGH,
        4), // SND_HEATLOCK_WARN              = 25, //!< heat-seeker launch
            // warning
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MUST_PLAY,
        1), // SND_OUT_OF_MISSLES             = 26, //!< tried to fire a
            // missle when none are left
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MUST_PLAY,
        1), // SND_OUT_OF_WEAPON_ENERGY       = 27, //!< tried to fire
            // lasers when not enough energy left
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MUST_PLAY,
        1), // SND_TARGET_FAIL                = 28, //!< target fail sound
            // (i.e. press targeting key, but nothing happens)
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MUST_PLAY,
        1), // SND_SQUADMSGING_ON             = 29, //!< squadmate message
            // menu appears
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MUST_PLAY,
        1), // SND_SQUADMSGING_OFF            = 30, //!< squadmate message
            // menu disappears
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_HIGH,
        5), // SND_DEBRIS                     = 31, //!< debris sound
            // (persistant, looping)
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MUST_PLAY,
        2), // SND_SUBSYS_DIE_1               = 32, //!< subsystem gets
            // destroyed on player ship
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_HIGH,
        1), // SND_MISSILE_START_LOAD         = 33, //!< missle start load
            // (during rearm/repair)
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_HIGH,
        1), // SND_MISSILE_LOAD               = 34, //!< missle load
            // (during rearm/repair)
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_HIGH,
        1), // SND_SHIP_REPAIR                = 35, //!< ship is being
            // repaired (during rearm/repair)
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MUST_PLAY,
        3), // SND_PLAYER_HIT_LASER           = 36, //!< player ship is hit
            // by laser fire
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MUST_PLAY,
        3), // SND_PLAYER_HIT_MISSILE         = 37, //!< player ship is hit
            // by missile
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MUST_PLAY, 1), // SND_CMEASURE_CYCLE = 38,
                                             // //!< countermeasure cycle
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_HIGH,
        2), // SND_SHIELD_HIT                 = 39, //!< shield hit
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MUST_PLAY, 2), // SND_SHIELD_HIT_YOU = 40,
                                             // //!< player shield is hit
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MUST_PLAY,
        1), // SND_GAME_MOUSE_CLICK           = 41, //!< mouse click
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MUST_PLAY, 2), // SND_ASPECTLOCK_WARN = 42,
                                             // //!< aspect launch warning
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MUST_PLAY,
        1), // SND_SHIELD_XFER_OK             = 43, //!< shield quadrant
            // transfer successful
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_HIGH, 5), // SND_ENGINE_WASH                =
                                        // 44, //!< Engine wash (looped)
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_HIGH,
        2), // SND_WARP_IN                    = 45, //!< warp hole opening
            // up for arriving
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_HIGH,
        2), // SND_WARP_OUT                   = 46, //!< warp hole opening
            // up for departing (Same as warp in for now)
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MUST_PLAY, 1), // SND_PLAYER_WARP_FAIL = 47,
                                             // //!< player warp has failed
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MUST_PLAY,
        1), // SND_STATIC                     = 48, //!< hud gauge static
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MUST_PLAY,
        3), // SND_SHIP_EXPLODE_2             = 49, //!< ship explosion 2
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MUST_PLAY,
        1), // SND_PLAYER_WARP_OUT            = 50, //!< ship is warping
            // out in 3rd person
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MEDIUM, 5), // SND_SHIP_SHIP_HEAVY = 51, //!<
                                          // heavy ship-ship collide sound
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MEDIUM, 5), // SND_SHIP_SHIP_LIGHT = 52, //!<
                                          // light ship-ship collide sound
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MEDIUM,
        5), // SND_SHIP_SHIP_SHIELD           = 53, //!< shield ship-ship
            // collide overlay sound
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MUST_PLAY,
        1), // SND_THREAT_FLASH               = 54, //!< missile threat
            // indicator flashes
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MUST_PLAY,
        3), // SND_PROXIMITY_WARNING          = 55, //!< proximity warning
            // (heat seeker)
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MUST_PLAY,
        3), // SND_PROXIMITY_ASPECT_WARNING   = 56, //!< proximity warning
            // (aspect)
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_HIGH,
        2), // SND_DIRECTIVE_COMPLETE         = 57, //!< directive complete
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MEDIUM_HIGH,
        3), // SND_SUBSYS_EXPLODE             = 58, //!< other ship
            // subsystem destroyed
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MUST_PLAY, 2), // SND_CAPSHIP_EXPLODE = 59,
                                             // //!< captial ship explosion
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_HIGH,
        3), // SND_CAPSHIP_SUBSYS_EXPLODE     = 60, //!< captial ship
            // subsystem destroyed
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MUST_PLAY, 2), // SND_LARGESHIP_WARPOUT = 61,
                                             // //!< large ship warps out
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MUST_PLAY,
        5), // SND_ASTEROID_EXPLODE_LARGE     = 62, //!< large asteroid
            // blows up
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MUST_PLAY,
        5), // SND_ASTEROID_EXPLODE_SMALL     = 63, //!< small asteroid
            // blows up
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MUST_PLAY,
        2), // SND_CUE_VOICE                  = 64, //!< sound to indicate
            // voice is about to start
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MUST_PLAY,
        2), // SND_END_VOICE                  = 65, //!< sound to indicate
            // voice has ended
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MUST_PLAY, 2), // SND_CARGO_SCAN = 66, //!<
                                             // cargo scanning (looped)
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MEDIUM,
        5), // SND_WEAPON_FLYBY               = 67, //!< weapon flyby sound
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_HIGH,
        5), // SND_ASTEROID                   = 68, //!< asteroid sound
            // (persistant, looped)
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_HIGH,
        2), // SND_CAPITAL_WARP_IN            = 69, //!< capital warp hole
            // opening
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_HIGH,
        2), // SND_CAPITAL_WARP_OUT           = 70, //!< capital warp hole
            // closing
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_HIGH, 5), // SND_ENGINE_LOOP_LARGE          =
                                        // 71, //!< LARGE engine ambient
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MUST_PLAY,
        1), // SND_SUBSPACE_LEFT_CHANNEL      = 72, //!< subspace ambient
            // sound (left channel) (looped)
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MUST_PLAY,
        1), // SND_SUBSPACE_RIGHT_CHANNEL     = 73, //!< subspace ambient
            // sound (right channel) (looped)
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MUST_PLAY,
        4), // SND_MISSILE_EVADED_POPUP       = 74, //!< "evaded" HUD popup
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_HIGH, 4), // SND_ENGINE_LOOP_HUGE           =
                                        // 75, //!< HUGE engine ambient
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MEDIUM_LOW,
        8), // SND_LIGHT_LASER_FIRE           = 76, //!< SD-4 Sidearm laser
            // fired
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MEDIUM_LOW,
        8), // SND_LIGHT_LASER_IMPACT         = 77, //!< DR-2 Scalpel fired
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MEDIUM_LOW,
        8), // SND_HVY_LASER_FIRE             = 78, //!< Flail II fired
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MEDIUM_LOW,
        8), // SND_HVY_LASER_IMPACT           = 79, //!< Prometheus R laser
            // fired
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MEDIUM_LOW,
        8), // SND_MASSDRV_FIRED              = 80, //!< Prometheus S laser
            // fired
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MEDIUM_LOW,
        8), // SND_MASSDRV_IMPACT             = 81, //!< GTW-66 Newton
            // Cannon fired
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MEDIUM_LOW, 8), // SND_FLAIL_FIRED = 82, //!<
                                              // UD-8 Kayser Laser fired
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MEDIUM_LOW,
        8), // SND_FLAIL_IMPACT               = 83, //!< GTW-19 Circe laser
            // fired
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MEDIUM_LOW,
        8), // SND_NEUTRON_FLUX_FIRED         = 84, //!< GTW-83 Lich laser
            // fired
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MEDIUM_LOW,
        8), // SND_NEUTRON_FLUX_IMPACT        = 85, //!< Laser impact
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MEDIUM_LOW,
        8), // SND_DEBUG_LASER_FIRED          = 86, //!< Subach-HLV Vasudan
            // laser
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MEDIUM_LOW,
        8), // SND_ROCKEYE_FIRED              = 87, //!< rockeye missile
            // launch
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MEDIUM_LOW,
        8), // SND_MISSILE_IMPACT1            = 88, //!< missile impact 1
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MEDIUM_LOW,
        8), // SND_MAG_MISSILE_LAUNCH         = 89, //!< mag pulse missile
            // launch
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MEDIUM_LOW,
        8), // SND_FURY_MISSILE_LAUNCH        = 90, //!< fury missile
            // launch
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MEDIUM_LOW,
        8), // SND_SHRIKE_MISSILE_LAUNCH      = 91, //!< shrike missile
            // launch
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MEDIUM_LOW,
        8), // SND_ANGEL_MISSILE_LAUNCH       = 92, //!< angel fire missile
            // launch
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MEDIUM_LOW,
        8), // SND_CLUSTER_MISSILE_LAUNCH     = 93, //!< cluster bomb
            // launch
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MEDIUM_LOW,
        8), // SND_CLUSTERB_MISSILE_LAUNCH    = 94, //!< cluster baby bomb
            // launch
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MEDIUM_LOW,
        8), // SND_STILETTO_MISSILE_LAUNCH    = 95, //!< stiletto bomb
            // launch
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MEDIUM_LOW,
        8), // SND_TSUNAMI_MISSILE_LAUNCH     = 96, //!< tsunami bomb
            // launch
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MEDIUM_LOW,
        8), // SND_HARBINGER_MISSILE_LAUNCH   = 97, //!< harbinger bomb
            // launch
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MEDIUM_LOW,
        8), // SND_MEGAWOKKA_MISSILE_LAUNCH   = 98, //!< mega wokka launch
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MEDIUM_LOW,
        8), // SND_CMEASURE1_LAUNCH           = 99, //!< countermeasure 1
            // launch
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MEDIUM_LOW,
        8), // SND_SHIVAN_LIGHT_LASER_FIRE    = 100,//!< Shivan light laser
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_HIGH,
        3), // SND_SHOCKWAVE_EXPLODE          = 101,//!< shockwave ignition
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MEDIUM_LOW,
        8), // SND_SWARM_MISSILE_LAUNCH       = 102,//!< swarm missile
            // sound
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MEDIUM_LOW,
        8), // SND_UNDEFINED_103              = 103,//!< Shivan heavy laser
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MEDIUM, 3), // SND_UNDEFINED_104 = 104,//!<
                                          // Vasudan SuperCap engine
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MEDIUM, 5), // SND_UNDEFINED_105 = 105,//!<
                                          // Shivan SuperCap engine
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MEDIUM, 5), // SND_UNDEFINED_106 = 106,//!<
                                          // Terran SuperCap engine
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MEDIUM_LOW,
        8), // SND_UNDEFINED_107              = 107,//!< Vasudan light
            // laser fired
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MEDIUM_LOW,
        8), // SND_UNDEFINED_108              = 108,//!< Shivan heavy laser
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_HIGH,
        2), // SND_SHOCKWAVE_IMPACT           = 109,//!< shockwave impact
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MEDIUM_LOW,
        8), // SND_UNDEFINED_110              = 110,//!< TERRAN TURRET 1
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MEDIUM_LOW,
        8), // SND_UNDEFINED_111              = 111,//!< TERRAN TURRET 2
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MEDIUM_LOW,
        8), // SND_UNDEFINED_112              = 112,//!< VASUDAN TURRET 1
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MEDIUM_LOW,
        8), // SND_UNDEFINED_113              = 113,//!< VASUDAN TURRET 2
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MEDIUM_LOW,
        8), // SND_UNDEFINED_114              = 114,//!< SHIVAN TURRET 1
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MUST_PLAY,
        1), // SND_TARG_LASER_LOOP            = 115,//!< targeting laser
            // loop sound
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MEDIUM,
        8), // SND_FLAK_FIRE                  = 116,//!< Flak Gun Launch
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MEDIUM_LOW,
        8), // SND_SHIELD_BREAKER             = 117,//!< Flak Gun Impact
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MEDIUM_LOW,
        8), // SND_EMP_MISSILE                = 118,//!< EMP Missle
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MEDIUM,
        5), // SND_AUTOCANNON_LOOP            = 119,//!< Escape Pod Drone
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_HIGH,
        5), // SND_AUTOCANNON_SHOT            = 120,//!< Beam Hit 1
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_HIGH,
        4), // SND_BEAM_LOOP                  = 121,//!< beam loop
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_HIGH,
        4), // SND_BEAM_UP                    = 122,//!< beam power up
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_HIGH,
        4), // SND_BEAM_DOWN                  = 123,//!< beam power down
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_HIGH,
        4), // SND_BEAM_SHOT                  = 124,//!< Beam shot 1
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_HIGH,
        4), // SND_BEAM_VAPORIZE              = 125,//!< Beam shot 2
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MEDIUM, 4), // SND_TERRAN_FIGHTER_ENG =
                                          // 126,//!< Terran fighter engine
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MEDIUM, 4), // SND_TERRAN_BOMBER_ENG =
                                          // 127,//!< Terran bomber engine
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MEDIUM, 4), // SND_TERRAN_CAPITAL_ENG =
                                          // 128,//!< Terran cruiser engine
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MEDIUM,
        4), // SND_SPECIESB_FIGHTER_ENG       = 129,//!< Vasudan fighter
            // engine
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MEDIUM, 4), // SND_SPECIESB_BOMBER_ENG =
                                          // 130,//!< Vasudan bomber engine
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MEDIUM,
        4), // SND_SPECIESB_CAPITAL_ENG       = 131,//!< Vasudan cruiser
            // engine
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MEDIUM, 4), // SND_SHIVAN_FIGHTER_ENG =
                                          // 132,//!< Shivan fighter engine
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MEDIUM, 4), // SND_SHIVAN_BOMBER_ENG =
                                          // 133,//!< Shivan bomber engine
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MEDIUM, 4), // SND_SHIVAN_CAPITAL_ENG =
                                          // 134,//!< Shivan cruiser engine
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MEDIUM_HIGH,
        3), // SND_REPAIR_SHIP_ENG            = 135,//!< Repair ship
            // beacon/engine sound
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MEDIUM, 4), // SND_UNDEFINED_136 = 136,//!<
                                          // Terran capital engine
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MEDIUM, 4), // SND_UNDEFINED_137 = 137,//!<
                                          // Vasudan capital engine
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MEDIUM, 4), // SND_UNDEFINED_138 = 138,//!<
                                          // Shivan capital engine
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MEDIUM, 3), // SND_DEBRIS_ARC_01 = 139,//!<
                                          // 0.10 second spark sound effect
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MEDIUM, 3), // SND_DEBRIS_ARC_02 = 140,//!<
                                          // 0.25 second spark sound effect
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MEDIUM, 3), // SND_DEBRIS_ARC_03 = 141,//!<
                                          // 0.50 second spark sound effect
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MEDIUM, 3), // SND_DEBRIS_ARC_04 = 142,//!<
                                          // 0.75 second spark sound effect
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MEDIUM,
        3), // SND_DEBRIS_ARC_05              = 143,//!< 1.00 second spark
            // sound effect
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_HIGH, 3), // SND_UNDEFINED_144              =
    ...
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_HIGH,
        1), // SND_UNDEFINED_163              = 163,//!< (Empty in Retail)
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_HIGH,
        1), // SND_UNDEFINED_164              = 164,//!< (Empty in Retail)
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_HIGH,
        1), // SND_UNDEFINED_165              = 165,//!< (Empty in Retail)
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_HIGH,
        1), // SND_UNDEFINED_166              = 166,//!< (Empty in Retail)
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_HIGH,
        1), // SND_UNDEFINED_167              = 167,//!< (Empty in Retail)
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_HIGH,
        1), // SND_UNDEFINED_168              = 168,//!< (Empty in Retail)
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_HIGH,
        1), // SND_UNDEFINED_169              = 169,//!< (Empty in Retail)
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_HIGH,
        1), // SND_UNDEFINED_170              = 170,//!< (Empty in Retail)
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_HIGH,
        1), // SND_UNDEFINED_171              = 171,//!< (Empty in Retail)
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_HIGH,
        1), // SND_UNDEFINED_172              = 172,//!< (Empty in Retail)
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MUST_PLAY, 1), // SND_SUPERNOVA_1 = 173,//!<
                                             // SuperNova (distant)
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MUST_PLAY, 1), // SND_SUPERNOVA_2 = 174,//!<
                                             // SuperNova (shockwave)
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MEDIUM, 3), // SND_UNDEFINED_175 = 175,//!<
                                          // Shivan large engine
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MEDIUM, 3), // SND_UNDEFINED_176 = 176,//!<
                                          // Shivan large engine
    EnhancedSoundData (
    ...
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_HIGH,
        4), // SND_LIGHTNING_2                = 181,//!< Thunder 2 sound in
            // neblua
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MEDIUM_HIGH,
    ...
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_HIGH, 1), // SND_UNDEFINED_186              =
    ...
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MEDIUM_HIGH,
        2), // SND_UNDEFINED_190              = 190,//!< Instellation 1
    EnhancedSoundData (
        SND_ENHANCED_PRIORITY_MEDIUM_HIGH,
        2) // SND_UNDEFINED_191              = 191,//!< Instellation 2
};

static const EnhancedSoundData
    default_enhanced_sound_data (SND_ENHANCED_PRIORITY_MEDIUM_HIGH, 1);
...
void gamesnd_add_retail_default_enhanced_sound_data () {
    ...
    for (std::vector< game_snd >::iterator it = Snds.begin (),
                                           end = Snds.end ();
         it != end; ++it, ++i) {
        if (it->enhanced_sound_data.priority ==
            SND_ENHANCED_PRIORITY_INVALID) {
            if (i < NUM_RETAIL_GAMEPLAY_SOUNDS) {
                it->enhanced_sound_data.priority =
                    Default_sound_priorities[i].priority;
            }
            else {
                it->enhanced_sound_data.priority =
                    default_enhanced_sound_data.priority;
            }
        }

        if (it->enhanced_sound_data.limit < 1) {
            if (i < NUM_RETAIL_GAMEPLAY_SOUNDS) {
                it->enhanced_sound_data.limit =
                    Default_sound_priorities[i].limit;
            }
            else {
                it->enhanced_sound_data.limit =
                    default_enhanced_sound_data.limit;
            }
        }
    }
}
 ...
 *
 */
int gamesnd_lookup_name (
    const char* name, const std::vector< game_snd >& sounds) {
    ...
    for (std::vector< game_snd >::const_iterator snd = sounds.begin ();
         snd != sounds.end (); ++snd) {
        if (snd->name == name) { return i; }
        i++;
    }
...
interface_snd_id gamesnd_get_by_iface_tbl_index (int index) {
    ...
    if (idx < 0) { return interface_snd_id (); }
    else {
 ...
 * required_string and optional_string aren't needed, as this function deals
 * with that as its tag parameter, just make sure that the destination sound
 * index can handle -1 if things don't work out.
 *
 * @param tag Tag
...
void parse_game_sound (const char* tag, gamesnd_id* idx_dest) {
    if (optional_string (tag)) {
        ...
        *idx_dest = gamesnd_get_by_name (buf.c_str ());
        ...
        // The special case "-1" is needed to silence warnings where sounds are
        // intentionally removed
        if (!idx_dest->isValid () && buf != "-1") {
            error_display (
                0, "Could not find game sound with name '%s'!", buf.c_str ());
        }
    }
}
...
void parse_iface_sound (const char* tag, interface_snd_id* idx_dest) {
    ...
    if (optional_string (tag)) {
        ...
        *idx_dest = gamesnd_get_by_iface_name (buf.c_str ());
        ...
        if (!idx_dest->isValid () && buf != "-1") {
            error_display (
                0, "Could not find interface sound with name '%s'!",
                buf.c_str ());
        }
    }
}
 ...
 * entry, required_string and optional_string aren't needed, as this function
 * deals with that as its tag parameter, just make sure that the destination
 * sound index(es) can handle -1 if things don't work out.
 *
 ...
 *
 */
void parse_iface_sound_list (
    const char* tag, std::vector< interface_snd_id >& destination,
    const char* object_name, bool scp_list) {
    if (optional_string (tag)) {
        int check = 0;

        // if we're using the old format, parse the first entry separately
        if (!scp_list) { stuff_int (&check); }
        ...
        for (size_t i = 0; !check_for_eoln (); i++) {
            ...
            // we do this conditionally to avoid adding needless entries when
            // reparsing
 ...
 *
 * The method currently used is to load all those sounds that have the hardware
 * flag set.  This works well since we don't want to try and load hardware
 * sounds in on the fly (too slow).
 */
        ...
        if (!gs->preload) { // don't try to load anything that's already
            ...
            for (auto& entry : gs->sound_entries) {
                if (entry.filename[0] != 0 &&
                    strncasecmp (entry.filename, NOX ("none.wav"), 4) != 0) {
                    game_busy (
                        NOX ("** preloading gameplay sounds **")); // Animate
                                                                   // loading
                        // cursor... does
                        // nothing if
                        // loading screen
...
void parse_gamesnd_old (game_snd* gs) {
    ...
    // Default pitch is 1.0. This is set here in case we don't have a valid
    // file name
...
EnhancedSoundPriority convert_to_enhanced_priority (const char* priority_str) {
    ...
    if (!strcasecmp (priority_str, "Must Play")) {
        ...
        error_display (
            1, "Unknown enhanced sound priority: %s\n", priority_str);
...
static GameSoundCycleType parse_cycle_type () {
    if (optional_string ("Sequential")) {
        ...
        error_display (
            0,
            "Failed to parse sound cycle type. Expected 'sequential' or "
            "'random'. Got [%.32s]",
            next_tokens ());
        // Ignore everything until the end of the line. That should hopefully
        // skip the bad token.
...
void parse_gamesnd_soundset (game_snd* gs, bool no_create) {
    // If this gets called then we just saw "+Entry:" so we can begin
    // processing the first entry immediately

    do {
        // For now there is no way to change an existing entry so ever +Entry
        // statement creates a new sound entry
    ...
    if (optional_string ("+Priority:")) {
        ...
        EnhancedSoundPriority priority =
            convert_to_enhanced_priority (priority_string.c_str ());
        if (priority != SND_ENHANCED_PRIORITY_INVALID) {
            gs->enhanced_sound_data.priority = priority;
        }
        // else case not needed since conversion function displays message on
        // error
    }
    ...
    if (optional_string ("+Limit:")) {
        ...
        if ((temp_limit > 0) &&
            (static_cast< uint > (temp_limit) <= SND_ENHANCED_MAX_LIMIT)) {
            gs->enhanced_sound_data.limit = (unsigned int)temp_limit;
        }
        else {
            error_display (
                1, "Invalid enhanced sound limit: %d\n", temp_limit);
        }
    }
...
void parse_gamesnd_new (game_snd* gs, bool no_create) {
    ...
    if (!no_create) {
        ...
        if (gs->sound_entries.size () != 1) {
            error_display (
                1,
                "The SCP syntax cannot be used to modify an existing sound "
                "that has more than one entry! Use the soundset syntax for "
                "adding new entries.");
        }
        entry = &gs->sound_entries.back ();
    }
    ...
    if (strcasecmp (name, "<same>") != 0) { strcpy (entry->filename, name); }
        ...
        // entry
        error_display (
            1, "'<same>' is only allowed if +nocreate was specified!");
        return;
    }
...
void gamesnd_parse_entry (
    game_snd* gs, bool no_create, std::vector< game_snd >* lookupVector) {
    std::string name;
    ...
    if (optional_string ("+Filename:")) { parse_gamesnd_new (gs, no_create); }
 ...
 *
 * @return @c true when a new entry has been parsed and should be added to the
 *list of known entries. @c false otherwise, for example in case of @c
 *+nocreate
 */
bool gamesnd_parse_line (
    ...
    if (lookupVector != NULL) {
        if (optional_string ("+nocreate")) { no_create = true; }
    }
    ...
    try {
        ...
        if (optional_string ("#Flyby Sounds Start")) {
            ...
            while (!check_for_string ("#Flyby Sounds End") &&
                   (sanity_check <= (int)Species_info.size ())) {
                for (i = 0; i < Species_info.size (); i++) {
                    ...
                    if (check_for_string (species_name_tag)) {
                        gamesnd_parse_line (
                            &species->snd_flyby_fighter, species_name_tag);
                        gamesnd_parse_line (
                            &species->snd_flyby_bomber, species_name_tag);
                        sanity_check--;
                    }
                    else {
                        sanity_check++;
...
/**
 * Callback function for the UI code to call when the mouse first goes over a
 * button.
 */
...
game_snd_entry* gamesnd_choose_entry (game_snd* gs) {
    ...
    case GameSoundCycleType::Random:
        if (gs->sound_entries.size () == 1) { index = 0; }
        else {
            index =
                util::UniformRange< size_t > (0, gs->sound_entries.size () - 1)
                    .next ();
        }
        break;
    case GameSoundCycleType::Sequential:
        if (gs->last_entry_index == std::numeric_limits< size_t >::max ()) {
            // If this is the first time we must return the first sound to keep
