...
// if player targets a hostile ship at less than this range, switch to battle
// track
#define BATTLE_START_MIN_TARGET_DIST 500

extern int
    Event_Music_battle_started; // flag that will tell us if we've started a
                                // battle in the current mission
...
#endif // FREESPACE2_GAMESND_EVENTMUSIC_HH
