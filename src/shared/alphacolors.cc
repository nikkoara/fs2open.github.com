        ...
        try {
                ...
                if (optional_string("#Team Colors")) {
                        while (required_string_either("#End", "$Team Name:")) {
                                ...
                                if (Team_Colors.find(temp) == Team_Colors.end()) { // Only push to the vector if the
                ...
                if (optional_string("#Color Tags")) {
                        while (required_string_either("$Tag:", "#End") < 1) {
                                ...
                                if (Tagged_Colors.find(tag) == Tagged_Colors.end()) { // Only push the tag to our list of
                                ...
                                case -1:
                                        ...
                                        if (Tagged_Colors.find(tag) == Tagged_Colors.end()) { // It was a new color, but since we
