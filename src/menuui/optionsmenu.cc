...
void options_sliders_update()
{
        ...
        if (Joy_dead_zone_size != Options_sliders[gr_screen.res][OPT_JOY_DEADZONE_SLIDER].slider.pos * 5) {
                Joy_dead_zone_size = Options_sliders[gr_screen.res][OPT_JOY_DEADZONE_SLIDER]
                                             .slider.pos
                                     * 5;
                gamesnd_play_iface(InterfaceSounds::USER_SELECT);
        }
...
void options_menu_close()
{
        ...
        for (i = 0; i < NUM_TABS; i++) {
                ...
                if ((Backgrounds[gr_screen.res][i].mask >= 0) && (i != Tab)) { // Ui_window.destroy() expects to release current
                                                                               // tab's mask.
...
void options_menu_do_frame(float /*frametime*/)
{
        ...
        if (Tab == OPTIONS_TAB) {
                ...
                gr_string(
                        x + (Options_skills_text_coords[gr_screen.res][OPTIONS_W_COORD] / 2) - (w / 2),
