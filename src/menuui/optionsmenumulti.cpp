...
UI_XSTR Om_pro_text[GR_NUM_RESOLUTIONS][OM_PRO_NUM_TEXT] = {
    {
        // GR_640
        { "TCP", 1378, 38, 70, UI_XSTR_COLOR_GREEN, -1,
          &Om_pro_buttons[0][OM_PRO_TCP].button },
        { "IPX", 1379, 38, 88, UI_XSTR_COLOR_GREEN, -1,
          &Om_pro_buttons[0][OM_PRO_IPX].button },
        { "IP Address", 1380, 30, 128, UI_XSTR_COLOR_GREEN, -1,
          &Om_pro_bogus },
        { "add", 1381, 22, 235, UI_XSTR_COLOR_GREEN, -1,
          &Om_pro_buttons[0][OM_PRO_ADD_IP].button },
        { "rem.", 1382, 68, 235, UI_XSTR_COLOR_GREEN, -1,
          &Om_pro_buttons[0][OM_PRO_DELETE_IP].button },
        { "Broadcast Locally", 1387, 42, 260, UI_XSTR_COLOR_GREEN, -1,
          &Om_pro_buttons[0][OM_PRO_LOCAL_BROADCAST].button },
        { "PXO", 1383, 42, 291, UI_XSTR_COLOR_GREEN, -1,
        ...
        { "Voice", 1528, 557, 60, UI_XSTR_COLOR_GREEN, -1,
          &Om_pro_buttons[0][OM_PRO_VOX_TAB].button },
        { "General", 1388, 542, 77, UI_XSTR_COLOR_GREEN, -1,
          &Om_pro_buttons[0][OM_PRO_GEN_TAB].button },
    },
    {
        // GR_1024
        { "TCP", 1378, 61, 113, UI_XSTR_COLOR_GREEN, -1,
          &Om_pro_buttons[1][OM_PRO_TCP].button },
        { "IPX", 1379, 61, 141, UI_XSTR_COLOR_GREEN, -1,
          &Om_pro_buttons[1][OM_PRO_IPX].button },
        { "IP Address", 1380, 47, 206, UI_XSTR_COLOR_GREEN, -1,
          &Om_pro_bogus },
        { "add", 1381, 36, 375, UI_XSTR_COLOR_GREEN, -1,
          &Om_pro_buttons[1][OM_PRO_ADD_IP].button },
        { "rem.", 1382, 109, 375, UI_XSTR_COLOR_GREEN, -1,
          &Om_pro_buttons[1][OM_PRO_DELETE_IP].button },
        { "Broadcast Locally", 1387, 68, 417, UI_XSTR_COLOR_GREEN, -1,
          &Om_pro_buttons[1][OM_PRO_LOCAL_BROADCAST].button },
        { "PXO", 1383, 68, 467, UI_XSTR_COLOR_GREEN, -1,
        ...
        { "Voice", 1528, 921, 96, UI_XSTR_COLOR_GREEN, -1,
          &Om_pro_buttons[1][OM_PRO_VOX_TAB].button },
        { "General", 1388, 902, 123, UI_XSTR_COLOR_GREEN, -1,
...
int Ip_list_max_display[GR_NUM_RESOLUTIONS] = { 5, 5 };
...
// setting vars
int Om_local_broadcast; // whether the player has local broadcast selected or
                        // not
...
UI_XSTR Om_gen_text[GR_NUM_RESOLUTIONS][OM_GEN_NUM_TEXT] = {
    {
        // GR_640
        { "Object Update", 1391, 511, 104, UI_XSTR_COLOR_GREEN, -1,
          &Om_gen_bogus },
        { "Low", 1160, 558, 127, UI_XSTR_COLOR_GREEN, -1,
          &Om_gen_buttons[0][OM_GEN_OBJ_LOW].button },
        { "Medium", 1161, 538, 149, UI_XSTR_COLOR_GREEN, -1,
          &Om_gen_buttons[0][OM_GEN_OBJ_MED].button },
        { "High", 1162, 556, 171, UI_XSTR_COLOR_GREEN, -1,
          &Om_gen_buttons[0][OM_GEN_OBJ_HIGH].button },
        { "Lan", 1392, 561, 193, UI_XSTR_COLOR_GREEN, -1,
          &Om_gen_buttons[0][OM_GEN_OBJ_LAN].button },
        { "Pilot / Squad Images", 1393, 463, 214, UI_XSTR_COLOR_GREEN, -1,
          &Om_gen_bogus },
        { "Yes", 1394, 555, 257, UI_XSTR_COLOR_GREEN, -1,
          &Om_gen_buttons[0][OM_GEN_PIX_YES].button },
        { "No", 1395, 604, 257, UI_XSTR_COLOR_GREEN, -1,
          &Om_gen_buttons[0][OM_GEN_PIX_NO].button },
        { "Transfer Missions", 1396, 478, 271, UI_XSTR_COLOR_GREEN, -1,
          &Om_gen_bogus },
        { "/multidata", 1397, 519, 292, UI_XSTR_COLOR_GREEN, -1,
          &Om_gen_buttons[0][OM_GEN_XFER_MULTIDATA_YES].button },
        { "/missions", 1398, 527, 314, UI_XSTR_COLOR_GREEN, -1,
          &Om_gen_buttons[0][OM_GEN_XFER_MULTIDATA_NO].button },
        { "Flush Cache", 1399, 529, 334, UI_XSTR_COLOR_GREEN, -1,
          &Om_gen_bogus },
        { "Never", 1400, 548, 355, UI_XSTR_COLOR_GREEN, -1,
          &Om_gen_buttons[0][OM_GEN_FLUSH_NO].button },
        { "Before Game", 1401, 502, 377, UI_XSTR_COLOR_GREEN, -1,
          &Om_gen_buttons[0][OM_GEN_FLUSH_YES].button },
    },
    {
        // GR_1024
        { "Object Update", 1391, 818, 166, UI_XSTR_COLOR_GREEN, -1,
          &Om_gen_bogus },
        { "Low", 1160, 913, 204, UI_XSTR_COLOR_GREEN, -1,
          &Om_gen_buttons[1][OM_GEN_OBJ_LOW].button },
        { "Medium", 1161, 892, 239, UI_XSTR_COLOR_GREEN, -1,
          &Om_gen_buttons[1][OM_GEN_OBJ_MED].button },
        { "High", 1162, 909, 274, UI_XSTR_COLOR_GREEN, -1,
          &Om_gen_buttons[1][OM_GEN_OBJ_HIGH].button },
        { "Lan", 1392, 916, 310, UI_XSTR_COLOR_GREEN, -1,
          &Om_gen_buttons[1][OM_GEN_OBJ_LAN].button },
        { "Pilot / Squad Images", 1393, 821, 345, UI_XSTR_COLOR_GREEN, -1,
          &Om_gen_bogus },
        { "Yes", 1394, 887, 411, UI_XSTR_COLOR_GREEN, -1,
          &Om_gen_buttons[1][OM_GEN_PIX_YES].button },
        { "No", 1395, 966, 411, UI_XSTR_COLOR_GREEN, -1,
          &Om_gen_buttons[1][OM_GEN_PIX_NO].button },
        { "Transfer Missions", 1396, 844, 435, UI_XSTR_COLOR_GREEN, -1,
          &Om_gen_bogus },
        { "/multidata", 1397, 858, 468, UI_XSTR_COLOR_GREEN, -1,
          &Om_gen_buttons[1][OM_GEN_XFER_MULTIDATA_YES].button },
        { "/missions", 1398, 870, 503, UI_XSTR_COLOR_GREEN, -1,
          &Om_gen_buttons[1][OM_GEN_XFER_MULTIDATA_NO].button },
        { "Flush Cache", 1399, 886, 533, UI_XSTR_COLOR_GREEN, -1,
          &Om_gen_bogus },
        { "Never", 1400, 897, 568, UI_XSTR_COLOR_GREEN, -1,
          &Om_gen_buttons[1][OM_GEN_FLUSH_NO].button },
        { "Before Game", 1401, 849, 603, UI_XSTR_COLOR_GREEN, -1,
...
UI_XSTR Om_vox_text[GR_NUM_RESOLUTIONS][OM_VOX_NUM_TEXT] = {
    {
        // GR_640
        { "Mic test", 1389, 567, 104, UI_XSTR_COLOR_GREEN, -1,
          &Om_vox_buttons[0][OM_VOX_VOICE_TEST].button },
        { "Voice Quality", 1531, 439, 149, UI_XSTR_COLOR_GREEN, -1,
          &Om_vox_bogus },
        { "Voice Transmission", 1530, 439, 193, UI_XSTR_COLOR_GREEN, -1,
          &Om_vox_bogus },
        { "On", 1285, 556, 233, UI_XSTR_COLOR_GREEN, -1,
          &Om_vox_buttons[0][OM_VOX_VOICE_YES].button },
        { "Off", 1286, 604, 233, UI_XSTR_COLOR_GREEN, -1,
          &Om_vox_buttons[0][OM_VOX_VOICE_NO].button },
        { "Mute", 1390, 594, 381, UI_XSTR_COLOR_GREEN, -1,
          &Om_vox_buttons[0][OM_VOX_VOICE_MUTE].button },
    },
    {
        // GR_1024
        { "mic test", 1389, 908, 166, UI_XSTR_COLOR_GREEN, -1,
          &Om_vox_buttons[1][OM_VOX_VOICE_TEST].button },
        { "Voice Quality", 1531, 703, 239, UI_XSTR_COLOR_GREEN, -1,
          &Om_vox_bogus },
        { "Voice Transmission", 1530, 783, 310, UI_XSTR_COLOR_GREEN, -1,
          &Om_vox_bogus },
        { "On", 1285, 890, 373, UI_XSTR_COLOR_GREEN, -1,
          &Om_vox_buttons[1][OM_VOX_VOICE_YES].button },
        { "Off", 1286, 967, 373, UI_XSTR_COLOR_GREEN, -1,
          &Om_vox_buttons[1][OM_VOX_VOICE_NO].button },
        { "Mute", 1390, 950, 609, UI_XSTR_COLOR_GREEN, -1,
...
op_sliders Om_vox_sliders[GR_NUM_RESOLUTIONS][NUM_OM_VOX_SLIDERS] = {
    {
        // GR_640
        op_sliders (
            "OVB_18", 429, 162, -1, -1, 18, 20, 10, NULL, -1, -1, -1, NULL, -1,
            -1, -1), // voice QOS
    },
    {
        // GR_1024
        op_sliders (
            "2_OVB_18", 686, 259, -1, -1, 18, 31, 10, NULL, -1, -1, -1, NULL,
            -1, -1, -1), // voice QOS
    }
};

// player list area
int Om_vox_plist_coords[GR_NUM_RESOLUTIONS][4] = { { // GR_640
                                                     377, 270, 232, 79 },
                                                   { // GR_1024
                                                     604, 432, 371, 127 } };
int Om_vox_plist_max_display[GR_NUM_RESOLUTIONS] = { 6, 6 };
...
void options_multi_add_notify (const char* str) {
    ...
    if (str != NULL) { strcpy_s (Om_notify_string, str); }
...
void options_multi_load_protocol_controls () {
    ...
    for (idx = 0; idx < OM_PRO_NUM_BUTTONS; idx++) {
        // create the object
        Om_pro_buttons[gr_screen.res][idx].button.create (
            Om_window, "", Om_pro_buttons[gr_screen.res][idx].x,
            Om_pro_buttons[gr_screen.res][idx].y, 1, 1, 0, 1);

        // set the sound to play when highlighted
        Om_pro_buttons[gr_screen.res][idx].button.set_highlight_action (
            common_play_highlight_sound);

        // set the ani for the button
        Om_pro_buttons[gr_screen.res][idx].button.set_bmaps (
            Om_pro_buttons[gr_screen.res][idx].filename);

        // set the hotspot
        Om_pro_buttons[gr_screen.res][idx].button.link_hotspot (
            Om_pro_buttons[gr_screen.res][idx].hotspot);
    }
    ...
    Om_tracker_login.create (
        Om_window, Om_tracker_login_coords[gr_screen.res][0],
        Om_tracker_login_coords[gr_screen.res][1],
        Om_tracker_login_coords[gr_screen.res][2], LOGIN_LEN - 1,
        Multi_tracker_login,
        UI_INPUTBOX_FLAG_INVIS | UI_INPUTBOX_FLAG_ESC_CLR |
            UI_INPUTBOX_FLAG_KEYTHRU | UI_INPUTBOX_FLAG_NO_BACK);
    Om_tracker_passwd.create (
        Om_window, Om_tracker_passwd_coords[gr_screen.res][0],
        Om_tracker_passwd_coords[gr_screen.res][1],
        Om_tracker_passwd_coords[gr_screen.res][2], LOGIN_LEN - 1,
        Multi_tracker_passwd,
        UI_INPUTBOX_FLAG_INVIS | UI_INPUTBOX_FLAG_ESC_CLR |
            UI_INPUTBOX_FLAG_PASSWD | UI_INPUTBOX_FLAG_KEYTHRU |
            UI_INPUTBOX_FLAG_NO_BACK);
    Om_tracker_squad_name.create (
        Om_window, Om_tracker_squad_name_coords[gr_screen.res][0],
    ...
    // create the invisible button for checking for clicks on the ip address
    // list
    Om_ip_button.create (
        Om_window, "", Ip_list_coords[gr_screen.res][0],
        Ip_list_coords[gr_screen.res][1], Ip_list_coords[gr_screen.res][2],
        Ip_list_coords[gr_screen.res][3], 0, 1);
    Om_ip_button.hide ();

    // create the new ip address input box
    Om_ip_input.create (
        Om_window, Ip_input_coords[gr_screen.res][0],
        Ip_input_coords[gr_screen.res][1], Ip_input_coords[gr_screen.res][2],
        IP_STRING_LEN, IP_EMPTY_STRING,
        UI_INPUTBOX_FLAG_INVIS | UI_INPUTBOX_FLAG_ESC_CLR |
...
void options_multi_init_protocol_vars () {
    ...
    Om_local_broadcast =
        (Player->m_local_options.flags & MLO_FLAG_LOCAL_BROADCAST) ? 1 : 0;
...
void options_multi_protocol_do (int key) {
    ...
    if (Om_local_broadcast) {
        Om_pro_buttons[gr_screen.res][OM_PRO_LOCAL_BROADCAST]
    ...
    case KEY_TAB:
        ...
        if (Om_tracker_login.has_focus ()) { Om_tracker_passwd.set_focus (); }
    ...
    // check to see if the user has clicked on the ip list and selected a new
    // item
...
// if the accept button was hit
void options_multi_protocol_accept () {
    // if the user has selected local broadcast write it into his options
    // struct
...
void options_multi_protocol_button_pressed (int n) {
    ...
    case OM_PRO_LOCAL_BROADCAST:
        ...
        if (!Om_local_broadcast) { Om_local_broadcast = 1; }
        else {
    ...
    case OM_PRO_VMT:
        ...
        // if the thing is toggled on - enable the inputbox controls, else
        // diable them
        if (Om_tracker_flag) {
            Om_tracker_login.enable ();
            Om_tracker_passwd.enable ();
    ...
    case OM_PRO_IPX:
        ...
        popup (
            ...
            "The old IPX protocol is no longer supported.");
        break;
    }
}
...
void options_multi_protocol_save_ip_file () {
    ...
    for (idx = 0; idx < Om_num_ips; idx++) {
        ...
        // MWA -- commented out next line because name resolution might fail
        // when it was added.  We'll only grab games that we can actually get
        // to.
...
void options_multi_protocol_display_ips () {
    ...
    // get the # of items we should be displaying based upon the # of addresses
    // and the starting display point
    ...
    for (idx = Om_ip_start; idx >= Om_ip_start - Om_ip_disp_count + 1; idx--) {
        if (idx == Om_ip_selected) { gr_set_color_fast (&Color_bright); }
        else {
            gr_set_color_fast (&Color_white);
        }

        gr_printf_menu (
            Ip_list_coords[gr_screen.res][0], y_start, "%s", Om_ip_addrs[idx]);
        y_start += line_height;
    }
}
...
void options_multi_protocol_check_ip_list () {
    ...
    if (Om_ip_button.pressed ()) {
        ...
        if (item < Om_ip_disp_count) { Om_ip_selected = Om_ip_start - item; }
    }
}
...
void options_multi_protocol_delete_ip () {
    ...
    if (Om_ip_selected != -1) {
        ...
        Om_num_ips--;
        if (Om_num_ips <= 0) { Om_ip_selected = -1; }
        else {
            if (Om_ip_selected > 0) { Om_ip_selected--; }
        }
    }
}
...
int options_multi_verify_ip () {
    ...
    if (!Ip_validated_already) {
        ...
        // otherwise, change the popup text to indicate that it is invalid and
...
void options_multi_protocol_add_current_ip () {
    ...
    if (popup_till_condition (
            options_multi_verify_ip, XSTR ("Cancel", 387),
            XSTR ("Verifying ip address", 388)) == 10) {
        if (Om_num_ips < MAX_IP_ADDRS) {
            ...
            if (Om_num_ips == 1) { Om_ip_selected = 0; }
        }
        else {
            options_multi_add_notify (
                XSTR ("Max # of IP addresses reached!", 389));
        }
    }
}
...
void options_multi_load_gen_controls () {
    ...
    for (idx = 0; idx < OM_GEN_NUM_BUTTONS; idx++) {
        // create the object
        Om_gen_buttons[gr_screen.res][idx].button.create (
            Om_window, "", Om_gen_buttons[gr_screen.res][idx].x,
            Om_gen_buttons[gr_screen.res][idx].y, 1, 1, 0, 1);

        // set the sound to play when highlighted
        Om_gen_buttons[gr_screen.res][idx].button.set_highlight_action (
            common_play_highlight_sound);

        // set the ani for the button
        Om_gen_buttons[gr_screen.res][idx].button.set_bmaps (
            Om_gen_buttons[gr_screen.res][idx].filename);

        // set the hotspot
        Om_gen_buttons[gr_screen.res][idx].button.link_hotspot (
            Om_gen_buttons[gr_screen.res][idx].hotspot);
    }
...
void options_multi_gen_accept () {
    ...
    if (Om_gen_pix) { Player->m_local_options.flags |= MLO_FLAG_ACCEPT_PIX; }
...
void options_multi_gen_do () {
    ...
    if (Om_gen_xfer_multidata) {
        Om_gen_buttons[gr_screen.res][OM_GEN_XFER_MULTIDATA_YES]
            .button.draw_forced (2);
    }
    else {
        Om_gen_buttons[gr_screen.res][OM_GEN_XFER_MULTIDATA_NO]
            .button.draw_forced (2);
    }
...
void options_multi_load_vox_controls () {
    ...
    for (idx = 0; idx < OM_VOX_NUM_BUTTONS; idx++) {
        // create the object
        Om_vox_buttons[gr_screen.res][idx].button.create (
            Om_window, "", Om_vox_buttons[gr_screen.res][idx].x,
            Om_vox_buttons[gr_screen.res][idx].y, 1, 1, 0, 1);

        // set the sound to play when highlighted
        Om_vox_buttons[gr_screen.res][idx].button.set_highlight_action (
            common_play_highlight_sound);

        // set the ani for the button
        Om_vox_buttons[gr_screen.res][idx].button.set_bmaps (
            Om_vox_buttons[gr_screen.res][idx].filename);

        // set the hotspot
        Om_vox_buttons[gr_screen.res][idx].button.link_hotspot (
            Om_vox_buttons[gr_screen.res][idx].hotspot);
    }
    ...
    for (idx = 0; idx < NUM_OM_VOX_SLIDERS; idx++) {
        Om_vox_sliders[gr_screen.res][idx].slider.create (
            Om_window, Om_vox_sliders[gr_screen.res][idx].x,
    ...
    Om_vox_plist_button.create (
        Om_window, "", Om_vox_plist_coords[gr_screen.res][0],
        Om_vox_plist_coords[gr_screen.res][1],
        Om_vox_plist_coords[gr_screen.res][2],
    ...
    for (idx = 0; idx < MAX_PLAYERS; idx++) {
        ...
        if (MULTI_CONNECTED (Net_players[idx]) &&
            ...
            // set his mute flag
            Om_vox_player_flags[Om_vox_num_players] =
                (Multi_voice_local_prefs & (1 << idx)) ? 1 : 0;
...
void options_multi_vox_do () {
    ...
    if ((Om_vox_player_select != NULL) &&
        !Om_vox_player_flags[options_multi_vox_plist_get (
            Om_vox_player_select)]) {
        Om_vox_buttons[gr_screen.res][OM_VOX_VOICE_MUTE].button.draw_forced (
            2);
    }
    ...
    case OM_VOX_TEST_RECORDING:
        ...
        Om_vox_buttons[gr_screen.res][OM_VOX_VOICE_TEST].button.draw_forced (
            2);
        ...
        if (!multi_voice_test_recording ()) {
            ...
            if (Om_vox_voice_comp_size != -1) {
                ...
                if (handle != -1) {
                    Om_vox_playback_handle = rtvoice_play (
                        handle, Om_vox_comp_buffer, Om_vox_voice_comp_size);
                ...
                // on error, notify the user something is wrong
                    ...
                    options_multi_add_notify (XSTR (
                        "Error trying to playback recorded voice! Check your "
                        "hardware",
                        390));
    ...
    case OM_VOX_TEST_PLAYBACK:
        ...
        if ((Om_vox_playback_handle.isValid ()) &&
            !ds_is_channel_playing (ds_get_channel (Om_vox_playback_handle))) {
...
void options_multi_vox_button_pressed (int n) {
    ...
    // scroll the player list up
    case OM_VOX_PLIST_UP: options_multi_vox_plist_scroll_up (); break;

    // scroll the player list down
    case OM_VOX_PLIST_DOWN: options_multi_vox_plist_scroll_down (); break;
    ...
    case OM_VOX_VOICE_TEST:
        ...
        if ((Net_player != NULL) &&
            (Net_player->flags & NETINFO_FLAG_CONNECTED)) {
            options_multi_add_notify (
                XSTR ("Cannot test mic while in a multiplayer game!", 391));
            break;
        }
        ...
        if (!Multi_voice_can_record) {
            options_multi_add_notify (XSTR (
                "DirectSoundCapture could not be initialized. To initialize "
                "DirectSoundCapture your sound card must be full duplex and "
                "your sound card drivers must support DirectSoundCapture",
                392));
        }
        else {
            ...
            if (Om_vox_test_status == OM_VOX_TEST_NONE) {
                ...
                rtvoice_set_qos (
                    Om_vox_sliders[gr_screen.res][OM_VOX_QOS_SLIDER]
                        .slider.pos +
                    1);
...
void options_multi_vox_process_waveform () {
    ...
    if (Om_vox_test_status == OM_VOX_TEST_NONE) { return; }

    // grey the screen
    gr_set_shader (&Grey_shader);
    gr_shade (
        0, 0, gr_screen.clip_width, gr_screen.clip_height, GR_RESIZE_NONE);

    switch (Om_vox_test_status) {
    case OM_VOX_TEST_RECORDING:
        // if we have no sound buffer size, do nothing
        if (Om_vox_voice_buffer_size <= 0) { return; }

        // if we are not recording, do nothing
        if (Om_vox_test_status != OM_VOX_TEST_RECORDING) { return; }
        ...
        for (idx = 0; idx < c_width; idx++) {
            ...
            running_avg /= avg_len;
            gr_line (
                (gr_screen.max_w_unscaled - OM_VOX_WAVE_WIDTH) / 2 + idx,
                OM_VOX_WAVE_Y,
                (gr_screen.max_w_unscaled - OM_VOX_WAVE_WIDTH) / 2 + idx,
                OM_VOX_WAVE_Y + running_avg, GR_RESIZE_MENU);
        }
        ...
        if (multi_voice_test_packet_tossed ()) {
            gr_set_color_fast (&Color_bright);
            gr_string (
                OM_VOX_DROP_ICON_X, OM_VOX_DROP_ICON_Y,
                XSTR ("Packet Overflow", 393), GR_RESIZE_MENU);
        }
        break;
    ...
    case OM_VOX_TEST_PLAYBACK:
        ...
        buf_offset =
            ds_get_play_position (ds_get_channel (Om_vox_playback_handle));

        // get the # of samples we'll average for one line
        avg_len =
            (int)((float)OM_VOX_RECORD_INT * ((1024.0f * 11.0f) / 1000.0f)) /
            c_width;
    ...
    for (idx = Om_vox_plist_start; idx < Om_vox_num_players; idx++) {
        if (Om_vox_players[idx] != NULL) {
            ...
            font::force_fit_string (
                str, CALLSIGN_LEN + 1, Om_vox_plist_coords[gr_screen.res][2]);

            // blit the callsign
            gr_string (
                Om_vox_plist_coords[gr_screen.res][0], y_start, str,
                GR_RESIZE_MENU);
        ...
        if (p_count >= Om_vox_plist_max_display[gr_screen.res]) { break; }
    }
}
...
int options_multi_vox_plist_get (net_player* pl) {
    ...
    for (idx = 0; idx < Om_vox_num_players; idx++) {
        if (pl == Om_vox_players[idx]) { return idx; }
    }
...
void options_multi_vox_plist_scroll_down () {
    ...
    if ((Om_vox_num_players - Om_vox_plist_start) >=
        Om_vox_plist_max_display[gr_screen.res]) {
        Om_vox_plist_start++;
        gamesnd_play_iface (InterfaceSounds::USER_SELECT);
    }
    else {
...
void options_multi_do (int key) {
    ...
    switch (Om_mode) {
    case OM_MODE_GENERAL: options_multi_gen_do (); break;
    case OM_MODE_VOX: options_multi_vox_do (); break;
    default: Int3 ();
    }
}
...
bool options_multi_ok_to_accept () {
    ...
    if (Om_tracker_flag) {
        if (strlen (Multi_tracker_login) == 0) { return false; }
...
bool options_multi_accept () {
    ...
    if (!options_multi_ok_to_accept ()) { return false; }
    ...
    // if we're connected to a game server, update our options on the server
    // now
    if ((Net_player != NULL) &&
...
// called when the multiplayer tab is hit - initializes/switches all necessary
// data. NOTE : this is different from the initialization function, which is
...
// return the bitmap handle of the current background bitmap, or -1 if the
// multiplayer tab is not active
int options_multi_background_bitmap () {
    // return the background bitmap mode based upon the current mode
    switch (Om_mode) {
    case OM_MODE_GENERAL: return Om_background_0;

    case OM_MODE_VOX: return Om_background_1;
    }
...
void options_multi_set_voice_data (
    unsigned char* sound_buf, int buf_size, double /*gain*/) {
    if ((sound_buf == NULL) || (buf_size <= 0)) { return; }
    ...
    if (Om_vox_voice_comp_size == -1) { Om_vox_voice_comp_size = 0; }

    if ((Om_vox_voice_comp_size + buf_size) < OM_VOX_COMP_SIZE) {
        memcpy (
            Om_vox_comp_buffer + Om_vox_voice_comp_size, sound_buf, buf_size);
...
int options_multi_eat_tab () {
    ...
    if (Om_tracker_passwd.has_focus () || Om_tracker_login.has_focus () ||
        Om_tracker_squad_name.has_focus ()) {
        return 1;
    }
