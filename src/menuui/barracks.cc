...
int barracks_new_pilot_selected()
{
        ...
        for (i = 0; i < Num_pilot_images; i++) {
                if (!strcasecmp(stripped, Pilot_image_names[i])) {
                        break;
                }
        }
        Pic_number = i;
        ...
        for (i = 0; i < Num_pilot_squad_images; i++) {
                if (!strcasecmp(stripped, Pilot_squad_image_names[i])) {
                        break;
                }
        }
        Pic_squad_number = i;
...
void barracks_delete_pilot()
{
        ...
        if (!strcasecmp(Pilots[Selected_line], Cur_pilot->callsign)) {
                active = 1;
        }
        ...
        while (y + font_height <= Barracks_stats_coords[gr_screen.res][BARRACKS_H_COORD]) {
                ...
                if (*str == '*') {
                        ...
                        gr_line(
                                ...
                                Barracks_stats_coords[gr_screen.res][BARRACKS_X_COORD] + Barracks_stats_coords[gr_screen.res][BARRACKS_W_COORD] - w - 2,
                                i, GR_RESIZE_MENU);
                        gr_line(
                                Barracks_stats_coords[gr_screen.res][BARRACKS_X_COORD] + Barracks_stats_coords[gr_screen.res][BARRACKS_W_COORD] + 1,
                                i,
                                Barracks_stats2_coords[gr_screen.res][BARRACKS_X_COORD] + Barracks_stats2_coords[gr_screen.res][BARRACKS_W_COORD],
                                i, GR_RESIZE_MENU);
                } else {
                        gr_set_color_fast(&Color_text_normal);
                }
                ...
                gr_printf_menu(
                        Barracks_stats_coords[gr_screen.res][BARRACKS_X_COORD] + Barracks_stats_coords[gr_screen.res][BARRACKS_W_COORD] - w,
