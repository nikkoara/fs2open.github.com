...
//
// The idea is to read the mouse, and determine if the mouse pointer is
// currently over one of these regions.  Since these regions may be many
...
// used.
//
// The purpose of the key_in parameter is to allow the caller to determine if
// any keys are pressed while within the snazzy_menu_do().  It is an optional
// parameter.
//
