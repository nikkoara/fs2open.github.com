...
const char *fs2_open_credit_text = "SOURCE CODE PROJECT STAFF:\n"
                                   "\n"
                                   "Project Leader:\n"
                                   "\n"
...
void credits_init()
{
        ...
        Credit_start_pos = float(Credits_text_coords[gr_screen.res][CREDITS_H_COORD]);
...
void credits_do_frame(float /*frametime*/)
{
        ...
        int y_offset = 0;
        for (std::vector< std::string >::iterator iter = Credit_text_parts.begin();
