        ...
        case 0:
                for (idx1 = 0; idx1 < Neb2_slices; idx1++) {
                        for (idx2 = 0; idx2 < Neb2_slices; idx2++) {
                                ...
                                v->xyz.x = h_incw + (ws * (float)src) + fs2::prng::randf(0, -Nd->wj, Nd->wj);
                                v->xyz.y = h_inch + (hs * (float)idx1) + fs2::prng::randf(0, -Nd->hj, Nd->hj);
                                v->xyz.z = h_incd + (ds * (float)idx2) + fs2::prng::randf(0, -Nd->dj, Nd->dj);
                                ...
                                Neb2_cubes[src][idx1][idx2].rot_speed = fs2::prng::randf(0, -max_rotation, max_rotation);
        ...
        case 1:
                for (idx1 = 0; idx1 < Neb2_slices; idx1++) {
                        for (idx2 = 0; idx2 < Neb2_slices; idx2++) {
                                ...
                                v->xyz.x = h_incw + (ws * (float)idx1) + fs2::prng::randf(0, -Nd->wj, Nd->wj);
                                v->xyz.y = h_inch + (hs * (float)src) + fs2::prng::randf(0, -Nd->hj, Nd->hj);
                                v->xyz.z = h_incd + (ds * (float)idx2) + fs2::prng::randf(0, -Nd->dj, Nd->dj);
                                vm_vec_add2(v, &cube_corner);
                                ...
                                Neb2_cubes[idx1][src][idx2].rot_speed = fs2::prng::randf(0, -max_rotation, max_rotation);
                                Neb2_cubes[src][idx1][idx2].flash = 0.0f;
                        }
                }
                break;
        case 2:
                for (idx1 = 0; idx1 < Neb2_slices; idx1++) {
                        for (idx2 = 0; idx2 < Neb2_slices; idx2++) {
                                ...
                                v->xyz.x = h_incw + (ws * (float)idx1) + fs2::prng::randf(0, -Nd->wj, Nd->wj);
                                v->xyz.y = h_inch + (hs * (float)idx2) + fs2::prng::randf(0, -Nd->hj, Nd->hj);
                                v->xyz.z = h_incd + (ds * (float)src) + fs2::prng::randf(0, -Nd->dj, Nd->dj);
                                vm_vec_add2(v, &cube_corner);
                                ...
                                Neb2_cubes[idx1][idx2][src].rot_speed = fs2::prng::randf(0, -max_rotation, max_rotation);
                                Neb2_cubes[src][idx1][idx2].flash = 0.0f;
                        }
                }
                break;
        ...
        for (idx1 = 0; idx1 < Neb2_slices; idx1++) {
                for (idx2 = 0; idx2 < Neb2_slices; idx2++) {
                        for (idx3 = 0; idx3 < Neb2_slices; idx3++) {
                                ...
                                if ((ptemp.screen.xyw.x < 0.0f) || (ptemp.screen.xyw.x > (float)gr_screen.max_w) || (ptemp.screen.xyw.y < 0.0f) || (ptemp.screen.xyw.y > (float)gr_screen.max_h)) {
