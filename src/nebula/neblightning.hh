...
// generate a lightning bolt, returns l_left (the "head") and l_right (the
// "tail")
int nebl_gen (
...
// render the bolt
void nebl_render (
    bolt_type* bi, l_node* whee, float width, l_section* prev = NULL);
...
#endif // FREESPACE2_NEBULA_NEBLIGHTNING_HH
