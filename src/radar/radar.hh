...
#ifndef FREESPACE2_RADAR_RADAR_HH
#define FREESPACE2_RADAR_RADAR_HH
...
void radar_stuff_blip_info_std (
...
public:
    ...
    void
    drawContactImage (int x, int y, int rad, int idx, int clr_idx, int size);
...
#endif // FREESPACE2_RADAR_RADAR_HH
