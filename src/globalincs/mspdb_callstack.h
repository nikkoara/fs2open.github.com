 ...
 * Important note:
 *  When you call SCP_DumpStack, your thread will be suspended until the stack
 * is dumped If you've got more than a single thread
 */
...
public:
    ...
    virtual void
    OnEntry (void* address, const char* module, const char* symbol) PURE;
...
/* INTERNAL FUNCTIONS */
extern BOOL SCP_mspdbcs_ResolveSymbol (
    HANDLE hProcess, UINT_PTR dwAddress,
    SCP_mspdbcs_SDumpStackThreadInfo& siSymbol);
extern LPVOID __stdcall SCP_mspdbcs_FunctionTableAccess (
    HANDLE hProcess, DWORD64 dwPCAddress);
extern DWORD64 __stdcall SCP_mspdbcs_GetModuleBase (
