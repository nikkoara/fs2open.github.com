...
#ifndef FREESPACE2_GLOBALINCS_TOOLCHAIN_DOXYGEN_H
#define FREESPACE2_GLOBALINCS_TOOLCHAIN_DOXYGEN_H
...
#define SCP_FORMAT_STRING
 ...
 /**
  * @brief Specify which arguments are involved in printf-style string
  * formatting
  *
...
#define SCP_FORMAT_STRING_ARGS(formatArg, varArgs)
  ...
  * it's necessary to hide these changes behind a macro. Use this in place of
  * %zu
  */
...
#define PTRDIFF_T_ARG "%zd"
  ...
  *
  * This can be used to ensure that a static variable is present even if it
  * isn't referenced in the translation unit
  */
#define USED_VARIABLE
  ...
  *
  * Some compilers issue a warning if a fallthrough is detected. This define
  * can be used to suppress that warning.
  */
#define FALLTHROUGH

 /**
  * @brief Specifies that an analyzer should consider this function as
  * no-return
  */
#define CLANG_ANALYZER_NORETURN

 /**
  * @brief Specifies that the code at which point this macro appears at is
  * unreachable
...
#endif // FREESPACE2_GLOBALINCS_TOOLCHAIN_DOXYGEN_H
