...
// from ship.h
#define MAX_SHIPS \
    400 // max number of ship instances there can be.DTP; bumped from 200 to
        // 400
#define SHIPS_LIMIT \
    400 // what MAX_SHIPS will be at release time (for error checking in debug
        // mode); dtp Bumped from 200 to 400
...
#define MAX_TVT_WINGS \
    MAX_TVT_TEAMS* MAX_TVT_WINGS_PER_TEAM // number of wings in a TVT game
...
// size of complete escort list, including all those wanting to get onto list
// but without space
