...
#define CDARK_GRAY \
    Color_bright_white // since gray doesn't work with our current color
                       // system..
...
void ui_draw_shad (
    int x1, int y1, int x2, int y2, int r1, int g1, int b1, int r2, int g2,
    int b2);
