        ...
        float weapon_subsys_strength)
{
        ...
        float random_range = ((wip->flak_detonation_accuracy + (wip->flak_detonation_accuracy * 0.65f * (1.0f - weapon_subsys_strength))) * fs2::prng::randf(0, -1.0f, 1.0f));
        ...
        vec3d *pos, vec3d *dir, physics_info *pip, int turret_weapon_class)
{
        // sanity
        ASSERT(
                (turret_weapon_class >= 0) && (turret_weapon_class < Num_weapon_types));
