...
#ifndef FREESPACE2_UTIL_HEAPALLOCATOR_HH
#define FREESPACE2_UTIL_HEAPALLOCATOR_HH
 ...
 *
 * This class does not allocate memory! It only keeps track of where memory is
 * stored and which memory ranges may be reused later. This needs some kind of
 * underlying memory manager before it can do anything.
 */
class HeapAllocator {
public:
        /**
...
private:
     ...
     */
        ...
        static bool
        check_connected_range(const MemoryRange &left, const MemoryRange &right);
...
public:
     ...
     * @param offset The offset at which to free memory. This value must have
     * been returned by allocate previously!
     */
...
#endif // FREESPACE2_UTIL_HEAPALLOCATOR_HH
