...
#ifndef FREESPACE2_NETWORK_MULTI_KICK_H
#define FREESPACE2_NETWORK_MULTI_KICK_H
...
#define KICK_REASON_INGAME_ENDED \
    3 // kicked while ingame joining a mission about to end
