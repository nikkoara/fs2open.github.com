...
extern int
    Multi_ts_deleted_objnums[MULTI_TS_MAX_TVT_TEAMS * MULTI_TS_NUM_SHIP_SLOTS];
...
void multi_ts_get_team_and_slot (
    char* ship_name, int* team_index, int* slot_index,
...
void send_pslot_update_packet (
    int team, int code, interface_snd_id sound = interface_snd_id ());
