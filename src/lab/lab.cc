...
void labviewer_make_variables_window(Button * /*caller*/)
{
        ...
        Lab_variables_window = (Window *)Lab_screen->Add(new Window(
                "Class Variables",
                gr_screen.center_offset_x + gr_screen.center_w - (VAR_POS_RIGHTX + VAR_POS_RIGHTWIDTH + 25),
                gr_screen.center_offset_y + 200));
...
void labviewer_make_desc_window(Button * /*caller*/)
{
        ...
        Lab_description_window = (Window *)Lab_screen->Add(new Window(
                "Description",
                gr_screen.center_offset_x + gr_screen.center_w - gr_screen.center_w / 3 - 50,
                gr_screen.center_offset_y + gr_screen.center_h - gr_screen.center_h / 6 - 50,
...
void lab_do_frame(float frametime)
{
        ...
        if (test1) {
                ...
                case KEY_DIVIDE: {
                        ...
                        ASSERT(
                                (Lab_insignia_index >= 0) && (Lab_insignia_index < Num_pilot_squad_images));
