...
#define CHATBOX_FLAG_MULTI_PAUSED \
    (1 << 2) // chatbox in the multiplayer paused screen
#define CHATBOX_FLAG_DRAW_BOX (1 << 3) // should be drawn by the chatbox code
#define CHATBOX_FLAG_BUTTONS \
    (1 << 4) // the chatbox should be drawing/checking its own buttons
...
int chatbox_create (
    int mode_flags =
        (CHATBOX_FLAG_SMALL | CHATBOX_FLAG_DRAW_BOX | CHATBOX_FLAG_BUTTONS));
