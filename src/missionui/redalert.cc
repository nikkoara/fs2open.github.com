...
void red_alert_voice_load()
{
        ...
        if (strncasecmp(Briefing->stages[0].voice, NOX("none"), 4) != 0 && (Briefing->stages[0].voice[0] != '\0')) {
...
void red_alert_blit_title()
{
        ...
        gr_string(
                Ra_brief_text_wnd_coords[gr_screen.res][0] + ((Ra_brief_text_wnd_coords[gr_screen.res][2] - w) / 2),
