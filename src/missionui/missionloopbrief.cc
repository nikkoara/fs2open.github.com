...
void loop_brief_button_pressed(int i)
{
        ...
        case LOOP_BRIEF_ACCEPT:
                ...
                Campaign.loop_reentry = Campaign
...
void loop_brief_do(float frametime)
{
        ...
        case KEY_ESC:
                ...
                do_loop = popup(
                        PF_USE_NEGATIVE_ICON | PF_USE_AFFIRMATIVE_ICON | PF_IGNORE_ESC | PF_BODY_BIG,
                ...
                if (do_loop == 1) {
                        // select the loop mission
                        Campaign.loop_enabled = 1;
                        Campaign.loop_reentry = Campaign.next_mission; // save reentry pt, so we can break out
                                                                       // of loop
                        Campaign.next_mission = Campaign.loop_mission;
                }
