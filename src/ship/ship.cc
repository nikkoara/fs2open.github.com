...
#include "weapon/flak.hh" //phreak addded 11/05/02 for flak primaries
...
int Ship_auto_repair =
    1; // flag to indicate auto-repair of subsystem should occur
...
int Starting_wings[MAX_STARTING_WINGS]; // wings player starts a mission with
                                        // (-1 = none)
...
static void ship_add_cockpit_display (
    cockpit_display_info* display, int cockpit_model_num);
...
static int parse_ship_values (
    ship_info* sip, const bool is_template, const bool first_time,
    const bool replace);
...
flag_def_list Armor_flags[] = { { "ignore subsystem armor",
                                  SAF_IGNORE_SS_ARMOR, 0 } };
...
const size_t Num_man_types =
    sizeof (Man_types) / sizeof (flag_def_list_new< Thruster_Flags >);
...
// Use the last parameter here to tell the parser whether to stuff the flag
// into flags or flags2
flag_def_list_new< Model::Subsystem_Flags > Subsystem_flags[] = {
    { "untargetable", Model::Subsystem_Flags::Untargetable, true, false },
    { "carry no damage", Model::Subsystem_Flags::Carry_no_damage, true,
      false },
    { "use multiple guns", Model::Subsystem_Flags::Use_multiple_guns, true,
      false },
    { "fire down normals", Model::Subsystem_Flags::Fire_on_normal, true,
      false },
    { "check hull", Model::Subsystem_Flags::Turret_hull_check, true, false },
    { "fixed firingpoints", Model::Subsystem_Flags::Turret_fixed_fp, true,
      false },
    { "salvo mode", Model::Subsystem_Flags::Turret_salvo, true, false },
    { "no subsystem targeting", Model::Subsystem_Flags::No_ss_targeting, true,
      false },
    { "fire on target", Model::Subsystem_Flags::Fire_on_target, true, false },
    { "reset when idle", Model::Subsystem_Flags::Turret_reset_idle, true,
      false },
    { "carry shockwave", Model::Subsystem_Flags::Carry_shockwave, true,
      false },
    { "allow landing", Model::Subsystem_Flags::Allow_landing, true, false },
    { "target requires fov", Model::Subsystem_Flags::Fov_required, true,
      false },
    ...
    { "allow vanishing", Model::Subsystem_Flags::Allow_vanishing, true,
      false },
    ...
    { "wait for animation", Model::Subsystem_Flags::Turret_anim_wait, true,
      false },
    { "play fire sound for player",
      Model::Subsystem_Flags::Player_turret_sound, true, false },
    { "only target if can fire",
      Model::Subsystem_Flags::Turret_only_target_if_can_fire, true, false },
    { "no disappear", Model::Subsystem_Flags::No_disappear, true, false },
    { "collide submodel", Model::Subsystem_Flags::Collide_submodel, true,
      false },
    { "allow destroyed rotation", Model::Subsystem_Flags::Destroyed_rotation,
      true, false },
    { "turret use ammo", Model::Subsystem_Flags::Turret_use_ammo, true,
      false },
    { "autorepair if disabled", Model::Subsystem_Flags::Autorepair_if_disabled,
      true, false },
    { "don't autorepair if disabled",
      Model::Subsystem_Flags::No_autorepair_if_disabled, true, false },
    { "share fire direction", Model::Subsystem_Flags::Share_fire_direction,
      true, false }
};

const size_t Num_subsystem_flags =
    sizeof (Subsystem_flags) /
    sizeof (flag_def_list_new< Model::Subsystem_Flags >);
...
flag_def_list_new< Info_Flags > Ship_flags[] = {
    ...
    { "dont collide invisible", Info_Flags::Ship_class_dont_collide_invis,
      true, false },
    ...
    { "no weapon damage scaling", Info_Flags::Disable_weapon_damage_scaling,
      true, false },
    ...
    { "repair disabled subsystems", Info_Flags::Subsys_repair_when_disabled,
      true, false },
    // to keep things clean, obsolete options go last
    { "ballistic primaries", Info_Flags::Ballistic_primaries, false, false }
};

const size_t Num_ship_flags =
    sizeof (Ship_flags) / sizeof (flag_def_list_new< Info_Flags >);
...
const int num_ai_tgt_obj_flags =
    sizeof (ai_tgt_obj_flags) /
    sizeof (flag_def_list_new< Object::Object_Flags >);
...
flag_def_list_new< Ship::Info_Flags > ai_tgt_ship_flags[] = {
    ...
    { "default in tech database", Info_Flags::Default_in_tech_database, true,
      false },
    { "default in tech database multi", Info_Flags::Default_in_tech_database_m,
      true, false },
    { "flash", Info_Flags::Flash, true, false },
    { "show ship", Info_Flags::Show_ship_model, true, false },
    { "surface shields", Info_Flags::Surface_shields, true, false },
...
const int num_ai_tgt_ship_flags =
    sizeof (ai_tgt_ship_flags) /
    sizeof (flag_def_list_new< Ship::Info_Flags >);
...
flag_def_list_new< Weapon::Info_Flags > ai_tgt_weapon_flags[] = {
    ...
    { "default in tech database", Weapon::Info_Flags::Default_in_tech_database,
      true, false },
    ...
    { "variable lead homing", Weapon::Info_Flags::Variable_lead_homing, true,
      false },
    { "untargeted heat seeker", Weapon::Info_Flags::Untargeted_heat_seeker,
      true, false },
    { "no radius doubling", Weapon::Info_Flags::Hard_target_bomb, true,
      false },
    ...
    { "no lifeleft penalty", Weapon::Info_Flags::No_life_lost_if_missed, true,
      false },
    { "custom seeker str", Weapon::Info_Flags::Custom_seeker_str, true,
      false },
    ...
    { "chain external model fps", Weapon::Info_Flags::External_weapon_fp, true,
      false },
    { "external model launcher", Weapon::Info_Flags::External_weapon_lnch,
      true, false },
    { "takes blast damage", Weapon::Info_Flags::Takes_blast_damage, true,
      false },
    { "takes shockwave damage", Weapon::Info_Flags::Takes_shockwave_damage,
      true, false },
    ...
    { "same emp time for capships",
      Weapon::Info_Flags::Use_emp_time_for_capship_turrets, true, false },
    ...
    { "no homing speed ramp", Weapon::Info_Flags::No_homing_speed_ramp, true,
      false },
    { "pulls aspect seekers", Weapon::Info_Flags::Cmeasure_aspect_home_on,
      true, false },
...
const int num_ai_tgt_weapon_info_flags =
    sizeof (ai_tgt_weapon_flags) /
    sizeof (flag_def_list_new< Weapon::Info_Flags >);
...
static int Laser_energy_out_snd_timer; // timer so we play out of laser sound
                                       // effect periodically
static int Missile_out_snd_timer; // timer so we play out of laser sound effect
                                  // periodically

std::vector< ship_counts > Ship_type_counts;

// I don't want to do an AI cargo check every frame, so I made a global timer
// to limit check to every SHIP_CARGO_CHECK_INTERVAL ms.  Didn't want to make a
// timer in each ship struct.  Ensure inited to 1 at mission start.
...
static int ship_in_my_squadron (ship* shipp) {
    ...
    for (i = 0; i < MAX_STARTING_WINGS; i++) {
        if (shipp->wingnum == Starting_wings[i]) return 1;
    }

    for (i = 0; i < MAX_TVT_WINGS; i++) {
        if (shipp->wingnum == TVT_wings[i]) return 1;
    }
...
static void ship_obj_list_init () {
    ...
    for (i = 0; i < MAX_SHIP_OBJS; i++) { ship_obj_list_reset_slot (i); }
}
...
void ship_obj_list_rebuild () {
    ...
    for (objp = GET_FIRST (&obj_used_list);
        ...
        if (objp->type == OBJ_SHIP) {
            Ships[objp->instance].ship_list_index =
                ship_obj_list_add (OBJ_INDEX (objp));
        }
    }
}
...
static void parse_engine_wash (bool replace) {
    ...
    if (ewp != NULL) {
        ...
        // Don't create engine wash if it has +nocreate and is in a modular
        // table.
    ...
    if (optional_string ("$Radius Mult:")) { stuff_float (&ewp->radius_mult); }

    // length of cone
    if (optional_string ("$Length:")) { stuff_float (&ewp->length); }

    // intensity inside hemisphere (or at 0 distance from frustated cone)
    if (optional_string ("$Intensity:")) { stuff_float (&ewp->intensity); }
}

static const char* Warp_types[] = {
    "Default", "Knossos", "Babylon5", "Galactica", "Homeworld", "Hyperspace",
};
...
void ship_info::clone (const ship_info& other) {
    ...
    memcpy (
        ...
        sizeof (int) * MAX_SHIP_DETAIL_LEVELS);
    collision_lod = other.collision_lod;

    // I'm not sure if these three are A) a good idea or B) relevant at all.
    // -MageKing17
    ...
    if (other.n_subsystems > 0) {
        ...
        for (int i = 0; i < other.n_subsystems; i++) {
            ...
            memcpy (
                subsystems[i].triggers, other.subsystems[i].triggers,
    ...
    memcpy (
        primary_bank_weapons, other.primary_bank_weapons,
        sizeof (int) * MAX_SHIP_PRIMARY_BANKS);
    memcpy (
        primary_bank_ammo_capacity, other.primary_bank_ammo_capacity,
        sizeof (int) * MAX_SHIP_PRIMARY_BANKS);

    num_secondary_banks = other.num_secondary_banks;
    memcpy (
        secondary_bank_weapons, other.secondary_bank_weapons,
        sizeof (int) * MAX_SHIP_SECONDARY_BANKS);
    memcpy (
        secondary_bank_ammo_capacity, other.secondary_bank_ammo_capacity,
        sizeof (int) * MAX_SHIP_SECONDARY_BANKS);

    memcpy (
        draw_primary_models, other.draw_primary_models,
        sizeof (bool) * MAX_SHIP_PRIMARY_BANKS);
    memcpy (
        draw_secondary_models, other.draw_secondary_models,
        sizeof (bool) * MAX_SHIP_SECONDARY_BANKS);
    ...
    // ...Hmm. A memcpy() seems slightly overkill here, but I've settled into
    // the pattern of "array gets memcpy'd", so... -MageKing17
    memcpy (
        shield_point_augment_ctrls, other.shield_point_augment_ctrls,
        sizeof (int) * 4);
    ...
    memcpy (
        ...
        sizeof (int) * MAX_WEAPON_TYPES);

    memcpy (
        restricted_loadout_flag, other.restricted_loadout_flag,
        sizeof (int) * MAX_SHIP_WEAPONS);
    memcpy (
    ...
    afterburner_trail_faded_out_sections =
        other.afterburner_trail_faded_out_sections;
    ...
    memcpy (
        &thruster_flame_info, &other.thruster_flame_info,
        sizeof (thrust_pair));
    memcpy (
        &thruster_glow_info, &other.thruster_glow_info, sizeof (thrust_pair));
    memcpy (
        &thruster_secondary_glow_info, &other.thruster_secondary_glow_info,
        sizeof (thrust_pair_bitmap));
    memcpy (
        &thruster_tertiary_glow_info, &other.thruster_tertiary_glow_info,
        sizeof (thrust_pair_bitmap));
    memcpy (
        &thruster_distortion_info, &other.thruster_distortion_info,
        sizeof (thrust_pair_bitmap));
    ...
    // We can't copy the HUD gauge vector here since we can't construct a copy
    // of every HUD gauge since the type information is not available anymore
...
ship_info::ship_info (ship_info&& other) noexcept {
    ...
    // Then we swap everything (well, everything that matters to the
    // deconstructor).
    move (std::move (other));
}
...
ship_info::ship_info () {
    ...
    alt_name[0] = '\0';
    sprintf (
        short_name, "ShipClass%d", static_cast< int > (Ship_info.size ()));
    species = 0;
    class_type = -1;
    ...
    for (i = 0; i < 4; i++) { shield_point_augment_ctrls[i] = -1; }
    ...
    memset (
        allowed_bank_restricted_weapons, 0,
        sizeof (int) * MAX_SHIP_WEAPONS * MAX_WEAPON_TYPES);
    ...
    for (i = 0; i < MAX_MAN_THRUSTERS; i++) { maneuvering[i].reset (); }
    ...
    for (i = 0; i < MAX_IFFS; i++) {
        for (j = 0; j < MAX_IFFS; j++) ship_iff_info[i][j] = -1;
    }
...
static int parse_ship_template () {
    ...
    if (template_id != -1) {
        ...
        if (!skip_to_start_of_string_either ("$Template:", "#End")) {
            error_display (
                1,
                "Missing [#End] or [$Template] after duplicate entry for %s",
                sip->name);
        }
        return -1;
    }
...
static void parse_ship_sounds (ship_info* sip) {
    ...
    parse_ship_sound (
        "$MissileTrackingSnd:", GameSounds::MISSILE_TRACKING, sip);
    ...
    parse_ship_sound (
        "$PrimaryFireFailedSnd:", GameSounds::OUT_OF_WEAPON_ENERGY, sip);
    parse_ship_sound (
        "$SecondaryFireFailedSnd:", GameSounds::OUT_OF_MISSLES, sip);
    parse_ship_sound (
        "$HeatSeekerLaunchWarningSnd:", GameSounds::HEATLOCK_WARN, sip);
    parse_ship_sound (
        "$AspectSeekerLaunchWarningSnd:", GameSounds::ASPECTLOCK_WARN, sip);
    parse_ship_sound (
        "$MissileLockWarningSnd:", GameSounds::THREAT_FLASH, sip);
    parse_ship_sound (
        "$HeatSeekerProximityWarningSnd:", GameSounds::PROXIMITY_WARNING, sip);
    parse_ship_sound (
        "$AspectSeekerProximityWarningSnd:",
        GameSounds::PROXIMITY_ASPECT_WARNING, sip);
    parse_ship_sound (
        "$MissileEvadedSnd:", GameSounds::MISSILE_EVADED_POPUP, sip);
...
static void parse_ship_particle_effect (
    ship_info* sip, particle_effect* pe, const char* id_string) {
    float tempf;
    int temp;
    ...
    if (pe->n_low > pe->n_high) pe->n_low = pe->n_high;
    ...
    if (pe->min_rad > pe->max_rad) pe->min_rad = pe->max_rad;
    ...
    if (pe->min_life > pe->max_life) pe->min_life = pe->max_life;
    ...
    if (pe->min_vel > pe->max_vel) pe->min_vel = pe->max_vel;
...
static void parse_allowed_weapons (
    ship_info* sip, const bool is_primary, const bool is_dogfight,
    ...
    const char* allowed_banks_str =
        is_primary
            ? (is_dogfight ? "$Allowed Dogfight PBanks:" : "$Allowed PBanks:")
    ...
    if (optional_string (allowed_banks_str)) {
        // MageKing17 - We need to make modular tables replace bank
        // restrictions by default, instead of adding to them.
        if (!first_time &&
            !(optional_string (
                "+noreplace"))) { // Only makes sense for modular tables.
            // clear allowed weapons so the modular table can define new ones
            for (bank = 0; bank < max_banks; bank++) {
                for (i = 0; i < Num_weapon_types; i++) {
                    sip->allowed_bank_restricted_weapons[offset + bank][i] &=
                        ~weapon_type;
                }
        ...
        while (check_for_string ("(")) {
            ...
            num_allowed = stuff_int_list (
                allowed_weapons, MAX_WEAPON_TYPES, WEAPON_LIST_TYPE);

            // actually say which weapons are allowed
            for (i = 0; i < num_allowed; i++) {
                if (allowed_weapons[i] >=
                    0) // MK, Bug fix, 9/6/99.  Used to be "allowed_weapons"
                       // not "allowed_weapons[i]".
                {
                    sip->allowed_bank_restricted_weapons[offset + bank]
                                                        [allowed_weapons[i]] |=
                        weapon_type;
                }
            }
...
/**
 * Common method for parsing ship/subsystem primary/secondary weapons so that
 * the parser doesn't flip out in the event of a problem.
 *
 */
static void parse_weapon_bank (
    ...
    const char* default_banks_str =
        is_primary ? "$Default PBanks:" : "$Default SBanks:";
    const char* bank_capacities_str =
        is_primary ? "$PBank Capacity:" : "$SBank Capacity:";
    ...
    if (optional_string (default_banks_str)) {
        // get weapon list
        if (num_banks != NULL)
            *num_banks = stuff_int_list (
                bank_default_weapons, max_banks, WEAPON_LIST_TYPE);
        else
    ...
    if (optional_string (bank_capacities_str)) {
        // get capacity list
        num_bank_capacities =
            stuff_int_list (bank_capacities, max_banks, RAW_INTEGER_TYPE);
    }
...
static int parse_ship_values (
    ...
    // Ship fadein effect, used when no ani is specified or ship_select_3d is
    // active
    sip->selection_effect =
        Default_ship_select_effect; // By default, use the FS2 effect
    ...
    if (optional_string ("$Cockpit POF file:")) {
        ...
        // Goober5000 - if this is a modular table, and we're replacing an
        // existing file name, and the file doesn't exist, don't replace it
        if (replace)
    ...
    if (optional_string ("$POF file Techroom:")) {
        ...
        // if this is a modular table, and we're replacing an existing file
        // name, and the file doesn't exist, don't replace it
        if (replace)
    ...
    if (optional_string ("$Detail distance:")) {
        sip->num_detail_levels = stuff_int_list (
            sip->detail_distance, MAX_SHIP_DETAIL_LEVELS, RAW_INTEGER_TYPE);
    }
    ...
    if (optional_string ("$Collision LOD:")) {
        ...
        sip->collision_lod =
            MAX (0, MIN (sip->collision_lod, sip->num_detail_levels));
    }
    ...
    if (optional_string ("$Forward accel:")) stuff_float (&sip->forward_accel);

    if (optional_string ("$Forward decel:")) stuff_float (&sip->forward_decel);

    if (optional_string ("$Slide accel:")) stuff_float (&sip->slide_accel);

    if (optional_string ("$Slide decel:")) stuff_float (&sip->slide_decel);

    if (optional_string ("$Glide:")) { stuff_boolean (&sip->can_glide); }
    ...
    if (optional_string ("$Autoaim FOV:")) {
        ...
        if (fov_temp < 0.0f) fov_temp = 0.0f;

        if (fov_temp > 180.0f) fov_temp = 180.0f;
    ...
    if (optional_string ("$Convergence:")) {
        ...
        if (optional_string ("+Offset:")) {
            ...
            sip->aiming_flags.set (
                Ship::Aiming_Flags::Convergence_offset,
                !IS_VEC_NULL (&sip->convergence_offset));
        }
    }
    ...
    if (optional_string ("$Expl damage:")) { stuff_float (&sci->damage); }

    if (optional_string ("$Expl blast:")) { stuff_float (&sci->blast); }
    ...
    if (optional_string ("$Ship Death Effect:")) {
        ...
        parse_ship_particle_effect (
            sip, &sip->regular_end_particles, "normal death spew");
    }

    if (optional_string ("$Alternate Death Particles:")) {
        parse_ship_particle_effect (
            sip, &sip->knossos_end_particles, "knossos death spew");
    }
    ...
    if (optional_string ("$Shockwave Speed:")) { stuff_float (&sci->speed); }
    ...
    if (optional_string ("$Explosion Animations:")) {
        ...
        int parsed_ints =
            stuff_int_list (temp, MAX_FIREBALL_TYPES, RAW_INTEGER_TYPE);
        sip->explosion_bitmap_anims.clear ();
        sip->explosion_bitmap_anims.insert (
            sip->explosion_bitmap_anims.begin (), temp, temp + parsed_ints);
    }
    ...
    parse_weapon_bank (
        sip, true, &sip->num_primary_banks, sip->primary_bank_weapons,
        sip->primary_bank_ammo_capacity);
    ...
    parse_weapon_bank (
        sip, false, &sip->num_secondary_banks, sip->secondary_bank_weapons,
    ...
    if (optional_string ("$Power Output:")) stuff_float (&sip->power_output);
    ...
    if (optional_string ("$Flags:")) {
        ...
        if (!optional_string ("+noreplace")) {
            ...
            bool draw_weapon_models =
                sip->flags[Ship::Info_Flags::Draw_weapon_models];
            sip->flags.reset ();
            sip->flags.set (Ship::Info_Flags::Afterburner, has_afterburner);
            sip->flags.set (
                Ship::Info_Flags::Draw_weapon_models, draw_weapon_models);
        }
        ...
        for (auto i = 0; i < num_strings; i++) {
            ...
            // Goober5000 - in retail FreeSpace, some ship classes were
    ...
    find_and_stuff_optional (
        "$AI Class:", &sip->ai_class, F_NAME, Ai_class_names, Num_ai_classes,
        "AI class names");

    // Get Afterburner information
    // Be aware that if $Afterburner is not 1, the other Afterburner fields are
    // not read in
    int has_afterburner = 0;

    if (optional_string ("$Afterburner:")) stuff_boolean (&has_afterburner);
    ...
    if (optional_string ("$Trails:")) {
        ...
        if (optional_string ("+Bitmap:")) {
            ...
            stuff_string (
                sip->afterburner_trail.filename, F_NAME, MAX_FILENAME_LEN);
        }
    ...
    if (optional_string ("$Countermeasures:")) stuff_int (&sip->cmeasure_max);

    if (optional_string ("$Scan time:")) stuff_int (&sip->scan_time);
    ...
    if (optional_string ("$Closeup_pos:")) { stuff_vec3d (&sip->closeup_pos); }
        ...
        if (temp > sip->closeup_pos.xyz.z) sip->closeup_pos.xyz.z = temp;
    ...
    if (first_time) {
        ...
        sip->thruster_secondary_glow_info =
            species->thruster_secondary_glow_info;
        sip->thruster_tertiary_glow_info =
            species->thruster_tertiary_glow_info;
    ...
    if (optional_string ("$Thruster Bitmap 2:")) {
        ...
        if (VALID_FNAME (name_tmp))
            generic_bitmap_init (
                &sip->thruster_secondary_glow_info.normal, name_tmp);
    }
    ...
    if (optional_string ("$Thruster Bitmap 2a:")) {
        ...
        if (VALID_FNAME (name_tmp))
            generic_bitmap_init (
                &sip->thruster_secondary_glow_info.afterburn, name_tmp);
    }
    ...
    if (optional_string ("$Thruster Bitmap 3:")) {
        ...
        if (VALID_FNAME (name_tmp))
            generic_bitmap_init (
                &sip->thruster_tertiary_glow_info.normal, name_tmp);
    }
    ...
    if (optional_string ("$Thruster Bitmap 3a:")) {
        ...
        if (VALID_FNAME (name_tmp))
            generic_bitmap_init (
                &sip->thruster_tertiary_glow_info.afterburn, name_tmp);
    }
    ...
    if (optional_string ("$Thruster Bitmap Distortion:")) {
        ...
        if (VALID_FNAME (name_tmp))
            generic_bitmap_init (
                &sip->thruster_distortion_info.normal, name_tmp);
    }
    ...
    if (optional_string ("$Thruster Bitmap Distortion a:")) {
        ...
        if (VALID_FNAME (name_tmp))
            generic_bitmap_init (
                &sip->thruster_distortion_info.afterburn, name_tmp);
    }
    ...
    while (optional_string ("$Thruster Particles:")) {
        ...
        stuff_string (
            tpart.thruster_bitmap.filename, F_NAME, MAX_FILENAME_LEN);
    ...
    while (optional_string ("$Trail:")) {
        ...
        if (optional_string ("+ClearAll")) {
            memset (
                &sip->ct_info, 0, sizeof (trail_info) * MAX_SHIP_CONTRAILS);
            sip->ct_count = 0;
        }
    ...
    while (optional_string ("$Thruster:")) {
        int idx = -1;
        if (optional_string ("+index:")) { stuff_int (&idx); }
        ...
        if (optional_string ("+Used for:")) {
            parse_string_flag_list (
                mtp->use_flags, Man_types, Num_man_types, NULL);
        }
        ...
        if (optional_string ("+Texture:")) {
            ...
            ;
            tex_id = bm_load_animation (
                name_tmp, &tex_nframes, &tex_fps, nullptr, nullptr, true);
            if (tex_id < 0) tex_id = bm_load (name_tmp);
            if (tex_id >= 0) {
                if (mtp->tex_id >= 0) { bm_unload (mtp->tex_id); }
        ...
        if (optional_string ("+Radius:")) { stuff_float (&mtp->radius); }

        if (optional_string ("+Length:")) { stuff_float (&mtp->length); }
            ...
            do {
                ...
                if (fromtopos != std::string::npos) {
                    ...
                    for (int bank = ifrom; bank <= ito; ++bank) {
                        sip->glowpoint_bank_override_map[bank] =
                            (void*)(&(*gpo));
                    }
                }
                else {
    ...
    while ((optional_string ("$Ship IFF Colors:")) ||
           (optional_string ("$Ship IFF Colours:"))) {
        ...
        sip->ship_iff_info[iff_data[0]][iff_data[1]] = iff_init_color (
            iff_color_data[0], iff_color_data[1], iff_color_data[2]);
    }
    ...
    if (optional_string ("$Target Priority Groups:")) {
        ...
        if (optional_string ("+Override")) { override_strings = true; }
        ...
        for (auto j = 0; j < num_strings; j++) {
            ...
            for (i = 0; i < num_groups; i++) {
                if (!strcasecmp (
                    ...
                    // priority group name match clear it if override has been
                    // set
                    if (override_strings) {
    ...
    int n_subsystems = 0;
    int cont_flag = 1;
    model_subsystem subsystems[MAX_MODEL_SUBSYSTEMS]; // see model.h for
                                                      // max_model_subsystems
    ...
    for (auto i = 0; i < sip->n_subsystems; i++) {
        hull_percentage_of_hits -=
            sip->subsystems[i].max_subsys_strength / sip->max_hull_strength;
    }

    while (cont_flag) {
        int r = required_string_one_of (3, "#End", "$Subsystem:", type_name);
        switch (r) {
        case 0: cont_flag = 0; break;
        case 1: {
            float turning_rate;
            float percentage_of_hits;
            bool turret_has_base_fov = false;
            model_subsystem* sp =
                NULL; // to append on the ships list of subsystems
            ...
            if (sp == NULL) {
                ...
                memset (
                    sp->alt_dmg_sub_name, 0, sizeof (sp->alt_dmg_sub_name));
                ...
                for (auto i = 0; i < 32; i++) { sp->target_priority[i] = -1; }
            ...
            if (sfo_return == 2) {
                ...
                sp->max_subsys_strength =
                    sip->max_hull_strength * (percentage_of_hits / 100.0f);
            ...
            parse_game_sound (
                "$Turret Base RotationSnd:", &sp->turret_base_rotation_snd);
            parse_game_sound (
                "$Turret Gun RotationSnd:", &sp->turret_gun_rotation_snd);
            ...
            if (optional_string ("$AWACS:")) {
                ...
                if (sfo_return > 0) stuff_float_optional (&sp->awacs_radius);
            ...
            if (optional_string ("$Turret Direction Preference:")) {
                int temp;
                stuff_int (&temp);
                if (temp == 0) { sp->favor_current_facing = 0.0f; }
                else {
                    CAP (temp, 1, 100);
                    sp->favor_current_facing =
                        1.0f + (((float)(100 - temp)) / 10.0f);
                }
            }
            ...
            if (optional_string ("$Target Priority:")) {
                ...
                if (num_strings > 32) num_strings = 32;
            ...
            if (optional_string ("$Flags:")) {
                ...
                parse_string_flag_list (
                    tmp_flags, Subsystem_flags, Num_subsystem_flags, &errors);

                if (optional_string ("+noreplace")) { sp->flags |= tmp_flags; }
                else {
                    sp->flags = tmp_flags;
                }
                ...
                // If we've set any subsystem as landable, set a ship-info flag
                // as a shortcut for later
            ...
            if ((sp->flags[Model::Subsystem_Flags::Autorepair_if_disabled]) &&
                ...
                if (sip->flags
                    ...
                    sp->flags.remove (
                        Model::Subsystem_Flags::Autorepair_if_disabled);
                }
                else {
                    sp->flags.remove (
                        Model::Subsystem_Flags::No_autorepair_if_disabled);
            ...
            while (optional_string ("$animation:")) {
                ...
                if (!strcasecmp (name_tmp, "triggered")) {
                    ...
                    if (current_trigger->type == TRIGGER_TYPE_INITIAL) {
                        // the only thing initial animation type needs is the
                        // angle, so to save space lets just make everything
                        ...
                        if (optional_string ("+reverse_delay:"))
                            ...
                            current_trigger->reverse_start =
                                -1; // have some code figure this out for us
                        ...
                        if (optional_string ("$Sound:")) {
                            parse_game_sound (
                                "+Start:", &current_trigger->start_sound);

                            parse_game_sound (
                                "+Loop:", &current_trigger->loop_sound);

                            parse_game_sound (
                                "+End:", &current_trigger->end_sound);
...
static void parse_ship_type () {
    ...
    if (optional_string ("+nocreate")) { nocreate = true; }
        ...
        for (auto j = 0; j < num_strings; j++) {
            ...
            for (i = 0; i < num_groups; i++) {
                if (!strcasecmp (
                    ...
                    // find the index number of the current ship info type
                    Ai_tp_list[i].ship_type.push_back (
                        ship_type_name_lookup (name_buf));
                    break;
                }
            }
            if (i == num_groups) {
    ...
    if (optional_string ("$Counts for Alone:")) {
        stuff_boolean_flag (
            stp->flags, Ship::Type_Info_Flags::Counts_for_alone);
    }

    if (optional_string ("$Praise Destruction:")) {
        stuff_boolean_flag (
            stp->flags, Ship::Type_Info_Flags::Praise_destruction);
    }
    ...
    if (optional_string ("$Target as Threat:")) {
        stuff_boolean_flag (
            stp->flags, Ship::Type_Info_Flags::Target_as_threat);
    }

    if (optional_string ("$Show Attack Direction:")) {
        stuff_boolean_flag (
            stp->flags, Ship::Type_Info_Flags::Show_attack_direction);
    }
    ...
    if (optional_string ("$Turrets prioritize ship target:")) {
        stuff_boolean_flag (
            stp->flags, Ship::Type_Info_Flags::Turret_tgt_ship_tgt);
    }
    ...
    if (optional_string ("$Beams Easily Hit:")) {
        stuff_boolean_flag (
            stp->flags, Ship::Type_Info_Flags::Beams_easily_hit);
    }

    if (optional_string ("$Protected on cripple:")) {
        stuff_boolean_flag (
            stp->flags, Ship::Type_Info_Flags::AI_protected_on_cripple);
    }

    if (optional_string ("$No Huge Beam Impact Effects:")) {
        stuff_boolean_flag (
            stp->flags, Ship::Type_Info_Flags::No_huge_impact_eff);
    }

    if (optional_string ("$Don't display class in briefing:")) {
        stuff_boolean_flag (
            stp->flags, Ship::Type_Info_Flags::No_class_display);
    }
    ...
    if (optional_string ("$AI:")) {
        if (optional_string ("+Valid goals:")) {
            parse_string_flag_list (
                &stp->ai_valid_goals, Ai_goal_names, Num_ai_goals);
        }

        if (optional_string ("+Accept Player Orders:")) {
            stuff_boolean_flag (
                stp->flags, Ship::Type_Info_Flags::AI_accept_player_orders);
        }

        if (optional_string ("+Player Orders:")) {
            parse_string_flag_list (
                &stp->ai_player_orders, Player_orders, Num_player_orders);
        }

        if (optional_string ("+Auto attacks:")) {
            stuff_boolean_flag (
                stp->flags, Ship::Type_Info_Flags::AI_auto_attacks);
        }

        if (optional_string ("+Attempt broadside:")) {
            stuff_boolean_flag (
                stp->flags, Ship::Type_Info_Flags::AI_attempt_broadside);
        }
        ...
        if (optional_string ("+Guards attack this:")) {
            stuff_boolean_flag (
                stp->flags, Ship::Type_Info_Flags::AI_guards_attack);
        }

        if (optional_string ("+Turrets attack this:")) {
            stuff_boolean_flag (
                stp->flags, Ship::Type_Info_Flags::AI_turrets_attack);
        }

        if (optional_string ("+Can form wing:")) {
            stuff_boolean_flag (
                stp->flags, Ship::Type_Info_Flags::AI_can_form_wing);
        }

        if (optional_string ("+Active docks:")) {
            parse_string_flag_list (
                &stp->ai_active_dock, Dock_type_names, Num_dock_type_names);
        }

        if (optional_string ("+Passive docks:")) {
            parse_string_flag_list (
                &stp->ai_passive_dock, Dock_type_names, Num_dock_type_names);
        }
    ...
    if (optional_string ("$Explosion Animations:")) {
        ...
        stp->explosion_bitmap_anims.insert (
            stp->explosion_bitmap_anims.begin (), temp, temp + parsed_ints);
    }
    ...
    if (!nocreate) Ship_types.push_back (stp_buf);
}
...
static void ship_set_default_player_ship () {
    // already have one
    if (strlen (default_player_ship)) return;
...
static void parse_shiptbl (const char* filename) {
    try {
        ...
        if (optional_string ("#Default Player Ship")) {
            required_string ("$Name:");
            stuff_string (
                default_player_ship, F_NAME, sizeof (default_player_ship));
            required_string ("#End");
        }
        // Add engine washes
        ...
        if (optional_string ("#Ship Templates")) {
            while (required_string_either ("#End", "$Template:")) {
                if (parse_ship_template ()) { continue; }
            }
        ...
        if (optional_string ("#Ship Classes")) {
            while (required_string_either ("#End", "$Name:")) {
                if (parse_ship (filename, Parsing_modular_table)) { continue; }
            }
...
static bool ballistic_possible_for_this_ship (const ship_info* sip) {
    for (int i = 0; i < MAX_SHIP_PRIMARY_BANKS; i++) {
        for (int j = 0; j < Num_weapon_types; ++j) {
            if (sip->allowed_bank_restricted_weapons[i][j] &&
                (Weapon_info[j].wi_flags[Weapon::Info_Flags::Ballistic]))
                return true;
        }
    }
...
static void ship_parse_post_cleanup () {
    ...
    for (auto sip = Ship_info.begin (); sip != Ship_info.end (); ++sip) {
        // ballistic primary fixage...
        {
            ...
            // determine whether this ship had primary capacities specified for
            // it
        ...
        // ultra stupid compatbility handling for the once broken "generate
        // hud" flag. it was previously testing the afterburner flag, so that's
        // what we check for that
        ...
        // warn early rather than ambush the modder @ runtime (unless the ship
        // is also no-collide!) the 2nd part of this check is duplicated from
        ...
        if (sip->min_vel.xyz.x > sip->max_vel.xyz.x ||
            sip->min_vel.xyz.x < 0.0f) {
            error_display (
                0,
                "$Player Minimum Velocity X-value (%f) is negative or greater "
                "than max velocity X-value (%f), setting to zero\nFix for "
                "ship '%s'\n",
                sip->min_vel.xyz.x, sip->max_vel.xyz.x, sip->name);
            sip->min_vel.xyz.x = 0.0f;
        }
        if (sip->min_vel.xyz.y > sip->max_vel.xyz.y ||
            sip->min_vel.xyz.y < 0.0f) {
            error_display (
                0,
                "$Player Minimum Velocity Y-value (%f) is negative or greater "
                "than max velocity Y-value (%f), setting to zero\nFix for "
                "ship '%s'\n",
                sip->min_vel.xyz.y, sip->max_vel.xyz.y, sip->name);
            sip->min_vel.xyz.y = 0.0f;
        }
        if (sip->min_vel.xyz.z > sip->max_vel.xyz.z ||
            sip->min_vel.xyz.z < 0.0f) {
            error_display (
                0,
                "$Player Minimum Velocity Z-value (%f) is negative or greater "
                "than max velocity Z-value (%f), setting to zero\nFix for "
                "ship '%s'\n",
...
/**
 * Called once at the beginning of the game to parse ships.tbl and stuff the
 * ::Ship_info vector
 */
void ship_init () {
    if (!ships_inited) {
        ...
        for (i = 0; i < Ship_types.size (); i++) {
            ...
            for (j = 0; j < stp->ai_actively_pursues_temp.size (); j++) {
                idx = ship_type_name_lookup (
                    (char*)stp->ai_actively_pursues_temp[j].c_str ());
                if (idx >= 0) { stp->ai_actively_pursues.push_back (idx); }
            }
            ...
            for (j = 0; j < stp->ai_cripple_ignores_temp.size (); j++) {
                idx = ship_type_name_lookup (
                    (char*)stp->ai_cripple_ignores_temp[j].c_str ());
                if (idx >= 0) { stp->ai_cripple_ignores.push_back (idx); }
            }
...
static void ship_clear_subsystems () {
    for (auto it = Ship_subsystems.begin (); it != Ship_subsystems.end ();
         ++it) {
        delete[] * it;
    }
...
static int ship_allocate_subsystems (int num_so, bool page_in = false) {
    ...
    // allow a page-in thingy, so that we can grab as much as possible before
    // mission start, but without messing up our count for future things
    if (page_in) num_subsystems_save = Num_ship_subsystems;
...
void ship_level_init () {
    ...
    for (i = 0; i < MAX_WINGS; i++) {
        ...
        Wings[i].wing_insignia_texture =
            -1; // Goober5000 - default to no wing insignia
    ...
    for (i = 0; i < MAX_STARTING_WINGS; i++) Starting_wings[i] = -1;

    for (i = 0; i < MAX_SQUADRON_WINGS; i++) Squadron_wings[i] = -1;

    for (i = 0; i < MAX_TVT_WINGS; i++) TVT_wings[i] = -1;
 ...
 *
 * The reason parameter tells us why the ship left the mission (i.e. departed
 * or destroyed)
 */
...
int ship_find_exited_ship_by_signature (int signature) {
    ...
    for (i = 0; i < (int)Ships_exited.size (); i++) {
        if (signature == Ships_exited[i].obj_signature) return i;
    }
...
void physics_ship_init (object* objp) {
    ...
    pi->afterburner_forward_accel_time_const =
        sinfo->afterburner_forward_accel;
    ...
    pi->cur_glide_cap =
        pi->max_vel.xyz.z; // Init dynamic glide cap stuff to the max vel.
    if (sinfo->glide_cap > 0.000001f ||
        sinfo->glide_cap < -0.000001f) // Backslash
        pi->glide_cap = sinfo->glide_cap;
    else
        pi->glide_cap = MAX (
            MAX (pi->max_vel.xyz.z, sinfo->max_overclocked_speed),
            pi->afterburner_max_vel.xyz.z);
    // If there's not a value for +Max Glide Speed set in the table, we want
    // this cap to default to the fastest speed the ship can go. However, a
    // negative value means we want no cap, thus allowing nearly infinite
    // maximum gliding speeds.

    // SUSHI: If we are using dynamic glide capping, force the glide cap to 0
    // (understood by physics.cpp to mean the cap should be dynamic)
    if (sinfo->glide_dynamic_cap) pi->glide_cap = 0;

    pi->glide_accel_mult = sinfo->glide_accel_mult;

    // SUSHI: This defaults to the AI_Profile value, and is only optionally
    // overridden
    pi->use_newtonian_damp =
        The_mission.ai_profile
            ->flags[AI::Profile_Flags::Use_newtonian_dampening];
...
static void ship_set_warp_effects (object* objp, ship_info* sip) {
    ...
    if (shipp->warpin_effect != NULL) delete shipp->warpin_effect;
    ...
    case WT_HYPERSPACE:
        ...
        break;
    default: shipp->warpin_effect = new WarpEffect ();
    }

    if (shipp->warpout_effect != NULL) delete shipp->warpout_effect;
    ...
    case WT_HYPERSPACE:
        ...
        break;
    default: shipp->warpout_effect = new WarpEffect ();
    }
}
...
void ship::clear () {
    ...
    if (warpin_effect != NULL) delete warpin_effect;
    if (warpout_effect != NULL) delete warpout_effect;
    warpin_effect = NULL;
    warpout_effect = NULL;
    ...
    for (i = 0; i < MAX_DAMAGE_SLOTS; i++) damage_ship_id[i] = -1;
    ...
    for (i = 0; i < MAX_SHIP_ARCS; i++) arc_timestamp[i] = timestamp (-1);
    ...
    for (i = 0; i < MAX_SHIP_CONTRAILS; i++) ABtrail_ptr[i] = NULL;
    ...
    for (i = 0; i < MAX_IFFS; i++)
        for (j = 0; j < MAX_IFFS; j++) ship_iff_color[i][j] = -1;
...
const char* ship::get_display_string () {
    if (has_display_name ()) { return display_name.c_str (); }
    else {
        return ship_name;
    }
}
...
void ship_weapon::clear () {
    ...
    for (int i = 0; i < MAX_SHIP_PRIMARY_BANKS; i++) {
        ...
        primary_animation_position[i] =
            EModelAnimationPosition::MA_POS_NOT_SET;
    ...
    for (int i = 0; i < MAX_SHIP_SECONDARY_BANKS; i++) {
        ...
        secondary_animation_position[i] =
            EModelAnimationPosition::MA_POS_NOT_SET;
...
// NOTE: Now that the clear() member function exists, this function only sets
// the stuff associated with the object and ship class.
static void ship_set (int ship_index, int objnum, int ship_type) {
    ...
    if (!subsys_set (objnum)) {
        ...
        sprintf (
            err_msg,
            "Unable to allocate ship subsystems, which shouldn't be possible "
            "anymore. Current allocation is %d (%d in use). No subsystems "
            "have been assigned to %s.",
            Num_ship_subsystems_allocated, Num_ship_subsystems,
            shipp->ship_name);
    ...
    // because I think it's not needed - when I accidentally left this
    // unreachable it didn't cause any problems - Goober5000
...
void ship_recalc_subsys_strength (ship* shipp) {
    ...
    // make the current strength be 1.0.  If there are initial conditions on
    // the ship, then the mission parse code should take care of setting that.
    ...
    // count all of the subsystems of a particular type.  For each generic type
    // of subsystem, we store the total count of hits.  (i.e. for 3 engines, we
    // store the sum of the max_hits for each engine)
    for (ship_system = GET_FIRST (&shipp->subsys_list);
         ship_system != END_OF_LIST (&shipp->subsys_list);
        ...
        if (!(ship_system->flags[Ship::Subsystem_Flags::No_aggregate])) {
            ...
            shipp->subsys_info[type].aggregate_current_hits +=
                ship_system->current_hits;
        }

        // Get rid of any persistent sounds on the subsystem
        // This is inefficient + sloppy but there's not really an easy way to
        // handle things if a subsystem is brought back from the dead, other
        // than this
        if (ship_system->current_hits > 0.0f) {
            if (ship_system
                    ->subsys_snd_flags[Ship::Subsys_Sound_Flags::Dead]) {
                obj_snd_delete_type (
                    shipp->objnum, ship_system->system_info->dead_snd,
                    ship_system);
                ship_system->subsys_snd_flags.set (
                    Ship::Subsys_Sound_Flags::Dead, false);
            }
            if ((ship_system->system_info->alive_snd.isValid ()) &&
                !(ship_system
                      ->subsys_snd_flags[Ship::Subsys_Sound_Flags::Alive])) {
                obj_snd_assign (
                    shipp->objnum, ship_system->system_info->alive_snd,
                    &ship_system->system_info->pnt, 0, OS_SUBSYS_ALIVE,
                    ship_system);
                ship_system->subsys_snd_flags.set (
                    Ship::Subsys_Sound_Flags::Alive);
            }
            if (!(ship_system->subsys_snd_flags
                      [Ship::Subsys_Sound_Flags::Turret_rotation])) {
                if (ship_system->system_info->turret_base_rotation_snd
                        .isValid ()) {
                    obj_snd_assign (
                        shipp->objnum,
                        ship_system->system_info->turret_base_rotation_snd,
                        &ship_system->system_info->pnt, 0,
                        OS_TURRET_BASE_ROTATION, ship_system);
                    ship_system->subsys_snd_flags.set (
                        Ship::Subsys_Sound_Flags::Turret_rotation);
                }
                if (ship_system->system_info->turret_gun_rotation_snd
                        .isValid ()) {
                    obj_snd_assign (
                        shipp->objnum,
                        ship_system->system_info->turret_gun_rotation_snd,
                        &ship_system->system_info->pnt, 0,
                        OS_TURRET_GUN_ROTATION, ship_system);
                    ship_system->subsys_snd_flags.set (
                        Ship::Subsys_Sound_Flags::Turret_rotation);
                }
            }
            if ((ship_system->flags[Subsystem_Flags::Rotates]) &&
                (ship_system->system_info->rotation_snd.isValid ()) &&
                !(ship_system
                      ->subsys_snd_flags[Ship::Subsys_Sound_Flags::Rotate])) {
                obj_snd_assign (
                    shipp->objnum, ship_system->system_info->rotation_snd,
                    &ship_system->system_info->pnt, 0, OS_SUBSYS_ROTATION,
                    ship_system);
                ship_system->subsys_snd_flags.set (
                    Ship::Subsys_Sound_Flags::Rotate);
            }
        }
        else {
            if (ship_system
                ...
                obj_snd_delete_type (
                    ...
                    ship_system);
                ship_system->subsys_snd_flags.set (
                    Ship::Subsys_Sound_Flags::Alive, false);
                ;
            }
            if (ship_system->subsys_snd_flags
                    [Ship::Subsys_Sound_Flags::Turret_rotation]) {
                ...
                obj_snd_delete_type (
                    ...
                    ship_system);
                ship_system->subsys_snd_flags.set (
                    Ship::Subsys_Sound_Flags::Turret_rotation, false);
            }
            if (ship_system
                    ->subsys_snd_flags[Ship::Subsys_Sound_Flags::Rotate]) {
                obj_snd_delete_type (
                    ...
                    ship_system);
                ship_system->subsys_snd_flags.set (
                    Ship::Subsys_Sound_Flags::Rotate, false);
            }
            if ((ship_system->system_info->dead_snd.isValid ()) &&
                ...
                obj_snd_assign (
                    shipp->objnum, ship_system->system_info->dead_snd,
                    &ship_system->system_info->pnt, 0, OS_SUBSYS_DEAD,
                    ship_system);
                ship_system->subsys_snd_flags.set (
                    Ship::Subsys_Sound_Flags::Dead, false);
            }
    ...
    // set any ship flags which should be set.  unset the flags since we might
    // be repairing a subsystem through sexpressions.
    if ((shipp->subsys_info[SUBSYSTEM_ENGINE].type_count > 0) &&
        (shipp->subsys_info[SUBSYSTEM_ENGINE].aggregate_current_hits <=
         0.0f)) {
        shipp->flags.set (Ship_Flags::Disabled);
    }
    else {
        shipp->flags.remove (Ship_Flags::Disabled);
        ship_reset_disabled_physics (
            &Objects[shipp->objnum], shipp->ship_info_index);
    }
}
...
static void ship_copy_subsystem_fixup (ship_info* sip) {
    ...
    // if we need to get information for all our subsystems, we need to find
    // another ship with the same model number as our own and that has the
    // model information
    for (auto it = Ship_info.cbegin (); it != Ship_info.cend (); ++it) {
        model_subsystem *source_msp, *dest_msp;

        if ((it->model_num != model_num) || (&(*it) == sip)) { continue; }
        ...
        if (source_msp->model_num != -1) {
            ...
            // if none were found try finding a another ship to copy the data
            // from
            continue;
        }
        sip->flags.set (Ship::Info_Flags::Path_fixup);
...
// as with object, don't set next and prev to NULL because they keep the object
// on the free and used lists
void ship_subsys::clear () {
    ...
    for (i = 0; i < MAX_TFP; i++) turret_swarm_info_index[i] = -1;
    turret_swarm_num = 0;
    ...
    for (i = 0; i < 32; i++) target_priority[i] = -1;
...
static int subsys_set (int objnum, int ignore_subsys_info) {
    ...
    // set up the subsystems for this ship.  walk through list of subsystems in
    // the ship-info array. for each subsystem, get a new ship_subsys instance
    // and set up the pointers and other values
    list_init (
        &shipp->subsys_list); // initialize the ship's list of subsystems

    // make sure to have allocated the number of subsystems we require
    if (!ship_allocate_subsystems (sinfo->n_subsystems)) { return 0; }
    ...
    for (i = 0; i < sinfo->n_subsystems; i++) {
        ...
        ship_system->system_info =
            model_system; // set the system_info pointer to point to the data
        ...
        if (ship_system->system_info->alt_sub_name[0] != '\0') {
            ...
            memset (
                ship_system->sub_name, '\0', sizeof (ship_system->sub_name));
        }

        // copy subsystem target priorities stuff
        ship_system->num_target_priorities =
            ship_system->system_info->num_target_priorities;
        for (j = 0; j < 32; j++) {
            ship_system->target_priority[j] =
                ship_system->system_info->target_priority[j];
        }
        ...
        if ((The_mission.ai_profile->flags
                 [AI::Profile_Flags::Advanced_turret_fov_edge_checks]) ||
            (model_system->flags[Model::Subsystem_Flags::Fov_edge_check]))
            ship_system->flags.set (Ship::Subsystem_Flags::FOV_edge_check);
        if ((The_mission.ai_profile->flags
                 [AI::Profile_Flags::Require_turret_to_have_target_in_fov]) ||
        ...
        if (model_system->flags[Model::Subsystem_Flags::Ignore_if_dead])
            ship_system->flags.set (
                Ship::Subsystem_Flags::Missiles_ignore_if_dead);
        ...
        if (model_system->flags[Model::Subsystem_Flags::Player_turret_sound])
            ship_system->flags.set (
                Ship::Subsystem_Flags::Play_sound_for_player);
        if (model_system->flags[Model::Subsystem_Flags::No_disappear])
            ship_system->flags.set (Ship::Subsystem_Flags::No_disappear);
        if (model_system
                ->flags[Model::Subsystem_Flags::Autorepair_if_disabled])
            ship_system->flags.set (
                Ship::Subsystem_Flags::Autorepair_if_disabled);
        if (model_system
                ->flags[Model::Subsystem_Flags::No_autorepair_if_disabled])
            ship_system->flags.set (
                Ship::Subsystem_Flags::No_autorepair_if_disabled);
        ...
        for (k = 0; k < MAX_SHIP_PRIMARY_BANKS; k++) {
            if (model_system->primary_banks[k] != -1) {
                ship_system->weapons.primary_bank_weapons[j] =
                    model_system->primary_banks[k];
                ship_system->weapons.primary_bank_capacity[j] =
                    model_system
                        ->primary_bank_capacity[k]; // added by Goober5000
                ship_system->weapons.next_primary_fire_stamp[j] =
                    timestamp (0);
        ...
        for (k = 0; k < MAX_SHIP_SECONDARY_BANKS; k++) {
            if (model_system->secondary_banks[k] != -1) {
                ship_system->weapons.secondary_bank_weapons[j] =
                    model_system->secondary_banks[k];
                ship_system->weapons.secondary_bank_capacity[j] =
                    model_system->secondary_bank_capacity[k];
                ship_system->weapons.next_secondary_fire_stamp[j] =
                    timestamp (0);
        ...
        ship_system->turret_max_bomb_ownage =
            model_system->turret_max_bomb_ownage;
        ship_system->turret_max_target_ownage =
            model_system->turret_max_target_ownage;
        ...
        if ((ship_system->system_info
                 ->flags[Model::Subsystem_Flags::Share_fire_direction]) &&
            (!(ship_system->system_info
                   ->flags[Model::Subsystem_Flags::Turret_salvo]) &&
             !(ship_system->system_info
                   ->flags[Model::Subsystem_Flags::Use_multiple_guns]))) {
        ...
        for (k = 0; k < ship_system->weapons.num_primary_banks; k++) {
            float weapon_size =
                Weapon_info[ship_system->weapons.primary_bank_weapons[k]]
                    .cargo_size;
        ...
        ship_system->weapons.ai_class =
            sinfo->ai_class; // assume ai class of ship for turret
        ...
        if (ship_system->awacs_intensity > 0) {
            ship_system->system_info->flags.set (
                Model::Subsystem_Flags::Awacs);
        }

        // turn_rate, turn_accel
        float turn_accel = 0.5f;
        model_set_instance_info (
            &ship_system->submodel_info_1, model_system->turn_rate,
            turn_accel);

        model_clear_instance_info (&ship_system->submodel_info_2);

        // Clear this flag here so we correctly rebuild the turret matrix on
        // mission load
        ...
        if (model_system->flags[Model::Subsystem_Flags::Triggered]) {
            ship_system->triggered_rotation_index =
                (int)Triggered_rotations.size ();
            triggered_rotation tr;
            Triggered_rotations.push_back (tr);
        }
    }

    if (!ignore_subsys_info) { ship_recalc_subsys_strength (shipp); }
...
void compute_slew_matrix (matrix* orient, angles_t* a) {
    ...
    vm_angles_2_matrix (&tmp, &t2); // Changed the order of axis rotations.
                                    // First pitch, then yaw (Swifty)
...
void render_dock_bays (object* objp) {
    ...
    if (pm->docking_bays == NULL) return;

    if (pm->docking_bays[0].num_slots != 2) return;
...
static void
ship_find_warping_ship_helper (object* objp, dock_function_info* infop) {
    // only check ships
    if (objp->type != OBJ_SHIP) return;

    // am I arriving or departing by warp?
    if (Ships[objp->instance].is_arriving () ||
        Ships[objp->instance].flags[Ship_Flags::Depart_warp]) {
#ifndef NDEBUG
        // in debug builds, make sure only one of the docked objects has these
        // flags set
        if (infop->maintained_variables.bool_value) {
            // WMC - This is annoying and triggered in sm2-10
            // Warning(LOCATION, "Ship %s and its docked ship %s are arriving
            // or departing at the same time.\n",
            // Ships[infop->maintained_variables.objp_value->instance].ship_name,
...
void ship_render_cockpit (object* objp) {
    if (objp->type != OBJ_SHIP || objp->instance < 0) return;
    ...
    gr_set_proj_matrix (
        Proj_fov, gr_screen.clip_aspect, 0.02f, 10.0f * pm->rad);
    ...
    model_render_immediate (
        &render_info, sip->cockpit_model_num, &eye_ori, &pos);
...
void ship_render_show_ship_cockpit (object* objp) {
    ...
    matrix dummy;
    ship_get_eye (
        &cockpit_eye_pos, &dummy, objp, true,
        true); // Get cockpit eye position

    gr_end_view_matrix ();
    gr_end_proj_matrix ();
    gr_set_proj_matrix (
        Proj_fov, gr_screen.clip_aspect, 0.05f, Max_draw_distance);
    gr_set_view_matrix (
        &cockpit_eye_pos, &Eye_matrix); // Set Camera to cockpit eye position

    Glowpoint_override =
        true; // Turn off glowpoints so they dont get rendered fixed at origin
    ...
    model_render_immediate (
        ...
        &objp->orient,
        &vmd_zero_vector); // Render ship model with fixed detail level 0 so
                           // its not switching LOD when moving away from
                           // origin
...
void ship_init_cockpit_displays (ship* shipp) {
    ...
    // don't bother creating cockpit texture replacements if this ship has no
    // cockpit
    if (cockpit_model_num < 0) { return; }

    // check if we even have cockpit displays
    if (sip->displays.empty ()) { return; }

    if (Player_cockpit_textures != NULL) { return; }
...
static void ship_add_cockpit_display (
    cockpit_display_info* display, int cockpit_model_num) {
    if (strlen (display->filename) <= 0) { return; }
    ...
    if (Player_cockpit_textures[glow_target] < 0) {
        ...
        Player_cockpit_textures[glow_target] =
            bm_make_render_target (w, h, BMP_FLAG_RENDER_TARGET_DYNAMIC);

        // if no render target was made, bail
        if (Player_cockpit_textures[glow_target] < 0) { return; }
    }
...
static void ship_set_hud_cockpit_targets () {
    if (!Ship_info[Player_ship->ship_info_index].hud_enabled) { return; }
...
int ship_start_render_cockpit_display (size_t cockpit_display_num) {
    ...
    if (Player_cockpit_textures == NULL) { return -1; }

    // check sanity of the cockpit display handle
    if (cockpit_display_num >= Player_displays.size ()) { return -1; }

    cockpit_display* display = &Player_displays[cockpit_display_num];

    if (display->target < 0) { return -1; }

    if (!bm_set_render_target (display->target)) { return -1; }
    ...
    if (display->background >= 0) {
        ...
        gr_bitmap_ex (
            display->offset[0], display->offset[1], display->size[0],
            display->size[1], 0, 0, GR_RESIZE_NONE);
    }
...
void ship_end_render_cockpit_display (size_t cockpit_display_num) {
    ...
    // check sanity of the cockpit display handle
    if (cockpit_display_num >= Player_displays.size ()) { return; }
...
static void ship_subsystems_delete (ship* shipp) {
    if (NOT_EMPTY (&shipp->subsys_list)) {
        ...
        while (systemp != END_OF_LIST (&shipp->subsys_list)) {
            temp = GET_NEXT (systemp); // use temporary since pointers will get
                                       // screwed with next operation
...
void ship_delete (object* obj) {
    ...
    if (shipp->ai_index != -1) { ai_free_slot (shipp->ai_index); }

    // free up the list of subsystems of this ship.  walk through list and move
    // remaining subsystems on ship back to the free list for other ships to
    // use.
 ...
 *
 * This function updates the ship_index list (i.e. removes its entry in the
 * list) and packs the array accordingly.
 */
void ship_wing_cleanup (int shipnum, wing* wingp) {
    ...
    if (wingp->current_count == 0) {
        // if this wing was ordered to depart by the player, set the
        // current_wave equal to the total waves so we can mark the wing as
        // gone and no other ships arrive Goober5000 - also if it's
        // departing... this is sort of, but not exactly, what :V: did; but it
        // seems to be consistent with how it should behave
        if (wingp->flags
                [Ship::Wing_Flags::Departing,
                 Ship::Wing_Flags::Departure_ordered])
            wingp->current_wave = wingp->num_waves;

        // Goober5000 - some changes for clarity and closing holes
        // make sure to flag the wing as gone if all of its member ships are
        // gone and no more can arrive
        if ((wingp->current_wave == wingp->num_waves) &&
            (wingp->total_destroyed + wingp->total_departed +
            ...
            if (wingp->total_destroyed == wingp->total_arrived_count) {
                // first, be sure to mark a wing destroyed event if all members
                // of wing were destroyed and on the last wave.  This
                // circumvents a problem where the wing could be marked as
                // departed and destroyed if the last ships were destroyed
                // after the wing's departure cue became true.
                mission_log_add_entry (
                    LOG_WING_DESTROYED, wingp->name, NULL, team);
            }
            // if some ships escaped, log it as departed
            else if (wingp->total_vanished != wingp->total_arrived_count) {
                // if the wing wasn't destroyed, and it is departing, then mark
                // it as departed -- in this case, there had better be ships in
                // this wing with departure entries in the log file.  The
                // logfile code checks for this case.
                mission_log_add_entry (
                    LOG_WING_DEPARTED, wingp->name, NULL, team);
            }

#ifndef NDEBUG
            // WMC - Ships can depart too, besides being destroyed :P
            if ((wingp->total_destroyed + wingp->total_departed +
                 wingp->total_vanished) != wingp->total_arrived_count) {
                // apparently, there have been reports of ships still present
                // in the mission when this log entry if written.  Do a sanity
...
// functions to do management, like log entries and wing cleanup after a ship
// has been destroyed

// Goober5000
static void
ship_actually_depart_helper (object* objp, dock_function_info* infop) {
    // do standard departure stuff first
    objp->flags.set (Object::Object_Flags::Should_be_dead);
    if (objp->type == OBJ_SHIP)
        ship_cleanup (
            objp->instance, infop->parameter_variables.bool_value
                                ? SHIP_VANISHED
                                : SHIP_DEPARTED);

    // do the end-mission stuff if it's the player ship
    if (objp == Player_obj) gameseq_post_event (GS_EVENT_PLAYER_WARPOUT_DONE);
}

/**
 * Used to actually remove a ship, plus all the ships it's docked to, from the
 * mission
 */
...
void ship_cleanup (int shipnum, int cleanup_mode) {
    ...
    case SHIP_DEPARTED_REDALERT:
        // Ship was removed in previous mission. Mark as "player deleted" for
        // this mission
    ...
    if (cleanup_mode == SHIP_DESTROYED) {
        // determine if we need to count this ship as a kill in counting number
        // of kills per ship type look at the ignore flag for the ship (if not
        // in a wing), or the ignore flag for the wing (if the ship is in a
        // wing), and add to the kill count if the flags are not set
        if (!(shipp->flags[Ship_Flags::Ignore_count]) ||
            ((shipp->wingnum != -1) &&
             !(Wings[shipp->wingnum].flags[Ship::Wing_Flags::Ignore_count])))
            ship_add_ship_type_kill_count (shipp->ship_info_index);

        // let the event music system know an enemy was destroyed (important
        // for deciding when to transition from battle to normal music)
        if (Player_ship != NULL &&
            iff_x_attacks_y (Player_ship->team, shipp->team))
            event_music_hostile_ship_destroyed ();
    }

    // add mission log entry?
    // (vanished ships and red-alert deleted ships have no log, and destroyed
    // ships are logged in ship_hit_kill)
    if ((cleanup_mode == SHIP_DEPARTED_WARP) ||
        (cleanup_mode == SHIP_DEPARTED_BAY) ||
        (cleanup_mode ==
         SHIP_DEPARTED)) { // see if this ship departed within the radius of a
                           // jump node -- if so, put the node name into
        // the secondary mission log field
        CJumpNode* jnp = jumpnode_get_which_in (objp);
        if (jnp == NULL)
            mission_log_add_entry (
                LOG_SHIP_DEPARTED, shipp->ship_name, NULL, shipp->wingnum);
        else
            mission_log_add_entry (
                LOG_SHIP_DEPARTED, shipp->ship_name, jnp->GetName (),
                shipp->wingnum);
    }
    ...
    switch (cleanup_mode) {
    case SHIP_DESTROYED:
        WARNINGF (LOCATION, "SHIP DESTROYED: %s'\n'", shipp->ship_name);
        break;
    case SHIP_DEPARTED:
    case SHIP_DEPARTED_WARP:
    case SHIP_DEPARTED_BAY:
    ...
    case SHIP_DEPARTED_REDALERT:
        ...
        break;
    case SHIP_VANISHED:
        WARNINGF (LOCATION, "SHIP VANISHED: %s'\n'", shipp->ship_name);
        break;
    default:
    ...
    if ((shipp->wing_status_wing_index >= 0) &&
        (shipp->wing_status_wing_pos >= 0)) {
        switch (cleanup_mode) {
        case SHIP_DESTROYED:
        case SHIP_DESTROYED_REDALERT:
            hud_set_wingman_status_dead (
                shipp->wing_status_wing_index, shipp->wing_status_wing_pos);
            break;
        case SHIP_DEPARTED:
        case SHIP_DEPARTED_WARP:
        case SHIP_DEPARTED_BAY:
        case SHIP_DEPARTED_REDALERT:
            hud_set_wingman_status_departed (
                shipp->wing_status_wing_index, shipp->wing_status_wing_pos);
            break;
        case SHIP_VANISHED:
    ...
    if (shipp->wingnum != -1) {
        ...
        switch (cleanup_mode) {
        case SHIP_DESTROYED:
        case SHIP_DESTROYED_REDALERT: wingp->total_destroyed++; break;
        case SHIP_DEPARTED:
        case SHIP_DEPARTED_WARP:
        case SHIP_DEPARTED_BAY:
        case SHIP_DEPARTED_REDALERT: wingp->total_departed++; break;
    ...
    // Note, this call to ai_ship_destroy() must come after ship_wing_cleanup
    // for guarded wings to properly note the destruction of a ship in their
    // wing.
    ...
    // (for exploding ships, this list should have already been cleared by now,
    // via do_dying_undock_physics, except in the case of the destroy-instantly
    // sexp)
...
int ship_explode_area_calc_damage (
    ...
    float max_damage, float max_blast, float* damage, float* blast) {
    float dist;

    dist = vm_vec_dist_quick (pos1, pos2);

    // check outside outer radius
    if (dist > outer_rad) return -1;
...
static void ship_blow_up_area_apply_blast (object* exp_objp) {
    ...
    if ((max_damage < 0.1f) && (max_blast < 0.1f)) { return; }
    ...
    if (shockwave_speed > 0) {
        ...
        for (objp = GET_FIRST (&obj_used_list);
            ...
            if (ship_explode_area_calc_damage (
                    &exp_objp->pos, &objp->pos, inner_rad, outer_rad,
                    max_damage, max_blast, &damage, &blast) == -1) {
                continue;
            }

            switch (objp->type) {
            case OBJ_SHIP:
                ship_apply_global_damage (
                    objp, exp_objp, &exp_objp->pos, damage);
 ...
 *
 * This function relies on the "dead dock" list, which replaces the
 * dock_objnum_when_dead used in retail.
 */
static void do_dying_undock_physics (object* dying_objp, ship* dying_shipp) {
    ...
    // Goober5000 - as with ai_deathroll_start, we can't simply iterate through
    // the dock list while we're unlinking things.  So just repeatedly unlink
    // the first object.
    while (object_is_dead_docked (dying_objp)) {
        ...
        int dockee_index =
            dock_find_dead_dockpoint_used_by_object (docked_objp, dying_objp);

        // undo all the docking animations for the docked ship only
        model_anim_start_type (
            docked_shipp, TRIGGER_TYPE_DOCKED, dockee_index, -1);
        model_anim_start_type (
            docked_shipp, TRIGGER_TYPE_DOCKING_STAGE_3, dockee_index, -1);
        model_anim_start_type (
            docked_shipp, TRIGGER_TYPE_DOCKING_STAGE_2, dockee_index, -1);
        model_anim_start_type (
            docked_shipp, TRIGGER_TYPE_DOCKING_STAGE_1, dockee_index, -1);

        // only consider the mass of these two objects, not the whole assembly
        // (this is inaccurate, but the alternative is a huge mess of extra
        // code for a very small gain in realism)
        float docked_mass =
            dying_objp->phys_info.mass + docked_objp->phys_info.mass;

        // damage this docked object
        ship_apply_global_damage (
            docked_objp, dying_objp, &dying_objp->pos, damage);
        ...
        impulse_mag = 50.f * docked_objp->phys_info.mass *
                      dying_objp->phys_info.mass / docked_mass;
        ...
        physics_apply_whack (
            &impulse_vec, &pos, &docked_objp->phys_info, &docked_objp->orient,
        ...
        physics_apply_whack (
            &impulse_vec, &pos, &dying_objp->phys_info, &dying_objp->orient,
...
static void ship_dying_frame (object* objp, int ship_num) {
    ...
    if (shipp->flags[Ship_Flags::Dying]) {
        ...
        if (objp->hull_strength > 0) {
            ...
            objp->hull_strength -=
                hits_left * (1000.0f * flFrametime) / time_left;
        }
        ...
        if (shipp->flags[Ship_Flags::Vaporize]) {
            if (timestamp_elapsed (shipp->final_death_time)) {
                // play death sound
                snd_play_3d (
                    gamesnd_get_game_sound (GameSounds::VAPORIZED), &objp->pos,
                    &View_position, objp->radius, NULL, 0, 1.0f,
                    SND_PRIORITY_MUST_PLAY);

                // do joystick effect
                if (objp == Player_obj) { joy_ff_explode (); }
                ...
                // do all accounting for respawning client and server side
                // here.
                if (objp == Player_obj) {
        ...
        // Do fireballs for Big ship with propagating explostion, but not
        // Kamikaze
        if (!(Ai_info[shipp->ai_index].ai_flags[AI::AI_Flags::Kamikaze]) &&
            ship_get_exp_propagates (shipp) &&
            ...
            if (timestamp_elapsed (shipp->next_fireball)) {
                ...
                model_find_world_point (
                    &outpnt, &pnt1, sip->model_num, pm->detail[0],
                ...
                if (fireball_type < 0) {
                    fireball_type = FIREBALL_EXPLOSION_LARGE1 +
                                    rand () % FIREBALL_NUM_LARGE_EXPLOSIONS;
                }
                fireball_create (
                    &outpnt, fireball_type, FIREBALL_LARGE_EXPLOSION,
                    OBJ_INDEX (objp), rad, 0, &objp->phys_info.vel);
                // start the next fireball up in the next 50 - 200 ms (2-3 per
                // frame)
                int min_time = 333;
                int max_time = 500;
                ...
                // do sound - maybe start a random sound, if it has played far
                // enough.
                do_sub_expl_sound (
                    objp->radius, &outpnt,
                    shipp->sub_expl_sound_handle.data ());
            }
        }
        ...
        if (knossos_ship) {
            if (timestamp_elapsed (shipp->next_fireball)) {
                ...
                pe.num_high =
                    pef.n_high;  // Highest number of particles to create
                pe.pos = outpnt; // Where the particles emit from
                pe.vel = objp->phys_info
                             .vel; // Initial velocity of all the particles
        ...
        int time_until_minor_explosions =
            timestamp_until (shipp->final_death_time);
        ...
        if ((time_until_minor_explosions < 500) &&
            (time_until_minor_explosions > 100) &&
            (!shipp->pre_death_explosion_happened)) {
            shipp->next_fireball = timestamp (-1); // never time out again
            shipp->pre_death_explosion_happened =
                1; // Mark this event as having occurred

            polymodel* pm = model_get (sip->model_num);

            // Start shockwave for ship with propagating explosion, do now for
            // timing
            ...
            for (int zz = 0; zz < zz_max; zz++) {
                ...
                if (knossos_ship) { break; }

                if (sip->death_fx_r_mult <= 0.0f) { break; }
                ...
                model_find_world_point (
                    &outpnt, &tmp, pm->id, pm->detail[0], &objp->orient,
                    &objp->pos);
                ...
                fireball_create (
                    &outpnt, fireball_type, FIREBALL_MEDIUM_EXPLOSION,
                    OBJ_INDEX (objp), rad, 0, &objp->phys_info.vel);
            }
        }
        ...
        if (timestamp_elapsed (shipp->final_death_time)) {
            ...
            // play ship explosion sound effect, pick appropriate explosion
            // sound
            gamesnd_id sound_index;

            if (ship_has_sound (objp, GameSounds::SHIP_EXPLODE_1)) {
                sound_index =
                    ship_get_sound (objp, GameSounds::SHIP_EXPLODE_1);
            }
            else {
                if (sip->flags[Info_Flags::Capital] ||
                    sip->flags[Info_Flags::Knossos_device]) {
            ...
            snd_play_3d (
                gamesnd_get_game_sound (sound_index), &objp->pos,
                &View_position, objp->radius, NULL, 0, 1.0f,
                SND_PRIORITY_MUST_PLAY);
            if (objp == Player_obj) joy_ff_explode ();
            ...
            if (!knossos_ship) {
                if (sip->death_effect.isValid ()) {
                    ...
                    auto source =
                        particle::ParticleManager::get ()->createSource (
                            sip->death_effect);

                    // Use the position since the ship is going to be invalid
                    // soon
                    ...
                    pe.num_low =
                        pef.n_low; // Lowest number of particles to create
                    pe.num_high =
                        pef.n_high; // Highest number of particles to create
                    ...
                    pe.max_vel =
                        pef.max_vel; // How fast the fastest particle can move
            ...
            // If this is a large ship with a propagating explosion, set it to
            // blow up.
            if (ship_get_exp_propagates (shipp)) {
                if (Ai_info[shipp->ai_index]
                        .ai_flags[AI::AI_Flags::Kamikaze]) {
                    ship_blow_up_area_apply_blast (objp);
                }
                ...
                default_fireball_type =
                    FIREBALL_EXPLOSION_LARGE1 +
                    rand () % FIREBALL_NUM_LARGE_EXPLOSIONS;
                if (knossos_ship) {
                ...
                if (Ship_info[shipp->ship_info_index].big_exp_visual_rad >= 0)
                    big_rad =
                        Ship_info[shipp->ship_info_index].big_exp_visual_rad;

                fireball_type = fireball_ship_explosion_type (sip);
                if (fireball_type < 0) {
                    fireball_type = default_fireball_type;
                }
                fireball_objnum = fireball_create (
                    &objp->pos, fireball_type, FIREBALL_LARGE_EXPLOSION,
                    OBJ_INDEX (objp), big_rad, 0, &objp->phys_info.vel);
                if (fireball_objnum >= 0) {
                    explosion_life =
                        fireball_lifeleft (&Objects[fireball_objnum]);
                }
                else {
                    explosion_life = 0.0f;
                }

                // JAS:  I put in all this code because of an item on my todo
                // list that said that the ship destroyed debris shouldn't pop
                // in until the big explosion is 30% done.  I did this on Oct24
                // and me & Adam thought it looked dumb since the explosion
                // didn't move with the ship, so instead of just taking this
                // code out, since we might need it in the future, I disabled
                // it.   You can reenable it by changing the commenting on the
                // following two lines.
        ...
        if (timestamp_elapsed (shipp->really_final_death_time)) {
            ...
            while (subsys != END_OF_LIST (&shipp->subsys_list)) {
                ...
                if (subsys->system_info->type == SUBSYSTEM_TURRET) {
                    subsys->weapons.flags.set (
                        Ship::Weapon_Flags::Turret_Lock);
                }
            ...
            if (shipp->large_ship_blowup_index >= 0) {
                if (shipfx_large_blowup_do_frame (shipp, flFrametime)) {
                    ...
                    ship_cleanup (
                        ship_num,
                        SHIP_DESTROYED); // call ship function to clean up
            ...
            ship_cleanup (
                ship_num, SHIP_DESTROYED); // call ship function to clean up
                                           // after the ship is destroyed.
            shipp->really_final_death_time =
                timestamp (-1); // Never time out again!
        }

        // If a ship is dying (and not a capital or big ship) then stutter the
        // engine sound
        if (timestamp_elapsed (shipp->next_engine_stutter)) {
            if (!(sip->is_big_or_huge ())) {
                shipp->flags.toggle (
                    Ship_Flags::Engines_on); // toggle state of engines
...
static void
ship_chase_shield_energy_targets (ship* shipp, object* obj, float frametime) {
    float delta;
    ship_info* sip;

    if (shipp->flags[Ship_Flags::Dying]) return;
...
static int thruster_glow_anim_load (generic_anim* ga) {
    if (!VALID_FNAME (ga->filename)) return -1;
...
static void ship_init_thrusters () {
    if (Thrust_anim_inited == 1) return;
    ...
    for (size_t i = 0; i < Species_info.size (); i++) {
        ...
        {
            generic_bitmap_load (
                &species->thruster_secondary_glow_info.normal);
            generic_bitmap_load (
                &species->thruster_secondary_glow_info.afterburn);
            generic_bitmap_load (&species->thruster_tertiary_glow_info.normal);
            generic_bitmap_load (
                &species->thruster_tertiary_glow_info.afterburn);
 ...
 */
static void
ship_do_thruster_frame (ship* shipp, object* objp, float frametime) {
    float rate;
    int framenum;
    ...
    if (objp->phys_info.flags & PF_AFTERBURNER_ON) {
        flame_anim =
            &sinfo->thruster_flame_info.afterburn; // select afterburner flame
        glow_anim =
            &sinfo->thruster_glow_info.afterburn; // select afterburner glow
        secondary_glow_bitmap =
            sinfo->thruster_secondary_glow_info.afterburn.bitmap_id;
        tertiary_glow_bitmap =
            sinfo->thruster_tertiary_glow_info.afterburn.bitmap_id;
        distortion_bitmap =
            sinfo->thruster_distortion_info.afterburn.bitmap_id;
        ...
        secondary_glow_bitmap =
            sinfo->thruster_secondary_glow_info.normal.bitmap_id;
        tertiary_glow_bitmap =
            sinfo->thruster_tertiary_glow_info.normal.bitmap_id;
    ...
    if (flame_anim->first_frame >= 0) {
        ...
        framenum = bm_get_anim_frame (
            flame_anim->first_frame, shipp->thruster_frame,
            flame_anim->total_time, true);
    ...
    if (glow_anim->first_frame >= 0) {
        ...
        framenum = bm_get_anim_frame (
            glow_anim->first_frame, shipp->thruster_glow_frame,
            glow_anim->total_time, true);
 ...
 */
void ship_do_weapon_thruster_frame (
    weapon* weaponp, object* objp, float frametime) {
    float rate;
    int framenum;
    generic_anim *flame_anim, *glow_anim;
    ...
    if (flame_anim->first_frame >= 0) {
        ...
        framenum = bm_get_anim_frame (
            flame_anim->first_frame, weaponp->thruster_frame,
            flame_anim->total_time, true);
    ...
    if (glow_anim->first_frame >= 0) {
        ...
        framenum = bm_get_anim_frame (
            glow_anim->first_frame, weaponp->thruster_glow_frame,
            glow_anim->total_time, true);
...
// TODO: optimize by only calling ever N seconds and keeping track of elapsed
// time
//
// NOTE: need to update current_hits in the sp->subsys_list element, and the
// sp->subsys_info[] element.
...
static void ship_auto_repair_frame (int shipnum, float frametime) {
...
#ifndef NDEBUG
    if (!Ship_auto_repair) // only repair subsystems if Ship_auto_repair flag
                           // is set
        return;
#endif
    ...
    if (sip->hull_repair_rate != 0.0f) {
        objp->hull_strength +=
            sp->ship_max_hull_strength * sip->hull_repair_rate * frametime;
    ...
    if (!(sip->is_small_ship ()) && sip->subsys_repair_rate == -2.0f) return;
    ...
    for (ssp = GET_FIRST (&sp->subsys_list);
        ...
        if (ssp->current_hits < ssp->max_hits) {
            ...
            if (ssp->max_hits <= 0) continue;

            if (ssp->current_hits <= 0) {
                if (sip->flags
                        [Ship::Info_Flags::Subsys_repair_when_disabled]) {
                    if (ssp->flags[Ship::Subsystem_Flags::
                                       No_autorepair_if_disabled]) {
                        continue;
                    }
                }
                else if (!(ssp->flags[Ship::Subsystem_Flags::
                                          Autorepair_if_disabled])) {
                    continue;
                }
            }
            ...
            if (!(ssp->flags[Ship::Subsystem_Flags::No_aggregate])) {
                ssip->aggregate_current_hits +=
                    ssip->aggregate_max_hits * real_repair_rate * frametime;
                if (ssip->aggregate_current_hits > ssip->aggregate_max_hits) {
                    ssip->aggregate_current_hits = ssip->aggregate_max_hits;
                }
            }

            // check to see if this subsystem was totally non functional before
            // -- if so, then reset the flags
            if ((ssp->system_info->type == SUBSYSTEM_ENGINE) &&
                (sp->flags[Ship_Flags::Disabled])) {
...
// this function checks to see how far the player has strayed from his starting
// location (should be single player only).  Issues a warning at some distance.
// Makes mission end if he keeps flying away 3 strikes and you're out or too
// far away
#define PLAYER_MAX_DIST_WARNING \
    700000 // distance in KM at which player gets warning to return to battle
...
#define PLAYER_MAX_DIST_END \
    750000 // distance from starting loc at which we end mission
...
static void ship_check_player_distance_sub (player* p, int multi_target = -1) {
    ...
    if (dist > PLAYER_MAX_DIST_WARNING) {
        if (p->distance_warning_count == 0) { give_warning_to_player = 1; }
        else {
    ...
    if (give_warning_to_player) {
        ...
        // set timestamp unless player PLAYER_FLAGS_DIST_TO_BE_KILLED flag is
        // set
        ...
        if (p->distance_warning_count <= PLAYER_DISTANCE_MAX_WARNINGS) {
            message_send_builtin_to_player (
                MESSAGE_STRAY_WARNING, NULL, MESSAGE_PRIORITY_HIGH,
                MESSAGE_TIME_SOON, 0, 0, multi_target, -1);
        }
    ...
    if (engines_disabled) {
        if (!(sp->subsys_disrupted_flags & (1 << SUBSYSTEM_ENGINE))) {
            if (!(sp->flags[Ship_Flags::Disabled])) {
                ship_reset_disabled_physics (
                    &Objects[sp->objnum], sp->ship_info_index);
            }
        }
    }
}
...
int ship_subsys_disrupted (ship_subsys* ss) {
    ...
    if (timestamp_elapsed (ss->disruption_timestamp)) { return 0; }
    else {
        return 1;
    }
}
...
int ship_subsys_disrupted (ship* sp, int type) {
    ...
    if (sp->subsys_disrupted_flags & (1 << type)) { return 1; }
    else {
        return 0;
    }
}
...
DCF (
    lethality_decay,
    "Sets ship lethality_decay, or the time in sec to go from 100 to 0 health "
    "(default is 1/120)") {
...
#ifndef NDEBUG
    if (Objects[Ships[aip->shipnum].objnum]
            .flags[Object::Object_Flags::Player_ship]) {
        if (Framecount % 10 == 0) {
            int num_turrets = 0;
            if ((aip->target_objnum != -1) &&
                (Objects[aip->target_objnum].type == OBJ_SHIP)) {
                // TODO: put this where it belongs, this would involve
                // recompiling *everything* right now -WMC
                int num_turrets_attacking (
                    object * turret_parent, int target_objnum);
 ...
 *
 * When adding code to this function, decide whether or not a client in a
 * multiplayer game needs to execute the code you are adding.  Code which moves
 * things, creates things, etc probably doesn't need to be called.  If you
 * don't know -- find Allender!!!
 */
void ship_process_post (object* obj, float frametime) {
    ...
    if (obj->type != OBJ_SHIP) {
        WARNINGF (LOCATION, "Ignoring non-ship object in ship_process_post()");
        return;
    }
    ...
    // AL 1-6-98: record the initial ammo counts for ships, which is used as
    // the max limit for rearming Goober5000 - added ballistics support
    if (!(shipp->flags[Ship_Flags::Ammo_count_recorded])) {
        int max_missiles;
        for (int i = 0; i < MAX_SHIP_SECONDARY_BANKS; i++) {
            if (red_alert_mission ()) {
                max_missiles = get_max_ammo_count_for_bank (
                    shipp->ship_info_index, i,
                    shipp->weapons.secondary_bank_weapons[i]);
                shipp->weapons.secondary_bank_start_ammo[i] = max_missiles;
            }
            else {
                shipp->weapons.secondary_bank_start_ammo[i] =
                    shipp->weapons.secondary_bank_ammo[i];
            }
        }

        for (int i = 0; i < MAX_SHIP_PRIMARY_BANKS; i++) {
            if (red_alert_mission ()) {
                max_missiles = get_max_ammo_count_for_primary_bank (
                    shipp->ship_info_index, i,
                    shipp->weapons.primary_bank_weapons[i]);
                shipp->weapons.primary_bank_start_ammo[i] = max_missiles;
            }
            else {
                shipp->weapons.primary_bank_start_ammo[i] =
                    shipp->weapons.primary_bank_ammo[i];
            }
        }
    ...
    if (!(Game_mode & GM_STANDALONE_SERVER)) {
        ...
        if (obj != Player_obj &&
            Game_mode & GM_IN_MISSION) // don't plot myself.
        ...
        if ((obj != Viewer_obj) &&
            timestamp_elapsed (Ships[num].next_hit_spark)) {
            shipfx_emit_spark (
                num, -1); // -1 means choose random spark location
        }

        if (obj != Viewer_obj) { shipfx_do_damaged_arcs_frame (shipp); }
    ...
    if (shipp->is_arriving () &&
        Ai_info[shipp->ai_index].mode != AIM_BAY_EMERGE) {
    ...
    if ((!(shipp->is_arriving ()) ||
        ...
        // needs to do this code this code might call ship_fire_secondary which
        // will send the fire packets
            ...
            if (aip->ai_flags
                ...
                if (aip->support_ship_objnum >= 0) {
                    if (vm_vec_dist_quick (
                            &obj->pos,
                            &Objects[aip->support_ship_objnum].pos) <
                        (obj->radius +
                         Objects[aip->support_ship_objnum].radius) *
                            1.25f)
                        return;
                }
            }
        ...
        if (obj == Player_obj) { ship_check_player_distance (); }
        ...
        if ((Ships[num].ai_index >= 0) &&
            (!(obj->flags[Object::Object_Flags::Player_ship]) ||
             Player_use_ai)) {
            if (!physics_paused && !ai_paused) {
    ...
    if (pm->n_guns > sip->num_primary_banks) {
        ...
        for (i = sip->num_primary_banks; i < pm->n_guns; i++) {
            ...
            for (j = 0; j < Num_player_weapon_precedence; j++) {
                ...
                if ((Weapon_info[weapon_id].subtype == WP_LASER) ||
                    (Weapon_info[weapon_id].subtype == WP_BEAM)) {
...
/**
 * Faster version of ship_check_collision that does not do checking at the
 * polygon level.  Just checks to see if a vector will intersect a sphere.
 */
int ship_check_collision_fast (object* obj, object* other_obj, vec3d* hitpos) {
    ...
    mc.model_num = Ship_info[Ships[num].ship_info_index]
                       .model_num; // Fill in the model to check
    ...
    model_collide (&mc);
    if (mc.num_hits) *hitpos = mc.hit_point_world;
...
static void show_ship_subsys_count () {
    ...
    for (objp = GET_FIRST (&obj_used_list);
        ...
        if (o_type == OBJ_SHIP) {
            count +=
                Ship_info[Ships[objp->instance].ship_info_index].n_subsystems;
        }
    }

    if (count > Ship_subsys_hwm) { Ship_subsys_hwm = count; }
}
    ...
    for (int i = 0; i < pm->n_thrusters; i++) {
        ...
        for (int j = 0; j < bank->num_points; j++) {
            ...
            if (bank->points[j].norm.xyz.z > -0.5f) {
                continue; // only make ab trails for thrusters that are
                          // pointing backwards
            }
            ...
            ci->w_start =
                ...
                sip->afterburner_trail_width_factor; // width * table loaded
                                                     // width factor
            ci->w_end = 0.05f;                       // end width

            ci->a_start =
                1.0f *
                sip->afterburner_trail_alpha_factor; // start alpha  * table
                                                     // loaded alpha factor
            ci->a_end = 0.0f;                        // end alpha

            ci->max_life =
                sip->afterburner_trail_life; // table loaded max life
            ci->stamp = 60;                  // spew time???

            ci->n_fade_out_sections =
                sip->afterburner_trail_faded_out_sections; // initial fade out
...
int ship_create (matrix* orient, vec3d* pos, int ship_type, char* ship_name) {
    ...
    // The following check caps the number of ships that can be created.
    // Because Fred needs to create all the ships, regardless of when they
    // arrive/depart, it needs a higher limit than FreeSpace.  On release,
    ...
    // G5K: Corrected to apply specifically for ships with the no-collide flag.
    // (In retail, navbuoys already have this flag, so this doesn't break
    // anything.)
    default_ship_object_flags.set (
        Object::Object_Flags::Collides,
        !sip->flags[Ship::Info_Flags::No_collide]);
    ...
    if ((ship_name == NULL) || (ship_name_lookup (ship_name) >= 0) ||
        (ship_find_exited_ship_by_name (ship_name) >= 0)) {
    ...
    ai_clear_ship_goals (
        &Ai_info[Ships[n].ai_index]); // only do this one here.  Can't do it in
    ...
    // fix up references into paths for this ship's model to point to a
    // ship_subsys entry instead of a submodel index.  The ship_subsys entry
    // should be the same for *all* instances of the same ship.
            ...
            for (j = 0; j < pm->paths[i].nverts; j++) {
                for (k = 0; k < pm->paths[i].verts[j].nturrets; k++) {
                    int ptindex =
                        pm->paths[i]
                            .verts[j]
                            .turret_ids[k]; // this index is a submodel number
                                            // (ala bspgen)
                    int index;
                    ship_subsys* ss;

                    // iterate through the ship_subsystems looking for an id
                    // that matches
                    index = 0;
                    ss = GET_FIRST (&Ships[n].subsys_list);
                    while (ss != END_OF_LIST (&Ships[n].subsys_list)) {
                        if (ss->system_info->subobj_num ==
                            ptindex) { // when these are equal, fix up the ref
                            pm->paths[i].verts[j].turret_ids[k] =
                                index; // in path structure to index a
                                       // ship_subsys
                            break;
                        }
                        index++;
...
void change_ship_type (int n, int ship_type, int by_sexp) {
    ...
    if (sp->ship_info_index == ship_type) return;
    ...
    // MageKing17 - See if any AIs are doing anything with subsystems of this
    // ship (targeting, goal to destroy) keep track of those subsystems and
    // transfer the target/goal if the subsystem still exists, delete otherwise

    std::list< int > target_matches; // tells us to check this Ai_info index
                                     // during subsystem traversal

    std::list< ivec3 > subsystem_matches; // Ai_info index, goal index (or -1
                                          // for targeted), subsystem index
    // not having a subsystem index at first is why we have the target_matches
    // list: while traversing the subsystem list, a match can be compared
    // directly to the subsystem object, and its index added to
    // subsystem_matches.

    std::list< weapon* >
        homing_matches; // any missiles locked on to a subsystem from this ship

    std::list< std::pair< weapon*, int > >
        homing_subsystem_matches; // When homing_matches find matches, they put
                                  // them here

    std::list< weapon* > weapon_turret_matches; // projectiles that were fired
                                                // from turrets on this ship
    ...
    if (!(Fred_running) &&
        ...
        for (i = 0; i < MAX_AI_INFO; i++) {
            if (Ai_info[i].shipnum > -1) {
                if (Ai_info[i].targeted_subsys &&
                    Ai_info[i].targeted_subsys->parent_objnum == objnum) {
                    target_matches.push_back (i);
                }
                ai_goal* goals = Ai_info[i].goals;
                for (int j = 0; j < MAX_AI_GOALS; j++) {
                    // POSSIBLE OPTIMIZATION: goals[0] should be the active
                    // goal, so we might be able to reuse target_subsys_parent
                    // for that instead of doing ship_name_lookup()
                    if (goals[j].ai_mode == AI_GOAL_DESTROY_SUBSYSTEM &&
                        !(goals[j].flags
                              [AI::Goal_Flags::
                                   Subsys_needs_fixup])) { // If the subsystem
                                                           // name hasn't been
                                                           // parsed yet, we're
                                                           // fine.
        ...
        for (i = 0; i < MAX_WEAPONS; i++) {
            if (Weapons[i].objnum == -1) { continue; }
            weapon* wp = &Weapons[i];
            if (wp->homing_subsys &&
                wp->homing_subsys->parent_objnum == objnum) {
                homing_matches.push_back (wp);
            }
            if (wp->turret_subsys &&
                wp->turret_subsys->parent_objnum == objnum) {
    ...
    // Goober5000 - we can't copy the ship object because the tree of structs
    // contains at least one class without a copy constructor.  So let's just
    ...
    // Goober5000 - maintain the original hull, shield, and subsystem
    // percentages... gah
    ...
    while (ss != END_OF_LIST (&sp->subsys_list)) {
            ...
            // checked" list.
            {
                ...
                while (it != target_matches.end ()) {
                    ...
                    if (aip->targeted_subsys == ss) {
                        ivec3
                            temp = { *it, -1,
                                     num_saved_subsystems }; // -1 for the "goal" index means targeted, not
                                                             // actually a goal
                        subsystem_matches.push_back (temp);
                        aip->targeted_subsys =
                            NULL; // Clear this so that aip->last_subsys_target
                                  // won't point to a subsystem from the old
                                  // list later
            ...
            // Fix any weapons homing in on this subsystem.
            {
                ...
                while (it != homing_matches.end ()) {
                    if ((*it)->homing_subsys == ss) {
                        homing_subsystem_matches.push_back (
                            std::make_pair (*it, num_saved_subsystems));
                        auto erasor = it;
                        ++it;
            ...
            // Fix any projectiles fired from this subsystem.
            {
                ...
                while (it != weapon_turret_matches.end ()) {
                    if ((*it)->turret_subsys == ss) {
                        weapon_turret_subsystem_matches.push_back (
                            std::make_pair (*it, num_saved_subsystems));
                        auto erasor = it;
                        ++it;
            ...
            // Fix any subsystems in last_targeted_matches[].
            {
                ...
                while (it != last_targeted_matches.end ()) {
                    if (sp->last_targeted_subobject[*it] == ss) {
                        last_targeted_subsystem_matches.push_back (
                            std::make_pair (*it, num_saved_subsystems));
                        auto erasor = it;
                        ++it;
        ...
        strcpy (
            subsys_names[num_saved_subsystems], ss->system_info->subobj_name);

        if (ss->max_hits > 0.0f)
            subsys_pcts[num_saved_subsystems] =
    ...
    // if the subsystem list is not currently empty, then we need to clear it
    // out first.
    ...
    while (ss != END_OF_LIST (&sp->subsys_list)) {
        for (i = 0; i < num_saved_subsystems; i++) {
            if (!subsystem_strcasecmp (
                ...
                // MageKing17 - Every AI doing something with this subsystem
                // must transfer to the new one.
                {
    ...
    for (auto cit = subsystem_matches.cbegin ();
         cit != subsystem_matches.cend (); ++cit) {
        int goalnum = cit->y;
        ai_info* aip = &Ai_info[cit->x];
        if (goalnum == -1) {
            if (aip == Player_ai) { hud_cease_subsystem_targeting (0); }
            else {
    ...
    subsystem_matches.clear (); // We don't need these anymore, so may as well
                                // clear them now.

    for (auto cit = homing_subsystem_matches.cbegin ();
         cit != homing_subsystem_matches.cend (); ++cit) {
        cit->first->homing_subsys = nullptr;
    }

    homing_subsystem_matches.clear ();

    for (auto cit = weapon_turret_subsystem_matches.cbegin ();
         cit != weapon_turret_subsystem_matches.cend (); ++cit) {
        cit->first->turret_subsys = nullptr;
    }

    weapon_turret_subsystem_matches.clear ();

    for (auto cit = last_targeted_subsystem_matches.cbegin ();
         cit != last_targeted_subsystem_matches.cend (); ++cit) {
    ...
    // now free the memory
    for (i = 0; i < sip_orig->n_subsystems; i++) delete[] subsys_names[i];

    delete[] subsys_names;
    delete[] subsys_pcts;

    sp->afterburner_fuel = MAX (
        0, sip->afterburner_fuel_capacity -
               (sip_orig->afterburner_fuel_capacity - sp->afterburner_fuel));
    sp->cmeasure_count = MAX (
        0, sip->cmeasure_max - (sip_orig->cmeasure_max - sp->cmeasure_count));

    // avoid cases where either of these are 0
    if (sp->current_max_speed != 0 && sip_orig->max_speed != 0) {
        sp->current_max_speed =
            sip->max_speed * (sp->current_max_speed / sip_orig->max_speed);
    }
    else {
    ...
    if (by_sexp) {
        ...
        Objects[sp->objnum].phys_info.reduced_damp_decay =
            ph_inf.reduced_damp_decay;
        Objects[sp->objnum].phys_info.rotvel = ph_inf.rotvel;
        Objects[sp->objnum].phys_info.shockwave_decay = ph_inf.shockwave_decay;
        Objects[sp->objnum].phys_info.shockwave_shake_amp =
            ph_inf.shockwave_shake_amp;
    ...
    if (sip->flags[Ship::Info_Flags::Afterburner]) {
        ...
        for (int h = 0; h < pm->n_thrusters; h++) {
            for (int j = 0; j < pm->thrusters[h].num_points; j++) {
                ...
                // only make ab trails for thrusters that are pointing
                // backwards
                if (pm->thrusters[h].points[j].norm.xyz.z > -0.5) continue;

                ci->pt = pm->thrusters[h].points[j].pnt; // offset
                ci->w_start =
                    pm->thrusters[h].points[j].radius *
                    sip->afterburner_trail_width_factor; // width * table
                                                         // loaded width factor
                ...
                ci->a_start =
                    1.0f *
                    sip->afterburner_trail_alpha_factor; // start alpha  *
                                                         // table loaded alpha
                                                         // factor
                ...
                ci->n_fade_out_sections =
                    sip->afterburner_trail_faded_out_sections; // table loaded
                                                               // n sections to
                                                               // be faded out
    ...
    if (sip->flags[Ship::Info_Flags::Stealth]) // changing TO a stealthy ship
                                               // class
        sp->flags.set (Ship_Flags::Stealth);
    else if (sip_orig->flags[Ship::Info_Flags::Stealth]) // changing FROM a
                                                         // stealthy ship class
    ...
    else if (sip_orig->flags[Ship::Info_Flags::No_collide]) // changing FROM a
                                                            // no-collision
                                                            // ship class
        obj_set_flags (objp, objp->flags + Object::Object_Flags::Collides);
    ...
    // Chief1983: Make sure that when changing to a new ship with secondaries,
    // you switch to bank 0.  They still won't fire if the
    // SF2_SECONDARIES_LOCKED flag is on as this should have carried over.
    ...
    // The E - If we're switching during gameplay, make sure we get valid
    ...
    if (!(Game_mode & GM_IN_MISSION) && !(Fred_running)) {
        ...
        Objects[sp->objnum].phys_info.vel.xyz.z =
            Objects[sp->objnum].phys_info.speed;
        Objects[sp->objnum].phys_info.prev_ramp_vel =
    ...
    if (sp->ship_replacement_textures != NULL) {
        ...
        for (std::vector< texture_replace >::iterator tr =
            ...
            for (j = 0; j < pm->n_textures; j++) {
                ...
                if (tnum > -1)
                    sp->ship_replacement_textures[j * TM_NUM_TYPES + tnum] =
                        tr->new_texture_id;
            }
        }
    }

    if (sip->uses_team_colors) { sp->team_name = sip->default_team_name; }
}
...
int ship_fire_primary_debug (object* objp) {
    ...
    if (i != MAX_WEAPONS) {
        int weapon_objnum;
        weapon_objnum =
            weapon_create (&wpos, &objp->orient, i, OBJ_INDEX (objp));
        weapon_set_tracking_info (
            weapon_objnum, OBJ_INDEX (objp),
            Ai_info[shipp->ai_index].target_objnum);
        return 1;
    }
    else
        return 0;
 ...
 * @param rand_val is used in multiplayer to ensure that all clients in the
 * game fire countermeasure the same way
 */
int ship_launch_countermeasure (object* objp, int rand_val) {
    ...
    int arand;
    if (rand_val < 0) { arand = myrand (); }
    else {
        arand = rand_val;
    }

    // in the case where the server is an observer, he can launch
    // countermeasures unless we do this.
    if (objp->type == OBJ_OBSERVER) { return 0; }
    ...
    // we might check the count of countermeasures left depending on game
    // state.  Multiplayer clients do not need to check any objects other than
    ...
    if (check_count &&
        ...
        if (objp == Player_obj) {
            if (sip->cmeasure_max < 1 || sip->cmeasure_type < 0) {
                ...
                HUD_sourced_printf (
                    HUD_SOURCE_HIDDEN, "%s",
                    XSTR ("Not equipped with countermeasures", 1633));
            }
            else if (shipp->current_cmeasure < 0) {
                // TODO: multi-lingual support
                HUD_sourced_printf (
                    HUD_SOURCE_HIDDEN, "%s",
                    XSTR ("No countermeasures selected", 1634));
            }
            else if (shipp->cmeasure_count <= 0) {
                HUD_sourced_printf (
                    HUD_SOURCE_HIDDEN, "%s",
                    XSTR ("No more countermeasure charges.", 485));
            }
            snd_play (
                gamesnd_get_game_sound (
                    ship_get_sound (Player_obj, GameSounds::OUT_OF_MISSLES)),
                0.0f);
        }
    ...
    vm_vec_scale_add (
        &pos, &objp->pos, &objp->orient.vec.fvec, -objp->radius / 2.0f);

    cobjnum = weapon_create (
...
void ship_maybe_play_primary_fail_sound () {
    ...
    if (timestamp_elapsed (Laser_energy_out_snd_timer)) {
        ...
        if (Weapon_info[swp->primary_bank_weapons[swp->current_primary_bank]]
        ...
        snd_play (gamesnd_get_game_sound (
            ship_get_sound (Player_obj, GameSounds::OUT_OF_WEAPON_ENERGY)));
    }
}
...
static int ship_maybe_play_secondary_fail_sound (weapon_info* wip) {
    hud_start_flash_weapon (
        Player_ship->weapons.num_primary_banks +
        Player_ship->weapons.current_secondary_bank);
...
static int ship_weapon_maybe_fail (ship* sp) {
    ...
    // If playing on lowest skill level, weapons will not fail due to subsystem
    // damage
    if (Game_skill_level == 0) { return 0; }
    ...
    if (!rval) {
        ...
        if (ship_subsys_disrupted (sp, SUBSYSTEM_WEAPONS)) { rval = 1; }
    }
...
static int ship_stop_fire_primary_bank (object* obj, int bank_to_stop) {
    ...
    if (shipp->primary_rotate_rate[bank_to_stop] > 0.0f)
        shipp->primary_rotate_rate[bank_to_stop] -=
            Weapon_info[swp->primary_bank_weapons[bank_to_stop]]
                .weapon_submodel_rotate_accell *
            flFrametime;
    if (shipp->primary_rotate_rate[bank_to_stop] < 0.0f)
        shipp->primary_rotate_rate[bank_to_stop] = 0.0f;
    if (Ship_info[shipp->ship_info_index].draw_primary_models[bank_to_stop]) {
        shipp->primary_rotate_ang[bank_to_stop] +=
            shipp->primary_rotate_rate[bank_to_stop] * flFrametime;
...
bool in_autoaim_fov (ship* shipp, int bank_to_fire, object* obj) {
    ...
    if (aip->targeted_subsys != nullptr) {
        get_subsystem_world_pos (
            &Objects[aip->target_objnum], aip->targeted_subsys,
            &target_position);
    }
    else {
    ...
    dist_to_target =
        vm_vec_dist_quick (&Objects[shipp->objnum].pos, &target_position);

    hud_calculate_lead_pos (
        &plr_to_target_vec, &target_position, obj, winfo_p, dist_to_target);
    vm_vec_sub2 (&plr_to_target_vec, &Objects[shipp->objnum].pos);

    float angle_to_target =
        vm_vec_delta_ang (&player_forward_vec, &plr_to_target_vec, nullptr);

    if (angle_to_target <= autoaim_fov) { return true; }
    else {
        return false;
    }
}

// fires a primary weapon for the given object.  It also handles multiplayer
// cases. in multiplayer, the starting network signature, and number of banks
// fired are sent to all the clients in the game. All the info is passed to
// send_primary at the end of the function.  The check_energy parameter
// (defaults to 1) tells us whether or not we should check the energy.  It will
// be 0 when a multiplayer client is firing an AI primary.
int ship_fire_primary (object* obj, int stream_weapons, int force) {
    ...
    float dist_to_target =
        0; // distance to target, for autoaim & automatic convergence
    ...
    // in the case where the server is an observer, he can fire (which) would
    ...
    if (swp->num_primary_banks <= 0) { return 0; }

    if (swp->current_primary_bank < 0) { return 0; }

    // If the primaries have been locked, bail
    if (shipp->flags[Ship_Flags::Primaries_locked]) { return 0; }

    sound_played = gamesnd_id ();

    // Fire the correct primary bank.  If primaries are linked
    // (SF_PRIMARY_LINKED set), then fire both primary banks.
    ...
    for (i = 0; i < num_primary_banks; i++) {
        ...
        if (swp->primary_animation_position[bank_to_fire] == MA_POS_SET) {
            if (timestamp_elapsed (
                    swp->primary_animation_done_time[bank_to_fire]))
        ...
        if (needs_target_pos) {
            ...
            if (The_mission.ai_profile
                ...
                vm_vec_scale_sub2 (
                    &target_velocity_vec, &obj->phys_info.vel,
                    winfo_p->vel_inherit_amount);
        }

        if (winfo_p->weapon_submodel_rotate_vel > 0.0f) {
            if (shipp->primary_rotate_rate[bank_to_fire] <
                winfo_p->weapon_submodel_rotate_vel)
                shipp->primary_rotate_rate[bank_to_fire] +=
                    winfo_p->weapon_submodel_rotate_accell * flFrametime;
            if (shipp->primary_rotate_rate[bank_to_fire] >
                winfo_p->weapon_submodel_rotate_vel)
                shipp->primary_rotate_rate[bank_to_fire] =
                    winfo_p->weapon_submodel_rotate_vel;
            if (sip->draw_primary_models[bank_to_fire]) {
                shipp->primary_rotate_ang[bank_to_fire] +=
                    shipp->primary_rotate_rate[bank_to_fire] * flFrametime;
        ...
        // if this is a targeting laser, start it up   ///- only targeting
        // laser if it is tag-c, otherwise it's a fighter beam -Bobboau
        if ((winfo_p->wi_flags[Weapon::Info_Flags::Beam]) &&
            (winfo_p->tag_level == 3) &&
            (shipp->flags[Ship_Flags::Trigger_down]) &&
            (winfo_p->b_info.beam_type == BEAM_TYPE_C)) {
            ship_start_targeting_laser (shipp);
            continue;
        }

        // if we're firing stream weapons and this is a non stream weapon, skip
        // it
        if (stream_weapons &&
            !(winfo_p->wi_flags[Weapon::Info_Flags::Stream])) {
            continue;
        }
        // if we're firing non stream weapons and this is a stream weapon, skip
        // it
        if (!stream_weapons &&
            (winfo_p->wi_flags[Weapon::Info_Flags::Stream])) {
            continue;
        ...
        // only non-multiplayer clients (single, multi-host) need to do
        // timestamp checking
        ...
        if (shipp->flags[Ship_Flags::Primary_linked] &&
            winfo_p->wi_flags[Weapon::Info_Flags::Nolink]) {
            continue;
        }
        ...
        if (winfo_p->burst_shots > swp->burst_counter[bank_to_fire]) {
            ...
            winfo_p->max_delay != 0.0f &&
            winfo_p->min_delay != 0.0f) { // Random fire delay (DahBlount)
            next_fire_delay =
                (((float)rand ()) /
                 (((float)RAND_MAX + 1.0f) *
                      (winfo_p->max_delay - winfo_p->min_delay + 1.0f) +
                  winfo_p->min_delay)) *
                1000.0f;
        }
        else {
        ...
        if ((num_primary_banks > 1) &&
            !(winfo_p->wi_flags[Weapon::Info_Flags::No_linked_penalty]) &&
            !(The_mission.ai_profile
                  ->flags[AI::Profile_Flags::Disable_linked_fire_penalty])) {
            int effective_primary_banks = 0;
            for (int it = 0; it < num_primary_banks; it++) {
                if ((it == bank_to_fire) ||
                    !(Weapon_info[swp->primary_bank_weapons[it]].wi_flags
                          [Weapon::Info_Flags::Nolink,
        ...
        if (winfo_p->fof_spread_rate > 0.0f) {
            // Adjust the primary_bank_fof_cooldown based on how long it's been
            // since the last shot.
            float reset_amount =
                (timestamp_until (swp->last_primary_fire_stamp[bank_to_fire]) /
                 1000.0f) *
                winfo_p->fof_reset_rate;
            swp->primary_bank_fof_cooldown[bank_to_fire] +=
                winfo_p->fof_spread_rate + reset_amount;
        ...
        if ((next_fire_delay > 0.0f)) {
            if (obj->flags[Object::Object_Flags::Player_ship]) {
                ...
                if ((int)next_fire_delay < 1) { next_fire_delay = 1.0f; }
            }

            swp->next_primary_fire_stamp[bank_to_fire] =
                timestamp ((int)(next_fire_delay));
        ...
        if (sip->flags[Ship::Info_Flags::Dyn_primary_linking]) {
            ...
            swp->last_primary_fire_stamp[bank_to_fire] = timestamp ();
            // to maintain balance of fighters with more fire points they will
            // fire faster than ships with fewer points
        }
        else {
            swp->next_primary_fire_stamp[bank_to_fire] =
                timestamp ((int)(next_fire_delay));
        ...
        // weapon. Note that we can have partial bank firing, if the weapons
        // subsystem is partially functional, which should be cool.
        if (ship_weapon_maybe_fail (shipp) && !force) {
            if (obj == Player_obj) { ship_maybe_play_primary_fail_sound (); }
        ...
        if (pm->n_guns > 0) {
            ...
            if (needs_target_pos) {
                ...
                vm_vec_scale_add (
                    &predicted_target_pos, &target_position,
                    &target_velocity_vec, time_to_target);
                polish_predicted_target_pos (
                    winfo_p, &Objects[aip->target_objnum], &target_position,
                    &predicted_target_pos, dist_to_target, &last_delta_vec, 1);
                vm_vec_sub (
                    &plr_to_target_vec, &predicted_target_pos, &obj->pos);

                if (has_autoaim) {
                    angle_to_target = vm_vec_delta_ang (
                        &player_forward_vec, &plr_to_target_vec, NULL);
                ...
                if (sip->minimum_convergence_distance > dist_to_aim) {
                    float dist_mult;
                    dist_mult =
                        sip->minimum_convergence_distance / dist_to_aim;
                    vm_vec_scale_add (
                        &predicted_target_pos, &obj->pos, &plr_to_target_vec,
                        dist_mult);
            ...
            if (winfo_p->wi_flags
                    [Weapon::Info_Flags::
                         Beam]) { // the big change I made for fighter beams,
                                  // if there beams fill out the Fire_Info for
                                  // a targeting laser then fire it, for each
                                  // point in the weapon bank -Bobboau
                float t;
                if (winfo_p->burst_shots > swp->burst_counter[bank_to_fire]) {
                    ...
                    t = winfo_p->fire_wait; // doing that time scale thing on
                                            // enemy fighter is just ugly with
                                            // beams, especaly ones that have
                                            // careful timeing
                    swp->burst_counter[bank_to_fire] = 0;
                }
                swp->next_primary_fire_stamp[bank_to_fire] =
                ...
                if (shipp->weapon_energy <
                    points * winfo_p->energy_consumed * flFrametime) {
                    swp->next_primary_fire_stamp[bank_to_fire] =
                        timestamp ((int)(next_fire_delay));
                    if (obj == Player_obj) {
                ...
                shipp->beam_sys_info.turret_num_firing_points =
                    1; // dummy turret info is used per firepoint
                shipp->beam_sys_info.turret_fov = cosf (
                    (winfo_p->field_of_fire != 0.0f) ? winfo_p->field_of_fire
                                                     : 180);

                shipp->fighter_beam_turret_data.disruption_timestamp =
                    timestamp (0);
                shipp->fighter_beam_turret_data.turret_next_fire_pos = 0;
                shipp->fighter_beam_turret_data.current_hits = 1.0;
                shipp->fighter_beam_turret_data.system_info =
                    &shipp->beam_sys_info;

                fbfire_info.target_subsys =
                    Ai_info[shipp->ai_index].targeted_subsys;
                fbfire_info.beam_info_index =
                    shipp->weapons.primary_bank_weapons[bank_to_fire];
                ...
                for (v = 0; v < points; v++) {
                    if (winfo_p->b_info.beam_shots) {
                        j = (shipp->last_fired_point[bank_to_fire] + 1) %
                            num_slots;
                    ...
                    fbfire_info.targeting_laser_offset =
                        pm->gun_banks[bank_to_fire].pnt[j];
                    shipp->beam_sys_info.pnt =
                        pm->gun_banks[bank_to_fire].pnt[j];
                    shipp->beam_sys_info.turret_firing_point[0] =
                        pm->gun_banks[bank_to_fire].pnt[j];
            ...
            else // if this isn't a fighter beam, do it normally -Bobboau
            {
                ...
                // ok if this is a cycling weapon use shots as the number of
                // points to fire from at a time otherwise shots is the number
                // of times all points will be fired (used mostly for the
                // 'shotgun' effect)
                if (sip->flags[Ship::Info_Flags::Dyn_primary_linking]) {
                    numtimes = 1;
                    points = MIN (
                        num_slots, swp->primary_bank_slot_count[bank_to_fire]);
                }
                else if (winfo_p->wi_flags[Weapon::Info_Flags::Cycle]) {
                    numtimes = 1;
                ...
                // The energy-consumption code executes even for ballistic
                // primaries, because there may be a reason why you want to
                // have ballistics consume energy.  Perhaps you can't fire too
                // many too quickly or they'll overheat.  If not, just set the
                // weapon's energy_consumed to 0 and it'll work just fine. -
                // Goober5000

                // fail unless we're forcing (energy based primaries)
                if ((shipp->weapon_energy <
                     points * numtimes *
                         winfo_p->energy_consumed) // was num_slots
                    && !force) {
                    swp->next_primary_fire_stamp[bank_to_fire] =
                        timestamp ((int)(next_fire_delay));
                    if (obj == Player_obj) {
                ...
                // moved the above to here to use points instead of num_slots
                // for energy consumption check

                // ballistics support for primaries - Goober5000
                if (winfo_p->wi_flags[Weapon::Info_Flags::Ballistic]) {
                    // If ship is being repaired/rearmed, it cannot fire
                    // ballistics
                    ...
                    // determine if there is enough ammo left to fire weapons
                    // on this bank.  As with primary weapons, we might or
                    // might not check ammo counts depending on game mode, who
                    ...
                    if (Weapon_energy_cheat == 0) {
                        ...
                        // make sure we don't go below zero; any such error is
                        // excusable because it only happens when the bank is
                        // depleted in one shot
                ...
                // deplete the weapon reserve energy by the amount of energy
                // used to fire the weapon Only subtract the energy amount
                // required for equipment operation once
                shipp->weapon_energy -=
                    points * numtimes * winfo_p->energy_consumed;
                ...
                for (w = 0; w < numtimes; w++) {
                    ...
                    for (j = 0; j < points; j++) {
                        ...
                        if ((winfo_p->wi_flags[Weapon::Info_Flags::Cycle]) ||
                            ...
                            pt = (shipp->last_fired_point[bank_to_fire] + 1) %
                                 num_slots;
                        }
                        else {
                            pt = j;
                        ...
                        int sub_shots = 1;
                        // Use 0 instead of bank_to_fire as index when checking
                        // the number of external weapon model firingpoints
                        if (weapon_model && weapon_model->n_guns)
                            if (!(winfo_p->wi_flags[Weapon::Info_Flags::
                                                        External_weapon_fp]))
                                sub_shots =
                                    weapon_model->gun_banks[0].num_slots;

                        for (int s = 0; s < sub_shots; s++) {
                            pnt = pm->gun_banks[bank_to_fire].pnt[pt];
                            // Use 0 instead of bank_to_fire as index to
                            // external weapon model firingpoints
                            if (weapon_model && weapon_model->n_guns) {
                                if (winfo_p
                                        ->wi_flags[Weapon::Info_Flags::
                                                       External_weapon_fp]) {
                                    vm_vec_add2 (
                                        &pnt,
                                        &weapon_model->gun_banks[0].pnt
                                             [swp->external_model_fp_counter
                                                  [bank_to_fire]]);
                                }
                                else {
                                    vm_vec_add2 (
                                        &pnt,
                                        &weapon_model->gun_banks[0].pnt[s]);
                                }
                            }
                            ...
                            */
                            if (has_autoaim && in_automatic_aim_fov) {
                                ...
                                if (has_converging_autoaim) {
                                    // converging autoaim
                                    vm_vec_sub (
                                        &firing_vec, &predicted_target_pos,
                                        &firing_pos);
                                }
                                else {
                                    // autoaim
                                ...
                                vm_vector_2_matrix (
                                    &firing_orient, &firing_vec, NULL, NULL);
                            }
                            else if (
                                (sip->aiming_flags
                                     [Ship::Aiming_Flags::Std_convergence]) ||
                                ((sip->aiming_flags[Ship::Aiming_Flags::
                                                        Auto_convergence]) &&
                                 (aip->target_objnum != -1))) {
                                // std & auto convergence
                                vec3d target_vec, firing_vec,
                                    convergence_offset;

                                // make sure vector is of the set length
                                vm_vec_copy_normalize (
                                    &target_vec, &player_forward_vec);
                                if ((sip->aiming_flags
                                         [Ship::Aiming_Flags::
                                              Auto_convergence]) &&
                                    (aip->target_objnum != -1)) {
                                    ...
                                    vm_vec_scale (
                                        &target_vec,
                                        sip->convergence_distance);
                                }

                                // if there is convergence offset then make use
                                // of it)
                                if (sip->aiming_flags
                                        [Ship::Aiming_Flags::
                                             Convergence_offset]) {
                                    vm_vec_unrotate (
                                        &convergence_offset,
                                        &sip->convergence_offset,
                                        &obj->orient);
                                    vm_vec_add2 (
                                        &target_vec, &convergence_offset);
                                }

                                vm_vec_add2 (&target_vec, &obj->pos);
                                vm_vec_sub (
                                    &firing_vec, &target_vec, &firing_pos);
                                ...
                                vm_vector_2_matrix (
                                    &firing_orient, &firing_vec, NULL, NULL);
                                         ...
                                         [Ship::Info_Flags::Gun_convergence]) {
                                // model file defined convergence
                                vec3d firing_vec;
                                vm_vec_unrotate (
                                    &firing_vec,
                                    &pm->gun_banks[bank_to_fire].norm[pt],
                                    &obj->orient);
                                vm_vector_2_matrix (
                                    &firing_orient, &firing_vec, NULL, NULL);
                            }
                            ...
                            if (winfo_p->wi_flags
                                ...
                                float recoil_force =
                                    (winfo_p->mass * winfo_p->max_speed *
                                     winfo_p->recoil_modifier *
                                     sip->ship_recoil_modifier);

                                firepoint_list[current_firepoint++] =
                                    firing_pos;

                                vm_vec_scale (
                                    &local_impulse, (-1 * recoil_force));
                                vm_vec_add2 (&total_impulse, &local_impulse);
                            }

                            // create the weapon -- the network signature for
                            // multiplayer is created inside of weapon_create
                            weapon_objnum = weapon_create (
                                &firing_pos, &firing_orient, weapon_idx,
                                OBJ_INDEX (obj), new_group_id, 0, 0,
                                swp->primary_bank_fof_cooldown[bank_to_fire]);
                            ...
                            if (winfo_p->wi_flags[Weapon::Info_Flags::Flak]) {
                                ...
                                vec3d predicted_pos;
                                float flak_range =
                                    (winfo_p->lifetime) * (winfo_p->max_speed);
                                float range_to_target = flak_range;
                                float wepstr = ship_get_subsystem_strength (
                                    shipp, SUBSYSTEM_WEAPONS);
                                ...
                                if (target != NULL) {
                                    set_predicted_enemy_pos (
                                        &predicted_pos, obj, &target->pos,
                                        &target->phys_info.vel, aip);
                                    range_to_target = vm_vec_dist (
                                        &predicted_pos, &obj->pos);
                                }

                                // if we have a target and its in range
                                if ((target != NULL) &&
                                    (range_to_target < flak_range)) {
                                    // set flak range to range of ship
                                    flak_pick_range (
                                        &Objects[weapon_objnum], &firing_pos,
                                        &predicted_pos, wepstr);
                                }
                                else {
                                    flak_set_range (
                                ...
                                if ((winfo_p->muzzle_flash >= 0) &&
                                    (((shipp == Player_ship) &&
                                     ...
                                     (shipp != Player_ship))) {
                                    flak_muzzle_flash (
                                        &firing_pos, &obj->orient.vec.fvec,
                                        &obj->phys_info,
                                        swp->primary_bank_weapons
                                            [bank_to_fire]);
                                }
                            }
                            ...
                            if ((obj != Player_obj) ||
                                (sip->flags
                                     [Ship::Info_Flags::Show_ship_model]) ||
                                (Viewer_mode)) {
                                // show the flash only if in not cockpit view,
                                // or if "show ship" flag is set
                                shipfx_flash_create (
                                    obj, sip->model_num, &pnt,
                                    &obj->orient.vec.fvec, 1, weapon_idx);
                            }
                            ...
                            if ((winfo_p->wi_flags
                                ...
                                // (mass * velocity) / 10
                                game_shudder_apply (
                                    500, (winfo_p->mass * winfo_p->max_speed) *
                                             0.1f);
                            }

                            num_fired++;
                            shipp->last_fired_point[bank_to_fire] =
                                (shipp->last_fired_point[bank_to_fire] + 1) %
                                num_slots;
                        }
                    }
                    swp->external_model_fp_counter[bank_to_fire]++;
                ...
                if (winfo_p->wi_flags[Weapon::Info_Flags::Apply_Recoil]) {
                    ...
                    vm_vec_avg_n (
                        &avg_firepoint, (int)current_firepoint,
                        firepoint_list);
        ...
        // Only play the weapon fired sound if it hasn't been played yet.  This
        // is to avoid playing the same sound multiple times when banks are
        // linked with the same weapon.

        if (!(winfo_p->wi_flags[Weapon::Info_Flags::Beam])) { // not a beam
                                                              // weapon?
            if (sound_played != winfo_p->launch_snd) {
                ...
                if (obj == Player_obj) {
                    if (winfo_p->launch_snd.isValid ()) {
                        ...
                        // Update the last timestamp until continous fire is
                        // over, so we have the timestamp of the cease-fire.
                        if (shipp->was_firing_last_frame[bank_to_fire] == 1) {
                            swp->last_primary_fire_sound_stamp[bank_to_fire] =
                                timestamp ();
                        }

                        // Check for pre-launch sound and play if relevant
                        if ((winfo_p->pre_launch_snd
                                 .isValid ()) // If this weapon type has a
                                              // pre-fire sound
                            &&
                            ((timestamp () - swp->last_primary_fire_sound_stamp
                                                 [bank_to_fire]) >=
                             winfo_p
                            ...
                            snd_play (
                                gamesnd_get_game_sound (
                                    winfo_p->pre_launch_snd),
                                0.0f, 1.0f, SND_PRIORITY_MUST_PLAY); // play it
                        }
                        else { // Otherwise, play normal firing sounds
                            // HACK
                            if (winfo_p->launch_snd ==
                                gamesnd_id (GameSounds::AUTOCANNON_SHOT)) {
                                snd_play (
                                    gamesnd_get_game_sound (
                                        winfo_p->launch_snd),
                                    0.0f, 1.0f, SND_PRIORITY_TRIPLE_INSTANCE);
                            }
                            else {
                                snd_play (
                                    gamesnd_get_game_sound (
                                        winfo_p->launch_snd),
                                    0.0f, 1.0f, SND_PRIORITY_MUST_PLAY);
                            }
                        }
                        ...
                        if (sw_pl->current_primary_bank >= 0) {
                            wip = &Weapon_info
                                      [sw_pl->primary_bank_weapons
                                           [sw_pl->current_primary_bank]];
                            int force_level =
                                (int)((wip->armor_factor + wip->shield_factor * 0.2f) * (wip->damage * wip->damage - 7.5f) * 0.45f + 0.6f) *
                                    10 +
                                2000;

                            // modify force feedback for ballistics: make it
                            // stronger
                            if (wip->wi_flags[Weapon::Info_Flags::Ballistic])
                    ...
                    if (winfo_p->launch_snd.isValid ()) {
                        snd_play_3d (
                            gamesnd_get_game_sound (winfo_p->launch_snd),
                            &obj->pos, &View_position);
                    }
                }
            }
        }
...
static void ship_start_targeting_laser (ship* shipp) {
    ...
    if ((shipp->weapons.primary_bank_weapons[0] >= 0) &&
        (Weapon_info[shipp->weapons.primary_bank_weapons[0]]
    ...
    if ((shipp->weapons.primary_bank_weapons[1] >= 0) &&
        (Weapon_info[shipp->weapons.primary_bank_weapons[1]]
             .wi_flags[Weapon::Info_Flags::Beam]) &&
        (Weapon_info[shipp->weapons.primary_bank_weapons[1]]
             .b_info.beam_type == BEAM_TYPE_C)) {
        bank1_laser = 1;
...
static void ship_stop_targeting_laser (ship* shipp) {
    shipp->targeting_laser_bank = -1;
    shipp->targeting_laser_objnum =
        -1; // erase old laser obj num if it has any -Bobboau
}
...
void ship_process_targeting_lasers () {
    ...
    for (so = GET_FIRST (&Ship_obj_list); so != END_OF_LIST (&Ship_obj_list);
         so = GET_NEXT (so)) {
        // sanity checks
        if (so->objnum < 0) { continue; }
        if (Objects[so->objnum].type != OBJ_SHIP) { continue; }
        ...
        if ((shipp->targeting_laser_bank >= 0) &&
...
static int maybe_detonate_weapon (ship_weapon* swp, object* /*src*/) {
    ...
    if ((objnum < 0) || (objnum >= MAX_OBJECTS)) { return 0; }

    objp = &Objects[objnum];

    if (objp->type != OBJ_WEAPON) { return 0; }

    if ((objp->instance < 0) || (objp->instance >= MAX_WEAPONS)) { return 0; }
            ...
            if (maybe_detonate_weapon (swp, obj)) {
                ...
                for (mo = GET_FIRST (&Missile_obj_list);
                    ...
                    if ((mobjp != first_objp) &&
                        ...
                        if (Weapon_info[Weapons[mobjp->instance]
                                            .weapon_info_index]
...
int ship_fire_secondary (object* obj, int allow_swarm) {
    ...
    // in the case where the object is a ghost (a delayed fire packet from
    ...
    if (swp->num_secondary_banks <= 0) { return 0; }

    // If the secondaries have been locked, bail
    if (shipp->flags[Ship_Flags::Secondaries_locked]) { return 0; }

    // If ship is being repaired/rearmed, it cannot fire missiles
    if (aip->ai_flags[AI::AI_Flags::Being_repaired]) { return 0; }

    num_fired = 0; // tracks how many missiles actually fired

    // niffiwan: allow swarm/corkscrew bank to keep firing if current bank
    // changes
    ...
    if (bank < 0 || bank >= sip->num_secondary_banks) { return 0; }
        ...
        if (swp->current_secondary_bank >= 0) {
            if (timestamp_elapsed (swp->next_secondary_fire_stamp[bank])) {
                swp->next_secondary_fire_stamp[bank] =
                    timestamp (MAX ((int)flFrametime * 3000, 250));
            }
        }
        return 0;
    }

    // niffiwan: 04/03/12: duplicate of a check approx 100 lines above - not
    // needed?
    if (bank < 0) { return 0; }
        ...
        if (aip->current_target_is_locked <= 0) {
            if (obj == Player_obj) {
                if (!Weapon_energy_cheat) {
                    ...
                    if ((aip->target_objnum != -1) &&
                        (vm_vec_dist_quick (
                             &obj->pos, &Objects[aip->target_objnum].pos) >
                         max_dist)) {
                        HUD_sourced_printf (
                            HUD_SOURCE_HIDDEN, "%s",
                            XSTR ("Too far from target to acquire lock", 487));
                    }
                    else {
                        ...
                        HUD_sourced_printf (
                            HUD_SOURCE_HIDDEN,
                            XSTR ("Cannot fire %s without a lock", 488),
                            missile_name);
                    }

                    snd_play (gamesnd_get_game_sound (ship_get_sound (
                        Player_obj, GameSounds::OUT_OF_MISSLES)));
                    swp->next_secondary_fire_stamp[bank] =
                        timestamp (800); // to avoid repeating messages
                    return 0;
                }
            }
            else {
        ...
        if (!ship_is_tagged (&Objects[aip->target_objnum])) {
            if (obj == Player_obj) {
                if (!Weapon_energy_cheat) {
                    HUD_sourced_printf (
                        HUD_SOURCE_HIDDEN,
                        NOX ("Cannot fire %s if target is not tagged"),
    ...
    if (Weapon_info[weapon_idx].burst_shots >
        swp->burst_counter[bank_adjusted]) {
        t = Weapon_info[weapon_idx].burst_delay;
        swp->burst_counter[bank_adjusted]++;
    }
    else {
        t = Weapon_info[weapon_idx]
                .fire_wait; // They can fire 5 times a second
    ...
    if (pm->n_missiles > 0) {
        ...
        // determine if there is enough ammo left to fire weapons on this bank.
        // As with primary weapons, we might or might not check ammo counts
        ...
        if (shipp->flags[Ship_Flags::Secondary_dual_fire] && num_slots > 1) {
            ...
            // AL 11-19-97: Ensure enough ammo remains when firing linked
            // secondary weapons
            ...
            // de-set the flag just in case dual-fire was set but couldn't be
            // used because there's less than two firepoints
        ...
        for (j = start_slot; j <= end_slot; j++) {
            ...
            if (pnt_index >= num_slots) { pnt_index = 0; }
            ...
            if (!(sip->flags[Ship::Info_Flags::Gun_convergence])) {
                ...
                vec3d firing_vec;
                vm_vec_unrotate (
                    &firing_vec, &pm->missile_banks[bank].norm[pnt_index - 1],
                    &obj->orient);
                vm_vector_2_matrix (&firing_orient, &firing_vec, NULL, NULL);
            }

            // create the weapon -- for multiplayer, the net_signature is
            // assigned inside of weapon_create
            weapon_num = weapon_create (
                &firing_pos, &firing_orient, weapon_idx, OBJ_INDEX (obj), -1,
                aip->current_target_is_locked);
            ...
            if (weapon_num >= 0) {
                weapon_idx =
                    Weapons[Objects[weapon_num].instance].weapon_info_index;
                weapon_set_tracking_info (
                ...
                if ((obj != Player_obj) ||
                    ...
                    (Viewer_mode)) {
                    // show the flash only if in not cockpit view, or if "show
                    // ship" flag is set
                    shipfx_flash_create (
                        obj, sip->model_num, &pnt, &obj->orient.vec.fvec, 0,
                        weapon_idx);
                }
                ...
                if ((wip->wi_flags[Weapon::Info_Flags::Shudder]) &&
                    ...
                    // (mass * velocity) / 10
                    game_shudder_apply (
                        500, (wip->mass * wip->max_speed) * 0.1f);
                }
    ...
    if (obj == Player_obj) {
        if (Weapon_info[weapon_idx].launch_snd.isValid ()) {
            snd_play (
                gamesnd_get_game_sound (Weapon_info[weapon_idx].launch_snd),
                0.0f, 1.0f, SND_PRIORITY_MUST_PLAY);
            swp = &Player_ship->weapons;
            if (bank >= 0) {
                wip = &Weapon_info[swp->secondary_bank_weapons[bank]];
                if (Player_ship->flags[Ship_Flags::Secondary_dual_fire]) {
                    joy_ff_play_secondary_shoot (
                        (int)(wip->cargo_size * 2.0f));
                }
                else {
...
done_secondary:
    ...
    // if we are out of ammo in this bank then don't carry over firing
    ...
    // has
    // no information / member that stores the next valids banks remaning
    // fire_wait delay.
    //
    // what he should have done was to check of the next valid bank had any
    // fire delay that had elapsed, if it had elapsed, then it would have no
    // firedelay. and then add 250 ms of delay. in effect, this way there is no
    // penalty if there is any firedelay remaning in the next valid bank. the
    // delay is there to prevent things like Trible/Quad Fire Trebuchets.
    //
    // niffiwan: only try to switch banks if object has multiple banks, and
    // firing bank is the current bank
    if ((obj->flags[Object::Object_Flags::Player_ship]) &&
        (swp->secondary_bank_ammo[bank] <= 0) &&
        (swp->num_secondary_banks >= 2) &&
        (bank == swp->current_secondary_bank)) {
        if (ship_select_next_secondary (
                obj)) { // DTP here we switch to the next valid bank, but we
                        // can't call weapon_info on next fire_wait

            if (timestamp_elapsed (
                    shipp->weapons.next_secondary_fire_stamp
                        [shipp->weapons
                             .current_secondary_bank])) { // DTP, this is
                                                          // simply a copy of
                                                          // the manual cycle
                                                          // functions
                shipp->weapons.next_secondary_fire_stamp
                    [shipp->weapons.current_secondary_bank] =
                    timestamp (1000); // Bumped from 250 to 1000 because some
                                      // people seem to be to triggerhappy :).
                shipp->weapons.last_secondary_fire_stamp
                    [shipp->weapons.current_secondary_bank] = timestamp ();
            }

            if (obj == Player_obj) {
                snd_play (gamesnd_get_game_sound (
                    ship_get_sound (Player_obj, GameSounds::SECONDARY_CYCLE)));
            }
        }
    }
...
static int primary_out_of_ammo (ship_weapon* swp, int bank) {
    ...
    if (Weapon_info[swp->primary_bank_weapons[bank]]
            .wi_flags[Weapon::Info_Flags::Ballistic]) {
        if (swp->primary_bank_ammo[bank] <= 0) { return 1; }
    }
 ...
 * @param direction forward == CYCLE_PRIMARY_NEXT, backward ==
 * CYCLE_PRIMARY_PREV
 *
 * NOTE: This code can be called for any arbitrary ship.  HUD messages and
 * sounds are only used for the player ship.
 */
int ship_select_next_primary (object* objp, int direction) {
    ...
    // redid case structure to possibly add more primaries in the future -
    // Goober5000
    if (swp->num_primary_banks == 0) {
        if (objp == Player_obj) {
            HUD_sourced_printf (
                HUD_SOURCE_HIDDEN, "%s",
                XSTR ("This ship has no primary weapons", 490));
        ...
        if (objp == Player_obj) {
            HUD_sourced_printf (
                HUD_SOURCE_HIDDEN,
                XSTR ("This ship has only one primary weapon: %s", 491),
                Weapon_info
    ...
    if (ship_has_a_ballistic_primary (shipp)) {
        // if we can't link, disengage primary linking and change to next
        // available bank
        if (shipp->flags[Ship_Flags::Primary_linked]) {
            for (i = 0; i < swp->num_primary_banks; i++) {
                if (!Weapon_info[swp->primary_bank_weapons[i]]
                         .wi_flags[Weapon::Info_Flags::Nolink] &&
                    primary_out_of_ammo (swp, i)) // We only care if linkable
                                                  // primaries are out of ammo.
                {
                    shipp->flags.remove (Ship_Flags::Primary_linked);
                    ...
                    if (direction == CYCLE_PRIMARY_NEXT) {
                        ...
                        swp->current_primary_bank =
                            shipp->weapons.num_primary_banks - 1;
                    }
                    break;
                }
            }
        ...
        // check to see if we keep cycling...we have to if we're out of ammo in
        // the current bank
        if (primary_out_of_ammo (swp, swp->current_primary_bank)) {
            ...
            for (i = 1; i < swp->num_primary_banks; i++) {
                ...
                if (direction == CYCLE_PRIMARY_NEXT) {
                    new_bank = (swp->current_primary_bank + i) %
                               swp->num_primary_banks;
                }
                else {
                    new_bank = (swp->current_primary_bank +
                                swp->num_primary_banks - i) %
                               swp->num_primary_banks;
                }

                // check to see if this is a valid bank
                if (!primary_out_of_ammo (swp, new_bank)) { break; }
            }
            // set the new bank; defaults to resetting to the old bank if we
    ...
    // check to make sure we actually changed banks (which can fail to happen
    // if e.g. ballistic weapons ran out of ammo)
    ...
    if (objp == Player_obj) { gamesnd_play_error_beep (); }
    return 0;
}
...
int ship_select_next_secondary (object* objp) {
    ...
    // redid the switch structure to allow additional seconary banks if added
    // later - Goober5000
    if (swp->num_secondary_banks == 0) {
        if (objp == Player_obj) {
            HUD_sourced_printf (
                HUD_SOURCE_HIDDEN, "%s",
                XSTR ("This ship has no secondary weapons", 492));
            gamesnd_play_error_beep ();
        }
        return 0;
    }
        ...
        if (objp == Player_obj) {
            HUD_sourced_printf (
                HUD_SOURCE_HIDDEN,
                XSTR ("This ship has only one secondary weapon: %s", 493),
                Weapon_info
        ...
        for (i = 1; i < swp->num_secondary_banks; i++) {
            new_bank =
                (swp->current_secondary_bank + i) % swp->num_secondary_banks;
            if (swp->secondary_bank_ammo[new_bank] <= 0) continue;
        ...
        if (swp->current_secondary_bank != original_bank) {
            ...
            if (objp == Player_obj) {
                snd_play (
                    gamesnd_get_game_sound (ship_get_sound (
                        Player_obj, GameSounds::SECONDARY_CYCLE)),
                    0.0f);
            }
 ...
 * @return number of weapons in list.
 */
int get_available_secondary_weapons (
    object* objp, int* outlist, int* outbanklist) {
    int count = 0;
    int i;
    ship* shipp;
...
void wing_bash_ship_name (char* ship_name, const char* wing_name, int index) {
    ...
    // (but don't do this for names that have the hash as the first or last
    // character)
...
/**
 * Needed in addition to wing_name_lookup because it does a straight lookup
 * without caring about how many ships are in the wing, etc.
 */
...
int ship_info_lookup (const char* token) {
    ...
    // found a parenthesis
        ...
        // chop off right parenthesis (it exists because otherwise the left
...
int get_subsystem_pos (vec3d* pos, object* objp, ship_subsys* subsysp) {
    ...
    if (mss->subobj_num == -1) {
        ...
        find_submodel_instance_world_point (
            pos, Ships[objp->instance].model_instance_num, mss->subobj_num,
            &objp->orient, &objp->pos);
    }
...
void ship_model_start (object* objp) {
    ...
    for (pss = GET_FIRST (&shipp->subsys_list);
        ...
        if (psub->subobj_num >= 0) {
            model_set_instance (
                model_num, psub->subobj_num, &pss->submodel_info_1,
                &pss->flags);
        }

        if ((psub->subobj_num != psub->turret_gun_sobj) &&
            (psub->turret_gun_sobj >= 0)) {
            model_set_instance (
                model_num, psub->turret_gun_sobj, &pss->submodel_info_2,
                &pss->flags);
        }
    }
}
...
/**
 * Like ship_model_start but fills submodel instances instead of the submodels
 * themselves
 */
void ship_model_update_instance (object* objp) {
    ...
    for (pss = GET_FIRST (&shipp->subsys_list);
        ...
        if (psub->subobj_num >= 0) {
            model_update_instance (
                model_instance_num, psub->subobj_num, &pss->submodel_info_1,
                pss->flags);
        }
        ...
        if ((psub->subobj_num != psub->turret_gun_sobj) &&
            (psub->turret_gun_sobj >= 0)) {
            model_update_instance (
                model_instance_num, psub->turret_gun_sobj,
                &pss->submodel_info_2, pss->flags);
        }
    }
...
int ship_find_num_turrets (object* objp) {
    ...
    for (pss = GET_FIRST (&shipp->subsys_list);
        ...
        psub = pss->system_info;
        switch (psub->type) {
        case SUBSYSTEM_TURRET: n++; // drop through
...
static void ship_set_eye (object* obj, int eye_index) {
    ...
    ship_info* sip = &Ship_info[shipp->ship_info_index];
    if (sip->model_num < 0) return;

    polymodel* pm = model_get (sip->model_num);

    if (pm == NULL || eye_index > pm->n_view_positions) return;

    shipp->current_viewpoint = eye_index;
}

// calculates the eye position for this ship in the global reference frame.
// Uses the view_positions array in the model.  The 0th element is the normal
// viewing position. the vector of the eye is returned in the parameter 'eye'.
// The orientation of the eye is returned in orient.  (NOTE: this is kind of
// bogus for now since non 0th element eyes have no defined up vector)
void ship_get_eye (
    ...
    // check to be sure that we have a view eye to look at.....spit out nasty
    // debug message
    if (shipp->current_viewpoint < 0 || pm->n_view_positions == 0 ||
        shipp->current_viewpoint > pm->n_view_positions) {
        *eye_pos = obj->pos;
        *eye_orient = obj->orient;
        return;
    }

    // eye points are stored in an array -- the normal viewing position for a
    // ship is the current_eye_index element.
    ...
    if (ep->parent >= 0 && pm->submodel[ep->parent].can_move) {
        find_submodel_instance_point_orient (
            eye_pos, eye_orient, shipp->model_instance_num, ep->parent,
            &ep->pnt, &vmd_identity_matrix);
        vec3d tvec = *eye_pos;
        ...
        model_find_world_point (
            eye_pos, &ep->pnt, pm->id, ep->parent, &obj->orient,
...
ship_subsys* ship_get_best_subsys_to_attack (
    ...
    for (ss = GET_FIRST (&sp->subsys_list);
         ss != END_OF_LIST (&sp->subsys_list); ss = GET_NEXT (ss)) {
        if ((ss->system_info->type == subsys_type) && (ss->current_hits > 0)) {
            // get world pos of subsystem
            vm_vec_unrotate (
                &gsubpos, &ss->system_info->pnt, &Objects[sp->objnum].orient);
            vm_vec_add2 (&gsubpos, &Objects[sp->objnum].pos);

            // now find the number of ships attacking this subsystem by
            // iterating through the ships list, and checking if
            // aip->targeted_subsys matches the subsystem we're checking
            num_attackers = 0;
            sop = GET_FIRST (&Ship_obj_list);
            while (sop != END_OF_LIST (&Ship_obj_list)) {
                if (Ai_info[Ships[Objects[sop->objnum].instance].ai_index]
                        .targeted_subsys == ss) {
                    num_attackers++;
                }
                sop = GET_NEXT (sop);
            ...
            if (ship_subsystem_in_sight (
                    &Objects[sp->objnum], ss, attacker_pos, &gsubpos)) {
    ...
    if (best_in_sight_subsys == NULL) {
        // no subsystems are in sight, so return the subsystem with the lowest
        // # of attackers
...
ship_get_indexed_subsys (ship* sp, int index, vec3d* attacker_pos) {
    ...
    // first, special code to see if the index < 0.  If so, we are looking for
    // one of several possible engines or one of several possible turrets.  If
    // we enter this if statement, we will always return something.
    if (index < 0) {
        int subsys_type;
        ...
        if (attacker_pos != NULL) {
            ss =
                ship_get_best_subsys_to_attack (sp, subsys_type, attacker_pos);
            return ss;
        }
        else {
            // next, scan the list of subsystems and search for the first
            // subsystem of the particular type which has > 0 hits remaining.
            for (ss = GET_FIRST (&sp->subsys_list);
                 ss != END_OF_LIST (&sp->subsys_list); ss = GET_NEXT (ss)) {
                if ((ss->system_info->type == subsys_type) &&
                    (ss->current_hits > 0))
                    return ss;
            }
        }
 ...
 */
int ship_get_index_from_subsys (
    ship_subsys* ssp, int objnum, int error_bypass) {
    if (ssp == NULL)
        return -1;
    else {
        int count;
...
// routine to return the strength of a subsystem.  We keep a total hit tally
// for all subsystems which are similar (i.e. a total for all engines).  These
// routines will return a number between 0.0 and 1.0 which is the relative
// combined strength of the given subsystem type.  The number calculated for
// the engines is slightly different.  Once an engine reaches < 15% of its
// hits, its output drops to that %.  A dead engine has no output.
float ship_get_subsystem_strength (ship* shipp, int type) {
    float strength;
    ship_subsys* ssp;
    ...
    // short circuit 1
    if (shipp->subsys_info[type].aggregate_max_hits <= 0.0f) return 1.0f;

    // short circuit 0
    if (shipp->subsys_info[type].aggregate_current_hits <= 0.0f) return 0.0f;
    ...
    if ((type == SUBSYSTEM_ENGINE) && (strength < 1.0f)) {
        ...
        while (ssp != END_OF_LIST (&shipp->subsys_list)) {
            if (ssp->system_info->type == SUBSYSTEM_ENGINE) {
                ...
                if (ratio < ENGINE_MIN_STR) ratio = ENGINE_MIN_STR;
 ...
 *
 * NOTE: this function was made to be called by the debug function
 * dcf_set_subsys().  If you want to use this, be sure that you test it for all
 * cases.
 */
void ship_set_subsystem_strength (ship* shipp, int type, float strength) {
    ...
    while (ssp != END_OF_LIST (&shipp->subsys_list)) {
        if ((ssp->system_info->type == type) &&
            !(ssp->flags[Ship::Subsystem_Flags::No_aggregate])) {
    ...
    // update the objects integrity, needed since we've bashed the strength of
    // a subsysem
    diff =
        total_current_hits - shipp->subsys_info[type].aggregate_current_hits;
...
#define REARM_NUM_BALLISTIC_PRIMARIES_PER_BATCH \
    100 // how many bullets are dropped in per load sound

/**
 * Calculates approximate time in seconds it would take to rearm and repair
 * object.
 */
float ship_calculate_rearm_duration (object* objp) {
    ...
    if (sip->sup_shield_repair_rate > 0.0f && max_shields > 0.0f)
        shield_rep_time = (max_shields - shield_get_strength (objp)) /
                          (max_shields * sip->sup_shield_repair_rate);

    max_hull_repair = sp->ship_max_hull_strength *
    ...
    if ((The_mission.flags[Mission::Mission_Flags::Support_repairs_hull]) &&
        ...
        hull_rep_time =
            (max_hull_repair - objp->hull_strength) /
            (sp->ship_max_hull_strength * sip->sup_hull_repair_rate);
    }
    ...
    while (ssp != END_OF_LIST (&sp->subsys_list)) {
        ...
        if ((max_subsys_repair > ssp->current_hits) &&
            (sip->sup_subsys_repair_rate > 0.0f)) {
            subsys_rep_time += (max_subsys_repair - ssp->current_hits) /
                               (ssp->max_hits * sip->sup_subsys_repair_rate);
        }
    ...
    for (i = 0; i < swp->num_primary_banks; i++) {
        ...
        if (wip->wi_flags[Weapon::Info_Flags::Ballistic]) {
            ...
            // don't factor in the time it takes for the first reload, since
            // that is loaded instantly
            num_reloads--;

            if (num_reloads < 0) continue;

            if (!found_first_empty && (swp->primary_bank_start_ammo[i] -
                                       swp->primary_bank_ammo[i])) {
                found_first_empty = true;
                prim_rearm_time +=
                    gamesnd_get_max_duration (gamesnd_get_game_sound (
                        GameSounds::MISSILE_START_LOAD)) /
                    1000.0f;
            }
    ...
    for (i = 0; i < swp->num_secondary_banks; i++) {
        ...
        num_reloads =
            (swp->secondary_bank_start_ammo[i] - swp->secondary_bank_ammo[i]) /
            REARM_NUM_MISSILES_PER_BATCH;

        // take into account a fractional reload
        if ((swp->secondary_bank_start_ammo[i] - swp->secondary_bank_ammo[i]) %
                REARM_NUM_MISSILES_PER_BATCH !=
            0) {
            num_reloads++;
        }

        // don't factor in the time it takes for the first reload, since that
        // is loaded instantly
        num_reloads--;

        if (num_reloads < 0) continue;

        if (!found_first_empty && (swp->secondary_bank_start_ammo[i] -
                                   swp->secondary_bank_ammo[i])) {
            found_first_empty = true;
            sec_rearm_time +=
                gamesnd_get_max_duration (
                    gamesnd_get_game_sound (GameSounds::MISSILE_START_LOAD)) /
                1000.0f;
        }
    ...
    return shield_rep_time + hull_rep_time + subsys_rep_time +
           prim_rearm_time + sec_rearm_time + 1.2f;
}

// ==================================================================================
// ship_do_rearm_frame()
//
// function to rearm a ship.  This function gets called from the ai code
// ai_do_rearm_frame (or some function of a similar name).  Returns 1 when ship
// is fully repaired and rearmed, 0 otherwise
//
int ship_do_rearm_frame (object* objp, float frametime) {
    int i, banks_full, primary_banks_full, subsys_type, subsys_all_ok,
        last_ballistic_idx = -1;
    float shield_str, max_shield_str = 0.0f, repair_delta, repair_allocated,
                      max_hull_repair, max_subsys_repair;
    ship* shipp;
    ship_weapon* swp;
    ship_info* sip;
    ship_subsys* ssp;
    ...
    if (shipp->flags[Ship_Flags::Warp_broken]) {
        ...
        HUD_sourced_printf (
            HUD_SOURCE_HIDDEN, "%s", XSTR ("Subspace drive repaired.", 1635));
    ...
    if (!(objp->flags[Object::Object_Flags::No_shields])) {
        ...
        if (shield_str < (max_shield_str)) {
            if (objp == Player_obj) { player_maybe_start_repair_sound (); }
            shield_str +=
                shipp->ship_max_shield_strength * frametime *
                sip->sup_shield_repair_rate; // repair rate is unaffected by
                                             // $Max Shield Recharge
            if (shield_str > max_shield_str) { shield_str = max_shield_str; }
            shield_set_strength (objp, shield_str);
        }
    }

    // Repair the ship integrity (subsystems + hull).  This works by applying
    // the repair points to the subsystems.  Ships integrity is stored is
    // objp->hull_strength, so that always is incremented by repair_allocated
    repair_allocated =
    ...
    // Don't "reverse-repair" the hull if it's already above the max repair
    // threshold
    ...
    if (The_mission.flags[Mission::Mission_Flags::Support_repairs_hull]) {
        ...
        if (objp->hull_strength > shipp->ship_max_hull_strength) {
            objp->hull_strength = shipp->ship_max_hull_strength;
            repair_allocated -=
                (shipp->ship_max_hull_strength - objp->hull_strength);
        }
    }
    ...
    if (sip->sup_subsys_repair_rate == 0.0f)
        ...
        repair_allocated = shipp->ship_max_hull_strength * frametime *
                           sip->sup_subsys_repair_rate;
    else if (!(sip->sup_hull_repair_rate == sip->sup_subsys_repair_rate))
        repair_allocated = repair_allocated * sip->sup_subsys_repair_rate /
    ...
    while (ssp != END_OF_LIST (&shipp->subsys_list)) {
        ...
        if (ssp->current_hits < max_subsys_repair && repair_allocated > 0) {
            ...
            // -- if so, then reset the flags
            if ((ssp->system_info->type == SUBSYSTEM_ENGINE) &&
                (shipp->flags[Ship_Flags::Disabled])) {
                shipp->flags.remove (Ship_Flags::Disabled);
    ...
    // now deal with rearming the player.  All secondary weapons have a certain
    // rate at which they can be rearmed.  We can rearm multiple banks at once.
    banks_full = 0;
    primary_banks_full = 0;
    if (subsys_all_ok) {
        for (i = 0; i < swp->num_secondary_banks; i++) {
            // Actual loading of missiles is preceded by a sound effect which
            // is the missile loading equipment moving into place
            if (aip->rearm_first_missile == TRUE) {
                swp->secondary_bank_rearm_time[i] = timestamp (
                    (int)gamesnd_get_max_duration (gamesnd_get_game_sound (
                        GameSounds::MISSILE_START_LOAD)));
            }

            if (swp->secondary_bank_ammo[i] <
                ...
                if (timestamp_elapsed (swp->secondary_bank_rearm_time[i])) {
                    rearm_time =
                        Weapon_info[swp->secondary_bank_weapons[i]].rearm_rate;
                    swp->secondary_bank_rearm_time[i] =
                        timestamp ((int)(rearm_time * 1000.0f));

                    snd_play_3d (
                        gamesnd_get_game_sound (GameSounds::MISSILE_LOAD),
                        &objp->pos, &View_position);
                    if (objp == Player_obj) joy_ff_play_reload_effect ();
        ...
        for (i = 0; i < swp->num_primary_banks; i++) {
            if (Weapon_info[swp->primary_bank_weapons[i]]
                    .wi_flags[Weapon::Info_Flags::Ballistic]) {
                // Actual loading of bullets is preceded by a sound effect
                // which is the bullet loading equipment moving into place
                if (aip->rearm_first_ballistic_primary == TRUE) {
                    // Goober5000
                    gamesnd_id sound_index;
                    if (gamesnd_game_sound_valid (
                            GameSounds::BALLISTIC_START_LOAD))
                        sound_index = GameSounds::BALLISTIC_START_LOAD;
                    else
                        sound_index = GameSounds::MISSILE_START_LOAD;

                    swp->primary_bank_rearm_time[i] =
                        timestamp ((int)gamesnd_get_max_duration (
                            gamesnd_get_game_sound (sound_index)));
                }

                if (swp->primary_bank_ammo[i] <
                    ...
                    if (timestamp_elapsed (swp->primary_bank_rearm_time[i])) {
                        rearm_time = Weapon_info[swp->primary_bank_weapons[i]]
                                         .rearm_rate;
                        swp->primary_bank_rearm_time[i] =
                            timestamp ((int)(rearm_time * 1000.f));

                        // Goober5000
                        gamesnd_id sound_index;
                        if (gamesnd_game_sound_valid (
                                GameSounds::BALLISTIC_LOAD))
    ...
    int shields_full = 0;
    if ((objp->flags[Object::Object_Flags::No_shields])) { shields_full = 1; }
    else {
        if (shield_get_strength (objp) >= max_shield_str) shields_full = 1;
        if (sip->sup_shield_repair_rate == 0.0f) shields_full = 1;
    }

    int hull_ok = 0;
    if (objp->hull_strength >= max_hull_repair) hull_ok = 1;
    ...
    // return 1 if at end of subsystem list, hull damage at 0, and shields full
    // and all secondary banks full.
    if ((subsys_all_ok && shields_full &&
         (The_mission.flags[Mission::Mission_Flags::Support_repairs_hull]) &&
         hull_ok) ||
        (subsys_all_ok && shields_full &&
         !(The_mission.flags[Mission::Mission_Flags::Support_repairs_hull]))) {
        if (objp == Player_obj) { player_stop_repair_sound (); }
        ...
        if ((banks_full == swp->num_secondary_banks) &&
            ...
            if (timestamp_elapsed (aip->rearm_release_delay)) return 1;
        }
        else {
            aip->rearm_release_delay = timestamp (1200);
        }
...
// function which is used to find a repair ship to repair requester_obj.  the
// way repair ships will work is: if no ships in the mission at all, return 0
// if a ship can immediately satisfy a repair request, return 1 and fill in the
// pointer if no ships can satisfy a request, but we haven't reached either the
// concurrent or cumulative limit, return 2 if no ships can satisfy a request,
// and we've reached the limits, but a request can be queued, return 3 and fill
// in the pointer if no ships can satisfy a request, we've reached the limits,
// and we can't queue anything, we're out of luck -- return 4
int ship_find_repair_ship (object* requester_obj, object** ship_we_found) {
    ...
    ASSERTX (
        ...
        "%d, which is smaller than 0 or bigger than %d",
        requester_obj->instance, MAX_SHIPS);
    ...
    for (objp = GET_FIRST (&obj_used_list);
        ...
        if ((objp->type == OBJ_SHIP) &&
            ...
            ASSERTX (
                ...
                "Ship '%s' does not have a valid pointer to a ship class. "
                "Pointer is %d, which is smaller than 0 or bigger than %d",
                shipp->ship_name, shipp->ship_info_index,
                static_cast< int > (Ship_info.size ()));

            sip = &Ship_info[shipp->ship_info_index];

            if (!(sip->flags[Ship::Info_Flags::Support])) { continue; }
            ...
            if (aip->ai_flags
                ...
                // done soonest by estimating how many seconds it will take for
                // the support ship to reach the requester. The estimate is
                // calculated by calculating how many seconds it will take the
                // support ship to travel from its current location to the
                // requester at max velocity We assume that every leg of the
                // support ships journey will take the amount of time for the
                // support ship to fly from its current location to the
                // requester.  This is a bit hacky but it penalizes further
                // away support ships, so a futher support ship will only be
                // called if the closer ones are really busy.  This is just a
                // craps shoot anyway because everything is moving around.
                float howlong = 0;
                ...
                if (min_time_till_available < 0.0f ||
                    howlong < min_time_till_available) {
    ...
    if (num_support_ships == 0) { return 0; }
    // ship available?
    else if (nearest_support_ship != NULL) {
        // the nearest non-busy support ship is to service request
        if (ship_we_found != NULL) *ship_we_found = nearest_support_ship;
        return 1;
    }
    // no ships available; are we below the limits?  (can we bring another ship
    // in? -- and btw an Arriving_support_ship counts as being able to bring
    // one in)
    else if (
        (num_support_ships < The_mission.support_ships.max_concurrent_ships) &&
        ((Arriving_support_ship == NULL &&
         ...
         (Arriving_support_ship != NULL &&
          The_mission.support_ships.tally <=
              The_mission.support_ships.max_support_ships))) {
        // We are allowed more support ships in the mission; request another
        // ship to service this request.
        return 2;
    }
    // we're at the limit, but maybe a ship will become available
    else if (soonest_available_support_ship != NULL) {
        // found more support ships than should be in mission, so I can't ask
        // for more, instead I will give the player the ship that will be done
        // soonest
...
void ship_close () {
    ...
    if (CLOAKMAP != -1) bm_release (CLOAKMAP);
}
...
void ship_assign_sound (ship* sp) {
    ...
    if (sip->engine_snd.isValid ()) {
        vm_vec_copy_scale (
            &engine_pos, &objp->orient.vec.fvec, -objp->radius / 2.0f);
    ...
    while (moveup != END_OF_LIST (&sp->subsys_list)) {
        ...
        if (strstr (moveup->system_info->name, "enginelarge")) {
            obj_snd_assign (
                sp->objnum, GameSounds::ENGINE_LOOP_LARGE,
                &moveup->system_info->pnt, 0);
        }
        else if (strstr (moveup->system_info->name, "enginehuge")) {
            obj_snd_assign (
                sp->objnum, GameSounds::ENGINE_LOOP_HUGE,
                &moveup->system_info->pnt, 0);
        }
        ...
        if (moveup->current_hits > 0.0f) {
            if (moveup->system_info->alive_snd.isValid ()) {
                obj_snd_assign (
                    sp->objnum, moveup->system_info->alive_snd,
                    &moveup->system_info->pnt, 0, OS_SUBSYS_ALIVE, moveup);
                moveup->subsys_snd_flags.set (Ship::Subsys_Sound_Flags::Alive);
            }
            if (moveup->system_info->turret_base_rotation_snd.isValid ()) {
                obj_snd_assign (
                    sp->objnum, moveup->system_info->turret_base_rotation_snd,
                    &moveup->system_info->pnt, 0, OS_TURRET_BASE_ROTATION,
                    moveup);
                moveup->subsys_snd_flags.set (
                    Ship::Subsys_Sound_Flags::Turret_rotation);
            }
            if (moveup->system_info->turret_gun_rotation_snd.isValid ()) {
                obj_snd_assign (
                    sp->objnum, moveup->system_info->turret_gun_rotation_snd,
                    &moveup->system_info->pnt, 0, OS_TURRET_GUN_ROTATION,
                    moveup);
                moveup->subsys_snd_flags.set (
                    Ship::Subsys_Sound_Flags::Turret_rotation);
            }
            if ((moveup->system_info->rotation_snd.isValid ()) &&
                (moveup->flags[Ship::Subsystem_Flags::Rotates])) {
                obj_snd_assign (
                    sp->objnum, moveup->system_info->rotation_snd,
                    &moveup->system_info->pnt, 0, OS_SUBSYS_ROTATION, moveup);
                moveup->subsys_snd_flags.set (
                    Ship::Subsys_Sound_Flags::Rotate);
            }
        }
            ...
            if (moveup->system_info->dead_snd.isValid ()) {
                obj_snd_assign (
                    sp->objnum, moveup->system_info->dead_snd,
                    &moveup->system_info->pnt, 0, OS_SUBSYS_DEAD, moveup);
...
void ship_assign_sound_all () {
    ...
    for (objp = GET_FIRST (&obj_used_list);
        ...
        if (objp->type == OBJ_SHIP && Player_obj != objp) {
            ...
            // check to make sure this guy hasn't got sounds already assigned
            // to him
            ...
            if (!has_sounds) { ship_assign_sound (&Ships[objp->instance]); }
        }
    }
}
...
DCF (set_shield, "Change player ship shield strength") {
    ...
    if (dc_optional_string_either ("status", "--status") ||
        dc_optional_string_either ("?", "--?")) {
        dc_printf (
            "Shields are currently %.2f", shield_get_strength (Player_obj));
        return;
    }
    ...
    shield_set_strength (
        Player_obj, value * shield_get_max_strength (Player_obj));
...
DCF (set_subsys, "Set the strength of a particular subsystem on player ship") {
    ...
    if (arg == "weapons") { subsystem = SUBSYSTEM_WEAPONS; }
    else if (arg == "engine") {
    ...
    if (dc_optional_string_either ("status", "--status") ||
        ...
        if (subsystem == SUBSYSTEM_ENGINE) {
            ...
            Player_ship->flags.set (
                Ship_Flags::Disabled, (val_f < ENGINE_MIN_STR));
        }
    }
}
// XSTR:ON
...
// two functions to keep track of counting ships of particular types.  Maybe we
// should be rolling this thing into the stats section??  The first function
// adds a ship of a particular type to the overall count of ships of that type
// (called from MissionParse.cpp).  The second function adds to the kill total
// of ships of a particular type.  Note that we use the ship_info flags
// structure member to determine what is happening.
...
int ship_docking_valid (int /*docker*/, int /*dockee*/) {
    // Goober5000
    // So many people have asked for this function to be extended that it's
    // making less and less sense to keep it around.  We should probably just
    // let any ship type dock with any other ship type and assume the mission
    // designer is smart enough not to mess things up.
    return 1;
}
...
int ship_get_random_player_wing_ship (
    int flags, float max_dist, int persona_index, int get_first,
    int multi_team) {
    ...
    // iterate through starting wings of player.  Add ship indices of ships
    ...
    for (i = 0; i < Num_wings; i++) {
        ...
        // multi-team?
        if (multi_team >= 0) {
            if (i == TVT_wings[multi_team]) { wingnum = i; }
            else {
                continue;
            }
        }
        ...
        for (j = 0; j < Wings[wingnum].current_count; j++) {
            ...
            if ((flags == SHIP_GET_NO_PLAYERS ||
                 flags == SHIP_GET_UNSILENCED) &&
            ...
            if ((flags == SHIP_GET_UNSILENCED) &&
                (Ships[ship_index].flags[Ship_Flags::No_builtin_messages])) {
                continue;
            }

            // don't process ships on a different team
            if (multi_team < 0) {
                if (Player_ship->team != Ships[ship_index].team) { continue; }
            }
            ...
            if ((max_dist > 1.0f) && (multi_team < 0)) {
                ...
                dist = vm_vec_dist_quick (
                    &Objects[Ships[ship_index].objnum].pos, &Player_obj->pos);
                if (dist > max_dist) { continue; }
            }

            // if we should be checking persona's, then don't add ships that
            // don't have the proper persona
            if (persona_index != -1) {
            ...
            if (get_first) { return ship_index; }
...
// this function returns a random index into the Ship array of a ship of the
...
int ship_get_random_team_ship (int team_mask, int flags, float max_dist) {
    ...
    // for any allied, go through the ships list and find all of the ships on
    // that team
    num = 0;
    for (objp = GET_FIRST (&obj_used_list);
         objp != END_OF_LIST (&obj_used_list); objp = GET_NEXT (objp)) {
        ...
        if (!iff_matches_mask (Ships[objp->instance].team, team_mask))
            continue;
        else if (!Ship_info[Ships[objp->instance].ship_info_index]
                      .is_flyable ())
            continue;
        else if (
            (flags == SHIP_GET_NO_PLAYERS) &&
            (objp->flags[Object::Object_Flags::Player_ship]))
            continue;
        else if (
            (flags == SHIP_GET_ONLY_PLAYERS) &&
            !(objp->flags[Object::Object_Flags::Player_ship]))
            continue;

        if (Ships[objp->instance].flags[Ship_Flags::Dying]) { continue; }
...
int ship_engine_ok_to_warp (ship* sp) {
    ...
    if (sp->flags[Ship_Flags::Disabled]) return 0;

    if (sp->flags[Ship_Flags::Warp_broken] ||
        sp->flags[Ship_Flags::Warp_never])
        return 0;

    float engine_strength = ship_get_subsystem_strength (sp, SUBSYSTEM_ENGINE);

    // if at 0% strength, can't warp
    if (engine_strength <= 0.0f) return 0;

    // player ships playing above Very Easy can't warp when below a threshold
    if ((sp == Player_ship) && (Game_skill_level > 0) &&
        (engine_strength < SHIP_MIN_ENGINES_TO_WARP))
        return 0;
...
int ship_navigation_ok_to_warp (ship* sp) {
    ...
    if (!(The_mission.ai_profile
              ->flags[AI::Profile_Flags::Navigation_subsys_governs_warp]))
        return 1;

    float navigation_strength =
        ship_get_subsystem_strength (sp, SUBSYSTEM_NAVIGATION);

    // if at 0% strength, can't warp
    if (navigation_strength <= 0.0f) return 0;

    // player ships playing above Very Easy can't warp when below a threshold
    if ((sp == Player_ship) && (Game_skill_level > 0) &&
        (navigation_strength < SHIP_MIN_NAV_TO_WARP))
        return 0;
...
int ship_return_subsys_path_normal (
    ...
    if (ss->system_info->path_num >= 0) {
        ...
        ASSERTX (
            ...
            "for subsystem '%s'!\n",
            pm->filename, pm->n_paths, ss->system_info->path_num,
            ss->system_info->subobj_name);
        if (ss->system_info->path_num > pm->n_paths) return 1;
        ...
        if (mp->nverts >= 2) {
            ...
            vm_vec_unrotate (
                &gpath_point, path_point, &Objects[shipp->objnum].orient);
...
int ship_subsystem_in_sight (
    ...
    if (objp->type != OBJ_SHIP) return 0;

    // See if we are at least facing the subsystem
    if (do_facing_check) {
        if (ship_return_subsys_path_normal (
                &Ships[objp->instance], subsys, subsys_pos, &subsys_fvec)) {
            // non-zero return value means that we couldn't generate a normal
            // from path info... so use inaccurate method
    ...
    // See if ray from eye to subsystem actually hits close enough to the
    // subsystem position
    ...
    mc.model_num = Ship_info[Ships[objp->instance].ship_info_index]
                       .model_num; // Fill in the model to check
...
ship_return_next_subsys (ship* shipp, int type, vec3d* attacker_pos) {
    ...
    // loop through all the subsystems, if we find a match that has some
    // strength, return it
...
// Returns null if all subsystems of that type are destroyed or none is in
// sight.
 ...
 * @return strength of shields in the quadrant that was hit as a percentage,
 * between 0 and 1.0
 */
float ship_quadrant_shield_strength (object* hit_objp, int quadrant_num) {
    ...
    if (hit_objp->flags[Object::Object_Flags::No_shields]) { return 0.0f; }

    // If shields weren't hit, return 0
    if (quadrant_num < 0) return 0.0f;
...
static int ship_has_homing_missile_locked (ship* shipp) {
    ...
    for (mo = GET_NEXT (&Missile_obj_list);
        ...
        if (wip->subtype != WP_MISSILE) continue;

        if (!(wip->is_homing ())) continue;

        if (wp->homing_object == locked_objp) { return 1; }
    } // end for
    ...
    for (so = GET_FIRST (&Ship_obj_list); so != END_OF_LIST (&Ship_obj_list);
        ...
        if (aip->target_objnum == shipp->objnum) {
            if (aip->aspect_locked_time > 0.1f) {
                ...
                dist = vm_vec_dist_quick (
                    &objp->pos, &Objects[shipp->objnum].pos);
                wep_range =
                    ship_get_secondary_weapon_range (&Ships[objp->instance]);
                if (wep_range > dist) {
                    WARNINGF (LOCATION, "AI ship is seeking lock");
                    return 1;
                }
            }
        }
...
int ship_lock_threat (ship* sp) {
    ...
    if (ship_is_getting_locked (sp)) { return 1; }

    return 0;
}

// converts a bitmask, such as 0x08, into the bit number this would be (3 in
// this case) NOTE: Should move file to something like Math_utils.
...
static const char*
ship_get_ai_target_display_name (int goal, const char* name) {
    switch (goal) {
...
std::string ship_return_orders (ship* sp) {
    ...
    if (aigp->ai_mode < 0) return std::string ();

    auto order_text = Ai_goal_text (aigp->ai_mode);
    if (order_text == nullptr) return std::string ();
    ...
    if (aigp->target_name) {
        target_name =
            ship_get_ai_target_display_name (aigp->ai_mode, aigp->target_name);
    ...
    case AI_GOAL_REARM_REPAIR:
    case AI_GOAL_FLY_TO_SHIP:
        if (aigp->target_name) { outbuf += target_name; }
        else {
            outbuf += XSTR ("no orders", 495);
        }
        break;
    ...
    case AI_GOAL_DESTROY_SUBSYSTEM: {
        if (aip->targeted_subsys != nullptr) {
            ...
            sprintf (
                outbuf, XSTR ("atk %s %s", 496), target_name.c_str (),
                subsys_name);
        }
        else {
            outbuf += XSTR ("no orders", 495);
...
char* ship_return_time_to_goal (char* outbuf, ship* sp) {
    ...
    if (aip->mode == AIM_WAYPOINTS) {
        ...
        if (aip->wp_list != NULL) {
            ...
            vec3d* prev_vec = NULL;
            for (ii =
                     (aip->wp_list->get_waypoints ().begin () + aip->wp_index);
        ...
        if ((Objects[sp->objnum].phys_info.speed <= 0) ||
            (max_speed <= 0.0f)) {
            time = -1;
        }
        else {
        ...
        // don't return anytime for time to except for waypoints and actual
        // docking.
        return NULL;
    }
...
/* Karajorma - V decided not to use this function so I've commented it out so
it isn't confused with code +that is actually in use. Someone might want to get
it working using AI_Profiles at some point so I didn't +simply delete it.

// Called to check if any AI ships might reveal the cargo of any cargo
containers.
//
// This is called once a frame, but a global timer 'Ship_cargo_check_timer'
will limit this
// function to being called every SHIP_CARGO_CHECK_INTERVAL ms.  I think that
...
limit check to
    ...
    // Check all friendly fighter/bombers against all non-friendly cargo
containers that don't have
    ...
    while(cargo_so != END_OF_LIST(&Ship_obj_list)){
        ...
        if (
(Ship_info[cargo_sp->ship_info_index].flags[Ship::Info_Flags::Cargo]) &&
(cargo_sp->team != Player_ship->team) ) {
            ...
            // check against friendly fighter/bombers +
cruiser/freighter/transport
            // IDEA: could cull down to fighter/bomber if we want this to run a
bit quicker for ( ship_so=GET_FIRST(&Ship_obj_list); ship_so !=
END_OF_LIST(&Ship_obj_list); ship_so=GET_NEXT(ship_so) )
            {
                ...
                if ( Ship_info[ship_sp->ship_info_index].flags &
(SIF_SMALL_SHIP|SIF_BIG_SHIP) ) { cargo_objp = &Objects[cargo_sp->objnum];
                    // use square of distance, faster than getting real
distance (which will use sqrt) dist_squared =
vm_vec_dist_squared(&cargo_objp->pos, &Objects[ship_sp->objnum].pos);
                    limit_squared =
...
// Maybe warn player about this attacking ship.  This is called once per frame,
// and the information about the closest attacking ship comes for free, since
...
#define PLAYER_MIN_WARN_DIST \
    100 // minimum distance attacking ship can be from player and still allow
        // warning
#define PLAYER_MAX_WARN_DIST \
    1000 // maximum distance attacking ship can be from plyaer and still allow
         // warning
...
void ship_maybe_warn_player (ship* enemy_sp, float dist) {
    ...
    // First check if the player has reached the maximum number of warnings for
    // a mission
    ...
    if (!timestamp_elapsed (Player->allow_warn_timestamp)) { return; }

    // Check to see if check timer has elapsed.  Necessary, since we don't want
    // to check each frame
    if (!timestamp_elapsed (Player->check_warn_timestamp)) { return; }
    Player->check_warn_timestamp = timestamp (PLAYER_CHECK_WARN_INTERVAL);

    // only allow warnings if within a certain distance range
    if (dist < PLAYER_MIN_WARN_DIST || dist > PLAYER_MAX_WARN_DIST) { return; }

    // only warn if a fighter or bomber is attacking the player
    if (!(Ship_info[enemy_sp->ship_info_index].is_small_ship ())) { return; }

    // get vector from player to target
    vm_vec_normalized_dir (
        &vec_to_target, &Objects[enemy_sp->objnum].pos, &Eye_position);

    // ensure that enemy fighter is oriented towards player
    fdot = vm_vec_dot (
        &Objects[enemy_sp->objnum].orient.vec.fvec, &vec_to_target);
    if (fdot > -0.7) { return; }
    ...
    // check if attacking ship is on six.  return if not far enough behind
    // player.
    if (fdot > -0.7) return;
...
void ship_maybe_praise_player (ship* deader_sp) {
    ...
    // First check if the player has reached the maximum number of praises for
    // a mission
    ...
    if (!timestamp_elapsed (Player->allow_praise_timestamp)) { return; }

    // make sure player is not a traitor
    if (Player_ship->team == Iff_traitor) { return; }

    // only praise if killing an enemy!
    if (deader_sp->team == Player_ship->team) { return; }

    // don't praise the destruction of navbuoys, cargo or other non-flyable
    // ship types
    ...
    if (Player->praise_delay_timestamp) { return; }

    // We don't want to praise the player right away.. it is more realistic to
    // wait a moment
...
void ship_maybe_praise_self (ship* deader_sp, ship* killer_sp) {
    ...
    if ((Builtin_messages[MESSAGE_PRAISE_SELF].max_count > -1) &&
        (Player->praise_self_count >=
         Builtin_messages[MESSAGE_PRAISE_SELF].max_count)) {
        return;
    }

    if (!timestamp_elapsed (Player->praise_self_timestamp)) { return; }

    // only praise if killing an enemy so check they both attack each other!
    if (!((iff_x_attacks_y (deader_sp->team, killer_sp->team)) &&
          (iff_x_attacks_y (killer_sp->team, deader_sp->team)))) {
        return;
    }

    // only send messages from the player's wingmen
    if (killer_sp->wingnum == -1) { return; }
    for (j = 0; j < MAX_STARTING_WINGS; j++) {
    ...
    if (killer_sp->flags[Ship_Flags::No_builtin_messages]) { return; }

    message_send_builtin_to_player (
        MESSAGE_PRAISE_SELF, killer_sp, MESSAGE_PRIORITY_HIGH,
        MESSAGE_TIME_SOON, 0, 0, -1, -1);
    Player->praise_self_timestamp =
        timestamp (Builtin_messages[MESSAGE_PRAISE_SELF].min_delay);
    Player->praise_self_count++;
}
...
static void awacs_maybe_ask_for_help (ship* sp, int multi_team_filter) {
    ...
    if (message >= 0) {
        message_send_builtin_to_player (
            message, sp, MESSAGE_PRIORITY_HIGH, MESSAGE_TIME_IMMEDIATE, 0, 0,
            -1, multi_team_filter);
        Player->allow_ask_help_timestamp =
            timestamp (Builtin_messages[MESSAGE_HELP].min_delay);
...
void ship_maybe_ask_for_help (ship* sp) {
    ...
    // First check if the player has reached the maximum number of ask_help's
    // for a mission
    ...
    if (!timestamp_elapsed (Player->allow_ask_help_timestamp)) return;
    ...
    if (!(sp->flags[Ship_Flags::From_player_wing])) return;

    // first check if hull is at a critical level
    if (objp->hull_strength <
        ASK_HELP_HULL_PERCENT * sp->ship_max_hull_strength)
        goto play_ask_help;
    ...
    if (shield_get_strength (objp) >
        (ASK_HELP_SHIELD_PERCENT * shield_get_max_strength (objp)))
        return;

play_ask_help:

    if (!(Ship_info[sp->ship_info_index]
              .is_fighter_bomber ())) // If we're still here, only continue if
                                      // we're a fighter or bomber.
        return;

    if (!(sp->flags[Ship_Flags::No_builtin_messages])) // Karajorma - Only
                                                       // unsilenced ships
                                                       // should ask for help
    {
        message_send_builtin_to_player (
            MESSAGE_HELP, sp, MESSAGE_PRIORITY_HIGH, MESSAGE_TIME_IMMEDIATE, 0,
            0, -1, multi_team_filter);
        Player->allow_ask_help_timestamp =
            timestamp (Builtin_messages[MESSAGE_HELP].min_delay);
...
/**
 * The player has just entered death roll, maybe have wingman mourn the loss of
 * the player
 */
void ship_maybe_lament () {
    ...
    if (rand () % 4 == 0) {
        ...
        if (ship_index >= 0)
            message_send_builtin_to_player (
                MESSAGE_PLAYER_DIED, &Ships[ship_index], MESSAGE_PRIORITY_HIGH,
                MESSAGE_TIME_IMMEDIATE, 0, 0, -1, -1);
    }
}
...
void ship_scream (ship* sp) {
    ...
    message_send_builtin_to_player (
        MESSAGE_WINGMAN_SCREAM, sp, MESSAGE_PRIORITY_HIGH,
        MESSAGE_TIME_IMMEDIATE, 0, 0, -1, multi_team_filter);
    Player->allow_scream_timestamp =
        timestamp (Builtin_messages[MESSAGE_WINGMAN_SCREAM].min_delay);
    Player->scream_count++;
...
void ship_maybe_scream (ship* sp) {
    ...
    if (sp->flags[Ship_Flags::No_death_scream]) return;
    ...
    if (!(sp->flags[Ship_Flags::Always_death_scream])) {
        ...
        if (!timestamp_elapsed (Player->allow_scream_timestamp)) return;

        // for WCSaga, only do a subset of the checks
        if (!(The_mission.ai_profile
                  ->flags[AI::Profile_Flags::Perform_fewer_scream_checks])) {
            // bail if this ship isn't from the player wing
            if (!(sp->flags[Ship_Flags::From_player_wing])) return;

            // first check if the player has reached the maximum number of
            // screams for a mission
            if ((Builtin_messages[MESSAGE_WINGMAN_SCREAM].max_count > -1) &&
                (Player->scream_count >=
                 Builtin_messages[MESSAGE_WINGMAN_SCREAM].max_count)) {
                return;
            }

            // if on different teams (i.e. team v. team games in multiplayer),
            // no scream
            if (Player_ship->team != sp->team) return;
        }
    }
...
/**
 * This function is only for notifying the player that the ship's ammo is low,
 * without necessarily requesting support (e.g. if support is disallowed for
 * this mission).  It is not called if support was successfully requested in
...
void ship_maybe_tell_about_low_ammo (ship* sp) {
    ...
    // we don't want a ship complaining about low ammo after it has just
    // complained about needing support
    if (!timestamp_elapsed (Player->request_repair_timestamp)) return;

    if (!timestamp_elapsed (Player->allow_ammo_timestamp)) return;
    ...
    // don't mention low ammo if we're docked, for the same reason as in
    // maybe_request_support
    if (object_is_docked (&Objects[sp->objnum])) return;

    // for now, each ship can only complain about low ammo once a mission to
    // stop it getting repetitive
    if (sp->ammo_low_complaint_count) { return; }
        ...
        if (wip->wi_flags[Weapon::Info_Flags::Ballistic]) {
            if (swp->primary_bank_start_ammo[i] > 0) {
                if ((float)swp->primary_bank_ammo[i] /
                    ...
                    Player->allow_ammo_timestamp =
                        timestamp (PLAYER_LOW_AMMO_MSG_INTERVAL);

                    // better reset this one too
                    Player->request_repair_timestamp =
                        timestamp (PLAYER_REQUEST_REPAIR_MSG_INTERVAL);
...
void ship_maybe_tell_about_rearm (ship* sp) {
    ...
    if (heavily_damaged || (sp->flags[Ship_Flags::Disabled])) {
        ...
        for (i = 0; i < swp->num_secondary_banks; i++) {
            if (swp->secondary_bank_start_ammo[i] > 0) {
                if ((float)swp->secondary_bank_ammo[i] /
                        (float)swp->secondary_bank_start_ammo[i] <
                    0.5f) {
    ...
    if (message_type >= 0) {
        if (rand () & 1)
            message_send_builtin_to_player (
                message_type, sp, MESSAGE_PRIORITY_NORMAL, MESSAGE_TIME_SOON,
        ...
        for (i = 0; i < MAX_SHIP_PRIMARY_BANKS; i++) {
            if (swp->primary_animation_position[i] == MA_POS_NOT_SET) {
                if (model_anim_start_type (
                        sp, TRIGGER_TYPE_PRIMARY_BANK, i, 1)) {
                    swp->primary_animation_done_time[i] =
                        model_anim_get_time_type (
                            sp, TRIGGER_TYPE_PRIMARY_BANK, i);
        ...
        for (i = 0; i < MAX_SHIP_SECONDARY_BANKS; i++) {
            if (i == swp->current_secondary_bank) {
                ...
                if (swp->secondary_animation_position[i] == MA_POS_NOT_SET) {
                    if (model_anim_start_type (
                            sp, TRIGGER_TYPE_SECONDARY_BANK, i, 1)) {
                        swp->secondary_animation_done_time[i] =
                            model_anim_get_time_type (
                                sp, TRIGGER_TYPE_SECONDARY_BANK, i);
...
int ship_get_by_signature (int signature) {
    ...
    for (so = GET_FIRST (&Ship_obj_list); so != END_OF_LIST (&Ship_obj_list);
        ...
        if ((Objects[so->objnum].signature == signature) &&
            (Objects[so->objnum].type == OBJ_SHIP)) {
 ...
 *
 * Happens at two different locations (at least when this function was
...
void ship_do_cargo_revealed (ship* shipp, int /* from_network */) {
    ...
    if (strcasecmp (
        ...
        0) {
        mission_log_add_entry (
            LOG_CARGO_REVEALED, shipp->ship_name, NULL,
            (shipp->cargo1 & CARGO_INDEX_MASK));
    }
}
...
void ship_do_cap_subsys_cargo_revealed (
    ...
    if (strcasecmp (
            ...
            NOX ("nothing")) != 0) {
        mission_log_add_entry (
            LOG_CAP_SUBSYS_CARGO_REVEALED, shipp->ship_name,
            subsys->system_info->subobj_name,
 ...
 *
 * @param shipp Pointer to ship from which currently selected secondary weapon
 * will be ranged
 */
 ...
 */
int get_max_ammo_count_for_primary_bank (
    int ship_class, int bank, int ammo_type) {
    float capacity, size;
...
/**
 * Determine the number of secondary ammo units (missile/bomb) allowed max for
 * a ship
 */
int get_max_ammo_count_for_bank (int ship_class, int bank, int ammo_type) {
    ...
    if (ship_class < 0 || bank < 0 || ammo_type < 0) { return 0; }
    else {
        capacity =
 ...
 */
int get_max_ammo_count_for_turret_bank (
    ...
    if (!swp || bank < 0 || ammo_type < 0) { return 0; }
    else {
...
void ship_page_in () {
    ...
    for (auto sip = Ship_info.begin (); sip != Ship_info.end (); ++sip) {
        if (sip->flags[Ship::Info_Flags::Support]) {
            WARNINGF (LOCATION, "Found support ship '%s'", sip->name);
    ...
    for (i = 0; i < MAX_SHIPS; i++) {
        ...
        WARNINGF (LOCATION, "Found ship '%s'", Ships[i].ship_name);
        ship_class_used[Ships[i].ship_info_index]++;

        // check if we are going to use a Knossos device and make sure the
        // special warp ani gets pre-loaded
        if (Ship_info[Ships[i].ship_info_index]
                .flags[Ship::Info_Flags::Knossos_device])
            Knossos_warp_ani_used = 1;

        // mark any weapons as being used, saves memory and time if we don't
        // load them all
    ...
    for (p_object* p_objp = GET_FIRST (&Ship_arrival_list);
        ...
        WARNINGF (LOCATION, "Found future arrival ship '%s'", p_objp->name);
        ship_class_used[p_objp->ship_class]++;

        // This will go through Subsys_index[] and grab all weapons: primary,
        // secondary, and turrets
        for (i = p_objp->subsys_index;
             i < (p_objp->subsys_index + p_objp->subsys_count); i++) {
            for (j = 0; j < MAX_SHIP_PRIMARY_BANKS; j++) {
    ...
    for (auto sip = Ship_info.begin (); sip != Ship_info.end (); i++, ++sip) {
        ...
        for (auto it = Ship_info.begin (); it != Ship_info.end (); ++it) {
            if ((it->model_num > -1) &&
                ...
                if ((sip->n_subsystems > 0) &&
                    (sip->subsystems[0].model_num > -1)) {
                    ship_previously_loaded =
                        (int)std::distance (Ship_info.begin (), it);

                    // It is possible in some cases for sip->model_num to
                    // change, and for subsystems->model_num to still point to
                    // the old model index; this makes sure it doesn't happen.
                    // -zookeeper
                ...
                // the model should already be loaded so this wouldn't take
                // long, but we need to make sure that the load count for the
                // model is correct
                test_id = model_load (
                    sip->pof_file, sip->n_subsystems, &sip->subsystems[0]);
        ...
        if (model_previously_loaded >= 0) {
            ...
            if (ship_previously_loaded != i) {
                ...
                for (j = 0; j < sip->n_subsystems; j++) {
                    if (sip->subsystems[j].model_num != sip->model_num) {
                        polymodel* sip_pm = (sip->model_num >= 0)
            ...
            for (j = 0; j < sip->n_subsystems; j++)
                ASSERTX (
                    ...
                    sip->subsystems[j].name, sip->subsystems[j].model_num,
                    sip->pof_file, sip->model_num); // JAS
#endif
        }
        ...
        if (!sip->explosion_bitmap_anims.empty ()) {
            ...
            sip->class_type >= 0 &&
            !Ship_types[sip->class_type].explosion_bitmap_anims.empty ()) {
            int num_fireballs = (int)Ship_types[sip->class_type]
                                    .explosion_bitmap_anims.size ();
            for (j = 0; j < num_fireballs; j++) {
                fireball_used[Ship_types[sip->class_type]
                                  .explosion_bitmap_anims[j]] = 1;
            }
        }
    }
    ...
    for (i = 0; i < (int)Species_info.size (); i++) {
        ...
        bm_page_in_texture (
            thruster->flames.normal.first_frame,
            thruster->flames.normal.num_frames);
        bm_page_in_texture (
            thruster->flames.afterburn.first_frame,
            thruster->flames.afterburn.num_frames);
            ...
            if (Ships[i].ship_replacement_textures != NULL) {
                ...
                for (j = 0; j < MAX_REPLACEMENT_TEXTURES; j++) {
                    if (Ships[i].ship_replacement_textures[j] > -1) {
                        bm_page_in_texture (
                            Ships[i].ship_replacement_textures[j]);
                    }
                }
            }
        }
...
void ship_page_in_textures (int ship_index) {
    ...
    if ((ship_index < 0) ||
        (ship_index >= static_cast< int > (Ship_info.size ())))
        return;
    ...
    if (!generic_bitmap_load (&sip->thruster_secondary_glow_info.normal))
        bm_page_in_texture (
            sip->thruster_secondary_glow_info.normal.bitmap_id);

    if (!generic_bitmap_load (&sip->thruster_secondary_glow_info.afterburn))
        bm_page_in_texture (
            sip->thruster_secondary_glow_info.afterburn.bitmap_id);
    ...
    if (!generic_bitmap_load (&sip->thruster_tertiary_glow_info.afterburn))
        bm_page_in_texture (
            sip->thruster_tertiary_glow_info.afterburn.bitmap_id);
    ...
    for (i = 0; i < (int)sip->afterburner_thruster_particles.size (); i++) {
        generic_anim_load (
            &sip->afterburner_thruster_particles[i].thruster_bitmap);
        bm_page_in_texture (sip->afterburner_thruster_particles[i]
                                .thruster_bitmap.first_frame);
    }
}
...
void ship_page_out_textures (int ship_index, bool release) {
    ...
    for (i = 0; i < (int)sip->afterburner_thruster_particles.size (); i++)
        PAGE_OUT_TEXTURE (sip->afterburner_thruster_particles[i]
                              .thruster_bitmap.first_frame);
}
...
int is_support_allowed (object* objp, bool do_simple_check) {
    ...
    if (AutoPilotEngaged) return 0;

    // none allowed
    if (The_mission.support_ships.max_support_ships == 0) return 0;

    // ship_find_repair_ship is a little expensive, so let's not do it every
    // frame
    if (!do_simple_check) {
        ...
        if (The_mission.support_ships.max_support_ships > 0) {
            // if all the allowed ships have been used up, can't rearm unless
            // something's available in-mission or arriving
            if ((The_mission.support_ships.tally >=
                 The_mission.support_ships.max_support_ships)) {
    ...
    if (!do_simple_check) {
        ...
        if ((result == 0 || result == 2) &&
            ...
            int temp = ship_name_lookup (
                Parse_names[The_mission.support_ships.arrival_anchor]);
            if (temp < 0) { return 0; }

            // make sure it's not leaving or blowing up
            if (Ships[temp].is_dying_or_departing ()) { return 0; }

            // also make sure that parent ship's fighterbay hasn't been
            // destroyed
            if (ship_fighterbays_all_destroyed (&Ships[temp])) { return 0; }
        }
    }
    ...
    if ((The_mission.support_ships.ship_class < 0) &&
        !(The_mission.support_ships.support_available_for_species &
          (1 << Ship_info[shipp->ship_info_index].species))) {
        return 0;
    }

    // this is also somewhat expensive
    if (!do_simple_check) {
        // Goober5000 - extra check to make sure this guy has a rearming
        // dockpoint
        if (model_find_dock_index (
                Ship_info[shipp->ship_info_index].model_num, DOCK_TYPE_REARM) <
            0) {
...
int ship_get_random_targetable_ship () {
    ...
    for (so = GET_FIRST (&Ship_obj_list); so != END_OF_LIST (&Ship_obj_list);
        ...
        if ((Objects[so->objnum].instance < 0) ||
            (Objects[so->objnum].instance >= MAX_SHIPS))
            continue;

        // skip if we aren't supposed to target it
        if (should_be_ignored (&Ships[Objects[so->objnum].instance])) continue;
...
void object_jettison_cargo (
    ...
    model_anim_start_type (
        cargo_shipp, TRIGGER_TYPE_DOCKING_STAGE_3, dockee_index, -1);
    model_anim_start_type (
        cargo_shipp, TRIGGER_TYPE_DOCKING_STAGE_2, dockee_index, -1);
    model_anim_start_type (
        cargo_shipp, TRIGGER_TYPE_DOCKING_STAGE_1, dockee_index, -1);
    ...
    // Goober5000 - add log
    mission_log_add_entry (
        LOG_SHIP_UNDOCKED, shipp->ship_name, cargo_shipp->ship_name);

    // physics stuff
    if (jettison_new) {
        // new method uses dockpoint normals and user-specified force
        extern void find_adjusted_dockpoint_normal (
            vec3d * global_p0_norm, object * objp, polymodel * pm,
            int submodel, int dock_index);
        extern int find_parent_rotating_submodel (
            polymodel * pm, int dock_index);

        polymodel* pm =
            model_get (Ship_info[shipp->ship_info_index].model_num);
        int docker_rotating_submodel =
            find_parent_rotating_submodel (pm, docker_index);
        vec3d docker_p0_norm;

        find_adjusted_dockpoint_normal (
            &docker_p0_norm, objp, pm, docker_rotating_submodel, docker_index);

        // set for relative separation speed (see also do_dying_undock_physics)
        pos = docker_p0_norm;
        vm_vec_copy_scale (
            &impulse, &docker_p0_norm,
            jettison_speed * cargo_objp->phys_info.mass);
    }
    else {
        // the old method sends cargo in the wrong direction and with an
        // impulse that depends on the size of the ship
    ...
    // whack the ship
    physics_apply_whack (
        &impulse, &pos, &cargo_objp->phys_info, &cargo_objp->orient,
        cargo_objp->phys_info.mass);
}
...
int ship_get_turret_type (ship_subsys* subsys) {
    // not a turret at all
    if (subsys->system_info->type != SUBSYSTEM_TURRET) { return 0; }

    // if it rotates
    if (subsys->system_info->turret_turning_rate > 0.0f) { return 2; }
...
ship_subsys* ship_get_subsys (ship* shipp, const char* subsys_name) {
    // sanity checks
    if ((shipp == NULL) || (subsys_name == NULL)) { return NULL; }

    ship_subsys* ss = GET_FIRST (&shipp->subsys_list);
    while (ss != END_OF_LIST (&shipp->subsys_list)) {
        // check subsystem name
        if (!subsystem_strcasecmp (
                ss->system_info->subobj_name, subsys_name)) {
            return ss;
        }
...
// returns 0 if no conflict, 1 if conflict, -1 on some kind of error with wing
// struct
...
int ship_get_reinforcement_team (int r_index) {
    ...
    if (p_objp != NULL) return p_objp->team;
    ...
    if (wing_index >= 0) {
        ...
        for (p_objp = GET_FIRST (&Ship_arrival_list);
             ...
             p_objp = GET_NEXT (p_objp)) {
            // check by wingnum
            if (p_objp->wingnum == wing_index) return p_objp->team;
        }
    }
...
/**
 * Determine if the given texture is used by a ship type. return ship info
 * index, or -1 if not used by a ship
 */
int ship_get_texture (int bitmap) {
    // check all ship types
    for (auto it = Ship_info.cbegin (); it != Ship_info.cend (); ++it) {
        if ((it->model_num >= 0) &&
            model_find_texture (it->model_num, bitmap) == 1) {
            return (int)std::distance (Ship_info.cbegin (), it);
        }
    }
...
void ship_update_artillery_lock () {
    ...
    for (so = GET_FIRST (&Ship_obj_list); so != END_OF_LIST (&Ship_obj_list);
         so = GET_NEXT (so)) {
        // get the ship
        if ((so->objnum >= 0) && (Objects[so->objnum].type == OBJ_SHIP) &&
            (Objects[so->objnum].instance >= 0)) {
            shipp = &Ships[Objects[so->objnum].instance];
        }
        else {
            continue;
        ...
        // get ai info
        if (shipp->ai_index >= 0) { aip = &Ai_info[shipp->ai_index]; }
        ...
        ASSERT (
            ...
            (Weapon_info[shipp->weapons.primary_bank_weapons
                             [shipp->weapons.current_primary_bank]]
                 .b_info.beam_type == BEAM_TYPE_C));
        if (!(Weapon_info[shipp->weapons.primary_bank_weapons
                              [shipp->weapons.current_primary_bank]]
                  .wi_flags[Weapon::Info_Flags::Beam]) ||
            (Weapon_info[shipp->weapons.primary_bank_weapons
                             [shipp->weapons.current_primary_bank]]
        ...
        // get collision info
        if (!beam_get_collision (
                shipp->targeting_laser_objnum, 0, &c_objnum, &cinfo)) {
            CLEAR_ARTILLERY_AND_CONTINUE ();
        }
        ...
        if ((c_objnum != aip->artillery_objnum) ||
            (Objects[c_objnum].signature != aip->artillery_sig)) {
        ...
        // otherwise we're hitting the same guy. check to see if we've strayed
        // too far
        if (vm_vec_dist_quick (&local_hit, &aip->artillery_lock_pos) >
            artillery_dist) {
        ...
        if (aip->artillery_objnum >= 0 && aip->artillery_lock_time >= 2.0f) {
            ssm_create (
                &Objects[aip->artillery_objnum], &cinfo->hit_point_world, 0,
                NULL, shipp->team);
 ...
 *
 * May not work if delta box is large and negative (ie, adjusted box crosses
 * over on itself - min > max)
 */
int check_world_pt_in_expanded_ship_bbox (
    ...
    return (
        (ship_pt.xyz.x > pm->mins.xyz.x - delta_box) &&
        (ship_pt.xyz.x < pm->maxs.xyz.x + delta_box) &&
        (ship_pt.xyz.y > pm->mins.xyz.y - delta_box) &&
        (ship_pt.xyz.y < pm->maxs.xyz.y + delta_box) &&
        (ship_pt.xyz.z > pm->mins.xyz.z - delta_box) &&
        (ship_pt.xyz.z < pm->maxs.xyz.z + delta_box));
}
...
float ship_get_warpout_speed (object* objp) {
    ...
    if (sip->warpout_type == WT_IN_PLACE_ANIM && sip->warpout_speed <= 0.0f) {
        ...
        sip->warpout_type == WT_SWEEPER ||
        sip->warpout_type == WT_IN_PLACE_ANIM) {
    ...
    return shipfx_calculate_warp_dist (objp) /
           shipfx_calculate_warp_time (objp, WD_WARP_OUT);
}
...
int ship_is_beginning_warpout_speedup (object* objp) {
    ...
    if (aip->mode == AIM_WARP_OUT) {
        if ((aip->submode == AIS_WARP_3) || (aip->submode == AIS_WARP_4) ||
...
void ship_set_new_ai_class (int ship_num, int new_ai_class) {
    ...
    init_aip_from_class_and_profile (
        aip, &Ai_classes[new_ai_class], The_mission.ai_profile);
...
// Goober5000 - will attempt to load an insignia bitmap and set it as active
// for the wing copied more or less from managepilot.cpp
...
bool ship_useful_for_departure (int shipnum, int /*path_mask*/) {
    ...
    if (!ship_has_dock_bay (shipnum)) return false;

    // make sure that the bays are not all destroyed
    if (ship_fighterbays_all_destroyed (&Ships[shipnum])) return false;

    // in the future, we might want to check bay paths against destroyed
    // fighterbays, but that capability doesn't currently exist (note, a mask
    // of 0 indicates all paths are valid)
    // if (path_mask != 0)
    //{
    //}
...
bool ship_fighterbays_all_destroyed (ship* shipp) {
    ...
    while (subsys != END_OF_LIST (&shipp->subsys_list)) {
        ...
        if (ship_subsys_is_fighterbay (subsys)) {
            ...
            if (!ship_subsys_takes_damage (subsys)) return false;

            // if fighterbay isn't destroyed, we're good
            if (subsys->current_hits > 0) return false;
        }
    ...
    // if the ship has no fighterbay subsystems at all, it must be an unusual
    // case, like the Faustus, so pretend it's okay...
    if (num_fighterbay_subsystems == 0) return false;
...
static bool ship_subsys_is_fighterbay (ship_subsys* ss) {
    ...
    if (!strncasecmp (NOX ("fighter"), ss->system_info->name, 7)) {
        return true;
    }
...
void ship_do_submodel_rotation (
    ...
    if (psub->flags[Model::Subsystem_Flags::Triggered] &&
        pss->triggered_rotation_index >= 0) {
    ...
    if (psub->flags[Model::Subsystem_Flags::Artillery]) {
        ...
        if (!(shipp->flags[Ship_Flags::Trigger_down])) return;
        ...
        if (shipp->flags[Ship_Flags::Primary_linked]) {
            ...
            if (ammo_tally <= 0) return;
        }
        // check unlinked
        else {
            // do not rotate if this is not the firing bank or if we have no
            // ammo in this bank
...
int ship_has_energy_weapons (ship* shipp) {
    ...
    return (
        Ship_info[shipp->ship_info_index].max_weapon_reserve >
        WEAPON_RESERVE_THRESHOLD);
}
...
static int ship_class_get_priority (int ship_class) {
    ...
    if (sip->flags[Info_Flags::Knossos_device])
        ...
        sip->flags[Info_Flags::Fighter] || sip->flags[Info_Flags::Stealth])
        return 12;
...
/**
 * Gives the index into the Damage_types[] vector of a specified damage type
 * name
...
/**
 * Either loads a new damage type, or returns the index of one with the same
 * name as given
 */
...
const int Num_piercing_effect_types =
    sizeof (PiercingTypes) / sizeof (flag_def_list);

static int piercing_type_get (char* str) {
    int i;
    for (i = 0; i < Num_piercing_effect_types; i++) {
        if (!strcasecmp (PiercingTypes[i].name, str))
...
const int Num_difficulty_scale_types =
    sizeof (DifficultyScaleTypes) / sizeof (flag_def_list);
...
const int Num_armor_type_constants =
    sizeof (ArmorTypeConstants) / sizeof (flag_def_list);
...
// Nuke: this is the number of storage locations load/store calculations are
// allowed to use
#define AT_NUM_STORAGE_LOCATIONS 8

// STEP 2: Add the name string to the array
const char* TypeNames[] = { "additive", "multiplicative", "exponential",
                            "exponential base", "cutoff", "reverse cutoff",
                            "instant cutoff", "instant reverse cutoff",
                            // Added by Nuke
                            "cap", "instant cap", "set", "load", "store",
                            "random" };
...
float TypeDefaultValues[] = {
    ...
    1.0f, // multiplicatve
    1.0f, // exp
    1.0f, // exp base - Damage will always be one (No mathematical way to do
          // better)
    0.0f, // cutoff
    0.0f, // reverse cutoff
    0.0f, // instant cutoff
    ...
    // Added by Nuke
    0.0f, // cap - caps are the same as reverse cutoffs, but sets damage to
          // value instead of 0
    0.0f, // instant cap
    0.0f, // set - set the damage to value
    0.0f, // data storage index - load and store calculations allow you to dump
          // and retrieve the current damage in one of a few memory locations
          // (these only persist for the duration of the computation)
...
float ArmorType::GetDamage (
    float damage_applied, int in_damage_type_idx, float diff_dmg_scale,
    int is_beam) {
    // Nuke: If the weapon has no damage type, just return damage
    if (in_damage_type_idx < 0) {
        // multiply by difficulty scaler now, since it is no longer done where
        // this is called
    ...
    // Find the entry in the weapon that corresponds to the given weapon damage
    // type
    ...
    if (adtp != NULL) {
        ...
        for (size_t i = 0; i < num; i++) {
            ...
            if ((storage_idx >= 0) &&
                ...
                using_storage = true;
                // using +value: (or error cases caught at parse, where this
                // holda a 0.0f)
            }
            else if (
                storage_idx ==
                AT_CONSTANT_NOT_USED) { // save time checking all possible
                                        // constants when most of the time you
                                        // will be using +value:
            ...
            // face: terrible hack to work consistently with beams and additive
            // damages
            if (is_beam &&
                (adtp->Calculations[i] == AT_TYPE_ADDITIVE ||
            ...
            case AT_TYPE_ADDITIVE: damage_applied += curr_arg; break;
            case AT_TYPE_MULTIPLICATIVE: damage_applied *= curr_arg; break;
            ...
            case AT_TYPE_EXPONENTIAL_BASE:
                ...
                break;
            case AT_TYPE_CUTOFF:
                if (damage_applied < curr_arg) damage_applied = 0;
                break;
            ...
            case AT_TYPE_INSTANT_REVERSE_CUTOFF:
                ...
                break;
            case AT_TYPE_CAP:
                if (damage_applied > curr_arg) damage_applied = curr_arg;
                break;
        ...
        if (damage_applied < 0.0f) damage_applied = 0.0f;
...
float ArmorType::GetShieldPiercePCT (int damage_type_idx) {
    if (damage_type_idx < 0) return 0.0f;
    ...
    if (adtp != NULL) { return adtp->shieldpierce_pct; }

    return 0.0f;
}

int ArmorType::GetPiercingType (int damage_type_idx) {
    if (damage_type_idx < 0) return 0;
    ...
    if (adtp != NULL) { return adtp->piercing_type; }
...
float ArmorType::GetPiercingLimit (int damage_type_idx) {
    ...
    if (adtp != NULL) { return adtp->piercing_start_pct; }
        ...
        while (optional_string ("+Calculation:")) {
            ...
            if (calc_type == -1) {
                ...
                if (optional_string ("+Stored Value:")) {
                    ...
                    adt.Arguments.push_back (
                        0.0f); // this isnt used in this case, just take up
                               // space so the indices lign up, also a fallback
                               // value in case of bad altArguments
                }
                else if (optional_string (
                             "+Constant:")) { // use one of the pre-defined
                                              // constants
                    stuff_string (buf, F_NAME, NAME_LENGTH);
                ...
                else { // Nuke: +Value, only required if storage location or
                       // constant is not used -nuke
                    required_string ("+Value:");
                    stuff_float (&temp_float);
                    adt.altArguments.push_back (
                        AT_CONSTANT_NOT_USED); // set this to
                                               // AT_CONSTANT_NOT_USED so we
                                               // know to just use the value
                                               // from adt.Arguments instead of
...
int armor_type_get_idx (char* name) {
    ...
    for (size_t i = 0; i < num; i++) {
        if (Armor_types[i].IsName (name)) return (int)i;
    }
...
void parse_armor_type () {
    ...
    if (optional_string ("$Flags:"))
        parse_string_flag_list (
            (int*)&tat.flags, Armor_flags, Num_armor_flags);
...
void parse_ai_target_priorities () {
    ...
    if (n_entries == 0) first_time = true;
    ...
    if (optional_string ("+Weapon Class:")) {
        ...
        for (i = 0; i < num_strings; i++) {
            for (j = 0; j < MAX_WEAPON_TYPES; j++) {
                if (!strcasecmp (
                        Weapon_info[j].name, temp_strings[i].c_str ())) {
    ...
    if (already_exists == -1) { Ai_tp_list.push_back (temp_priority); }
    else {
...
void parse_weapon_targeting_priorities () {
    ...
    if (optional_string ("$Name:")) {
        ...
        if (k == MAX_WEAPON_TYPES) {
            error_display (
                0,
                "Unrecognized weapon '%s' found when setting weapon targeting "
                "priorities.\n",
                tempname);
            if (optional_string (
                    "+Target Priority:")) { // consume the data to avoid
                                            // parsing errors
            ...
            if (optional_string ("+Target Priority:")) {
                ...
                for (i = 0; i < num_strings; i++) {
                    ...
                    if (j == num_groups)
                        error_display (
                            0,
                            "Unrecognized string '%s' found when setting "
...
static int ship_get_subobj_model_num (ship_info* sip, char* subobj_name) {
    for (int i = 0; i < sip->n_subsystems; i++) {
        if (!subsystem_strcasecmp (
                sip->subsystems[i].subobj_name, subobj_name))
...
gamesnd_id ship_get_sound (object* objp, GameSounds id) {
    ...
    std::map< GameSounds, gamesnd_id >::iterator element =
        sip->ship_sounds.find (id);
...
/**
 * Given a ship with bounding box and a point, find the closest point on the
 * bbox
 *
...
int get_nearest_bbox_point (object* ship_objp, vec3d* start, vec3d* box_pt) {
    ...
    polymodel* pm;
    pm = model_get (
        Ship_info[Ships[ship_objp->instance].ship_info_index].model_num);
    ...
    // find box_pt
    int inside =
        project_point_onto_bbox (&pm->mins, &pm->maxs, &rf_start, &temp);
...
void ship_set_thruster_info (
    mst_info* mst, object* obj, ship* shipp, ship_info* sip) {
    ...
    mst->use_ab = (obj->phys_info.flags & PF_AFTERBURNER_ON) ||
                  (obj->phys_info.flags & PF_BOOSTER_ON);
    mst->glow_noise =
        shipp->thruster_glow_noise * sip->thruster_glow_noise_mult;
...
void ship_render_batch_thrusters (object* obj) {
    ...
    for (int i = 0; i < sip->num_maneuvering; i++) {
        ...
        if (pi->side_thrust > 0 &&
            (mtp->use_flags[Ship::Thruster_Flags::Slide_right])) {
            render_amount = pi->side_thrust;
        }
        else if (
            pi->side_thrust < 0 &&
            (mtp->use_flags[Ship::Thruster_Flags::Slide_left])) {
            render_amount = -pi->side_thrust;
        }
        else if (
            pi->vert_thrust > 0 &&
            (mtp->use_flags[Ship::Thruster_Flags::Slide_up])) {
            render_amount = pi->vert_thrust;
        }
        else if (
            pi->vert_thrust < 0 &&
            (mtp->use_flags[Ship::Thruster_Flags::Slide_down])) {
            render_amount = -pi->vert_thrust;
        }
        else if (
            pi->forward_thrust > 0 &&
            (mtp->use_flags[Ship::Thruster_Flags::Forward])) {
            render_amount = pi->forward_thrust;
        }
        else if (
            pi->forward_thrust < 0 &&
            (mtp->use_flags[Ship::Thruster_Flags::Reverse])) {
            render_amount = -pi->forward_thrust;
        }

        // Don't render small faraway thrusters (more than 10k * radius away)
        if (vm_vec_dist (&Eye_position, &obj->pos) >
            (10000.0f * mtp->radius)) {
            render_amount = 0.0f;
        }
        ...
        if (render_amount > 0.0f) {
            ...
            if (shipp->thrusters_start[i] <= 0) {
                ...
                if (mtp->start_snd.isValid ())
                    snd_play_3d (
                        gamesnd_get_game_sound (mtp->start_snd), &mtp->pos,
                        &Eye_position, 0.0f, &obj->phys_info.vel);
            }
            ...
            if (!Cmdline_freespace_no_sound) {
                if (mtp->loop_snd.isValid () &&
                    ...
                    (!mtp->start_snd.isValid () ||
                     (gamesnd_get_max_duration (
                          gamesnd_get_game_sound (mtp->start_snd)) <
                      timestamp () - shipp->thrusters_start[i]))) {
                    shipp->thrusters_sounds[i] = obj_snd_assign (
                        OBJ_INDEX (obj), mtp->loop_snd, &mtp->pos, 1);
                }
            }
            ...
            if (mtp->tex_id >= 0) {
                ...
                // End
                vm_vec_scale_add (
                    &tmpend, &mtp->pos, &mtp->norm, len * render_amount);
                ...
                // man_thruster_get_slot(bmap_frame);
            ...
            if (mtp->stop_snd.isValid ()) {
                ...
                snd_play_3d (
                    gamesnd_get_game_sound (mtp->stop_snd), &mtp->pos,
                    &Eye_position, 0.0f, &obj->phys_info.vel);
            }
        }
    }
...
void ship_render_weapon_models (
    model_render_params* ship_render_info, model_draw_list* scene, object* obj,
    int render_flags) {
    int num = obj->instance;
    ship* shipp = &Ships[num];
    ship_info* sip = &Ship_info[Ships[num].ship_info_index];

    if (!(sip->flags[Ship::Info_Flags::Draw_weapon_models]) ||
        (shipp->flags[Ship_Flags::Cloaked])) {
        return;
    }
    ...
    // primary weapons
    for (i = 0; i < swp->num_primary_banks; i++) {
        if (Weapon_info[swp->primary_bank_weapons[i]].external_model_num ==
                -1 ||
        ...
        for (k = 0; k < bank->num_slots; k++) {
            polymodel* pm = model_get (
                Weapon_info[swp->primary_bank_weapons[i]].external_model_num);

            pm->gun_submodel_rotation = shipp->primary_rotate_ang[i];

            model_render_queue (
                ship_render_info, scene,
                Weapon_info[swp->primary_bank_weapons[i]].external_model_num,
    ...
    for (i = 0; i < swp->num_secondary_banks; i++) {
        if (Weapon_info[swp->secondary_bank_weapons[i]].external_model_num ==
                -1 ||
            !sip->draw_secondary_models[i]) {
            continue;
        }

        bank = &(model_get (sip->model_num))->missile_banks[i];

        if (Weapon_info[swp->secondary_bank_weapons[i]]
                .wi_flags[Weapon::Info_Flags::External_weapon_lnch]) {
            for (k = 0; k < bank->num_slots; k++) {
                model_render_queue (
                    ship_render_info, scene,
                    Weapon_info[swp->secondary_bank_weapons[i]]
                        .external_model_num,
                    &vmd_identity_matrix, &bank->pnt[k]);
            }
        }
            ...
            for (k = 0; k < bank->num_slots; k++) {
                ...
                vm_vec_scale_add2 (
                    ...
                    -(1.0f - shipp->secondary_point_reload_pct[i][k]) *
                        model_get (Weapon_info[swp->secondary_bank_weapons[i]]
                                       .external_model_num)
                            ->rad);
                ...
                model_render_queue (
                    ...
                    Weapon_info[swp->secondary_bank_weapons[i]]
                        .external_model_num,
                    &vmd_identity_matrix, &secondary_weapon_pos);
            }
        }
    }
...
int ship_render_get_insignia (object* /* obj */, ship* shipp) {
    ...
    if (ship_in_my_squadron (shipp)) { return Player->insignia_texture; }
...
void ship_render_set_animated_effect (
    model_render_params* render_info, ship* shipp, uint* /*render_flags*/) {
    if (!shipp->shader_effect_active || Rendering_to_shadow_map) { return; }
    ...
    if (sep->invert_timer) {
        timer =
            1.0f -
            ((timer_get_milliseconds () - shipp->shader_effect_start_time) /
             (float)shipp->shader_effect_duration);
...
void ship_render (object* obj, model_draw_list* scene) {
    ...
    bool show_thrusters =
        (!shipp->flags[Ship_Flags::No_thrusters]) && !Rendering_to_shadow_map;
    dock_function_info dfi;
    ...
    dock_evaluate_all_docked_objects (
        obj, &dfi, ship_find_warping_ship_helper);
    ...
    if (dfi.maintained_variables.bool_value) {
        ...
        is_first_stage_arrival =
            warp_shipp->flags[Ship_Flags::Arriving_stage_1];
        ...
        // purposes -zookeeper
        if (Ship_info[warp_shipp->ship_info_index].warpin_type ==
            WT_HYPERSPACE) {
            warp_shipp = NULL;
    ...
    if (is_first_stage_arrival) {
        ...
        if (shipp->is_arriving ()) { shipp->warpin_effect->warpShipRender (); }
        else if (shipp->flags[Ship_Flags::Depart_warp]) {
    ...
    if (obj == Viewer_obj && !Rendering_to_shadow_map) {
        if (!(Viewer_mode & VM_TOPDOWN)) { return; }
    }
    ...
    if (vm_vec_dist_quick (&obj->pos, &Eye_position) < obj->radius * 50.0f &&
        ...
        for (int i = 0; i < MAX_SHIP_ARCS; i++) {
            if (timestamp_valid (shipp->arc_timestamp[i])) {
                model_add_arc (
                    sip->model_num, -1, &shipp->arc_pts[i][0],
                    &shipp->arc_pts[i][1], shipp->arc_type[i]);
            }
        }
    }
    ...
    if (!(shipp->flags[Ship_Flags::Disabled]) &&
        !ship_subsys_disrupted (shipp, SUBSYSTEM_ENGINE) && show_thrusters) {
        mst_info mst;
    ...
    if (sip->uses_team_colors &&
        !shipp->flags[Ship_Flags::Render_without_miscmap]) {
        team_color model_team_color;

        bool team_color_set = model_get_team_color (
            &model_team_color, shipp->team_name, shipp->secondary_team_name,
            shipp->team_change_timestamp, shipp->team_change_time);

        if (team_color_set) { render_info.set_team_color (model_team_color); }
    }
    ...
    if (!(shipp->flags[Ship_Flags::Cloaked])) {
        if ((The_mission.flags[Mission::Mission_Flags::Fullneb]) &&
            ...
            if (fog_val >= 0.6f) { render_info.set_detail_level_lock (2); }
        }

        model_render_queue (
            &render_info, scene, sip->model_num, &obj->orient, &obj->pos);
    }
