...
ADE_FUNC (
    ...
    if (!e1->is_constant) { e1->index = e2->index; }

    return ade_set_args (L, "o", l_Enum.Set (*e1));
}

ADE_FUNC (
    __tostring, l_Enum, NULL, "Returns enumeration name", "string",
...
ADE_FUNC (
    __eq, l_Enum, "enumeration", "Compares the two enumerations for equality",
    ...
    if (e1 == NULL || e2 == NULL) { return ADE_RETURN_FALSE; }
