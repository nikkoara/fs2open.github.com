...
uint batching_determine_vertex_layout(batch_info *info)
{
        if (info->prim_type == PRIM_TYPE_POINTS) {
                return vertex_format_data::mask(vertex_format_data::POSITION3) | vertex_format_data::mask(vertex_format_data::RADIUS) | vertex_format_data::mask(vertex_format_data::UVEC) | vertex_format_data::mask(vertex_format_data::TEX_COORD3);
        }

        if (info->mat_type == batch_info::VOLUME_EMISSIVE || info->mat_type == batch_info::DISTORTION) {
                return vertex_format_data::mask(vertex_format_data::POSITION3) | vertex_format_data::mask(vertex_format_data::COLOR4) | vertex_format_data::mask(vertex_format_data::TEX_COORD3) | vertex_format_data::mask(vertex_format_data::RADIUS);
        } else {
                return vertex_format_data::mask(vertex_format_data::POSITION3) | vertex_format_data::mask(vertex_format_data::COLOR4) | vertex_format_data::mask(vertex_format_data::TEX_COORD3);
        }
}
