        ...
        if (wipA->weapon_hitpoints > 0) {
                ...
                if ((The_mission.ai_profile
                    ...
                    && (wipA->is_locked_homing()) && (wpA->homing_object != &obj_used_list)) {
                        ...
                        (wipA->lifetime - wpA->lifeleft) < The_mission.ai_profile->delay_bomb_arm_timer[Game_skill_level])
                        return 0;
        }
        ...
        if (wipB->weapon_hitpoints > 0) {
                ...
                if ((The_mission.ai_profile
                    ...
                    && (wipB->is_locked_homing()) && (wpB->homing_object != &obj_used_list)) {
                        ...
                        (wipB->lifetime - wpB->lifeleft) < The_mission.ai_profile->delay_bomb_arm_timer[Game_skill_level])
                        return 0;
        }
