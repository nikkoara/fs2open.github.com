...
int collide_debris_weapon (obj_pair* pair) {
    ...
    if (hit) {
        ...
        Script_system.SetHookObjects (
            4, "Weapon", weapon_obj, "Debris", pdebris, "Self", weapon_obj,
            "Object", pdebris);
        bool weapon_override =
            Script_system.IsConditionOverride (CHA_COLLIDEDEBRIS, weapon_obj);

        Script_system.SetHookObjects (
            2, "Self", pdebris, "Object", weapon_obj);
        bool debris_override =
            Script_system.IsConditionOverride (CHA_COLLIDEWEAPON, pdebris);
        ...
        Script_system.SetHookObjects (
            2, "Self", weapon_obj, "Object", pdebris);
        if (!(debris_override && !weapon_override))
            Script_system.RunCondition (
                CHA_COLLIDEDEBRIS, '\0', NULL, weapon_obj);
        ...
        if ((debris_override && !weapon_override) ||
            ...
            Script_system.RunCondition (
                CHA_COLLIDEWEAPON, '\0', NULL, pdebris,
...
int collide_asteroid_weapon (obj_pair* pair) {
    ...
    if (hit) {
        ...
        Script_system.SetHookObjects (
            4, "Weapon", weapon_obj, "Asteroid", pasteroid, "Self", weapon_obj,
            "Object", pasteroid);

        bool weapon_override = Script_system.IsConditionOverride (
            CHA_COLLIDEASTEROID, weapon_obj);
        Script_system.SetHookObjects (
            2, "Self", pasteroid, "Object", weapon_obj);
        bool asteroid_override =
            Script_system.IsConditionOverride (CHA_COLLIDEWEAPON, pasteroid);
        ...
        Script_system.SetHookObjects (
            2, "Self", weapon_obj, "Object", pasteroid);
        if (!(asteroid_override && !weapon_override))
            Script_system.RunCondition (
                CHA_COLLIDEASTEROID, '\0', NULL, weapon_obj);
        ...
        if ((asteroid_override && !weapon_override) ||
            ...
            Script_system.RunCondition (
                CHA_COLLIDEWEAPON, '\0', NULL, pasteroid,
                Weapons[weapon_obj->instance].weapon_info_index);
