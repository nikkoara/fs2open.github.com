...
#ifndef FREESPACE2_OBJECT_OBJCOLLIDE_HH
#define FREESPACE2_OBJECT_OBJCOLLIDE_HH
...
// These are in CollideGeneral.cpp and are used by one or more of the
// collision- type specific collision modules.
//===============================================================================
...
#define COLLISION_TYPE_NEW                                                           \
        2       // keeps track of collision pairs.  throws out collisions that won't
                // happen.
...
void obj_add_pair(
        object *A, object *B, int check_time = -1, int add_to_end = 0);
...
#endif // FREESPACE2_OBJECT_OBJCOLLIDE_HH
