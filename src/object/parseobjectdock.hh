...
#ifndef FREESPACE2_OBJECT_PARSEOBJECTDOCK_HH
#define FREESPACE2_OBJECT_PARSEOBJECTDOCK_HH
...
public:
    ...
    p_dock_function_info () : early_return_condition (false) {
...
// should store its intermediate and return values in the p_dock_function_info
// class.
void dock_evaluate_all_docked_objects (
    p_object* objp, p_dock_function_info* infop,
    void (*function) (p_object*, p_dock_function_info*));

// docks all docked objects; called only from parse_create_object in
// missionparse.cpp
...
#endif // FREESPACE2_OBJECT_PARSEOBJECTDOCK_HH
