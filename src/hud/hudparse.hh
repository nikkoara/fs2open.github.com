...
struct gauge_settings  {
    ...
    gauge_settings ()
        : font_num (Hud_font), scale_gauge (Scale_retail_gauges),
          ship_idx (nullptr), use_clr (nullptr), use_coords (false),
          set_position (true), set_colour (true), slew (false) {
        base_res[0] = -1;
        base_res[1] = -1;
        memcpy (
...
#endif // FREESPACE2_HUD_HUDPARSE_HH
