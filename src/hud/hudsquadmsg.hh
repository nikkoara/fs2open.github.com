...
#define DEFAULT_MESSAGES                                             \
    (ATTACK_TARGET_ITEM | DISABLE_TARGET_ITEM | DISARM_TARGET_ITEM | \
     PROTECT_TARGET_ITEM | IGNORE_TARGET_ITEM | FORMATION_ITEM |     \
...
#define ENEMY_TARGET_MESSAGES                                           \
    (ATTACK_TARGET_ITEM | DISABLE_TARGET_ITEM | DISARM_TARGET_ITEM |    \
     IGNORE_TARGET_ITEM | STAY_NEAR_TARGET_ITEM | CAPTURE_TARGET_ITEM | \
     DISABLE_SUBSYSTEM_ITEM)
