        ...
        int team)
{
        ...
        // single player or the server
                ...
                for (idx = 0; idx < count; idx++) {
                        ssm.sinfo.delay_stamp[idx] = timestamp(200 + (int)fs2::prng::randf(0, -199.0f, 1000.0f));
                ...
                for (idx = 0; idx < moveup->sinfo.count; idx++) {
                        ...
                        if (!moveup->done_flags[idx]) {
                                ...
                                // maybe create his warpin effect
                                        ...
                                        (moveup->sinfo.delay_stamp[idx] >= 0) && timestamp_elapsed(moveup->sinfo.delay_stamp[idx])) {
                                        // get an orientation
                                        vec3d temp;
                                        matrix orient;
