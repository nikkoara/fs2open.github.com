        ...
        vec3d const *const *verts, float *hit_time)
{
         ...
         */
                ...
                C = 2.0f * delta_x_dot_ve * delta_x_dot_vs * ve_dot_vs + Rs2 * ve_dot_vs * ve_dot_vs - delta_x_sqr * ve_dot_vs * ve_dot_vs - delta_x_dot_ve * delta_x_dot_ve * vs_sqr;
                ...
                if ((root1 <= 1.0f) && (root1 >= 0.0f)) {
                        ...
                        if (fabsf(q - Rs2) < Rs_point2) { // error less than 0.1m absolute (2*delta*Radius)
                                goto Hit;
                        }
                }
                ...
                if ((root2 <= 1.0f) && (root2 >= 0.0f)) {
                        ...
                        float q = vm_vec_dist_squared(&temp_edge_hit, &temp_sphere_hit);
                        if (fabsf(q - Rs2) < Rs_point2) { // error less than 0.1m absolute
                                goto Hit;
                        }
                } else {
