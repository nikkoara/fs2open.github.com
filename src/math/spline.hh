...
#ifndef FREESPACE2_MATH_SPLINE_HH
#define FREESPACE2_MATH_SPLINE_HH
...
// max bezier degree - note the # of points directly corresponds to the degree
// (degree == n_points - 1). more points means more expensive!
...
public:
    ...
    vec3d d_pts[MAX_HERM_PTS]; // derivative of control points (think of as
                               // velocity)
    int num_pts;
...
public:
    ...
    herm_spline ();
    herm_spline (
        int _num_pts, vec3d* _pts[MAX_HERM_PTS], vec3d* _d_pts[MAX_HERM_PTS]);
...
#endif // FREESPACE2_MATH_SPLINE_HH
