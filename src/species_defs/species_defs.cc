                ...
                while (required_string_either("#END", "$Species_Name:")) {
                        ...
                        if (optional_string("$FRED Color:") || optional_string("$FRED Colour:")) {
                                ...
                                if (!strcasecmp(species->species_name, "Terran")) {
                                        ...
                                        !strcasecmp(species->species_name, "Ancients") || !strcasecmp(species->species_name, "Ancient")) {
                                        species->fred_color.rgb.r = 192;
                                        species->fred_color.rgb.g = 0;
                                        species->fred_color.rgb.b = 192;
                                } else {
                                    ...
                                    "+Shield_Hit_ani:")) // Shouldn't be required -- LPine
                        {
                                ...
                                species->shield_anim.first_frame = -1; // Landmine to trip up anyone who does end up using
                                                                       // this
                        }
