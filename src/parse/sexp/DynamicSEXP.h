 ...
 *
 * This class represents an implementation of a SEXP that can be added
 * dynamically to the SEXP system
 */
class DynamicSEXP {
protected:
...
public:
     ...
     *
     * All remaining parameters are optional and the implementation must handle
     * non-existing parameters gracefully
     *
    ...
    /**
     * @brief Gets the maximum number of how many arguments this SEXP may be
     * called with
     *
     * If this returns INT_MAX then there will be no limit to how many
     ...
     * @param node The SEXP node containing the first parameter of the
     * parameter list
     ...
     *
     * This is used by FRED to group SEXPs with similar purposes together. This
     * can be one of the *_SUBCATEGORY_* defines or a new id which has been
     * added dynamically.
     *
