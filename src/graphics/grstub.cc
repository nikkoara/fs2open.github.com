...
int gr_stub_create_buffer (BufferType, BufferUsageHint) { return -1; }
...
void gr_stub_fog_set (
    int /*fog_mode*/, int /*r*/, int /*g*/, int /*b*/, float /*fog_near*/,
    float /*fog_far*/) {}

void gr_stub_free_screen (int /*id*/) {}

void gr_stub_get_region (
    int /*front*/, int /*w*/, int /*h*/, ubyte* /*data*/) {}
...
void gr_stub_rect (
    int /*x*/, int /*y*/, int /*w*/, int /*h*/, int /*resize_mode*/) {}
...
void gr_stub_update_buffer_data (
    int /*handle*/, size_t /*size*/, void* /*data*/) {}

void gr_stub_update_buffer_data_offset (
...
void gr_stub_set_clip (
    int /*x*/, int /*y*/, int /*w*/, int /*h*/, int /*resize_mode*/) {}

int gr_stub_set_cull (int /*cull*/) { return 0; }

int gr_stub_set_color_buffer (int /*mode*/) { return 0; }
...
void gr_stub_stuff_secondary_color (
    vertex* /*v*/, ubyte /*fr*/, ubyte /*fg*/, ubyte /*fb*/) {}
...
int gr_stub_stencil_set (int /*mode*/) { return 0; }

void gr_stub_stencil_clear () {}

int gr_stub_alpha_mask_set (int /*mode*/, float /*alpha*/) { return 0; }

/*void gr_stub_shade(int x,int y,int w,int h)
{
}*/

void gr_stub_post_process_set_effect (
...
void gr_stub_update_texture (
    int /*bitmap_handle*/, int /*bpp*/, const ubyte* /*data*/, int /*width*/,
    int /*height*/) {}
...
int gr_stub_bm_make_render_target (
    int /*n*/, int* /*width*/, int* /*height*/, int* /*bpp*/, int* /*mm_lvl*/,
    int /*flags*/) {
    return 0;
}
...
bool gr_stub_init () {
    ...
    gr_screen.gf_render_primitives_particle =
        gr_stub_render_primitives_particle;
    gr_screen.gf_render_primitives_distortion =
        gr_stub_render_primitives_distortion;
