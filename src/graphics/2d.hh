...
/**
 * This should be basically just like it is in the VB
...
extern void
gr_printf_menu (int x, int y, const char* format,...)
    __attribute__ ((format (printf, 3, 4)));
// same as gr_printf_menu but accounts for menu zooming
extern void
gr_printf_menu_zoomed (int x, int y, const char* format,...)
    __attribute__ ((format (printf, 3, 4)));
// same as gr_printf but doesn't resize for non-standard resolutions
extern void
gr_printf_no_resize (int x, int y, const char* format,...)
    __attribute__ ((format (printf, 3, 4)));
