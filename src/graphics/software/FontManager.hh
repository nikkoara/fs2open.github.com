 ...
 *
 * This class is responsible for the creation, management and disposal of fonts
 * used by the FreeSpace engine. It contains static functions to load a
 * specific font type and functions to set or get the current font and can be
 * used to retrieve a font by name or index.
 *
 * @warning Don't @c delete a font which was retrieved from this class as they
...
public:
     ...
     * returns it to the caller. If the specified name could not be found then
     * @c NULL is returned instead.
     *
     ...
     * NULL when the specified index is invald
     *
     ...
     * which @verbatim (*fontIterator) == font @endverbatim is true.
     *
     ...
     * with the specified
     * @c size and @c type. The size can be changed later where the type is not
     * changeable.
     *
...
#endif // FREESPACE2_GRAPHICS_SOFTWARE_FONTMANAGER_HH
