...
#ifndef FREESPACE2_GRAPHICS_SOFTWARE_FONT_HH
#define FREESPACE2_GRAPHICS_SOFTWARE_FONT_HH
 ...
 *
 * Parses a font using either the font name or the font index and returns the
 * font index If the font could not be parsed because of a syntax error, -1 is
 * returned instead
 *
...
#endif // FREESPACE2_GRAPHICS_SOFTWARE_FONT_HH
