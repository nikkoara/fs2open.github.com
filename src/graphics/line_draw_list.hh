...
#ifndef FREESPACE2_GRAPHICS_LINE_DRAW_LIST_HH
#define FREESPACE2_GRAPHICS_LINE_DRAW_LIST_HH
 ...
 *
 * This should be used when a lot of lines are going to be rendered together.
 * The actual rendering operation will only be done once flush() is called so
 * the lines may overlap other objects that were rendered after the line was
 * added to this class.
 */
...
public:
     ...
     * pixel positions.
     *
     * A gradient is like a normal line but line will fade out towards the end
     * of the line.
     *
     * @param x1 Start X-Coordinate of the line
     * @param y1 Start Y-Coordinate of the line
...
#endif // FREESPACE2_GRAPHICS_LINE_DRAW_LIST_HH
