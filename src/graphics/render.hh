...
#ifndef FREESPACE2_GRAPHICS_RENDER_HH
#define FREESPACE2_GRAPHICS_RENDER_HH
 ...
 * g3_draw_line. This assumes he vertex's are already clipped, so call
 * g3_draw_line not this if you have two 3d points.
 ...
 *
 * This will defer rendering 2D interface elements until gr_2d_stop_buffer is
 * called. This can improve performance when doing a lot of 2D operations since
 * the actual drawing will only be done once.
 *
 * @warning This will only affect a few rendering operations and might change
