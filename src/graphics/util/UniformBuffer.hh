 ...
 *
 * This is a wrapper around a buffer handle from the graphics system which also
 * provides access to a uniform data aligner. It also manages the fence object
 * which detects if this buffer is still in use or can be reused by other
...
#endif // FREESPACE2_GRAPHICS_UTIL_UNIFORMBUFFER_HH
