 ...
 *
 * @details This also keeps a client side copy of the data since that is
 * required if the buffer is resized since the original data will not be kept
 * in that case.
 */
class GPUMemoryHeap {
...
public:
     ...
     * operations
     *
     * @warning Do no change the contents of this buffer! The contents are
     * managed by this class and may not be changed by external code.
     *
...
#endif // FREESPACE2_GRAPHICS_UTIL_GPUMEMORYHEAP_HH
