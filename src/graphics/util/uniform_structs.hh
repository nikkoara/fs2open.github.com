 ...
 * @file
 *
 * This file contains definitions for GPU uniform buffer structs. These structs
 * must respect the std140 layout rules. Read the OpenGL specification for the
 * exact layout and padding rules.
 */
...
#endif // FREESPACE2_GRAPHICS_UTIL_UNIFORM_STRUCTS_HH
