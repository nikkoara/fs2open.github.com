        ...
        material *material_info, bool set_base_map, bool set_clipping)
{
        ...
        if (set_clipping) {
                ...
                if (!clip_params.enabled) {
                        ...
                        ASSERTX(
                                Current_shader != NULL && (Current_shader->shader == SDR_TYPE_MODEL || Current_shader->shader == SDR_TYPE_PASSTHROUGH_RENDER || Current_shader->shader == SDR_TYPE_DEFAULT_MATERIAL),
