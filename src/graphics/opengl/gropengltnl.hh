 ...
 * @param expected_type The expected type of the buffer. Mainly used for debug
 * checking.
...
void opengl_tnl_set_material(
        material *material_info, bool set_base_map, bool set_clipping = true);
...
#endif // FREESPACE2_GRAPHICS_OPENGL_GROPENGLTNL_HH
