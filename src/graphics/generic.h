...
#ifndef FREESPACE2_GRAPHICS_GENERIC_H
#define FREESPACE2_GRAPHICS_GENERIC_H
...
public:
    ...
    generic_extras ()
        : width (0), height (0), u0 (0.0f), v0 (0.0f), u1 (1.0f), v1 (1.0f),
          alpha (1.0f), draw (true) {}
};
...
void generic_anim_render (
    generic_anim* ga, float frametime, int x, int y, bool menu = false,
    const generic_extras* ge = nullptr);
