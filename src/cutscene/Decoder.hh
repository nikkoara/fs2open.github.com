...
enum class FramePixelFormat { Invalid, YUV420, BGR, BGRA };
 ...
 *
 * A decoder maintaines two queues of decoded audio and video frames which are
...
public:
     ...
     *
     * @note A implementation should initialize the datastructures required for
     * decoding here.
     *
    ...
    virtual bool initialize (
        const std::string& fileName, const PlaybackProperties& properties) = 0;
    ...
    bool isSubtitleQueueFull () {
        return m_subtitleQueue->size () == m_queueSize;
    }
...
#endif // FREESPACE2_CUTSCENE_DECODER_HH
