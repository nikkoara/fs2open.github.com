...
{
        if (!strcasecmp(langauge_name, "eng")) {
                return "English";
        }
        if (!strcasecmp(langauge_name, "ger")) {
                return "German";
        }
        if (!strcasecmp(langauge_name, "spa")) {
                return "Spanish";
        }
        ...
        do {
                ...
                while (isDecoding()) {
                        ...
                        if (packet.stream_index == m_status->videoStreamIndex) {
                                ...
                                audioDecoder && packet.stream_index == m_status->audioStreamIndex) {
                                ...
                                subtitleDecoder && packet.stream_index == m_status->subtitleStreamIndex) {
