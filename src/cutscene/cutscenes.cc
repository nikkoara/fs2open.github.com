...
void cutscenes_screen_do_frame()
{
        ...
        if (Description_index != Selected_line) {
                ...
                Text_size = 0;
                if (Description_index < (int)Cutscene_list.size() && (int)Cutscene_list[Description_index] < (int)Cutscenes.size()) {
                        ...
                        if (src) {
                                ...
                                ASSERT(
                                        Text_size >= 0 && Text_size < Cutscene_max_text_lines[gr_screen.res]);
                        }
                }
        }
