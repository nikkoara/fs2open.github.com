...
extern int
    Last_frame_timestamp;    // A timestamp for when the previous frame ended
...
// if this value is set anywhere within the game_do_state_common() function,
// the normal do_state() will not be called for this frame. Useful for getting
// out of sticky sequencing situations.
...
// lookup the specified filename. return an fs_builtin_mission* if found, NULL
// otherwise
...
// make sure a CD is in the drive before continuing (returns 1 to continue,
// otherwise 0).
...
// calls to be executed when the game is put in or restored from minimized or
// inactive state
void game_pause ();
void game_unpause ();
...
#endif // FREESPACE2_FREESPACE2_FREESPACE_HH
