...
#define NP_WAYPOINT \
    0x0001 // Nav Point is bound to the position of a single node of a waypoint
           // path
...
#define NP_VISITED \
    0x0100 // Whether we've been within 1,000 meters of this waypoint
...
inline bool CanAutopilot (bool send_msg = false) {
    return CanAutopilot (Player_obj->pos, send_msg);
}
...
#endif // FREESPACE2_AUTOPILOT_AUTOPILOT_HH
