...
// endianess will be handled by cfile and others now, little-endian should be
...
#define ID_INFO \
    0x464e4950 // FNIP (PINF): POF file information, like command line, etc
#define ID_GRID 0x44495247 // DIRG (GRID): Grid information
#define ID_SPCL \
    0x4c435053 // LCPS (SPCL): Special object -- like a gun, missile, docking
               // point, etc.
...
#define ID_GLOX \
    0x584f4c47 // experimental glow points will be gone as soon as we get a
               // proper pof editor -Bobboau
...
#endif // FREESPACE2_MODEL_MODELSINC_HH
