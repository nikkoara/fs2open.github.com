...
// this is so stupid - required to get VC6 to use the following array
// initializer
EFXREVERBPROPERTIES::EFXREVERBPROPERTIES (
    const EFXREVERBPROPERTIES_list& list) {
    name = list.name;
...
static const EFXREVERBPROPERTIES_list
    EFX_Reverb_Defaults[EAX_ENVIRONMENT_COUNT] = {
        { "Generic", 1.0f,      1.0f,
          0.316228f, 0.891251f, 1.0f,
          1.49f,     0.83f,     1.0f,
          0.050003f, 0.007f,    { 0.0f, 0.0f, 0.0f },
          1.258925f, 0.011f,    { 0.0f, 0.0f, 0.0f },
          0.25f,     0.0f,      0.25f,
          0.0f,      0.994260f, 5000.0f,
          250.0f,    0.0f,      1 },
        { "Padded cell", 0.171500f, 1.0f,
          0.316228f,     0.001f,    1.0f,
          0.17f,         0.10f,     1.0f,
          0.250035f,     0.001f,    { 0.0f, 0.0f, 0.0f },
          1.269112f,     0.002f,    { 0.0f, 0.0f, 0.0f },
          0.25f,         0.0f,      0.25f,
          0.0f,          0.994260f, 5000.0f,
          250.0f,        0.0f,      1 },
        { "Room",    0.428687f, 1.0f,
          0.316228f, 0.592925f, 1.0f,
          0.40f,     0.83f,     1.0f,
          0.150314f, 0.002f,    { 0.0f, 0.0f, 0.0f },
          1.062919f, 0.003f,    { 0.0f, 0.0f, 0.0f },
          0.25f,     0.0f,      0.25f,
          0.0f,      0.994260f, 5000.0f,
          250.0f,    0.0f,      1 },
        { "Bathroom", 0.171500f, 1.0f,
          0.316228f,  0.251189f, 1.0f,
          1.49f,      0.54f,     1.0f,
          0.653131f,  0.007f,    { 0.0f, 0.0f, 0.0f },
          3.273407f,  0.011f,    { 0.0f, 0.0f, 0.0f },
          0.25f,      0.0f,      0.25f,
          0.0f,       0.994260f, 5000.0f,
          250.0f,     0.0f,      1 },
        { "Living room", 0.976563f, 1.0f,
          0.316228f,     0.001f,    1.0f,
          0.50f,         0.10f,     1.0f,
          0.205116f,     0.003f,    { 0.0f, 0.0f, 0.0f },
          0.280543f,     0.004f,    { 0.0f, 0.0f, 0.0f },
          0.25f,         0.0f,      0.25f,
          0.0f,          0.994260f, 5000.0f,
          250.0f,        0.0f,      1 },
        { "Stone room", 1.0f,      1.0f,
          0.316228f,    0.707946f, 1.0f,
          2.31f,        0.64f,     1.0f,
          0.441062f,    0.012f,    { 0.0f, 0.0f, 0.0f },
          1.100272f,    0.017f,    { 0.0f, 0.0f, 0.0f },
          0.25f,        0.0f,      0.25f,
          0.0f,         0.994260f, 5000.0f,
          250.0f,       0.0f,      1 },
        { "Auditorium", 1.0f,      1.0f,
          0.316228f,    0.578096f, 1.0f,
          4.32f,        0.59f,     1.0f,
          0.403181f,    0.02f,     { 0.0f, 0.0f, 0.0f },
          0.716968f,    0.03f,     { 0.0f, 0.0f, 0.0f },
          0.25f,        0.0f,      0.25f,
          0.0f,         0.994260f, 5000.0f,
          250.0f,       0.0f,      1 },
        { "Concert hall", 1.0f,      1.0f,
          0.316228f,      0.562341f, 1.0f,
          3.92f,          0.70f,     1.0f,
          0.242661f,      0.02f,     { 0.0f, 0.0f, 0.0f },
          0.997700f,      0.029f,    { 0.0f, 0.0f, 0.0f },
          0.25f,          0.0f,      0.25f,
          0.0f,           0.994260f, 5000.0f,
          250.0f,         0.0f,      1 },
        { "Cave",    1.0f,      1.0f,
          0.316228f, 1.0f,      1.0f,
          2.91f,     1.30f,     1.0f,
          0.500035f, 0.015f,    { 0.0f, 0.0f, 0.0f },
          0.706318f, 0.022f,    { 0.0f, 0.0f, 0.0f },
          0.25f,     0.0f,      0.25f,
          0.0f,      0.994260f, 5000.0f,
          250.0f,    0.0f,      0 },
        { "Arena",   1.0f,      1.0f,
          0.316228f, 0.447713f, 1.0f,
          7.24f,     0.33f,     1.0f,
          0.261216f, 0.02f,     { 0.0f, 0.0f, 0.0f },
          1.018591f, 0.03f,     { 0.0f, 0.0f, 0.0f },
          0.25f,     0.0f,      0.25f,
          0.0f,      0.994260f, 5000.0f,
          250.0f,    0.0f,      1 },
        { "Hangar",  1.0f,      1.0f,
          0.316228f, 0.316228f, 1.0f,
          10.05f,    0.23f,     1.0f,
          0.500035f, 0.02f,     { 0.0f, 0.0f, 0.0f },
          1.256030f, 0.03f,     { 0.0f, 0.0f, 0.0f },
          0.25f,     0.0f,      0.25f,
          0.0f,      0.994260f, 5000.0f,
          250.0f,    0.0f,      1 },
        { "Carpeted hallway",
          ...
          0.0f,
          1 },
        { "Hallway", 0.364500f, 1.0f,
          0.316228f, 0.707946f, 1.0f,
          1.49f,     0.59f,     1.0f,
          0.245754f, 0.007f,    { 0.0f, 0.0f, 0.0f },
          1.661499f, 0.011f,    { 0.0f, 0.0f, 0.0f },
          0.25f,     0.0f,      0.25f,
          0.0f,      0.994260f, 5000.0f,
          250.0f,    0.0f,      1 },
        { "Stone corridor",
          ...
          1 },
        { "Alley",   1.0f,      0.30f,
          0.316228f, 0.732825f, 1.0f,
          1.49f,     0.86f,     1.0f,
          0.250035f, 0.007f,    { 0.0f, 0.0f, 0.0f },
          0.995405f, 0.011f,    { 0.0f, 0.0f, 0.0f },
          0.125f,    0.95f,     0.25f,
          0.0f,      0.994260f, 5000.0f,
          250.0f,    0.0f,      1 },
        { "Forest",  1.0f,      0.30f,
          0.316228f, 0.022387f, 1.0f,
          1.49f,     0.54f,     1.0f,
          0.052481f, 0.162f,    { 0.0f, 0.0f, 0.0f },
          0.768245f, 0.088f,    { 0.0f, 0.0f, 0.0f },
          0.125f,    1.0f,      0.25f,
          0.0f,      0.994260f, 5000.0f,
          250.0f,    0.0f,      1 },
        { "City",    1.0f,      0.50f,
          0.316228f, 0.398107f, 1.0f,
          1.49f,     0.67f,     1.0f,
          0.073030f, 0.007f,    { 0.0f, 0.0f, 0.0f },
          0.142725f, 0.011f,    { 0.0f, 0.0f, 0.0f },
          0.25f,     0.0f,      0.25f,
          0.0f,      0.994260f, 5000.0f,
          250.0f,    0.0f,      1 },
        { "Mountains", 1.0f,      0.27f,
          0.316228f,   0.056234f, 1.0f,
          1.49f,       0.21f,     1.0f,
          0.040738f,   0.30f,     { 0.0f, 0.0f, 0.0f },
          0.191867f,   0.10f,     { 0.0f, 0.0f, 0.0f },
          0.25f,       1.0f,      0.25f,
          0.0f,        0.994260f, 5000.0f,
          250.0f,      0.0f,      0 },
        { "Quarry",  1.0f,      1.0f,
          0.316228f, 0.316228f, 1.0f,
          1.49f,     0.83f,     1.0f,
          0.0f,      0.061f,    { 0.0f, 0.0f, 0.0f },
          1.778279f, 0.025f,    { 0.0f, 0.0f, 0.0f },
          0.125f,    0.70f,     0.25f,
          0.0f,      0.994260f, 5000.0f,
          250.0f,    0.0f,      1 },
        { "Plain",   1.0f,      0.21f,
          0.316228f, 0.10f,     1.0f,
          1.49f,     0.50f,     1.0f,
          0.058479f, 0.179f,    { 0.0f, 0.0f, 0.0f },
          0.108893f, 0.10f,     { 0.0f, 0.0f, 0.0f },
          0.25f,     1.0f,      0.25f,
          0.0f,      0.994260f, 5000.0f,
          250.0f,    0.0f,      1 },
        { "Parking lot", 1.0f,      1.0f,
          0.316228f,     1.0f,      1.0f,
          1.65f,         1.50f,     1.0f,
          0.208209f,     0.008f,    { 0.0f, 0.0f, 0.0f },
          0.265155f,     0.012f,    { 0.0f, 0.0f, 0.0f },
          0.25f,         0.0f,      0.25f,
          0.0f,          0.994260f, 5000.0f,
          250.0f,        0.0f,      0 },
        { "Sewer pipe", 0.307063f, 0.80f,
          0.316228f,    0.316228f, 1.0f,
          2.81f,        0.14f,     1.0f,
          1.638702f,    0.014f,    { 0.0f, 0.0f, 0.0f },
          3.247133f,    0.021f,    { 0.0f, 0.0f, 0.0f },
          0.25f,        0.0f,      0.25f,
          0.0f,         0.994260f, 5000.0f,
          250.0f,       0.0f,      1 },
        { "Underwater", 0.364500f, 1.0f,
          0.316228f,    0.01f,     1.0f,
          1.49f,        0.10f,     1.0f,
          0.596348f,    0.007f,    { 0.0f, 0.0f, 0.0f },
          7.079458f,    0.011f,    { 0.0f, 0.0f, 0.0f },
          0.25f,        0.0f,      1.18f,
          0.348f,       0.994260f, 5000.0f,
          250.0f,       0.0f,      1 },
        { "Drugged", 0.428687f, 0.50f,
          0.316228f, 1.0f,      1.0f,
          8.39f,     1.39f,     1.0f,
          0.875992f, 0.002f,    { 0.0f, 0.0f, 0.0f },
          3.108136f, 0.03f,     { 0.0f, 0.0f, 0.0f },
          0.25f,     0.0f,      0.25f,
          1.0f,      0.994260f, 5000.0f,
          250.0f,    0.0f,      0 },
        { "Dizzy",   0.364500f, 0.60f,
          0.316228f, 0.630957f, 1.0f,
          17.23f,    0.56f,     1.0f,
          0.139155f, 0.02f,     { 0.0f, 0.0f, 0.0f },
          0.493742f, 0.03f,     { 0.0f, 0.0f, 0.0f },
          0.25f,     1.0f,      0.81f,
          0.31f,     0.994260f, 5000.0f,
          250.0f,    0.0f,      0 },
        { "Psychotic", 0.062500f, 0.50f,
          0.316228f,   0.840427f, 1.0f,
          7.56f,       0.91f,     1.0f,
          0.486407f,   0.02f,     { 0.0f, 0.0f, 0.0f },
          2.437811f,   0.03f,     { 0.0f, 0.0f, 0.0f },
          0.25f,       0.0f,      4.00f,
          1.0f,        0.994260f, 5000.0f,
          250.0f,      0.0f,      0 }
    };
...
typedef ALvoid (AL_APIENTRY* ALAUXILIARYEFFECTSLOTFV) (
...
static void* al_load_function (const char* func_name) {
    ...
    if (!func) { throw std::runtime_error (func_name); }
    return func;
}

static void al_efx_load_preset (size_t presetid) {
    if (!Ds_eax_inited) { return; }

    if (presetid >= EFX_presets.size ()) { return; }

    EFXREVERBPROPERTIES* prop = &EFX_presets[presetid];

    OpenAL_ErrorPrint (
        v_alEffectf (AL_EFX_effect_id, AL_EAXREVERB_DENSITY, prop->flDensity));
    OpenAL_ErrorPrint (v_alEffectf (
        AL_EFX_effect_id, AL_EAXREVERB_DIFFUSION, prop->flDiffusion));
    OpenAL_ErrorPrint (
        v_alEffectf (AL_EFX_effect_id, AL_EAXREVERB_GAIN, prop->flGain));
    OpenAL_ErrorPrint (
        v_alEffectf (AL_EFX_effect_id, AL_EAXREVERB_GAINHF, prop->flGainHF));
    OpenAL_ErrorPrint (
        v_alEffectf (AL_EFX_effect_id, AL_EAXREVERB_GAINLF, prop->flGainLF));
    OpenAL_ErrorPrint (v_alEffectf (
        AL_EFX_effect_id, AL_EAXREVERB_DECAY_TIME, prop->flDecayTime));
    OpenAL_ErrorPrint (v_alEffectf (
        AL_EFX_effect_id, AL_EAXREVERB_DECAY_HFRATIO, prop->flDecayHFRatio));
    OpenAL_ErrorPrint (v_alEffectf (
        AL_EFX_effect_id, AL_EAXREVERB_DECAY_LFRATIO, prop->flDecayLFRatio));
    OpenAL_ErrorPrint (v_alEffectf (
        AL_EFX_effect_id, AL_EAXREVERB_REFLECTIONS_GAIN,
        prop->flReflectionsGain));
    OpenAL_ErrorPrint (v_alEffectf (
        AL_EFX_effect_id, AL_EAXREVERB_REFLECTIONS_DELAY,
        prop->flReflectionsDelay));
    OpenAL_ErrorPrint (v_alEffectfv (
        AL_EFX_effect_id, AL_EAXREVERB_REFLECTIONS_PAN,
        prop->flReflectionsPan));
    OpenAL_ErrorPrint (v_alEffectf (
        AL_EFX_effect_id, AL_EAXREVERB_LATE_REVERB_GAIN,
        prop->flLateReverbGain));
    OpenAL_ErrorPrint (v_alEffectf (
        AL_EFX_effect_id, AL_EAXREVERB_LATE_REVERB_DELAY,
        prop->flLateReverbDelay));
    OpenAL_ErrorPrint (v_alEffectfv (
        AL_EFX_effect_id, AL_EAXREVERB_LATE_REVERB_PAN,
        prop->flLateReverbPan));
    OpenAL_ErrorPrint (v_alEffectf (
        AL_EFX_effect_id, AL_EAXREVERB_ECHO_TIME, prop->flEchoTime));
    OpenAL_ErrorPrint (v_alEffectf (
        AL_EFX_effect_id, AL_EAXREVERB_ECHO_DEPTH, prop->flEchoDepth));
    OpenAL_ErrorPrint (v_alEffectf (
        AL_EFX_effect_id, AL_EAXREVERB_MODULATION_TIME,
        prop->flModulationTime));
    OpenAL_ErrorPrint (v_alEffectf (
        AL_EFX_effect_id, AL_EAXREVERB_MODULATION_DEPTH,
        prop->flModulationDepth));
    OpenAL_ErrorPrint (v_alEffectf (
        AL_EFX_effect_id, AL_EAXREVERB_AIR_ABSORPTION_GAINHF,
        prop->flAirAbsorptionGainHF));
    OpenAL_ErrorPrint (v_alEffectf (
        AL_EFX_effect_id, AL_EAXREVERB_HFREFERENCE, prop->flHFReference));
    OpenAL_ErrorPrint (v_alEffectf (
        AL_EFX_effect_id, AL_EAXREVERB_LFREFERENCE, prop->flLFReference));
    OpenAL_ErrorPrint (v_alEffectf (
        AL_EFX_effect_id, AL_EAXREVERB_ROOM_ROLLOFF_FACTOR,
        prop->flRoomRolloffFactor));
    OpenAL_ErrorPrint (v_alEffecti (
        AL_EFX_effect_id, AL_EAXREVERB_DECAY_HFLIMIT, prop->iDecayHFLimit));
...
int ds_get_sid () {
    ...
    for (i = 0; i < sound_buffers.size (); i++) {
        if (sound_buffers[i].buf_id == 0) { return (int)i; }
    }
...
int ds_load_buffer (int* sid, int /*flags*/, ffmpeg::WaveFile* file) {
    ...
    *sid = ds_get_sid ();
    ...
    if (format == AL_INVALID_VALUE) { return -1; }

    std::vector< uint8_t > audio_buffer;
    audio_buffer.reserve (size);

    std::vector< uint8_t > buffer (
        file->getSampleRate () * file->getSampleByteSize ());
    int read;
    while ((read = file->Read (&buffer[0], buffer.size ())) >= 0) {
        if (read == 0) {
            ...
            audio_buffer.insert (
                audio_buffer.end (), buffer.begin (),
                std::next (buffer.begin (), read));
        }
    }

    Snd_sram += audio_buffer.size ();

    OpenAL_ErrorCheck (alBufferData (
                           pi, format, audio_buffer.data (),
                           (ALsizei)audio_buffer.size (), frequency),
                       return -1;);
...
int ds_init () {
    ...
    // make sure we can actually use AL_BYTE_LOKI (Mac/Win OpenAL doesn't have
    // it)
...
void ds_close_channel (int i) {
    ...
    if ((Channels[i].source_id != 0) && alIsSource (Channels[i].source_id)) {
        ...
        if (Ds_eax_inited) {
            OpenAL_ErrorPrint (alSource3i (
                Channels[i].source_id, AL_AUXILIARY_SEND_FILTER,
...
void ds_close_all_channels () {
    ...
    for (i = 0; i < MAX_CHANNELS; i++) { ds_close_channel (i); }
}
...
void ds_unload_buffer (int sid) {
    if ((sid < 0) || ((size_t)sid >= sound_buffers.size ())) { return; }
...
void ds_close_buffers () {
    ...
    for (i = 0; i < sound_buffers.size (); i++) { ds_unload_buffer ((int)i); }
...
/**
 * Find a free channel to play a sound on.  If no free channels exists, free up
 * one based on volume levels. This is the original retail version of
 * ds_get_free_channel().
 *
...
int ds_get_free_channel_retail (float new_volume, int snd_id, int priority) {
    ...
    switch (priority) {
    case DS_MUST_PLAY: limit = 100; break;

    case DS_LIMIT_ONE: limit = 1; break;

    case DS_LIMIT_TWO: limit = 2; break;
    ...
    for (i = 0; i < MAX_CHANNELS; i++) {
        ...
        if (chp->source_id == 0) {
            if (first_free_channel == -1) { first_free_channel = i; }
            continue;
        }
        ...
        OpenAL_ErrorCheck (
            alGetSourcei (chp->source_id, AL_SOURCE_STATE, &status), continue);
        ...
        if ((status == AL_INITIAL) || (status == AL_STOPPED)) {
            ...
            if (chp->snd_id == snd_id) {
                instance_count++;
                if ((chp->vol < lowest_instance_vol) &&
                    (chp->looping == FALSE)) {
    ...
    // If we've exceeded the limit, then maybe stop the duplicate if it is
    // lower volume
    if ((instance_count >= limit) && (lowest_instance_vol_index >= 0)) {
        // If there is a lower volume duplicate, stop it.... otherwise, don't
        // play the sound
        ...
        // there is no limit barrier to play the sound, but we have run out of
        // channels stop the lowest volume instance to play our sound if
        // priority demands it
        if ((lowest_vol_index != -1) && (priority == DS_MUST_PLAY)) {
            // Check if the lowest volume playing is less than the volume of
            // the requested sound. If so, then we are going to trash the
            // lowest volume sound.
    ...
    if ((first_free_channel >= 0) &&
        (Channels[first_free_channel].source_id == 0)) {
        OpenAL_ErrorCheck (
...
/**
 * Find a free channel to play a sound on.  If no free channels exists, free up
 * one based on priority and volume levels. Special version for enhanced mode.
 *
 * @param new_volume Volume for sound to play at
 * @param snd_id Which kind of sound to play
 * @param enhanced_priority Priority level, see EnhancedSoundPriority enum in
 * gamesnd.h
 ...
 * NOTE: snd_id is needed since we limit the number of concurrent samples
 */
int ds_get_free_channel_enhanced (
    float new_volume, int snd_id, int enhanced_priority,
            ...
            if (chp->snd_id == snd_id) {
                ...
                if ((chp->looping == FALSE) && !chp->is_ambient) {
                    if (chp->priority > least_important_instance_priority) {
                        ...
                        (chp->priority == least_important_instance_priority) &&
                ...
                chp->is_voice_msg || (chp->looping == TRUE) ||
                chp->is_ambient) {
                // a playing voice message, looping sound, or ambient sound is
                // not allowed to be preempted.
            }
                ...
                (chp->priority == least_important_priority) &&
                (chp->vol < least_important_vol)) {
                least_important_index = i;
                least_important_vol = chp->vol;
                least_important_priority = chp->priority;
            }
    ...
    // If we've exceeded the limit, then stop the least important duplicate if
    // it is lower or equal volume otherwise, don't play the sound
    if (((unsigned int)instance_count >= enhanced_limit) &&
        (least_important_instance_index >= 0)) {
        if (least_important_instance_vol <= new_volume) {
            ...
            // don't exceed per-sound concurrency limits, even if there are
            // spare channels
            first_free_channel = -1;
        }
    }
        ...
        // attempt to stop the least important sound to play our sound if
        // priority demands it
        if ((least_important_index != -1)) {
            // Check if the priority difference is great enough (must play or
            // at least 2 levels away) and if the least important sound's
            // volume playing is less than or equal to the volume of the
            // requested sound. If so, then we are going to trash the least
            // important sound.
            if ((enhanced_priority == SND_ENHANCED_PRIORITY_MUST_PLAY) ||
                (Channels[least_important_index].priority -
                     enhanced_priority >=
                 2)) {
...
/**
 * Find a free channel to play a sound on.  If no free channels exists, free up
 * one based on volume levels. This is the new generic version of
 * ds_get_free_channel().
 *
 * @param new_volume Volume for sound to play at
 * @param snd_id Which kind of sound to play
 * @param priority From retail :DS_MUST_PLAY, ::DS_LIMIT_ONE, ::DS_LIMIT_TWO,
 * ::DS_LIMIT_THREE
 ...
 * NOTE: snd_id is needed since we limit the number of concurrent samples
 */
int ds_get_free_channel (
    float volume, int snd_id, int priority, int& enhanced_priority,
    ...
    if (!Cmdline_no_enhanced_sound) {
        ...
        // exception: if retail priority is must play, we assume it's for a
        // good reason and thus follow suit with enhanced sound
        if (priority == DS_MUST_PLAY) {
            enhanced_priority = SND_ENHANCED_PRIORITY_MUST_PLAY;
        }

        first_free_channel = ds_get_free_channel_enhanced (
            volume, snd_id, enhanced_priority, enhanced_limit);
    }
    else { // enhanced sound is off
        first_free_channel =
            ds_get_free_channel_retail (volume, snd_id, priority);
    }
 ...
 */
int ds_create_buffer (
    int frequency, int bits_per_sample, int nchannels, int nseconds) {
    ALuint i;
    int sid;
    ...
    sound_buffers[sid].nbytes =
        nseconds * (bits_per_sample / 8) * nchannels * frequency;
...
int ds_lock_data (int sid, unsigned char* data, int size) {
    if ((sid < 0) || ((size_t)sid >= sound_buffers.size ())) { return -1; }

    ALenum format = openal_get_format (
        sound_buffers[sid].bits_per_sample, sound_buffers[sid].nchannels);
    ...
    OpenAL_ErrorCheck (
        alBufferData (
            sound_buffers[sid].buf_id, format, data, size,
            sound_buffers[sid].frequency),
        return -1);
...
/**
 * Play a sound without the usual baggage (used for playing back real-time
 * voice)
 *
...
int ds_play_easy (int sid, float volume) {
    ...
    int ch_idx = -1;
    if (!Cmdline_no_enhanced_sound) {
        ds_get_free_channel_enhanced (
            volume, -1, SND_ENHANCED_PRIORITY_MUST_PLAY,
            SND_ENHANCED_MAX_LIMIT);
    }
    else {
    ...
    if (Channels[ch_idx].sid != sid) {
        ...
        OpenAL_ErrorCheck (
            alSourcei (source_id, AL_BUFFER, buffer_id), return -1);
    }
    ...
    OpenAL_ErrorPrint (alSource3f (
        Channels[ch_idx].source_id, AL_POSITION, 0.0f, 0.0f, 0.0f));
    OpenAL_ErrorPrint (alSource3f (
        Channels[ch_idx].source_id, AL_VELOCITY, 0.0f, 0.0f, 0.0f));
 ...
 *
 * @return 1 if sound effect could not be started, >=0 sig for sound effect
 * successfully started
 */
ds_sound_handle ds_play (
    int sid, int snd_id, int priority,
    const EnhancedSoundData* enhanced_sound_data, float volume, float pan,
    int looping, bool is_voice_msg) {
    int ch_idx;
    int enhanced_priority = SND_ENHANCED_PRIORITY_INVALID;

    if (!ds_initialized) { return ds_sound_handle::invalid (); }

    ch_idx = ds_get_free_channel (
        volume, snd_id, priority, enhanced_priority, *enhanced_sound_data);

    if (ch_idx < 0) { return ds_sound_handle::invalid (); }
    ...
    if (pan) {
        OpenAL_ErrorPrint (alSource3f (
            Channels[ch_idx].source_id, AL_POSITION, pan, 0.0f, 1.0f));
    }
    else {
        OpenAL_ErrorPrint (alSource3f (
            Channels[ch_idx].source_id, AL_POSITION, 0.0f, 0.0f, 0.0f));
    ...
    OpenAL_ErrorPrint (
        alSourcef (Channels[ch_idx].source_id, AL_GAIN, volume));

    ALint status;
    OpenAL_ErrorCheck (
        alGetSourcei (Channels[ch_idx].source_id, AL_SOURCE_STATE, &status),
        return ds_sound_handle::invalid ());
    ...
    OpenAL_ErrorCheck (
        alSourcei (
            Channels[ch_idx].source_id, AL_BUFFER, sound_buffers[sid].buf_id),
        return ds_sound_handle::invalid ());

    OpenAL_ErrorPrint (
        alSourcei (Channels[ch_idx].source_id, AL_SOURCE_RELATIVE, AL_TRUE));

    OpenAL_ErrorPrint (alSourcei (
        Channels[ch_idx].source_id, AL_LOOPING,
        (looping) ? AL_TRUE : AL_FALSE));

    if (Ds_eax_inited) {
        OpenAL_ErrorPrint (alSource3i (
            Channels[ch_idx].source_id, AL_AUXILIARY_SEND_FILTER,
            AL_EFX_aux_id, 0, AL_FILTER_NULL));
    }
    ...
    if (channel_next_sig < 0) { channel_next_sig = 1; }
...
int ds_get_channel (ds_sound_handle sig) {
    ...
    for (i = 0; i < MAX_CHANNELS; i++) {
        if (Channels[i].source_id && (Channels[i].sig == sig)) {
            if (ds_is_channel_playing (i) == TRUE) { return i; }
        }
    }
...
int ds_is_channel_playing (int channel_id) {
    if (Channels[channel_id].source_id != 0) {
        ...
        OpenAL_ErrorPrint (alGetSourcei (
            Channels[channel_id].source_id, AL_SOURCE_STATE, &status));
...
/**
 * @brief Set the volume for a channel.  The volume is expected to be in linear
 * scale
 * @details If the sound is a 3D sound buffer, this is like re-establishing the
 * maximum volume.
 */
...
void ds_set_pan (int channel_id, float pan) {
    ...
    OpenAL_ErrorCheck (
        alGetSourcei (Channels[channel_id].source_id, AL_SOURCE_STATE, &state),
        return );

    if (state == AL_PLAYING) {
        // OpenAL_ErrorPrint( alSourcei(Channels[channel_id].source_id,
        // AL_SOURCE_RELATIVE, AL_TRUE) );
        OpenAL_ErrorPrint (alSource3f (
            Channels[channel_id].source_id, AL_POSITION, pan, 0.0f, 1.0f));
    }
}
...
float ds_get_pitch (int channel_id) {
    ...
    if ((channel_id < 0) || (channel_id >= MAX_CHANNELS)) { return -1; }
    ...
    if (status == AL_PLAYING) {
        OpenAL_ErrorPrint (
            alGetSourcef (Channels[channel_id].source_id, AL_PITCH, &alpitch));
    }
...
void ds_set_pitch (int channel_id, float pitch) {
    ...
    if (status == AL_PLAYING) {
        OpenAL_ErrorPrint (
            alSourcef (Channels[channel_id].source_id, AL_PITCH, pitch));
    }
}
 ...
 */
ds_sound_handle ds3d_play (
    int sid, int snd_id, vec3d* pos, vec3d* vel, float min, float max,
    int looping, float max_volume, float estimated_vol,
    const EnhancedSoundData* enhanced_sound_data, int priority,
    bool is_ambient) {
    int channel_id;
    int enhanced_priority = SND_ENHANCED_PRIORITY_INVALID;
    ...
    channel_id = ds_get_free_channel (
        estimated_vol, snd_id, priority, enhanced_priority,
        *enhanced_sound_data);

    if (channel_id < 0) { return ds_sound_handle::invalid (); }
    ...
    OpenAL_ErrorPrint (
        alSourcef (Channels[channel_id].source_id, AL_PITCH, 1.0f));

    OpenAL_ErrorPrint (
        alSourcef (Channels[channel_id].source_id, AL_GAIN, max_volume));
    ...
    OpenAL_ErrorCheck (
        alSourcei (
            Channels[channel_id].source_id, AL_BUFFER,
            sound_buffers[sid].buf_id),
        return ds_sound_handle::invalid ());

    if (Ds_eax_inited) {
        OpenAL_ErrorPrint (alSource3i (
            Channels[channel_id].source_id, AL_AUXILIARY_SEND_FILTER,
            AL_EFX_aux_id, 0, AL_FILTER_NULL));
    }

    OpenAL_ErrorPrint (alSourcei (
        Channels[channel_id].source_id, AL_SOURCE_RELATIVE, AL_FALSE));

    OpenAL_ErrorPrint (alSourcei (
        Channels[channel_id].source_id, AL_LOOPING,
        (looping) ? AL_TRUE : AL_FALSE));
...
void ds_set_position (int channel_id, unsigned int offset) {
    ...
    OpenAL_ErrorPrint (
        alSourcei (Channels[channel_id].source_id, AL_BYTE_OFFSET, offset));
}
...
unsigned int ds_get_play_position (int channel_id) {
    ...
    if (AL_play_position) {
        OpenAL_ErrorPrint (
            alGetSourcei (Channels[channel_id].source_id, AL_BYTE_LOKI, &pos));
        ...
        if (pos < 0) { pos = 0; }
            ...
            OpenAL_ErrorCheck (
                alGetBufferi (buf_id, AL_SIZE, &size), return 0);
        ...
        OpenAL_ErrorPrint (alGetSourcei (
            Channels[channel_id].source_id, AL_BYTE_OFFSET, &pos));
 ...
 * @todo Documentation
 */
unsigned int ds_get_write_position (int /*channel_id*/) { return 0; }
...
int ds_get_number_channels () {
    ...
    if (!ds_initialized) { return 0; }

    n = 0;
    for (i = 0; i < MAX_CHANNELS; i++) {
        if (Channels[i].source_id) {
            if (ds_is_channel_playing (i) == TRUE) { n++; }
        }
    }
 ...
 */
int ds_get_data (int /*sid*/, char* /*data*/) { return -1; }
...
int ds_eax_set_volume (float volume) {
    if (!Ds_eax_inited) { return -1; }

    CAP (volume, 0.0f, 1.0f);

    OpenAL_ErrorPrint (
        v_alEffectf (AL_EFX_effect_id, AL_EAXREVERB_GAIN, volume));

    OpenAL_ErrorCheck (
        v_alAuxiliaryEffectSloti (
...
int ds_eax_set_decay_time (float seconds) {
    ...
    OpenAL_ErrorPrint (
        v_alEffectf (AL_EFX_effect_id, AL_EAXREVERB_DECAY_TIME, seconds));
...
int ds_eax_set_damping (float damp) {
    ...
    OpenAL_ErrorPrint (
        v_alEffectf (AL_EFX_effect_id, AL_EAXREVERB_DECAY_HFRATIO, damp));
...
int ds_eax_set_all (unsigned long id, float vol, float damping, float decay) {
    ...
    if ((id == EAX_ENVIRONMENT_GENERIC) && (vol == 0.0f) &&
        (damping == 0.0f) && (decay == 0.0f)) {
        v_alAuxiliaryEffectSloti (
            AL_EFX_aux_id, AL_EFFECTSLOT_EFFECT, AL_EFFECT_NULL);
        Ds_active_env_idx = 0;
        Ds_active_env = false;
        return 0;
    }
    ...
    OpenAL_ErrorPrint (
        v_alEffectf (AL_EFX_effect_id, AL_EAXREVERB_DECAY_TIME, decay));
    OpenAL_ErrorPrint (
        v_alEffectf (AL_EFX_effect_id, AL_EAXREVERB_DECAY_HFRATIO, damping));
...
int ds_eax_get_all (EAX_REVERBPROPERTIES* er, int id) {
    ...
    if (id < 0) {
        if (!Ds_active_env) { return -1; }

        er->environment = Ds_active_env_idx;

        OpenAL_ErrorPrint (v_alGetEffectf (
            AL_EFX_effect_id, AL_EAXREVERB_GAIN, &er->fVolume));
        OpenAL_ErrorPrint (v_alGetEffectf (
            AL_EFX_effect_id, AL_EAXREVERB_DECAY_TIME, &er->fDecayTime_sec));
        OpenAL_ErrorPrint (v_alGetEffectf (
            AL_EFX_effect_id, AL_EAXREVERB_DECAY_HFRATIO, &er->fDamping));
    }
...
int ds_eax_init () {
    ...
    try {
        ...
        v_alGenAuxiliaryEffectSlots =
            (ALGENAUXILIARYEFFECTSLOTS)al_load_function (
                "alGenAuxiliaryEffectSlots");
        v_alDeleteAuxiliaryEffectSlots =
            (ALDELETEAUXILIARYEFFECTSLOTS)al_load_function (
                "alDeleteAuxiliaryEffectSlots");
        v_alIsAuxiliaryEffectSlot = (ALISAUXILIARYEFFECTSLOT)al_load_function (
            "alIsAuxiliaryEffectSlot");
        v_alAuxiliaryEffectSloti = (ALAUXILIARYEFFECTSLOTI)al_load_function (
            "alAuxiliaryEffectSloti");
        v_alAuxiliaryEffectSlotiv = (ALAUXILIARYEFFECTSLOTIV)al_load_function (
            "alAuxiliaryEffectSlotiv");
        v_alAuxiliaryEffectSlotf = (ALAUXILIARYEFFECTSLOTF)al_load_function (
            "alAuxiliaryEffectSlotf");
        v_alAuxiliaryEffectSlotfv = (ALAUXILIARYEFFECTSLOTFV)al_load_function (
 ...
 * @todo Documentation
 */
int ds_eax_is_inited () { return Ds_eax_inited; }
...
/**
 * @brief Given a valid channel, returns the sound signature (typically the
 * sound index)
 * @param channel_id
 * @return
 */
