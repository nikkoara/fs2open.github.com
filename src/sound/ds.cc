...
int ds_init()
{
        ...
        if (alcIsExtensionPresent(
                    ds_sound_device, (const ALchar *)"ALC_EXT_EFX")
            == AL_TRUE) {
                        ...
                        if (chp->snd_id == snd_id) {
                                ...
                                if ((chp->looping == FALSE) && !chp->is_ambient) {
                                        if (chp->priority > least_important_instance_priority) {
                                                ...
                                                (chp->priority == least_important_instance_priority) && (chp->vol < least_important_instance_vol)) {
                                                least_important_instance_vol = chp->vol;
                                                least_important_instance_priority = chp->priority;
                                                least_important_instance_index = i;
                                        }
                                ...
                                chp->is_voice_msg || (chp->looping == TRUE) || chp->is_ambient) {
                                ...
                                (chp->priority == least_important_priority) && (chp->vol < least_important_vol)) {
                                least_important_index = i;
                                least_important_vol = chp->vol;
                                least_important_priority = chp->priority;
                        }
...
int ds_eax_init()
{
        ...
        try {
                ...
                v_alGenAuxiliaryEffectSlots = (ALGENAUXILIARYEFFECTSLOTS)al_load_function(
                        "alGenAuxiliaryEffectSlots");
                v_alDeleteAuxiliaryEffectSlots = (ALDELETEAUXILIARYEFFECTSLOTS)al_load_function(
