...
int Mission_palette; // index into Nebula_palette_filenames[] of palette file
                     // to use for mission
...
// the ship arrival list will contain a list of ships that are yet to arrive.
// This list could also include ships that are part of wings!
...
// name of all ships to use while parsing a mission (since a ship might be
// referenced by something before that ship has even been loaded yet)
...
const char* Nebula_filenames[NUM_NEBULAS] = { "Nebula01", "Nebula02",
                                              "Nebula03" };

const char* Neb2_filenames[NUM_NEBULAS] = { "Nebfull01", "Nebfull02",
                                            "Nebfull03" };

// Note: Nebula_colors[] and Nebula_palette_filenames are linked via index
// numbers
...
const char* Ai_behavior_names[MAX_AI_BEHAVIORS] = {
    "Chase",    "Evade",     "Get behind", "Stay Near",  "Still",
    "Guard",    "Avoid",     "Waypoints",  "Dock",       "None",
    "Big Ship", "Path",      "Be Rearmed", "Safety",     "Evade Weapon",
    "Strafe",   "Play Dead", "Bay Emerge", "Bay Depart", "Sentry Gun",
    "Warp Out",
};
...
const char*
    Ship_class_names[MAX_SHIP_CLASSES]; // to be filled in from Ship_info array

const char* Icon_names[MIN_BRIEF_ICONS] = { "Fighter",
                                            "Fighter Wing",
                                            "Cargo",
                                            "Cargo Wing",
                                            "Largeship",
...
flag_def_list_new< Mission::Parse_Object_Flags > Parse_object_flags[] = {
    { "cargo-known", Mission::Parse_Object_Flags::SF_Cargo_known, true,
      false },
    { "ignore-count", Mission::Parse_Object_Flags::SF_Ignore_count, true,
      false },
    { "protect-ship", Mission::Parse_Object_Flags::OF_Protected, true, false },
    { "reinforcement", Mission::Parse_Object_Flags::SF_Reinforcement, true,
      false },
    { "no-shields", Mission::Parse_Object_Flags::OF_No_shields, true, false },
    { "escort", Mission::Parse_Object_Flags::SF_Escort, true, false },
    { "player-start", Mission::Parse_Object_Flags::OF_Player_start, true,
      false },
    { "no-arrival-music", Mission::Parse_Object_Flags::SF_No_arrival_music,
      true, false },
    { "no-arrival-warp", Mission::Parse_Object_Flags::SF_No_arrival_warp, true,
      false },
    { "no-departure-warp", Mission::Parse_Object_Flags::SF_No_departure_warp,
      true, false },
    { "locked", Mission::Parse_Object_Flags::SF_Locked, true, false },
    { "invulnerable", Mission::Parse_Object_Flags::OF_Invulnerable, true,
      false },
    { "hidden-from-sensors",
      Mission::Parse_Object_Flags::SF_Hidden_from_sensors, true, false },
    ...
    { "red-alert-carry",
      Mission::Parse_Object_Flags::SF_Red_alert_store_status, true, false },
    { "beam-protect-ship", Mission::Parse_Object_Flags::OF_Beam_protected,
      true, false },
    { "flak-protect-ship", Mission::Parse_Object_Flags::OF_Flak_protected,
      true, false },
    { "laser-protect-ship", Mission::Parse_Object_Flags::OF_Laser_protected,
      true, false },
    { "missile-protect-ship",
      Mission::Parse_Object_Flags::OF_Missile_protected, true, false },
    { "guardian", Mission::Parse_Object_Flags::SF_Guardian, true, false },
    { "special-warp", Mission::Parse_Object_Flags::Knossos_warp_in, true,
      false },
    ...
    { "friendly-stealth-invisible",
      Mission::Parse_Object_Flags::SF_Friendly_stealth_invis, true, false },
    { "don't-collide-invisible",
      Mission::Parse_Object_Flags::SF_Dont_collide_invis, true, false },
    { "primitive-sensors", Mission::Parse_Object_Flags::SF_Primitive_sensors,
      true, false },
    { "no-subspace-drive", Mission::Parse_Object_Flags::SF_No_subspace_drive,
      true, false },
    { "nav-carry-status", Mission::Parse_Object_Flags::SF_Nav_carry_status,
      true, false },
    { "affected-by-gravity",
      Mission::Parse_Object_Flags::SF_Affected_by_gravity, true, false },
    { "toggle-subsystem-scanning",
      Mission::Parse_Object_Flags::SF_Toggle_subsystem_scanning, true, false },
    { "targetable-as-bomb", Mission::Parse_Object_Flags::OF_Targetable_as_bomb,
      true, false },
    { "no-builtin-messages",
      Mission::Parse_Object_Flags::SF_No_builtin_messages, true, false },
    { "primaries-locked", Mission::Parse_Object_Flags::SF_Primaries_locked,
      true, false },
    { "secondaries-locked", Mission::Parse_Object_Flags::SF_Secondaries_locked,
      true, false },
    { "no-death-scream", Mission::Parse_Object_Flags::SF_No_death_scream, true,
      false },
    { "always-death-scream",
      Mission::Parse_Object_Flags::SF_Always_death_scream, true, false },
    { "nav-needslink", Mission::Parse_Object_Flags::SF_Nav_needslink, true,
      false },
    { "hide-ship-name", Mission::Parse_Object_Flags::SF_Hide_ship_name, true,
      false },
    { "set-class-dynamically",
      Mission::Parse_Object_Flags::SF_Set_class_dynamically, true, false },
    { "lock-all-turrets",
      Mission::Parse_Object_Flags::SF_Lock_all_turrets_initially, true,
      false },
    { "afterburners-locked",
      Mission::Parse_Object_Flags::SF_Afterburner_locked, true, false },
    { "force-shields-on", Mission::Parse_Object_Flags::OF_Force_shields_on,
      true, false },
    ...
    { "ship-locked", Mission::Parse_Object_Flags::SF_Ship_locked, true,
      false },
    { "weapons-locked", Mission::Parse_Object_Flags::SF_Weapons_locked, true,
      false },
    { "scramble-messages", Mission::Parse_Object_Flags::SF_Scramble_messages,
      true, false },
    { "no_collide", Mission::Parse_Object_Flags::OF_No_collide, true, false },
    { "no-disabled-self-destruct",
      Mission::Parse_Object_Flags::SF_No_disabled_self_destruct, true, false }
};

const size_t num_parse_object_flags =
    sizeof (Parse_object_flags) /
    sizeof (flag_def_list_new< Mission::Parse_Object_Flags >);

const char* Mission_event_log_flags[MAX_MISSION_EVENT_LOG_FLAGS] = {
    "true",          "false",
    "always true", // disabled
    "always false",  "first repeat", "last repeat",
    "first trigger", "last trigger", "state change",
};

// XSTR:ON

int Num_reinforcement_type_names =
    sizeof (Reinforcement_type_names) / sizeof (char*);
...
// calculates a "unique" file signature as a ushort (checksum) and an int (file
// length) the amount of The_mission we're going to checksum WARNING : do NOT
// call this function on the server - it will overwrite goals, etc
#define MISSION_CHECKSUM_SIZE \
    (NAME_LENGTH + NAME_LENGTH + 4 + DATE_TIME_LENGTH + DATE_TIME_LENGTH)
...
int mission_set_arrival_location (
    int anchor, int location, int distance, int objnum, int path_mask,
    vec3d* new_pos, matrix* new_orient);
...
void parse_object_set_handled_flag_helper (
    p_object* pobjp, p_dock_function_info* infop);
...
void parse_custom_bitmap (
    ...
    if (Fred_running && (found640) && !(found1024)) {
        mprintf (
            ("Mission: found an entry for %s but not a corresponding entry "
             "for %s!",
...
void parse_mission_info (mission* pm, bool basic = false) {
    ...
    if (pm->version != MISSION_VERSION)
        mprintf (
            ("Older mission, should update it (%.2f<-->%.2f)\n", pm->version,
             MISSION_VERSION));
    ...
    if (optional_string ("+Game Type:")) {
        // HACK HACK HACK -- stuff_string was changed to *not* ignore carriage
        // returns.  Since the old style missions may have carriage returns,
        // deal with it here.
        ignore_white_space ();
    ...
    if (optional_string ("+Game Type Flags:")) { stuff_int (&pm->game_type); }

    pm->flags.reset ();
    if (optional_string ("+Flags:")) { stuff_flagset (&pm->flags); }

    // nebula mission stuff
    Neb2_awacs = -1.0f;
    if (optional_string ("+NebAwacs:")) { stuff_float (&Neb2_awacs); }
    if (optional_string ("+Storm:")) {
        stuff_string (Mission_parse_storm_name, F_NAME, NAME_LENGTH);

        if (!basic) nebl_set_storm (Mission_parse_storm_name);
    }
    ...
    // if we are just requesting basic info then skip everything else.  the
    // reason for this is to make sure that we don't modify things outside of
    // the mission struct that might not get reset afterwards (like what can
    // happen in the techroom) - taylor
    //
    ...
    pm->support_ships.max_subsys_repair_val =
        100.0f; // ASSUMPTION: full repair capabilities
    ...
    for (int species = 0; species < (int)Species_info.size (); species++) {
        for (auto it = Ship_info.cbegin (); it != Ship_info.cend (); ++it) {
            if ((it->flags[Ship::Info_Flags::Support]) &&
                (it->species == species)) {
                pm->support_ships.support_available_for_species |=
                    (1 << species);
                break;
            }
        }
    ...
    if (optional_string ("+All Teams Attack")) { Mission_all_attack = 1; }
    else {
    ...
    if (optional_string ("+Viewer pos:")) { stuff_vec3d (&Parse_viewer_pos); }
    ...
    // multiplayer team v. team games have two teams.  If we have three teams,
    // we need to use a new mission mode!
    if ((pm->game_type & MISSION_TYPE_MULTI) &&
        (pm->game_type & MISSION_TYPE_MULTI_TEAMS)) {
        Num_teams = 2;
    }

    // Goober5000 - made this into a function since we use much the same
    // technique for the briefing background
    parse_custom_bitmap (
    ...
    if (optional_string ("$Sound Environment:")) {
        ...
        // NOTE: values will be clamped properly when the effect is actually
        // set
...
void parse_player_info2 (mission* pm) {
    ...
    for (nt = 0; nt < Num_teams; nt++) {
        ...
        total = stuff_loadout_list (
            list, MAX_SHIP_CLASSES * 4, MISSION_LOADOUT_SHIP_LIST);
        ...
        for (i = 0; i < total; i += 4) {
            // in a campaign, see if the player is allowed the ships or not.
            // Remove them from the pool if they are not allowed
            if (Game_mode & GM_CAMPAIGN_MODE || (MULTIPLAYER_CLIENT)) {
                if (!Campaign.ships_allowed[list[i]]) continue;
            }
        ...
        if (optional_string ("+Default_ship:")) {
            ...
            // see if the player's default ship is an allowable ship (campaign
            // only). If not, then what do we do?  choose the first allowable
            // one?
            if (Game_mode & GM_CAMPAIGN_MODE || (MULTIPLAYER_CLIENT)) {
                if (!(Campaign.ships_allowed[ptr->default_ship])) {
                    for (i = 0; i < static_cast< int > (Ship_info.size ());
                         i++) {
        ...
        if (ptr->default_ship ==
            -1) // invalid or not specified, make first in list
            ptr->default_ship = ptr->ship_list[0];

        required_string ("+Weaponry Pool:");
        total = stuff_loadout_list (
            list2, MAX_WEAPON_TYPES * 4, MISSION_LOADOUT_WEAPON_LIST);
        ...
        for (i = 0; i < total; i += 4) {
            // in a campaign, see if the player is allowed the weapons or not.
            // Remove them from the pool if they are not allowed
            if (Game_mode & GM_CAMPAIGN_MODE || (MULTIPLAYER_CLIENT)) {
                if (!Campaign.weapons_allowed[list2[i]]) { continue; }
            }
...
void parse_cutscenes (mission* pm) {
    ...
    if (optional_string ("#Cutscenes")) {
        ...
        while (!optional_string ("#end")) {
            ...
            scene.type = optional_string_one_of (
                6, "$Fiction Viewer Cutscene:", "$Command Brief Cutscene:",
                "$Briefing Cutscene:", "$Pre-game Cutscene:",
                "$Debriefing Cutscene:", "$Campaign End Cutscene:");

            // no more cutscenes specified?
            if (scene.type < 0) break;
...
void parse_briefing_info (mission* /*pm*/) {
    ...
    if (!optional_string ("#Briefing Info")) return;
...
void parse_music (mission* pm, int flags) {
    ...
    if (!optional_string ("#Music")) { return; }
    ...
    if (optional_string ("$Substitute Music:")) {
        stuff_string (
            pm->substitute_event_music_name, F_NAME, NAME_LENGTH, ",");
        Mp++;
        stuff_string (pm->substitute_briefing_music_name, F_NAME, NAME_LENGTH);
    }

    // Goober5000 - if the mission is being imported, the substitutes are the
    // specified tracks (with FS1 prefixes) and we generate new specified
    // tracks
    ...
    if (optional_string ("#Fiction Viewer")) {
        ...
        while (check_for_string ("$File:")) {
            ...
            if (optional_string ("$Font:"))
                stuff_string (
                    stage.font_filename, F_FILESPEC, MAX_FILENAME_LEN);

            if (optional_string ("$Voice:"))
                stuff_string (
                    stage.voice_filename, F_FILESPEC, MAX_FILENAME_LEN);

            if (optional_string ("$UI:"))
                stuff_string (stage.ui_name, F_NAME, NAME_LENGTH);

            parse_custom_bitmap (
                "$Background 640:", "$Background 1024:",
                stage.background[GR_640], stage.background[GR_1024]);
            ...
            if (strlen (stage.story_filename) > 0) {
                ...
                error_display (
                    0, "Fiction viewer story filename may not be empty!");
            }
        }
    }
}
...
void parse_cmd_brief (mission* /*pm*/) {
    ...
    while (optional_string ("$Stage Text:")) {
        ...
        stuff_string (
            Cur_cmd_brief->stage[stage].ani_filename, F_FILESPEC,
            MAX_FILENAME_LEN);
        if (optional_string ("+Wave Filename:"))
            stuff_string (
                Cur_cmd_brief->stage[stage].wave_filename, F_FILESPEC,
                MAX_FILENAME_LEN);
        else
...
void parse_cmd_briefs (mission* pm) {
    ...
    if (required_string_either ("#Command Briefing", "#Briefing")) return;
 ...
 *
 * NOTE: This updates the global Briefing struct with all the data necessary to
 * drive the briefing
 */
void parse_briefing (mission* /*pm*/, int flags) {
    ...
    // MWA -- 2/3/98.  we can now have multiple briefing and debriefings in a
    // mission
    for (nt = 0; nt < Num_teams; nt++) {
        if (!optional_string ("#Briefing")) break;
        ...
        parse_custom_bitmap (
            "$briefing_background_640:", "$briefing_background_1024:",
            bp->background[GR_640], bp->background[GR_1024]);
        parse_custom_bitmap (
            "$ship_select_background_640:", "$ship_select_background_1024:",
            bp->ship_select_background[GR_640],
            bp->ship_select_background[GR_1024]);
        parse_custom_bitmap (
            "$weapon_select_background_640:",
            "$weapon_select_background_1024:",
            bp->weapon_select_background[GR_640],
            bp->weapon_select_background[GR_1024]);
        ...
        while (required_string_either ("$end_briefing", "$start_stage")) {
            ...
            if (stage_num >= bp->num_stages) {
                error_display (
                    1,
                    "$num_stages did not match the number of specified "
                    "stages! %d stages were specified but there is at least "
                    "one more.",
                    bp->num_stages);
            }
            ...
            while (required_string_either ("$end_stage", "$start_icon")) {
                ...
                if (icon_num >= bs->num_icons) {
                    error_display (
                        1,
                        "$num_icons did not match the number of specified "
                        "icons! %d icons were specified but there is at least "
                        "one more.",
                        bs->num_icons);
                }
                ...
                // Goober5000 - import
                if (flags & MPF_IMPORT_FSM) {
                    // someone changed the jump node icon to a Knossos, so
                    // change it back
                ...
                find_and_stuff (
                    "$team:", &bi->team, F_NAME, temp_team_names, Num_iffs,
                    "team name");

                find_and_stuff (
                    "$class:", &bi->ship_class, F_NAME, Ship_class_names,
                ...
                if (optional_string ("+id:")) {
                    stuff_int (&bi->id);
                    if (bi->id >= Cur_brief_id) Cur_brief_id = bi->id + 1;
                }
                else {
                    bi->id = -1;
                ...
                stuff_int (&val);
                if (val > 0) { bi->flags |= BI_HIGHLIGHT; }

                if (optional_string ("$mirror:")) {
                    stuff_int (&val);
                    if (val > 0) { bi->flags |= BI_MIRROR_ICON; }
                }

                if (optional_string ("$use wing icon:")) {
                    stuff_int (&val);
                    if (val > 0) { bi->flags |= BI_USE_WING_ICON; }
                }
            ...
            if (icon_num != bs->num_icons) {
                error_display (
                    1,
                    "$num_icons did not match the number of specified icons! "
                    "%d icons were specified but only %d were parsed.",
                    bs->num_icons, icon_num);
            }
            icon_num = 0;
        ...
        if (stage_num != bp->num_stages) {
            error_display (
                1,
                "$num_stages did not match the number of specified icons! %d "
                "stages were specified but only %d were parsed.",
                bp->num_stages, stage_num);
        }
...
void parse_debriefing_new (mission* /*pm*/) {
    ...
    // 2/3/98 -- MWA.  We can now have multiple briefings and debriefings on a
    // team
    for (nt = 0; nt < Num_teams; nt++) {
        if (!optional_string ("#Debriefing_info")) break;
        ...
        // Yarn - use the same code as for mission loading screens
        parse_custom_bitmap (
            "$Background 640:", "$Background 1024:", db->background[GR_640],
            db->background[GR_1024]);
...
void position_ship_for_knossos_warpin (p_object* p_objp) {
    ...
    for (ship_obj* so = GET_FIRST (&Ship_obj_list);
        ...
        if (Ship_info[Ships[ship_objp->instance].ship_info_index]
            ...
            if (vm_vec_dist_quick (&ship_objp->pos, &p_objp->pos) <
                2.0f * (ship_objp->radius + objp->radius)) {
    ...
    float dist = fvi_ray_plane (
        &new_point, &knossos_objp->pos, &knossos_objp->orient.vec.fvec,
        &p_objp->pos, &p_objp->orient.vec.fvec, 0.0f);
    float desired_dist = -pm->mins.xyz.z;
    vm_vec_scale_add2 (
        &objp->pos, &objp->orient.vec.fvec, (dist - desired_dist));
...
/**
 * This is conceptually almost the same as ::obj_move_one_docked_object and is
...
void parse_dock_one_docked_object (p_object* pobjp, p_object* parent_pobjp) {
    ...
    parent_dockpoint_name =
        dock_find_dockpoint_used_by_object (parent_pobjp, pobjp);
    ...
    dockpoint = model_find_dock_name_index (
        Ship_info[Ships[objp->instance].ship_info_index].model_num,
        dockpoint_name);
    parent_dockpoint = model_find_dock_name_index (
    ...
    if ((dockpoint < 0) || (parent_dockpoint < 0)) {
        ...
        if (parent_dockpoint < 0)
            ReleaseWarning (
                ...
                parent_dockpoint_name,
                model_get (
                    Ship_info[Ships[parent_objp->instance].ship_info_index]
                        .model_num)
                    ->filename);
    ...
    // dock them
    nprintf (
        ("AI", "Initially docked: %s to parent %s\n",
...
// Goober5000
void parse_create_docked_object_helper (
    p_object* pobjp, p_dock_function_info* infop) {
    // create the object
    ...
    if (pobjp != infop->parameter_variables.objp_value) {
        // If an object is present at the beginning of the mission, it may not
        // have been put on the arrival list.  This is totally dependent on the
        // order the objects are parsed in the mission file because that is the
        // order in which they are created.  All the objects in a docked group
        // are created simultaneously when and only when the leader is created.
...
int parse_create_object (p_object* pobjp) {
    ...
    // if this guy is part of a dock group, create the entire group, starting
    // with the leader
    if (object_is_docked (pobjp)) {
        ...
        // Just as we couldn't create the parse dock trees until we had parsed
        // them all, we can't dock the in-game objects until we have created
        // them all. :p

        // create all the objects
        dock_evaluate_all_docked_objects (
            pobjp, &dfi, parse_create_docked_object_helper);
...
/**
 * Given a stuffed p_object struct, create an object and fill in the necessary
 * fields.
...
int parse_create_object_sub (p_object* p_objp) {
    ...
    // Goober5000 - if this object is being created because he's docked to
    // something, and he's in a wing, then mark the wing as having arrived
    ...
    // Goober5000 - this is also stupid; this is in ship_set but it needs to be
    // done here because of the special hitpoints mod
    Objects[objnum].hull_strength = shipp->ship_max_hull_strength;

    shipp->respawn_priority = p_objp->respawn_priority;

    // if this is a multiplayer dogfight game, and its from a player wing, make
    // it team traitor
    ...
    if (aip->mode == AIM_SAFETY) { aip->submode = AISS_1; }
    ...
    shipp->weapons.ai_class =
        p_objp->ai_class; // Fred uses this instead of above.
    // Fixes a bug where the AI class attributes were not copied if the AI
    // class was set in the mission.
    ...
    if (Ship_info[shipp->ship_info_index].uses_team_colors &&
        !p_objp->team_color_setting.empty ())
    ...
    for (std::vector< texture_replace >::iterator tr =
        ...
        for (j = 0; j < pm->n_textures; j++) {
            ...
            if (tnum > -1)
                shipp->ship_replacement_textures[j * TM_NUM_TYPES + tnum] =
                    tr->new_texture_id;
        }
    }
    ...
    // forcing the shields on or off depending on flags -- but only if shield
    ...
    // force shields on means we have them regardless of other flags; per r5332
    // this ranks above the next check
    ...
    if (p_objp
            ->flags[Mission::Parse_Object_Flags::SF_Red_alert_store_status]) {
        if (!(Game_mode & GM_MULTIPLAYER)) {
    ...
    // set the orders that this ship will accept.  It will have already been
    // set to default from the ship create code, so only set them if the parse
    // object flags say they are unique
    ...
    // if ship is in a wing, and the wing's no_warp_effect flag is set, then
    // set the equivalent flag for the ship
    if ((shipp->wingnum != -1) &&
        (Wings[shipp->wingnum].flags[Ship::Wing_Flags::No_arrival_warp]))
        shipp->flags.set (Ship::Ship_Flags::No_arrival_warp);

    if ((shipp->wingnum != -1) &&
        (Wings[shipp->wingnum].flags[Ship::Wing_Flags::No_departure_warp]))
    ...
    // if the wing index and wing pos are set for this parse object, set them
    // for the ship.  This is useful in multiplayer when ships respawn
    shipp->wing_status_wing_index = p_objp->wing_status_wing_index;
    shipp->wing_status_wing_pos = p_objp->wing_status_wing_pos;

    // set up the ai_goals for this object -- all ships created here are AI
    // controlled.
    if (p_objp->ai_goals != -1) {
        ...
        // free the sexpression nodes only for non-wing ships.  wing code will
        // handle its own case
        if (p_objp->wingnum < 0)
            free_sexp2 (p_objp->ai_goals); // free up sexp nodes for reuse,
    ...
    // damaged (*not* 20% of max hits).  This is opposite the way that the
    // initial velocity/hull strength/shields work
    ...
    while (i--) {
            ...
            for (j = 0; j < wp->num_primary_banks; j++) {
                if (Fred_running) {
                    ...
                    Assertion (
                        ...
                        "(%s) Bank (%i) Weapon (%s)",
                        shipp->ship_name, sssp->name, j,
                        Weapon_info[wp->primary_bank_weapons[j]].name);

                    int capacity = (int)std::lround (
                        sssp->primary_ammo[j] / 100.0f *
                        sip->primary_bank_ammo_capacity[j]);
                    wp->primary_bank_ammo[j] = (int)std::lround (
                        capacity /
                        Weapon_info[wp->primary_bank_weapons[j]].cargo_size);
                }
            }
            ...
            for (j = 0; j < wp->num_secondary_banks; j++) {
                if (Fred_running) {
                    ...
                    Assertion (
                        ...
                        "Subsystem (%s) Bank (%i) Weapon (%s)",
                        shipp->ship_name, sssp->name, j,
                        Weapon_info[wp->secondary_bank_weapons[j]].name);

                    int capacity = (int)std::lround (
                        sssp->secondary_ammo[j] / 100.0f *
                        sip->secondary_bank_ammo_capacity[j]);
                    wp->secondary_bank_ammo[j] = (int)std::lround (
                        capacity /
                        Weapon_info[wp->secondary_bank_weapons[j]].cargo_size);
                }
            }
        ...
        while (ptr != END_OF_LIST (&shipp->subsys_list)) {
            // check the mission flag to possibly free all beam weapons -
            // Goober5000, taken from SEXP.CPP
            if (The_mission
                    .flags[Mission::Mission_Flags::Beam_free_all_by_default]) {
            ...
            if (shipp->flags[Ship::Ship_Flags::Lock_all_turrets_initially] ||
                ptr->system_info
                    ->flags[Model::Subsystem_Flags::Turret_locked]) {
            ...
            if (!subsystem_strcasecmp (
                ...
                if (sssp->primary_banks[0] != SUBSYS_STATUS_NO_CHANGE)
                    for (j = 0; j < MAX_SHIP_PRIMARY_BANKS; j++)
                        ptr->weapons.primary_bank_weapons[j] =
                            sssp->primary_banks[j];

                if (sssp->secondary_banks[0] != SUBSYS_STATUS_NO_CHANGE)
                    for (j = 0; j < MAX_SHIP_SECONDARY_BANKS; j++)
                        ptr->weapons.secondary_bank_weapons[j] =
                            sssp->secondary_banks[j];
                ...
                for (j = 0; j < ptr->weapons.num_primary_banks; j++) {
                    if (Fred_running) {
                        ...
                        int capacity = (int)std::lround (
                            sssp->primary_ammo[j] / 100.0f *
                            ptr->weapons.primary_bank_capacity[j]);
                        ptr->weapons.primary_bank_ammo[j] = (int)std::lround (
                            capacity /
                            Weapon_info[ptr->weapons.primary_bank_weapons[j]]
                                .cargo_size);
                    }
                ...
                for (j = 0; j < ptr->weapons.num_secondary_banks; j++) {
                    if (Fred_running) {
                        ...
                        int capacity = (int)std::lround (
                            sssp->secondary_ammo[j] / 100.0f *
                            ptr->weapons.secondary_bank_capacity[j]);
                        ptr->weapons
                            .secondary_bank_ammo[j] = (int)std::lround (
                            capacity /
                            Weapon_info[ptr->weapons.secondary_bank_weapons[j]]
                                .cargo_size);
                    }
                ...
                ptr->turret_animation_position =
                    MA_POS_NOT_SET; // model animation position is not set
    ...
    if ((Game_mode & GM_IN_MISSION) && (!Fred_running)) {
        ...
        if (shipp->hotkey != -1)
            mission_hotkey_mf_add (
                shipp->hotkey, shipp->objnum, HOTKEY_MISSION_FILE_ADDED);
        if ((shipp->wingnum != -1) && (Wings[shipp->wingnum].hotkey != -1))
            mission_hotkey_mf_add (
                Wings[shipp->wingnum].hotkey, shipp->objnum,
    ...
    // for multiplayer games, make a call to the network code to assign the
    // object signature of the newly created object.  The network host of the
    // netgame will always assign a signature to a newly created object.  The
    // network signature will get to the clients of the game in different
    // manners depending on whether or not an individual ship or a wing was
    // created.
    if (Game_mode & GM_MULTIPLAYER) {
        Objects[objnum].net_signature = p_objp->net_signature;

        // Goober5000 - for an initially docked group, only send the packet for
        // the dock leader... this is necessary so that the docked hierarchy of
        // objects can be created in the right order on the client side
        if (!object_is_docked (p_objp) ||
            (p_objp->flags[Mission::Parse_Object_Flags::SF_Dock_leader])) {
            if ((Game_mode & GM_IN_MISSION) && MULTIPLAYER_MASTER &&
                (p_objp->wingnum == -1))
                send_ship_create_packet (
                    &Objects[objnum],
...
/**
 * There are a bunch of assumptions in the code that, in FS2, the wing will be
 * created first, and then it will create its component ships.  If a wing
 * arrives because all its ships were docked to something else, these
 * assumptions are turned inside out.  So we have to sort of bootstrap the
 * creation of the wing by running a subset of the code from
...
void parse_bring_in_docked_wing (p_object* p_objp, int wingnum, int shipnum) {
    ...
    if (wingp->current_wave == 0) {
        ...
        mission_log_add_entry (
            LOG_WING_ARRIVED, wingp->name, NULL, wingp->current_wave);
...
void resolve_parse_flags (
    ...
    // P_AIF_KAMIKAZE, P_AIF_NO_DYNAMIC, and P_SF_RED_ALERT_CARRY are handled
    // in parse_create_object_sub
    ...
    if (parse_flags
            [Mission::Parse_Object_Flags::SF_Lock_all_turrets_initially])
...
void fix_old_special_explosions (p_object* p_objp, int variable_index) {
    ...
    p_objp->special_exp_damage =
        atoi (Block_variables[variable_index + DAMAGE].text);
    p_objp->special_exp_blast =
        atoi (Block_variables[variable_index + BLAST].text);
    p_objp->special_exp_inner =
        atoi (Block_variables[variable_index + INNER_RAD].text);
    p_objp->special_exp_outer =
        atoi (Block_variables[variable_index + OUTER_RAD].text);
    p_objp->use_shockwave =
        (atoi (Block_variables[variable_index + PROPAGATE].text) ? 1 : 0);
    p_objp->special_exp_shockwave_speed =
        atoi (Block_variables[variable_index + SHOCK_SPEED].text);
...
void fix_old_special_hits (p_object* p_objp, int variable_index) {
    ...
    p_objp->special_hitpoints =
        atoi (Block_variables[variable_index + HULL_STRENGTH].text);
    p_objp->special_shield =
        atoi (Block_variables[variable_index + SHIELD_STRENGTH].text);
}

p_object::p_object ()
    : next (NULL), prev (NULL), dock_list (NULL), created_object (NULL) {}

// this will be called when Parse_objects is cleared between missions and upon
// shutdown
p_object::~p_object () { dock_free_dock_list (this); }
const char* p_object::get_display_string () {
    if (has_display_string ()) { return display_name.c_str (); }
    else {
        return name;
    }
}
bool p_object::has_display_string () { return !display_name.empty (); }

/**
 * Mp points at the text of an object, which begins with the "$Name:" field.
 * Snags all object information.  Creating the ship now only happens after
 * everything has been parsed.
 *
 * @param pm Mission
 * @param flag is parameter that is used to tell what kind information we are
 * retrieving from the mission. if we are just getting player starts, then
...
int parse_object (mission* pm, int /*flag*/, p_object* p_objp) {
    ...
    // Karajorma - See if there are any alternate classes specified for this
    // ship.
    p_objp->alt_classes.clear ();
    // The alt class can either be a variable or a ship class name
    char alt_ship_class
        [TOKEN_LENGTH > NAME_LENGTH ? TOKEN_LENGTH : NAME_LENGTH];
    int is_variable;
    ...
    while (optional_string ("$Alt Ship Class:")) {
        ...
        if (is_variable) {
            new_alt_class.variable_index =
                get_index_sexp_variable_name (alt_ship_class);
            if (new_alt_class.variable_index >= 0) {
                new_alt_class.ship_class = ship_info_lookup (
                    Sexp_variables[new_alt_class.variable_index].text);
            }
            else {
    ...
    if (MULTI_DOGFIGHT &&
        (Ship_info[p_objp->ship_class].flags[Ship::Info_Flags::Support]))
        return 0;
    ...
    // static alias stuff - stupid, but it seems to be necessary
    static const char* temp_team_names[MAX_IFFS];
    for (i = 0; i < Num_iffs; i++) temp_team_names[i] = Iff_info[i].iff_name;

    find_and_stuff (
        "$Team:", &p_objp->team, F_NAME, temp_team_names, Num_iffs,
        "team name");
    ...
    find_and_stuff (
        "$AI Behavior:", &p_objp->behavior, F_NAME, Ai_behavior_names,
        Num_ai_behaviors, "AI behavior");
    p_objp->ai_goals = -1;

    if (optional_string ("+AI Class:")) {
        p_objp->ai_class = match_and_stuff (
    ...
    if (optional_string ("$AI Goals:")) p_objp->ai_goals = get_sexp_main ();
    ...
    p_objp->cargo1 = -1;
    int temp;
    find_and_stuff_or_add (
        "$Cargo 1:", &temp, F_NAME, Cargo_names, &Num_cargo, MAX_CARGO,
        "cargo");
    ...
    parse_common_object_data (
        p_objp); // get initial conditions and subsys status
    count = 0;
    while (required_string_either (
        ...
        find_and_stuff (
            ...
            Status_desc_names, Num_status_names, "Status Description");
        find_and_stuff (
            "$Status:", &p_objp->status[count], F_NAME, Status_type_names,
            Num_status_names, "Status Type");
        find_and_stuff (
            "$Target:", &p_objp->target[count], F_NAME, Status_target_names,
            Num_status_names, "Target");
        count++;
    }
    ...
    find_and_stuff (
        "$Arrival Location:", &p_objp->arrival_location, F_NAME,
        Arrival_location_names, Num_arrival_names, "Arrival Location");
    ...
    find_and_stuff (
        "$Departure Location:", &p_objp->departure_location, F_NAME,
        Departure_location_names, Num_arrival_names, "Departure Location");
    ...
    if (optional_string ("+Flags:")) {
        ...
        parse_string_flag_list (
            p_objp->flags, Parse_object_flags, num_parse_object_flags,
            &unparsed);
        if (!unparsed.empty ()) {
    ...
    if (p_objp->flags[Mission::Parse_Object_Flags::OF_Player_start]) {
        p_objp->flags.set (
            Mission::Parse_Object_Flags::SF_Cargo_known); // make cargo known
                                                          // for players
        Player_starts++;
    }
    ...
    if (p_objp->special_shield != -1) {
        ...
        p_objp->ship_max_shield_strength =
            Ship_info[p_objp->ship_class].max_shield_strength;
    }
    ...
    p_objp->max_shield_recharge =
        Ship_info[p_objp->ship_class].max_shield_recharge;
    ...
    // check the optional parameter for destroying the ship before the mission
    // starts.  If this parameter is here, then we need to destroy the ship N
    // seconds before the mission starts (for debris purposes). store the time
    // value here.  We want to create this object for sure.  Set the arrival
    // cue and arrival delay to bogus values
    ...
    // check for the optional "orders accepted" string which contains the
    // orders from the default set that this ship will actually listen to
    if (optional_string ("+Orders Accepted:")) {
        stuff_int (&p_objp->orders_accepted);
        if (p_objp->orders_accepted != -1)
            p_objp->flags.set (
                Mission::Parse_Object_Flags::SF_Use_unique_orders);
    }

    p_objp->group = 0;
    if (optional_string ("+Group:")) stuff_int (&p_objp->group);

    bool table_score = false;
    if (optional_string ("+Use Table Score:")) { table_score = true; }

    if (optional_string ("+Score:")) {
        if (!table_score) { stuff_int (&p_objp->score); }
    ...
    if (table_score) { p_objp->score = Ship_info[p_objp->ship_class].score; }

    if (optional_string ("+Assist Score Percentage:")) {
        stuff_float (&p_objp->assist_score_pct);
        // value must be a percentage
        if (p_objp->assist_score_pct < 0) { p_objp->assist_score_pct = 0; }
    ...
    p_objp->replacement_textures =
        Ship_info[p_objp->ship_class]
            .replacement_textures; // initialize our set with the ship class
                                   // set, which may be empty
    if (optional_string ("$Texture Replace:") ||
        optional_string ("$Duplicate Model Texture Replace:")) {
        texture_replace tr;
        char* p;
    ...
    // now load the textures (do this outside the parse loop because we may
    // have ship class replacements too)
    for (std::vector< texture_replace >::iterator tr =
             p_objp->replacement_textures.begin ();
         tr != p_objp->replacement_textures.end (); ++tr) {
        // load the texture
    ...
    for (i = 0; i < MAX_IFFS; i++) {
        for (j = 0; j < MAX_IFFS; j++) { p_objp->alt_iff_color[i][j] = -1; }
    }

    // for multiplayer, assign a network signature to this parse object.  Doing
    // this here will allow servers to use the signature with clients when
    // creating new ships, instead of having to pass ship names all the time
    if (Game_mode & GM_MULTIPLAYER)
        p_objp->net_signature =
            multi_assign_network_signature (MULTI_SIG_SHIP);

    // set the wing_status position to be -1 for all objects.  This will get
    // set to an appropriate value when the wing positions are finally
    // determined.
...
void mission_parse_handle_late_arrivals (p_object* p_objp) {
    ...
    if (sip->n_subsystems > 0) { subsystems = &sip->subsystems[0]; }

    // we need the model to process the texture set, so go ahead and load it
    // now
    sip->model_num = model_load (sip->pof_file, sip->n_subsystems, subsystems);
}

// Goober5000 - I split this because 1) it's clearer; and 2) initially multiple
// docked ships would have been insanely difficult otherwise
//
// Maybe create the object.
// Don't create the new ship blindly.  First, check the sexp for the arrival
// cue to determine when this ship should arrive.  If not right away, stick
// this ship onto the ship arrival list to be looked at later.  Also check to
// see if it should use the wings arrival cue.  The ship may get created later
// depending on whether or not the wing is created. Always create ships when
// FRED is running.
void mission_parse_maybe_create_parse_object (p_object* pobjp) {
    ...
    if ((object_is_docked (pobjp) &&
        ...
        // we need to deal with replacement textures now, so that texture
        // page-in will work properly
    ...
    // the ship is present at the beginning of the mission, so we create it
        ...
        int real_objnum =
            parse_create_object (pobjp); // this object may later get destroyed
                                         // depending on wing status!!!!

        // if the ship is supposed to be destroyed before the mission, then
        // blow up the ship and mark the pieces as last forever.  Only call
        // this stuff when you are blowing up the ship
        if (pobjp->destroy_before_mission_time >= 0) {
...
void parse_common_object_data (p_object* objp) {
    ...
    if (optional_string ("+Initial Hull:")) stuff_int (&objp->initial_hull);
    ...
    while (optional_string ("+Subsystem:")) {
        ...
        if (subsystem_strcasecmp (Subsys_status[i].name, NOX ("pilot"))) {
            ...
            // \"%s\" found in mission!", objp->name, sip->name,
            // Subsys_status[i].name);
        }
        ...
        if (optional_string ("+Cargo Name:")) {
            ...
            int index =
                string_lookup (cargo_name, Cargo_names, Num_cargo, "cargo", 0);
            if (index == -1) {
        ...
        if (optional_string ("+AI Class:"))
            Subsys_status[i].ai_class = match_and_stuff (
                F_NAME, Ai_class_names, Num_ai_classes, "AI class");

        if (optional_string ("+Primary Banks:"))
            stuff_int_list (
                Subsys_status[i].primary_banks, MAX_SHIP_PRIMARY_BANKS,
                WEAPON_LIST_TYPE);

        // Goober5000
        if (optional_string ("+Pbank Ammo:"))
            stuff_int_list (
                Subsys_status[i].primary_ammo, MAX_SHIP_PRIMARY_BANKS,
                RAW_INTEGER_TYPE);

        if (optional_string ("+Secondary Banks:"))
            stuff_int_list (
                Subsys_status[i].secondary_banks, MAX_SHIP_SECONDARY_BANKS,
                WEAPON_LIST_TYPE);

        if (optional_string ("+Sbank Ammo:"))
            stuff_int_list (
                Subsys_status[i].secondary_ammo, MAX_SHIP_SECONDARY_BANKS,
                RAW_INTEGER_TYPE);
    }
}

/**
 * Checks if any ships of a certain ship class are still available in the team
 * loadout
 * @return The index of the ship in team_data->ship_list if found or -1 if it
 * isn't
 */
int get_reassigned_index (team_data* current_team, int ship_class) {
    // Search through the available ships to see if there is a matching ship
    // class in the loadout
    for (int i = 0; i < current_team->num_ship_choices; i++) {
        if (ship_class == current_team->ship_list[i]) {
            if (current_team->ship_count[i] > 0) { return i; }
            else {
                return -1;
            }
        }
...
/**
 * Attempts to set the class of this ship based which ship classes still remain
 * unassigned in the ship loadout The ship class specified by the mission file
 * itself is tested first. Followed by the list of alt classes. If an alt class
 * flagged as default_to_this_class is reached the ship will be assigned to
 * that class. If the class can't be assigned because no ships of that class
 * remain the function returns false.
 */
bool is_ship_assignable (p_object* p_objp) {
    ...
    // First lets check if the ship specified in the mission file is of an
    // assignable class
    ...
    if (loadout_index != -1) {
        ...
        // Since the ship in the mission file matched one available in the
        // loadout we need go no further
        return true;
    }

    // Now we check the alt_classes (if there are any)
    for (std::vector< alt_class >::iterator pac = p_objp->alt_classes.begin ();
         pac != p_objp->alt_classes.end (); ++pac) {
        ...
        if (pac->default_to_this_class == false) {
            ...
            loadout_index =
                get_reassigned_index (data_for_team, pac->ship_class);
            if (loadout_index != -1) {
                update_loadout_totals (data_for_team, loadout_index);
                break;
            }
...
/**
 * Checks the list of Parse_objects to see if any of them should be reassigned
 * based on the number of ships of that class that were present in the loadout.
 */
void process_loadout_objects () {
    std::vector< size_t > reassignments;

    // Loop through all the Parse_objects looking for ships that should be
    // affected by the loadout code.
    ...
    // Now we go though the ships we were unable to assign earlier and reassign
    ...
    for (size_t m = 0; m < reassignments.size (); m++) {
        ...
        if (current_team->loadout_total == 0) {
            // If there is nothing left to assign we should use the ship in the
            // mission file
    ...
    while (required_string_either ("#Wings", "$Name:")) {
        ...
        if (Game_mode & GM_MULTIPLAYER) {
            if ((Multi_ping_timestamp == -1) ||
                ...
                multi_ping_send_all ();
                Multi_ping_timestamp =
                    timer_get_milliseconds () +
                    10000; // timeout is 10 seconds between pings
            }
        }
    }

    // Goober5000 - I moved the docking stuff to post_process_ships_wings
    // because of interdependencies between ships and wings.  Neither docking
    // stuff nor ship stuff (for ships present at mission start) will be valid
    // until after post_process_ships_wings is run.
...
void swap_parse_object (p_object* p_obj, int new_ship_class) {
    ...
    p_obj->ship_max_hull_strength =
        new_ship_info->max_hull_strength * hp_multiplier;

    // Shields
    // Again we have to watch out for special hitpoints but this time we can't
    // assume that there will be a shield. So first lets see if there is one.
    if ((p_obj->ship_max_shield_strength !=
         old_ship_info->max_shield_strength) &&
    ...
    // Not using special hitpoints or a class which has a shield strength of
    // zero
    else {
    ...
    // Now cycle through the primary banks looking for banks that were added or
    // removed
    for (int i = 0; i < MAX_SHIP_PRIMARY_BANKS; i++) {
        // If we're dealing with a primary bank that actually should exist on
        // this ship
        if (i < num_pbanks) {
            ...
            if (ship_subsystems->primary_banks[i] == -1) {
                ...
                ship_subsystems->primary_banks[i] =
                    new_ship_info->primary_bank_weapons[i];
            }
        }
    ...
    // Now cycle through the secondary banks looking for banks that were added
    // or removed
    for (int j = 0; j < MAX_SHIP_SECONDARY_BANKS; j++) {
        ...
        if (j < num_sbanks) {
            ...
            if (ship_subsystems->secondary_banks[j] == -1) {
                // Give the ship the default weapon for this bank.
                ship_subsystems->secondary_banks[j] =
                    new_ship_info->secondary_bank_weapons[j];
            }
        }
...
p_object* mission_parse_get_parse_object (ushort net_signature) {
    ...
    for (ii = Parse_objects.begin (); ii != Parse_objects.end (); ++ii)
        if (ii->net_signature == net_signature) return &(*ii);
...
int parse_wing_create_ships (
    ...
    if (!force) {
        ...
        // the wing.  The first time, the arrival delay will be <= 0 meaning
        // that no timer object has been set yet.  Set up the timestamp which
        ...
        // if wing is coming from docking bay, then be sure that ship we are
        // arriving from actually exists (or will exist).
        if (wingp->arrival_location == ARRIVE_FROM_DOCK_BAY) {
            ...
            if (shipnum == -1) {
                ...
                // see if ship is yet to arrive.  If so, then return 0 so we
                // can evaluate again later.
                if (mission_parse_get_arrival_ship (name)) return 0;

                // since this wing cannot arrive from this place, we need to
                // mark the wing as destroyed and set the wing variables
                // appropriately.  Good for directives.

                // set the gone flag
                wingp->flags.set (Ship::Wing_Flags::Gone);

                // mark the number of waves and number of ships destroyed equal
                // to the last wave and the number of ships yet to arrive
                num_remaining =
                ...
                if (mission_log_get_time (
                    ...
                    wingp->total_destroyed += num_remaining;
                             ...
                             LOG_SHIP_DEPARTED, name, NULL, NULL)) {
            ...
            // Goober5000 - check status of fighterbays - if they're destroyed,
            // we can't launch - but we want to reeval later
            if (ship_fighterbays_all_destroyed (&Ships[shipnum])) return 0;
        }

        if (num_to_create == 0) return 0;

        // check the wave_delay_timestamp field.  If it is not valid, make it
        // valid (based on wave delay min and max values).  If it is valid, and
        // not elapsed, then return.  If it is valid and elasped, then continue
        // on.
        if (!timestamp_valid (wingp->wave_delay_timestamp)) {
            ...
            if ((wingp->wave_delay_min > 0) || (wingp->wave_delay_max > 0)) {
                ...
                // introduced one of the most serious breaches of coding
                // standards.  I'm to lazy to fix this the correct way.  Insert
                // a delay before the next wave of the wing can arrive to that
                // clients in the game have ample time to kill off any ships in
                // the wing before the next wave arrives.
                if (Game_mode & GM_MULTIPLAYER) { time_to_arrive += 7; }
                wingp->wave_delay_timestamp =
                    timestamp (time_to_arrive * 1000);
                return 0;
            }

            // if we get here, both min and max values are 0;  See comments
            // above for a most serious hack
            time_to_arrive = 0;
            if (Game_mode & GM_MULTIPLAYER) time_to_arrive += 7;
            time_to_arrive *= 1000;
        ...
        if (!timestamp_elapsed (wingp->wave_delay_timestamp)) return 0;
    }
    ...
    // if there are no ships to create, then all ships must be player start
    // ships -- do nothing in this case.
    if (num_to_create == 0) { return 0; }

    wingp->current_wave++; // we are creating new ships
    // we need to create num_to_create ships.  Since the arrival cues for ships
    // in a wing are ignored, then *all* ships must be in the
    // Ship_arrival_list.

    objnum = -1;

    // Goober5000 - we have to do this via the array because we have no
    // guarantee we'll be able to iterate along the list (since created objects
    // plus anything they're docked to will be removed from it)
    for (std::vector< p_object >::iterator ii = Parse_objects.begin ();
         ii != Parse_objects.end (); ++ii) {
        int index;
        ai_info* aip;
        p_object* p_objp = &(*ii);

        // ensure on arrival list
        if (!parse_object_on_arrival_list (p_objp)) continue;

        // compare the wingnums.  When they are equal, we can create the ship.
        // In the case of wings that have multiple waves, this code implies
        // that we essentially creating clones of the ships that were created
        // in Fred for the wing when more ships for a new wave arrive.  The
        // threshold value of a wing can also make one of the ships in a wing
        // be "cloned" more often than other ships in the wing.  I don't think
        // this matters much.
        ...
        // when ingame joining, we need to create a specific ship out of the
        // list of ships for a wing.  specific_instance is a 0 based integer
        // which specified which ship in the wing to create.  So, only create
        // the ship we actually need to.
        if ((Game_mode & GM_MULTIPLAYER) && (specific_instance > 0)) {
            specific_instance--;
            continue;
        }
        // when not creating a specific ship, we should skip over any ships
        // that weren't carried along in the red-alert
        else if (p_objp
                     ->flags[Mission::Parse_Object_Flags::Red_alert_deleted]) {
            num_to_create--;
            num_create_save--;
            ship_add_ship_type_count (p_objp->ship_class, -1);
            wingp->red_alert_skipped_ships++;

            // clear the flag so that this parse object can be used for the
            // next wave
            p_objp->flags.remove (
                Mission::Parse_Object_Flags::Red_alert_deleted);
        ...
        // bash the ship name to be the name of the wing + some number if there
        // is > 1 wave in this wing
        wingp->total_arrived_count++;
        if (wingp->num_waves > 1)
            wing_bash_ship_name (
                p_objp->name, wingp->name,
                wingp->total_arrived_count + wingp->red_alert_skipped_ships);

        // also, if multiplayer, set the parse object's net signature to be
        // wing's net signature base + total_arrived_count (before adding 1)
        if (Game_mode & GM_MULTIPLAYER) {
            p_objp->net_signature =
                (ushort) (wingp->net_signature + wingp->total_arrived_count);
        }
        ...
        hud_wingman_status_set_index (
            wingp, &Ships[Objects[objnum].instance], p_objp);

        p_objp->wing_status_wing_index =
            Ships[Objects[objnum].instance].wing_status_wing_index;
        p_objp->wing_status_wing_pos =
            Ships[Objects[objnum].instance].wing_status_wing_pos;

        wingp->current_count++;

        // keep any player ship on the parse object list -- used for respawns
        // 5/8/98 -- MWA -- don't remove ships from the list when you are
        // ingame joining
        if (!(p_objp->flags[Mission::Parse_Object_Flags::OF_Player_start])) {
            if ((Game_mode & GM_NORMAL) ||
                ...
                if (wingp->num_waves == wingp->current_wave) {
                    ...
                    if (p_objp->ai_goals != -1) free_sexp2 (p_objp->ai_goals);
                }
            }
        }

        // flag ship with SF_FROM_PLAYER_WING if a member of player starting
        // wings
        if (MULTI_TEAM) {
        ...
        // keep track of how many ships to create.  Stop when we have done all
        // that we are supposed to do.
        num_to_create--;
        if (num_to_create == 0) break;
    }
    ...
    // a red-alert wing that arrives late), so make sure to compact the list
    ...
    for (i = 0; i < length; i++) {
        if (wingp->ship_index[i] == -1) {
            ...
            for (j = i; j < length - 1; j++) {
                ...
                if (wingp->special_ship == j + 1) wingp->special_ship--;
            }
    ...
    // possibly play some event driven music here.  Send a network packet
    // indicating the wing was created.  Only do this stuff if actually in the
    // mission.
    if ((objnum != -1) &&
        (Game_mode &
         GM_IN_MISSION)) { // if true, we have created at least one new ship.
        int it, ship_num;

        // see if this wing is a player starting wing, and if so, call the
        // maybe_add_form_goal function to possibly make the wing form on the
        // player
        for (it = 0; it < MAX_STARTING_WINGS; it++) {
            if (Starting_wings[it] == wingnum) { break; }
        }
        if (it < MAX_STARTING_WINGS) { ai_maybe_add_form_goal (wingp); }

        mission_log_add_entry (
            LOG_WING_ARRIVED, wingp->name, NULL, wingp->current_wave);
        ship_num = wingp->ship_index[0];

        if (!(Ships[ship_num].flags[Ship::Ship_Flags::No_arrival_music]) &&
            !(wingp->flags[Ship::Wing_Flags::No_arrival_music])) {
            if (timestamp_elapsed (Allow_arrival_music_timestamp)) {
                Allow_arrival_music_timestamp =
                    timestamp (ARRIVAL_MUSIC_MIN_SEPARATION);
        ...
        // if in multiplayer (and I am the host) and in the mission, send a
        // wing create command to all other players
    ...
    wingp->wave_delay_timestamp = timestamp (
        -1); // we will need to set this up properly for the next wave
...
void parse_wing (mission* pm) {
    ...
    find_and_stuff (
        "$Arrival Location:", &wingp->arrival_location, F_NAME,
        Arrival_location_names, Num_arrival_names, "Arrival Location");
    ...
    find_and_stuff (
        "$Departure Location:", &wingp->departure_location, F_NAME,
        Departure_location_names, Num_arrival_names, "Departure Location");
    ...
    wing_goals = -1;
    if (optional_string ("$AI Goals:")) wing_goals = get_sexp_main ();
    ...
    // get the wave arrival delay bounds (if present).  Used as lower and upper
    // bounds (in seconds) which determine when new waves of a wing should
    // arrive.
    ...
    // be sure to set the wave arrival timestamp of this wing to pop right away
    // so that the wing could be created if it needs to be
    ...
    // 7/13/98 -- MWA
    // error checking against the player ship wings (i.e. starting & tvt) to be
    ...
    // Get the next starting signature for this in this wing.  We want to
    // reserve wave_count * num_waves of signature.  These can be used to
    // construct wings for ingame joiners.
    if (Game_mode & GM_MULTIPLAYER) {
        int next_signature;
    ...
    for (i = 0; i < MAX_SHIPS_PER_WING; i++) wingp->ship_index[i] = -1;

    // set up the ai_goals for this wing -- all ships created from this wing
    // will inherit these goals goals for the wing are stored slightly
    // differently than for ships.  We simply store the index into the
    // sexpression array of each goal (max 10).  When a ship in this wing is
    // created, each goal in the wings goal array is given to the ship.
    if (wing_goals != -1) {
        int sexp;

        // this will assign the goals to the wings as well as to any ships in
        // the wing that have been already created.
        for (sexp = CDR (wing_goals); sexp != -1; sexp = CDR (sexp))
            ai_add_wing_goal_sexp (
                sexp, AIG_TYPE_EVENT_WING, wingnum); // used by Fred

        free_sexp2 (wing_goals); // free up sexp nodes for reuse, since they
    ...
    for (i = 0; i < wingp->wave_count; i++) {
        ...
        // Goober5000 - since the ship/wing creation stuff is reordered to
        // accommodate multiple docking, everything is still only in the parse
        // array at this point (in both FRED and FS2)
        ...
        for (std::vector< p_object >::iterator p_objp = Parse_objects.begin ();
            ...
            if (!strcmp (ship_name, p_objp->name)) {
                ...
                // Goober5000 - if this is a player start object, there
                // shouldn't be a wing arrival delay (Mantis #2678)
                if ((p_objp->flags
 ...
 * NB: between parsing and the time this function is run, the path_mask
 * variables store the index of the path info; at all other times, they store
 * the masks of the bay paths as expected
 */
void post_process_path_stuff () {
    ...
    for (std::vector< p_object >::iterator pobjp = Parse_objects.begin ();
         pobjp != Parse_objects.end (); ++pobjp) {
        resolve_path_masks (pobjp->arrival_anchor, &pobjp->arrival_path_mask);
        resolve_path_masks (
            pobjp->departure_anchor, &pobjp->departure_path_mask);
    }
    ...
    for (i = 0; i < Num_wings; i++) {
        ...
        resolve_path_masks (
            wingp->departure_anchor, &wingp->departure_path_mask);
    }
}
...
void post_process_ships_wings () {
    ...
    // Goober5000 - first, resolve the path masks.  Needs to be done first
    // because mission_parse_maybe_create_parse_object relies on it.
    post_process_path_stuff ();

    // Goober5000 - now that we've parsed all the objects, resolve the
    // initially docked references. This must be done before anything that
    // relies on the dock references but can't be done until both ships and
    // wings have been parsed.
    mission_parse_set_up_initial_docks ();

    // Goober5000 - now create all objects that we can.  This must be done
    // before any ship stuff but can't be done until the dock references are
    // resolved.  This was originally done in parse_object().
    for (std::vector< p_object >::iterator ii = Parse_objects.begin ();
         ii != Parse_objects.end (); ++ii) {
    ...
    // ----------------- Now set up the wings.  This must be done after both
    // dock stuff and ship stuff.
...
// mission events are sexpressions which cause things to happen based on the
// outcome of other events in a mission.  Essentially scripting the different
// things that can happen in a mission
...
void parse_event (mission* /*pm*/) {
    ...
    if (optional_string ("+Trigger Count:")) {
        ...
        // if we have a trigger count but no repeat count, we want the event to
        // loop until it has triggered enough times
        if (event->repeat_count == 1) { event->repeat_count = -1; }
    ...
    event->interval = -1;
    if (optional_string ("+Interval:")) { stuff_int (&(event->interval)); }

    event->score = 0;
    if (optional_string ("+Score:")) { stuff_int (&event->score); }

    if (optional_string ("+Chained:")) { stuff_int (&event->chain_delay); }
...
void parse_goal (mission* pm) {
    ...
    // backwards compatibility for old Fred missions - all new missions should
    // use $MessageNew
    ...
    goalp->flags = 0;
    if (optional_string ("+Invalid:")) goalp->type |= INVALID_GOAL;
    if (optional_string ("+Invalid")) goalp->type |= INVALID_GOAL;
    if (optional_string ("+No music")) goalp->flags |= MGF_NO_MUSIC;

    goalp->score = 0;
    if (optional_string ("+Score:")) { stuff_int (&goalp->score); }
...
void parse_waypoints_and_jumpnodes (mission* pm) {
    ...
    while (optional_string ("$Jump Node:")) {
        ...
        if (optional_string ("$Jump Node Name:") ||
            optional_string ("+Jump Node Name:")) {
...
void parse_messages (mission* pm, int flags) {
    ...
    // messages,tbl.  Make parsing a whole lot easier!!!
    ...
    mprintf (
        ("Ending mission message count : %d\n", (int)Message_waves.size ()));
}
...
void parse_reinforcement (mission* pm) {
    ...
    find_and_stuff (
        "$Type:", &ptr->type, F_NAME, Reinforcement_type_names,
        Num_reinforcement_type_names, "reinforcement type");
    ...
    // now, if the reinforcement is a wing, then set the number of waves of the
    // wing == number of uses of the reinforcement
    if (instance >= 0) { Wings[instance].num_waves = ptr->uses; }
...
void parse_one_background (background_t* background) {
    // clear here too because this function can be called from more than one
    // place
...
void parse_bitmaps (mission* pm) {
    ...
    if (pm->flags[Mission::Mission_Flags::Fullneb]) {
        ...
        if (optional_string ("+Nebula:")) {
            ...
            if (optional_string ("+Bank:")) { stuff_int (&Nebula_bank); }
            else {
                Nebula_bank = 0;
            }

            if (optional_string ("+Heading:")) { stuff_int (&Nebula_heading); }
            else {
                Nebula_heading = 0;
            }
        }
        ...
        if (Nebula_index >= 0) {
            nebula_init (
                Nebula_filenames[Nebula_index], Nebula_pitch, Nebula_bank,
                Nebula_heading);
        }
        else {
            nebula_close ();
    ...
    // Goober5000
    Num_backgrounds = 0;
    while (optional_string ("$Bitmap List:") || check_for_string ("$Sun:") ||
           check_for_string ("$Starbitmap:")) {
...
void parse_asteroid_fields (mission* pm) {
    ...
    if (!optional_string ("#Asteroid Fields")) return;
    ...
    while (required_string_either ("#", "$density:")) {
        ...
        vec3d a_rad;
        vm_vec_sub (
            &a_rad, &Asteroid_field.max_bound, &Asteroid_field.min_bound);
...
void parse_variables () {
    ...
    if (!optional_string ("#Sexp_variables")) { return; }
    else {
    ...
    for (j = 0; j < num_variables; j++) {
        ...
        for (auto& current_pv : Campaign.persistent_variables) {
            ...
            if (!strcasecmp (
                ...
                // non-eternal warn but do nothing
                if (Sexp_variables[j].type &
                    SEXP_VARIABLE_SAVE_TO_PLAYER_FILE) {
                    error_display (
                        0,
                        "Variable %s is marked eternal but has the same name "
                        "as another persistent variable. One of these should "
                    ...
                    error_display (
                        0,
                        "Variable %s has the same name as another persistent "
                        "variable. One of these should be renamed to avoid "
                        "confusion",
                        Sexp_variables[j].text);
                }
            }
    ...
    // next, see if any eternal variables are set loop through the current
    // mission's variables
    for (j = 0; j < num_variables; j++) {
        // check against existing variables
        for (i = 0; i < (int)Player->variables.size (); i++) {
            ...
            if (!strcasecmp (
                ...
                if (Sexp_variables[j].type & SEXP_VARIABLE_IS_PERSISTENT) {
                    // if the variable in the player file is marked as eternal
                    // but the version in the mission file is not, we assume
                    // that the player file one is rogue and use the one in the
                    // mission file instead.
                    if ((Player->variables[i].type &
                         SEXP_VARIABLE_SAVE_TO_PLAYER_FILE) &&
                        !(Sexp_variables[j].type &
                          SEXP_VARIABLE_SAVE_TO_PLAYER_FILE)) {
                        break;
                    }
                    ...
                    /*
                    // check that the eternal flag has been set. Players using
                    a player file from before the eternal flag was added may
                    have old player-persistent variables
                    ...
                    */
                    ...
                    error_display (
                        0,
                        "Variable %s has the same name as an eternal "
                        "variable. One of these should be renamed to avoid "
                        "confusion",
                        Sexp_variables[j].text);
                }
...
int parse_mission (mission* pm, int flags) {
    ...
    *Player_start_shipname = 0; // make the string 0 length for checking later
    ...
    if (flags & MPF_ONLY_MISSION_INFO) return 0;

    parse_plot_info (pm);
    parse_variables ();
    parse_briefing_info (pm); // TODO: obsolete code, keeping so we don't
                              // obsolete existing mission files
    parse_cutscenes (pm);
    parse_fiction (pm);
    parse_cmd_briefs (pm);
    ...
    if ((Num_unknown_ship_classes > 0) || (Num_unknown_loadout_classes > 0)) {
        ...
        if (Game_mode & GM_STANDALONE_SERVER) {
            mprintf (
                ("Warning!  Could not load %d ship classes!",
                 Num_unknown_ship_classes));
            return -2;
        }
        // don't do this in FRED; we will display a separate popup
            ...
            if (Num_unknown_ship_classes > 0) {
                sprintf (
                    text,
                    "Warning!\n\nFreeSpace was unable to find %d ship class%s "
                    "while loading this mission.  This can happen if you try "
                    "to play a %s that is incompatible with the current "
                    "mod.\n\n",
                    Num_unknown_ship_classes,
                    (Num_unknown_ship_classes > 1) ? "es" : "",
                    (Game_mode & GM_CAMPAIGN_MODE) ? "campaign" : "mission");
            }
            else {
                sprintf (
                    text,
                    "Warning!\n\nFreeSpace was unable to find %d weapon "
                    "class%s while loading this mission.  This can happen if "
                    "you try to play a %s that is incompatible with the "
                    "current mod.\n\n",
                    Num_unknown_loadout_classes,
                    (Num_unknown_loadout_classes > 1) ? "es" : "",
                    (Game_mode & GM_CAMPAIGN_MODE) ? "campaign" : "mission");
            }
            ...
            strcpy (
                text + strlen (text) - 1,
                "\".)\n\n  You can continue to load the mission, but it is "
                "quite likely that you will encounter a large number of "
                "mysterious errors.  It is recommended that you either select "
                "a ");
            strcat (
                text, (Game_mode & GM_CAMPAIGN_MODE) ? "campaign" : "mission");
            strcat (
                text,
                " that is compatible with your current mod, or else exit "
                "FreeSpace and select a different mod.\n\n");

            strcat (text, "Do you want to continue to load the mission?");

            // now display the popup
            int popup_rval = popup (
                PF_TITLE_BIG | PF_TITLE_RED, 2, POPUP_NO, POPUP_YES, text);
            if (popup_rval == 0) { return -2; }
        }
    }
...
void post_process_mission () {
    ...
    // determine if player start has initial velocity and set forward cruise
    // percent to relect this
    if (Player_obj->phys_info.vel.xyz.z > 0.0f)
        Player->ci.forward_cruise_percent = Player_obj->phys_info.vel.xyz.z /
                                            Player_ship->current_max_speed *
                                            100.0f;
    ...
    // Goober5000 - this needs to be called only once after parsing of objects
    // and wings is complete (for individual invalidation, see
    // mission_parse_mark_non_arrival)
    mission_parse_mark_non_arrivals ();

    // deal with setting up arrival location for all ships.  Must do this now
    // after all ships are created
    ...
    for (i = 0; i < Num_sexp_nodes; i++) {
        if (is_sexp_top_level (i) &&
            ...
            // entering this if statement will result in program
            // termination!!!!! print out an error based on the return value
            // from check_sexp_syntax()
            if (result) {
                std::string sexp_str;
    ...
    if (!(Game_mode & GM_MULTIPLAYER)) { ai_post_process_mission (); }

    // first we need to clear out the counts for this mission
    ship_clear_ship_type_counts ();

    // we must also count all of the ships of particular types.  We count all
    // of the ships that do not have their SF_IGNORE_COUNT flag set.  We don't
    // count ships in wings when the equivalent wing flag is set. in counting
    // ships in wings, we increment the count by the wing's wave count to
    ...
    for (so = GET_FIRST (&Ship_obj_list); so != END_OF_LIST (&Ship_obj_list);
        ...
        if (Ships[shipnum].objnum == -1 ||
            ...
            continue;
        if (Ships[shipnum].flags[Ship::Ship_Flags::Ignore_count]) continue;
        if ((Ships[shipnum].wingnum != -1) &&
            (Wings[Ships[shipnum].wingnum]
                 .flags[Ship::Wing_Flags::Ignore_count]))
            continue;
    ...
    for (p_object* p_objp = GET_FIRST (&Ship_arrival_list);
        ...
        if (p_objp->flags[Mission::Parse_Object_Flags::SF_Ignore_count])
            continue;
        if ((p_objp->wingnum != -1) &&
            (Wings[p_objp->wingnum].flags[Ship::Wing_Flags::Ignore_count]))
            continue;

        if (p_objp->wingnum == -1)
            num = 1;
        else
            num = Wings[p_objp->wingnum].num_waves -
                  1; // subtract one since we already counted the first wave

        ship_add_ship_type_count (p_objp->ship_class, num);
    }

    // set player weapons that are selected by default
    // AL 09/17/97: I added this code to select the first primary/secondary
    // weapons, since I noticed the player ship sometimes doesn't get default
    // weapons selected
    ...
    for (so = GET_FIRST (&Ship_obj_list); so != END_OF_LIST (&Ship_obj_list);
        ...
        if (!(shipp->flags[Ship::Ship_Flags::From_player_wing])) continue;
        ...
        if (swp->num_secondary_banks > 0) {
            swp->current_secondary_bank =
                0; // currently selected secondary bank
        }
    }
    ...
    if (Game_mode & GM_MULTIPLAYER) { multi_respawn_build_points (); }
...
int get_mission_info (const char* filename, mission* mission_p, bool basic) {
    ...
    if (mission_p == NULL) mission_p = &The_mission;
...
void parse_init (bool basic) {
    ...
    for (int i = 0; i < MAX_CARGO; i++)
        Cargo_names[i] =
            Cargo_names_buf[i]; // make a pointer array for compatibility
...
// us which information to get when parsing the mission.  0 means get
// everything (default).  Other flags just gets us basic info such as game
// type, number of players etc.
int parse_main (const char* mission_name, int flags) {
    ...
    do {
        ...
        if (!(flags & MPF_IMPORT_FSM)) {
            CFILE* ftemp =
                cfopen (mission_name, "rt", CFILE_NORMAL, CF_TYPE_MISSIONS);
 ...
 * @param num_to_set The threshold value for wings may have us create more
 * ships in the wing when there are still some remaining
 */
void mission_set_wing_arrival_location (wing* wingp, int num_to_set) {
    int index;
    int anchor_objnum = -1;

    // get the starting index into the ship_index array of the first ship whose
    // location we need set.
    ...
    if ((wingp->arrival_location == ARRIVE_FROM_DOCK_BAY) ||
        ...
        while (index < wingp->current_count) {
            ...
            anchor_objnum = mission_set_arrival_location (
                wingp->arrival_anchor, wingp->arrival_location,
                wingp->arrival_distance, OBJ_INDEX (objp),
                wingp->arrival_path_mask, NULL, NULL);
        ...
        // wing is not arriving from a docking bay -- possibly move them based
        // on arriving near or in front of some other ship.
        index = wingp->current_count - num_to_set;
        leader_objp = &Objects[Ships[wingp->ship_index[index]].objnum];
        anchor_objnum = mission_set_arrival_location (
            wingp->arrival_anchor, wingp->arrival_location,
            wingp->arrival_distance, OBJ_INDEX (leader_objp),
            wingp->arrival_path_mask, &pos, &orient);
        if (anchor_objnum != -1) {
            ...
            while (index < wingp->current_count) {
                ...
                // change the position of the next ships in the wing.  Use the
                // cool function in AiCode.cpp which Mike K wrote to give new
                // positions to the wing members.
                get_absolute_wing_pos (
                    &objp->pos, leader_objp, wing_index++, 0);
...
/**
 * Called after a mission is parsed to set the arrival locations of all ships
 * in the mission to the apprioriate spot.  Mainly needed because ships might
 * be in dock bays to start the mission, so their AI mode must be set
 * appropriately.
 */
void mission_parse_set_arrival_locations () {
    int i;
    ...
    for (objp = GET_FIRST (&obj_used_list);
        ...
        // if the ship is in a wing -- ignore the info and let the wing info
        // handle it
        if (shipp->wingnum != -1) continue;

        // call function to set arrival location for this ship.
        mission_set_arrival_location (
            shipp->arrival_anchor, shipp->arrival_location,
            shipp->arrival_distance, OBJ_INDEX (objp),
            shipp->arrival_path_mask, NULL, NULL);
    }

    // do the wings
    for (i = 0; i < Num_wings; i++) {
        // if wing has no ships, then don't process it.
        if (Wings[i].current_count == 0) continue;
 ...
 */
void parse_object_mark_dock_leader_helper (
    p_object* pobjp, p_dock_function_info* infop) {
    int cue_to_check;
    ...
    if (!sexp_is_locked_false (cue_to_check)) {
        ...
        if (existing_leader != NULL) {
            ...
            if (ship_class_compare (
                    pobjp->ship_class, existing_leader->ship_class) >= 0) {
                // set my arrival cue to false
                reset_arrival_to_false (pobjp, true);
                return;
            }

            // otherwise, unmark the existing leader and set his arrival cue to
            // false
            existing_leader->flags.remove (
                Mission::Parse_Object_Flags::SF_Dock_leader);
...
// Goober5000
void parse_object_clear_handled_flag_helper (
    p_object* pobjp, p_dock_function_info* /*infop*/) {
...
void parse_object_clear_all_handled_flags () {
    ...
    for (std::vector< p_object >::iterator ii = Parse_objects.begin ();
        ...
        if (!object_is_docked (pobjp)) continue;
        ...
        dock_evaluate_all_docked_objects (
            pobjp, &dfi, parse_object_clear_handled_flag_helper);
    }
}

// Goober5000
// This function iterates through the Initially_docked array and builds the
// dock trees for each parse object.  This can only be done after all objects
// and wings have been parsed.
void mission_parse_set_up_initial_docks () {
    int i;
    ...
    for (i = 0; i < Total_initially_docked; i++) {
        ...
        if (dock_check_find_direct_docked_object (docker, dockee)) continue;
    ...
    for (std::vector< p_object >::iterator ii = Parse_objects.begin ();
        ...
        dock_evaluate_all_docked_objects (
            pobjp, &dfi, parse_object_mark_dock_leader_helper);
        ...
        dock_evaluate_all_docked_objects (
            pobjp, &dfi, parse_object_set_handled_flag_helper);
    }
...
int mission_parse_is_multi (const char* filename, char* mission_name) {
    ...
    // new way of getting information.  Open the file, and just get the name
    // and the game_type flags. return the flags if a multiplayer mission
    ...
    do {
        try {
            ...
            if (skip_to_string ("+Game Type Flags:") != 1) {
                nprintf (
                    ("Network",
                     "Unable to process %s because we couldn't find +Game "
                     "Type Flags:\n",
                     filename));
                break;
            }
 ...
 *
 * We will get the name, description, and number of players for a mission.
 * Probably used for multiplayer only? The calling function can use the
 * information in The_mission to get the name/description of the mission if
 * needed.
 */
int mission_parse_get_multi_mission_info (const char* filename) {
    ...
    // return the number of parse_players.  later, we might want to include
    // (optionally?) the number of other ships in the main players wing
    // (usually wing 'alpha') for inclusion of number of players allowed.
...
/**
 * Sets the arrival location of a parse object according to the arrival
 * location of the object.
 * @return objnum of anchor ship if there is one, -1 otherwise.
 */
int mission_set_arrival_location (
    int anchor, int location, int dist, int objnum, int path_mask,
    vec3d* new_pos, matrix* new_orient) {
    ...
    if (anchor & SPECIAL_ARRIVAL_ANCHOR_FLAG) {
        ...
        // get ship
        shipnum = ship_get_random_team_ship (
            iff_get_mask (iff_index),
            get_players ? SHIP_GET_ONLY_PLAYERS : SHIP_GET_ANY_SHIP);
    }
    // if we didn't find the arrival anchor in the list of special nodes, then
    // do a ship name lookup on the anchor
    else {
    ...
    // if arriving from docking bay, then set ai mode and call function as per
    // AL's instructions.
    if (location == ARRIVE_FROM_DOCK_BAY) {
        ...
        // TODO: maybe set distance to 2x ship radius of ship appearing in
        // front of?
        if (dist <= 0) {
        ...
        // get a vector which is the ships arrival position based on the type
        // of arrival this ship should have.  Arriving near a ship we use a
        // random normalized vector scaled by the distance given by the
        // designer.  Arriving in front of a ship means entering the battle in
        // the view cone.
        if (location == ARRIVE_NEAR_SHIP) {
            ...
            if (Game_mode & GM_NORMAL) {
                ...
                // in multiplayer, use the static rand functions so that all
                // clients can get the same information.
                r1 = static_rand (Objects[objnum].net_signature) < RAND_MAX_2
                         ? -1
                         : 1;
                r2 = static_rand (Objects[objnum].net_signature + 1) <
                             RAND_MAX_2
                         ? -1
                         : 1;
            }
            ...
            vm_vec_copy_scale (
                &t1, &(Objects[anchor_objnum].orient.vec.fvec), x);
            vm_vec_copy_scale (
                &t2, &(Objects[anchor_objnum].orient.vec.rvec),
                (1.0f - x) * r1);
            vm_vec_copy_scale (
                &t3, &(Objects[anchor_objnum].orient.vec.uvec),
                (1.0f - x) * r2);
        ...
        // add in the radius of the two ships involved.  This will make the
        // ship arrive further than specified, but will appear more accurate
        // since we are pushing the edge of the model to the specified
        // distance.  large objects appears to be a lot closer without the
        // following line because the object centers were at the correct
        // distance, but the model itself was much closer to the target ship.
        dist +=
            (int)Objects[objnum].radius + (int)Objects[anchor_objnum].radius;
        vm_vec_scale_add (
            &Objects[objnum].pos, &anchor_pos, &rand_vec, (float)dist);

        // I think that we will always want to orient the ship that is arriving
        // to face towards the ship it is arriving near/in front of.  The
        // effect will be cool!
        //
        // calculate the new fvec of the ship arriving and use only that to get
        // the matrix.  isn't a big deal not getting bank.
    ...
    // set the new_pos parameter since it might be used outside the function
    // (i.e. when dealing with wings).
    if (new_pos) memcpy (new_pos, &Objects[objnum].pos, sizeof (vec3d));
    ...
    for (i = 0; i < Num_reinforcements; i++) {
        ...
        if (!strcasecmp (rp->name, name)) {
            if (!(rp->flags & RF_IS_AVAILABLE)) {
                ...
                if (MULTIPLAYER_MASTER) { send_reinforcement_avail (i); }
            }
            return;
        }
    }
...
/**
 * Takes a parse object and checks the arrival cue, delay and destruction of
 * object it is arriving from then creates the object if necessary.
 *
...
int mission_did_ship_arrive (p_object* objp) {
    ...
    // we must first check to see if this ship is a reinforcement or not.  If
    // so, then don't process
    if (objp->flags[Mission::Parse_Object_Flags::SF_Reinforcement]) {
        // if this ship did arrive, mark the reinforcement as available, and
        // tell clients if in multiplayer mode
        if (should_arrive) {
    ...
    if (should_arrive) { // has the arrival criteria been met?
        ...
        // check to see if the delay field <= 0.  if so, then create a
        // timestamp and then maybe create the object
        ...
        if (!timestamp_elapsed (objp->arrival_delay)) return -1;

        // check to see if this ship is to arrive via a docking bay.  If so,
        // and the ship to arrive from doesn't exist, don't create.
        if (objp->arrival_location == ARRIVE_FROM_DOCK_BAY) {
            ...
            shipnum = ship_name_lookup (name);
            if (shipnum == -1) {
                // see if ship is yet to arrive.  If so, then return -1 so we
                // can evaluate again later.
        ...
        if (!(Ships[Objects[object_num].instance]
                  .flags[Ship::Ship_Flags::No_arrival_music]))
            if (timestamp_elapsed (Allow_arrival_music_timestamp)) {
                Allow_arrival_music_timestamp =
                    timestamp (ARRIVAL_MUSIC_MIN_SEPARATION);
...
/**
 * Set a flag on all parse objects on ship arrival list which cannot arrive in
 * the mission
 */
void mission_parse_mark_non_arrivals () {
    for (p_object* p_objp = GET_FIRST (&Ship_arrival_list);
        ...
        if (p_objp->wingnum != -1) {
            if (!object_is_docked (p_objp) &&
                (Sexp_nodes[Wings[p_objp->wingnum].arrival_cue].value ==
                 SEXP_KNOWN_FALSE))
                p_objp->flags.set (
                    Mission::Parse_Object_Flags::SF_Cannot_arrive);
        }
        else {
...
/**
 * Deal with support ship arrival. This function can get called from either
 * single or multiplayer.  Needed to that clients can know when to abort rearm.
 *
...
void mission_parse_support_arrived (int objnum) {
    ...
    // when the support ship arrives, the shipname it is supposed to repair is
    // in the 'misc' field of the parse object.  If the ship still exists, call
    // ai function which actually issues the goal for the repair
    ...
    Ships[Objects[objnum].instance].flags.set (
        Ship::Ship_Flags::Warped_support);
...
/**
 * Check the lists of arriving ships and wings, creating new ships/wings if the
 * arrival criteria have been met
 */
void mission_eval_arrivals () {
    ...
    // before checking arrivals, check to see if we should play a message
    // concerning arrivals of other wings.  We use the timestamps to delay the
    // arrival message slightly for better effect
    if (timestamp_valid (Arrival_message_delay_timestamp) &&
        timestamp_elapsed (Arrival_message_delay_timestamp) && !MULTI_TEAM) {
        int use_terran_cmd;
        ...
        if ((rship < 0) || use_terran_cmd)
            message_send_builtin_to_player (
                MESSAGE_ARRIVE_ENEMY, NULL, MESSAGE_PRIORITY_LOW,
        ...
        Arrival_message_delay_timestamp =
            timestamp (-1); // make the stamp invalid
    }

    // check the arrival list
    // Goober5000 - we can't run through the list the usual way because we
    // might remove a bunch of objects and completely screw up the list linkage
    for (std::vector< p_object >::iterator ii = Parse_objects.begin ();
         ii != Parse_objects.end (); ++ii) {
        p_object* pobjp = &(*ii);

        // make sure we're on the arrival list
        if (!parse_object_on_arrival_list (pobjp)) continue;

        // if this object has a wing, don't create it -- let code for wings
        // determine if it should be created
        if (pobjp->wingnum >= 0) continue;
    ...
    for (i = 0; i < Num_wings; i++) {
        ...
        if (wingp->flags[Ship::Wing_Flags::Gone]) continue;

        // if we have a reinforcement wing, then don't try to create new ships
        // automatically.
        if (wingp->flags[Ship::Wing_Flags::Reinforcement]) {
            // check to see in the wings arrival cue is true, and if so, then
            // mark the reinforcement as available
        ...
        if (wingp->flags[Ship::Wing_Flags::Departing]) continue;

        // must check to see if we are at the last wave.  Code above to
        // determine when a wing is gone only gets run when a ship is destroyed
        // (not every N seconds like it used to).  Do a quick check here.
        if (wingp->current_wave == wingp->num_waves) continue;

        // If the current wave of this wing is 0, then we haven't created the
        // ships in the wing yet. If the threshold of the wing has been
        // reached, then we need to create more ships.
        if ((wingp->current_wave == 0) ||
            (wingp->current_count <= wingp->threshold)) {
            // Call parse_wing_create_ships to try and create it.  That
            // function will eval the arrival cue of the wing and create the
            // ships if necessary.
            ...
            // If this wing was a reinforcement wing, then we need to reset the
            // reinforcement flag for the wing so the user can call in another
            // set if need be.
            ...
            if (wingp->flags[Ship::Wing_Flags::No_arrival_message]) continue;
            ...
            if (MULTI_TEAM) {
                ...
                // there are two timestamps at work here.  One to control how
                // often the player receives messages about incoming hostile
                // waves, and the other to control how long after the wing
                // arrives does the player actually get the message.
                if (timestamp_elapsed (Allow_arrival_message_timestamp_m
                                           [multi_team_filter])) {
                    if (!timestamp_valid (Arrival_message_delay_timestamp_m
                                              [multi_team_filter])) {
                    ...
                    Allow_arrival_message_timestamp_m[multi_team_filter] =
                        timestamp (ARRIVAL_MESSAGE_MIN_SEPARATION);
            ...
            // does the player attack this ship?
            else if (iff_x_attacks_y (
                         Player_ship->team,
                         Ships[wingp->ship_index[0]].team)) {
                // there are two timestamps at work here.  One to control how
                // often the player receives messages about incoming hostile
                // waves, and the other to control how long after the wing
                // arrives does the player actually get the message.
                if (timestamp_elapsed (Allow_arrival_message_timestamp)) {
                    if (!timestamp_valid (Arrival_message_delay_timestamp)) {
                        Arrival_message_delay_timestamp = timestamp_rand (
                            ARRIVAL_MESSAGE_DELAY_MIN,
                            ARRIVAL_MESSAGE_DELAY_MAX);
                    }
                    Allow_arrival_message_timestamp =
                        timestamp (ARRIVAL_MESSAGE_MIN_SEPARATION);
                }
            }
            // everything else
...
/**
 * Checks the warp drive; we might be able to depart some other way (e.g. by
 * entering a docking bay)
 */
int ship_can_use_warp_drive (ship* shipp) {
    // must *have* a subspace drive
    if (shipp->flags[Ship::Ship_Flags::No_subspace_drive]) return 0;

    // navigation must work
    if (!ship_navigation_ok_to_warp (shipp)) return 0;
...
int mission_do_departure (object* objp, bool goal_is_to_warp) {
    ...
    // if our current goal is to warp, then we won't consider departing to a
    // bay, because the goal explicitly says to warp out (this sort of goal can
    // be assigned in FRED, either in the ship's initial orders or as the
    // ai-warp-out goal)
    if (goal_is_to_warp) {
        // aha, but not if we were ORDERED to depart, because the comms menu
        // ALSO uses the goal code, and yet the comms menu means any departure
        // method!
        if ((shipp->flags[Ship::Ship_Flags::Departure_ordered]) ||
            ((shipp->wingnum >= 0) &&
             (Wings[shipp->wingnum]
    ...
    if (shipp->wingnum >= 0) {
        ...
        // (needed because the bay departure code will check the ship's
        // information again later on)
    ...
    // if departing to a docking bay, try to find the anchor ship to depart to.
    // If not found, then just make it warp out like anything else.
    if (location == DEPART_AT_DOCK_BAY) {
        ...
        // see if ship is in mission.  If not, then we can assume it was
        // destroyed or departed since it is not on the arrival list (as shown
        ...
        if (!ship_useful_for_departure (
            ...
            mprintf (
                ("Anchor ship %s not suitable for departure (dying, "
                 "departing, bays destroyed, etc.).  Trying to warp...\n",
                 name));
            goto try_to_warp;
        }

        // find a path
        if (ai_acquire_depart_path (
...
try_to_warp:
    ...
    // find something else to do
        ...
        // NOTE: this point should no longer be reached in the standard goal
        // code, since the goal or comm order must be achievable for this
        // function to be called.  This point should only be reached if the
        // ship has no subspace drive, AND either has no mothership assigned
        // (or departs to hyperspace) or the mothership was destroyed, AND
        // falls into one of the following cases: 1) The ship's departure cue
        // evaluates to true in the mission 2) A support ship has had its hull
        // fall to 25% when it has no repair targets 3) A fighter or bomber
...
void mission_eval_departures () {
    ...
    // scan through the active ships an evaluate their departure cues.  For
    // those ships whose time has come, set their departing flag.
    ...
    for (objp = GET_FIRST (&obj_used_list);
        ...
        if (objp->type == OBJ_SHIP) {
            ...
            // don't process a ship that is already departing or dying or
            // disabled AL 12-30-97: Added SF_CANNOT_WARP to check Goober5000 -
            // fixed so that it WILL eval when SF_CANNOT_WARP if departing to
            // dockbay
            ...
            // don't process ships that are part of a wing -- handled in
            // seperate case
            if (shipp->wingnum != -1) continue;

            // when the departure cue becomes true, set off the departure delay
            // timer.  We store the timer as -seconds in FreeSpace which
            // indicates that the timer has not been set.  If the timer is not
            // set, then turn it into a valid timer and keep evaluating the
            // timer until it is elapsed
            if (eval_sexp (shipp->departure_cue)) {
                if (shipp->departure_delay <= 0)
                    shipp->departure_delay =
                        timestamp (-shipp->departure_delay * 1000);
    ...
    // now scan through the list of wings and check their departure cues.  For
    // wings with that cue being true, we must update internal variables to
    // indicate that the wing is departed and that no further waves of this
    // wing will appear
    ...
    for (i = 0; i < Num_wings; i++) {
        ...
        // evaluate the sexpression.  If true, mark all the ships in this wing
        // as departing and increment the num departed in the wing structure.
        // Then add number of remaining waves * ships/wave to departed count to
        // get total count of ships in the wing which departed.  (We are
        // counting ships that have not yet arrived as departed if they never
        // arrive -- this may be bad, but for some reason seems like the right
        // thing to do).

        if (eval_sexp (wingp->departure_cue)) {
            // if we haven't set up the departure timer yet (would be <= 0)
            // setup the timer to pop N seconds later
            if (wingp->departure_delay <= 0)
                wingp->departure_delay =
                    timestamp (-wingp->departure_delay * 1000);
            if (!timestamp_elapsed (wingp->departure_delay)) continue;
            ...
            for (j = 0; j < wingp->current_count; j++) {
                ...
                mission_do_departure (objp);
                // don't add to wingp->total_departed here -- this is taken
                // care of in ship code.
            }
        }
    }
    Mission_departure_timestamp = timestamp (DEPARTURE_TIMESTAMP);
...
int insert_subsys_status (p_object* pobjp) {
    ...
    // this is not good; we have to allocate another slot, but then bump all
    // the slots upward so that this particular parse object's subsystems are
    // contiguous
    ...
    if (new_index != pobjp->subsys_index + pobjp->subsys_count) {
        ...
        memcpy (
            &temp_entry, &Subsys_status[new_index], sizeof (subsys_status));

        // shift elements upward
        for (i = Subsys_index - 1;
             i > (pobjp->subsys_index + pobjp->subsys_count); i--) {
            memcpy (
                &Subsys_status[i], &Subsys_status[i - 1],
                sizeof (subsys_status));
        }

        // correct the index so that the new subsystem belongs to the proper
        // p_object
        new_index = pobjp->subsys_index + pobjp->subsys_count;

        // put the blank entry in the p_object
        memcpy (
            &Subsys_status[new_index], &temp_entry, sizeof (subsys_status));
    }
    ...
    for (std::vector< p_object >::iterator ii = Parse_objects.begin ();
        ...
        if (ii->subsys_index >= new_index) ii->subsys_index++;
    }
...
// Goober5000
subsys_status*
parse_get_subsys_status (p_object* pobjp, const char* subsys_name) {
    int i;
    subsys_status* sssp;
...
int get_anchor (char* name) {
    ...
    if (special_anchor >= 0) return special_anchor;
...
void mission_parse_fixup_players () {
    ...
    for (objp = GET_FIRST (&obj_used_list);
        ...
        if ((objp->type == OBJ_SHIP) &&
            ...
            game_busy (NOX (
                "** fixing up player/ai stuff **")); // animate the loading
                                                     // screen, doesn't nothing
...
// code to warp in a new support ship.  It works by finding the average
// position of all ships in the mission, creating a vector from that position
// to the player, and scaling out behind the player some distance.  Should be
// sufficient.
...
/**
 * Adds requester_objp onto the queue of ships for the arriving support ship to
 * service
 */
void mission_add_to_arriving_support (object* requester_objp) {
    ...
    if (MULTIPLAYER_MASTER) {
        multi_maybe_send_repair_info (
            requester_objp, NULL, REPAIR_INFO_WARP_ADD);
    }
}

extern int pp_collide_any (
...
void mission_bring_in_support_ship (object* requester_objp) {
    ...
    // create a parse object, and put it onto the ship arrival list.  This
    // whole thing kind of stinks. I want to put it into a parse object since
    // it needs to arrive just a little later than this function is called.  I
    // have to make some assumptions in the code about values for the parse
    // object since I'm no longer working with a mission file.  These
    // exceptions will be noted with comments
    ...
    if (!get_warp_in_pos (&warp_in_pos, requester_objp, 1.0f, 0.1f, 1.0f))
        if (!get_warp_in_pos (&warp_in_pos, requester_objp, 1.0f, 0.2f, -1.0f))
            if (!get_warp_in_pos (
                    &warp_in_pos, requester_objp, -1.0f, -0.2f, -1.0f))
                if (!get_warp_in_pos (
                        &warp_in_pos, requester_objp, -1.0f, -0.1f, 1.0f))
                    get_warp_in_pos (
                        &warp_in_pos, requester_objp, 0.1f, 1.0f, 0.2f);
    ...
    // create a name for the ship.  use "Support #".  look for collisions until
    // one isn't found anymore
    i = 1;
    do {
        sprintf (pobj->name, NOX ("Support %d"), i);
        if ((ship_name_lookup (pobj->name) == -1) &&
            (ship_find_exited_ship_by_name (pobj->name) == -1))
            break;
        i++;
    } while (1);
    ...
    // a ship in the ship_info array with the same team as the requester of
    // type SIF_SUPPORT.  Might need to be changed, but who knows

    // Goober5000 - who knew of the SCP release? ;) only determine ship class
    // if not set by SEXP
    pobj->ship_class = The_mission.support_ships.ship_class;
    if (pobj->ship_class < 0) {
        requester_species =
            Ship_info[requester_shipp->ship_info_index].species;

        // 5/6/98 -- MWA  Don't need to do anything for multiplayer.  I think
        // that we always want to use the species of the caller ship.

        i = -1;
        // get index of correct species support ship
        for (auto it = Ship_info.cbegin (); it != Ship_info.cend (); ++it) {
            if ((it->species == requester_species) &&
                (it->flags[Ship::Info_Flags::Support])) {
    ...
    for (i = 0; i < MAX_IFFS; i++) {
        for (j = 0; j < MAX_IFFS; j++) { pobj->alt_iff_color[i][j] = -1; }
    }

    pobj->behavior = AIM_NONE; // ASSUMPTION:  the mission file has the string
                               // "None" which maps to AIM_NONE

    // set the ai_goals to -1.  We will put the requester object shipname in
    // repair target array and then take care of setting up the goal when
    // creating the ship!!!!
    pobj->ai_goals = -1;
    Num_arriving_repair_targets = 0;
    mission_add_to_arriving_support (requester_objp);
    ...
    if (Player_obj->flags[Object::Object_Flags::No_shields]) {
        pobj->flags.set (Mission::Parse_Object_Flags::
                             OF_No_shields); // support ships have no shields
                                             // when player has not shields
    }
...
/**
 * Returns true if the given ship is scheduled to be repaired by the arriving
 * support ship
 */
...
/**
 * Removed the given ship from the list of ships that are to get repair by
 * arriving support ship
 */
int mission_remove_scheduled_repair (object* objp) {
    ...
    if (index == Num_arriving_repair_targets) return 0;
...
int mission_parse_lookup_alt (const char* name) {
    ...
    for (idx = 0; idx < Mission_alt_type_count; idx++) {
        if (!strcmp (Mission_alt_types[idx], name)) return idx;
    }
...
void mission_parse_reset_alt () { Mission_alt_type_count = 0; }
...
int mission_parse_lookup_callsign (const char* name) {
    ...
    for (idx = 0; idx < Mission_callsign_count; idx++) {
        if (!strcmp (Mission_callsigns[idx], name)) return idx;
    }
...
void mission_parse_reset_callsign () { Mission_callsign_count = 0; }
...
/**
 * Go through all the displayed text in one section and fix the section and
 * text delimiters should all be different
 */
void conv_fix_punctuation_section (
    char* str, const char* section_start, const char* section_end,
    ...
    while (1) {
        ...
        replace_all (
            t1, "\"", "$quote", PARSE_TEXT_SIZE - (str - Parse_text),
            (t2 - t1));
    }
}
...
void conv_fix_punctuation () {
    // command briefings
    conv_fix_punctuation_section (
        Parse_text, "#Command Briefing", "#Briefing",
        "$Stage Text:", "$end_multi_text");

    // briefings
    conv_fix_punctuation_section (
        Parse_text, "#Briefing", "#Debriefing_info", "$multi_text",
        "$end_multi_text");

    // debriefings
    conv_fix_punctuation_section (
        Parse_text, "#Debriefing_info", "#Players", "$Multi text",
        "$end_multi_text");

    // messages
    conv_fix_punctuation_section (
        Parse_text, "#Messages", "#Reinforcements", "$Message:", "\n");
}
