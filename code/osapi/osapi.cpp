...
#ifdef __APPLE__
    // ewwww, I hate this!!  SDL_Delay() is causing issues for us though and
    // this basically matches Apple examples of the same thing.  Same as
    // SDL_Delay() but we aren't hitting up the system for anything during the
    // process
