...
ADE_LIB_DERIV(l_UserInterface_PilotSelect, "PilotSelect", NULL,
...
ADE_FUNC(getLastPilot, l_UserInterface_PilotSelect, nullptr,
         ...
         "table { callsign: string, is_multi: boolean }", "The pilot info or nil if there was no last pilot")
{
	using namespace luacpp;
	...
	table.addValue("callsign", info.callsign);
	table.addValue("is_multi", info.is_multi);
...
//**********SUBLIBRARY: UserInterface/PilotSelect
ADE_LIB_DERIV(l_UserInterface_MainHall, "MainHall", NULL,
