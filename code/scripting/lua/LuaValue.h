 ...
 *
 * This class holds a reference to a lua value and provides type checking to
...
public:
     ...
     * This is done by pushing the value onto the lua stack and creating a
     * reference to it.
     *
     * @param state The lua state
     * @param value The value to be referenced
     * @return luacpp::LuaValue A new LuaValue instance which references the
     * specified value
     */
     ...
     *
     * The instance does not point to a lua-value after the constructor has
     * finished. To reference a value use #setReference(LuaReferencePtr)
     *
     * @param state The lua state
     */
     ...
     *
     * @return bool @c true if it can be used and have an underlying reference,
     * @c false otherwise.
     */
    bool isValid () const;
 ...
 * @return `true` when the value are equal as specified by the lua "=="
 * operator.
 */
...
bool popValue (
    lua_State* luaState, LuaValue& target, int stackposition = -1,
    bool remove = true);
