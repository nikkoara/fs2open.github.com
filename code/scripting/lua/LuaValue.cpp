...
LuaValue::LuaValue (lua_State* state)
    : _luaState (state), _luaType (ValueType::NONE) {
...
const LuaReference LuaValue::getReference () const { return _reference; }

ValueType LuaValue::getValueType () const { return _luaType; }
...
bool popValue (
    lua_State* luaState, LuaValue& target, int stackposition, bool remove) {
