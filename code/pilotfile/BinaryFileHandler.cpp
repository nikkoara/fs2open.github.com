...
void pilot::BinaryFileHandler::startArrayWrite (
    const char*, size_t size, bool short_index) {
    if (short_index) { cfwrite_ushort ((short)size, _cfp); }
    else {
...
void pilot::BinaryFileHandler::flush () { cflush (_cfp); }
