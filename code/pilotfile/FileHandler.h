...
// This suppresses a GCC bug where it thinks that the Cutscenes from the enum
// class below shadows a global variable
...
public:
    ...
    virtual void startArrayWrite (
        const char* name, size_t size, bool short_length = false) = 0;
