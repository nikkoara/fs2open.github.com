...
//! arrays which hold the key mappings.  The array index represents a
//! key-independent action. please use SPACES for aligning the fields of this
//! array
// XSTR:OFF
config_item Control_config[CCFG_MAX + 1] = {
    // targeting a ship
    { KEY_T, -1, TARGET_TAB, true, "Target Next Ship", CC_TYPE_TRIGGER, -1, -1,
      0, false, false },
    { KEY_SHIFTED | KEY_T, -1, TARGET_TAB, true, "Target Previous Ship",
      CC_TYPE_TRIGGER, -1, -1, 0, false, false },
    { KEY_H, 2, TARGET_TAB, true, "Target Next Closest Hostile Ship",
      CC_TYPE_TRIGGER, -1, -1, 0, false, false },
    { KEY_SHIFTED | KEY_H, -1, TARGET_TAB, true,
      "Target Previous Closest Hostile Ship", CC_TYPE_TRIGGER, -1, -1, 0,
      false, false },
    { KEY_ALTED | KEY_H, -1, TARGET_TAB, true, "Toggle Auto Targeting",
      CC_TYPE_TRIGGER, -1, -1, 0, false, false },
    { KEY_F, -1, TARGET_TAB, true, "Target Next Closest Friendly Ship",
      CC_TYPE_TRIGGER, -1, -1, 0, false, false },
    { KEY_SHIFTED | KEY_F, -1, TARGET_TAB, true,
      "Target Previous Closest Friendly Ship", CC_TYPE_TRIGGER, -1, -1, 0,
      false, false },
    { KEY_Y, 4, TARGET_TAB, true, "Target Ship in Reticle", CC_TYPE_TRIGGER,
      -1, -1, 0, false, false },
    { KEY_G, -1, TARGET_TAB, true, "Target Target's Nearest Attacker",
      CC_TYPE_TRIGGER, -1, -1, 0, false, false },
    { KEY_ALTED | KEY_Y, -1, TARGET_TAB, true,
      "Target Last Ship to Send Transmission", CC_TYPE_TRIGGER, -1, -1, 0,
      false, false },
    ...
    { KEY_V, -1, TARGET_TAB, true, "Target Subsystem in Reticle",
      CC_TYPE_TRIGGER, -1, -1, 0, false, false },
    { KEY_S, -1, TARGET_TAB, true, "Target Next Subsystem", CC_TYPE_TRIGGER,
      -1, -1, 0, false, false },
    { KEY_SHIFTED | KEY_S, -1, TARGET_TAB, true, "Target Previous Subsystem",
      CC_TYPE_TRIGGER, -1, -1, 0, false, false },
    { KEY_ALTED | KEY_S, -1, TARGET_TAB, true,
      "Turn Off Targeting of Subsystems", CC_TYPE_TRIGGER, -1, -1, 0, false,
      false },

    // matching speed
    { KEY_M, -1, COMPUTER_TAB, true, "Match Target Speed", CC_TYPE_TRIGGER, -1,
      -1, 0, false, false },
    { KEY_ALTED | KEY_M, -1, COMPUTER_TAB, true, "Toggle Auto Speed Matching",
      CC_TYPE_TRIGGER, -1, -1, 0, false, false },

    // weapons
    { KEY_LCTRL, 0, WEAPON_TAB, true, "Fire Primary Weapon",
      CC_TYPE_CONTINUOUS, -1, -1, 0, false, false },
    { KEY_SPACEBAR, 1, WEAPON_TAB, true, "Fire Secondary Weapon",
      CC_TYPE_CONTINUOUS, -1, -1, 0, false, false },
    ...
    { KEY_DIVIDE, -1, WEAPON_TAB, true, "Cycle Secondary Weapon Bank",
      CC_TYPE_TRIGGER, -1, -1, 0, false, false },
    { KEY_SHIFTED | KEY_DIVIDE, -1, WEAPON_TAB, true,
      "Cycle Secondary Weapon Firing Rate", CC_TYPE_TRIGGER, -1, -1, 0, false,
      false },
    { KEY_X, 3, WEAPON_TAB, true, "Launch Countermeasure", CC_TYPE_TRIGGER, -1,
      -1, 0, false, false },

    // controls
    { KEY_A, -1, SHIP_TAB, true, "Forward Thrust", CC_TYPE_CONTINUOUS, -1, -1,
      0, false, false },
    { KEY_Z, -1, SHIP_TAB, true, "Reverse Thrust", CC_TYPE_CONTINUOUS, -1, -1,
      0, false, false },
    { KEY_PAD7, -1, SHIP_TAB, true, "Bank Left", CC_TYPE_CONTINUOUS, -1, -1, 0,
      false, false },
    { KEY_PAD9, -1, SHIP_TAB, true, "Bank Right", CC_TYPE_CONTINUOUS, -1, -1,
      0, false, false },
    { KEY_PAD8, -1, SHIP_TAB, true, "Pitch Forward", CC_TYPE_CONTINUOUS, -1,
      -1, 0, false, false },
    { KEY_PAD2, -1, SHIP_TAB, true, "Pitch Backward", CC_TYPE_CONTINUOUS, -1,
      -1, 0, false, false },
    { KEY_PAD4, -1, SHIP_TAB, true, "Turn Left", CC_TYPE_CONTINUOUS, -1, -1, 0,
      false, false },
    { KEY_PAD6, -1, SHIP_TAB, true, "Turn Right", CC_TYPE_CONTINUOUS, -1, -1,
      0, false, false },

    // throttle controls
    { KEY_BACKSP, -1, SHIP_TAB, true, "Set Throttle to Zero", CC_TYPE_TRIGGER,
      -1, -1, 0, false, false },
    { KEY_SLASH, -1, SHIP_TAB, true, "Set Throttle to Max", CC_TYPE_TRIGGER,
      -1, -1, 0, false, false },
    ...
    { KEY_SHIFTED | KEY_P, -1, COMPUTER_TAB, true, "Protect My Target",
      CC_TYPE_TRIGGER, -1, -1, 0, false, false },
    { KEY_SHIFTED | KEY_C, -1, COMPUTER_TAB, true, "Cover Me", CC_TYPE_TRIGGER,
      -1, -1, 0, false, false },
    { KEY_SHIFTED | KEY_J, -1, COMPUTER_TAB, true, "Return to Base",
      CC_TYPE_TRIGGER, -1, -1, 0, false, false },
    { KEY_SHIFTED | KEY_R, -1, COMPUTER_TAB, true, "Rearm Me", CC_TYPE_TRIGGER,
      -1, -1, 0, false, false },
    ...
    // Views
    { KEY_PADMULTIPLY, -1, COMPUTER_TAB, true, "Chase View", CC_TYPE_TRIGGER,
      -1, -1, 0, false, false },
    { KEY_PADPERIOD, -1, COMPUTER_TAB, true, "External View", CC_TYPE_TRIGGER,
      -1, -1, 0, false, false },
    ...
    { KEY_PAD0, -1, COMPUTER_TAB, true, "Free Look View", CC_TYPE_CONTINUOUS,
      -1, -1, 0, false, false }, // Not in use anymore (Swifty)
    { KEY_PADDIVIDE, -1, COMPUTER_TAB, true, "Current Target View",
      CC_TYPE_TRIGGER, -1, -1, 0, false, false },
    { KEY_PADPLUS, -1, COMPUTER_TAB, true, "Increase View Distance",
      CC_TYPE_CONTINUOUS, -1, -1, 0, false, false },
    { KEY_PADMINUS, -1, COMPUTER_TAB, true, "Decrease View Distance",
      CC_TYPE_CONTINUOUS, -1, -1, 0, false, false },
    { KEY_PAD5, -1, COMPUTER_TAB, true, "Center View", CC_TYPE_CONTINUOUS, -1,
      -1, 0, false, false },
    { -1, 33, COMPUTER_TAB, true, "View Up", CC_TYPE_CONTINUOUS, -1, -1, 0,
      false, false },
    { -1, 32, COMPUTER_TAB, true, "View Rear", CC_TYPE_CONTINUOUS, -1, -1, 0,
      false, false },
    { -1, 34, COMPUTER_TAB, true, "View Left", CC_TYPE_CONTINUOUS, -1, -1, 0,
      false, false },
    { -1, 35, COMPUTER_TAB, true, "View Right", CC_TYPE_CONTINUOUS, -1, -1, 0,
      false, false },

    { KEY_RAPOSTRO, -1, COMPUTER_TAB, true, "Cycle Radar Range",
      CC_TYPE_TRIGGER, -1, -1, 0, false, false },
    { KEY_C, -1, COMPUTER_TAB, true, "Communications Menu", CC_TYPE_TRIGGER,
      -1, -1, 0, false, false },
    { -1, -1, -1, true, "Show Objectives", CC_TYPE_TRIGGER, -1, -1, 0, false,
      false },
    { KEY_ALTED | KEY_J, -1, COMPUTER_TAB, true,
      "Enter Subspace (End Mission)", CC_TYPE_TRIGGER, -1, -1, 0, false,
      false },
    { KEY_J, -1, TARGET_TAB, true, "Target Target's Target", CC_TYPE_TRIGGER,
      -1, -1, 0, false, false },
    { KEY_TAB, 5, SHIP_TAB, true, "Afterburner", CC_TYPE_CONTINUOUS, -1, -1, 0,
      false, false },
    ...
    { KEY_Q, 7, COMPUTER_TAB, true, "Equalize Shields", CC_TYPE_TRIGGER, -1,
      -1, 0, false, false },
    { KEY_UP, -1, COMPUTER_TAB, true, "Augment Forward Shield",
      CC_TYPE_TRIGGER, -1, -1, 0, false, false },
    { KEY_DOWN, -1, COMPUTER_TAB, true, "Augment Rear Shield", CC_TYPE_TRIGGER,
      -1, -1, 0, false, false },
    { KEY_LEFT, -1, COMPUTER_TAB, true, "Augment Left Shield", CC_TYPE_TRIGGER,
      -1, -1, 0, false, false },
    ...
    { -1, -1, SHIP_TAB, false, "Glide When Pressed", CC_TYPE_CONTINUOUS, -1,
      -1, 0, false, false },
    // Backslash -- this was a convenient place for Glide When Pressed, as Show
    // Damage Popup isn't used
    { -1, -1, SHIP_TAB, true, "Bank When Pressed", CC_TYPE_CONTINUOUS, -1, -1,
      0, false, false },
    { -1, -1, -1, true, "Show Nav Map", CC_TYPE_TRIGGER, -1, -1, 0, false,
      false },
    { KEY_ALTED | KEY_E, -1, COMPUTER_TAB, true, "Add or Remove Escort",
      CC_TYPE_TRIGGER, -1, -1, 0, false, false },
    { KEY_ALTED | KEY_SHIFTED | KEY_E, -1, COMPUTER_TAB, true,
      "Clear Escort List", CC_TYPE_TRIGGER, -1, -1, 0, false, false },
    { KEY_E, -1, TARGET_TAB, true, "Target Next Escort Ship", CC_TYPE_TRIGGER,
      -1, -1, 0, false, false },
    ...
    { KEY_U, -1, TARGET_TAB, true, "Target Next Uninspected Cargo",
      CC_TYPE_TRIGGER, -1, -1, 0, false, false },
    { KEY_SHIFTED | KEY_U, -1, TARGET_TAB, true,
      "Target Previous Uninspected Cargo", CC_TYPE_TRIGGER, -1, -1, 0, false,
      false },
    { KEY_N, -1, TARGET_TAB, true, "Target Newest Ship in Area",
      CC_TYPE_TRIGGER, -1, -1, 0, false, false },
    { KEY_K, -1, TARGET_TAB, true, "Target Next Live Turret", CC_TYPE_TRIGGER,
      -1, -1, 0, false, false },
    ...
    { KEY_B, -1, TARGET_TAB, true, "Target Next Hostile Bomb or Bomber",
      CC_TYPE_TRIGGER, -1, -1, 0, false, false },
    { KEY_SHIFTED | KEY_B, -1, TARGET_TAB, true,
      "Target Previous Hostile Bomb or Bomber", CC_TYPE_TRIGGER, -1, -1, 0,
      false, false },
    ...
    { KEY_4, -1, COMPUTER_TAB, true, "(Multiplayer) Message Target",
      CC_TYPE_TRIGGER, -1, -1, 0, false, false },
    { KEY_ALTED | KEY_X, -1, COMPUTER_TAB, true,
      "(Multiplayer) Observer Zoom to Target", CC_TYPE_TRIGGER, -1, -1, 0,
      false, false },
    { KEY_SHIFTED | KEY_PERIOD, -1, COMPUTER_TAB, true,
      "Increase Time Compression", CC_TYPE_TRIGGER, -1, -1, 0, false, false },
    { KEY_SHIFTED | KEY_COMMA, -1, COMPUTER_TAB, true,
      "Decrease Time Compression", CC_TYPE_TRIGGER, -1, -1, 0, false, false },
    { KEY_L, -1, COMPUTER_TAB, true, "Toggle High HUD Contrast",
      CC_TYPE_TRIGGER, -1, -1, 0, false, false },
    { KEY_SHIFTED | KEY_N, -1, COMPUTER_TAB, true,
      "(Multiplayer) Toggle Network Info", CC_TYPE_TRIGGER, -1, -1, 0, false,
      false },
    { KEY_SHIFTED | KEY_END, -1, COMPUTER_TAB, true,
      "(Multiplayer) Self Destruct", CC_TYPE_TRIGGER, -1, -1, 0, false,
      false },

    // Misc
    { KEY_SHIFTED | KEY_O, -1, COMPUTER_TAB, true, "Toggle HUD",
      CC_TYPE_TRIGGER, -1, -1, 0, false, false },
    { KEY_SHIFTED | KEY_3, -1, SHIP_TAB, true, "Right Thrust",
      CC_TYPE_CONTINUOUS, -1, -1, 0, false, false },
    { KEY_SHIFTED | KEY_1, -1, SHIP_TAB, true, "Left Thrust",
      CC_TYPE_CONTINUOUS, -1, -1, 0, false, false },
    { KEY_SHIFTED | KEY_PADPLUS, -1, SHIP_TAB, true, "Up Thrust",
      CC_TYPE_CONTINUOUS, -1, -1, 0, false, false },
    { KEY_SHIFTED | KEY_PADENTER, -1, SHIP_TAB, true, "Down Thrust",
      CC_TYPE_CONTINUOUS, -1, -1, 0, false, false },
    { KEY_ALTED | KEY_SHIFTED | KEY_Q, -1, COMPUTER_TAB, true,
      "Toggle HUD Wireframe Target View", CC_TYPE_TRIGGER, -1, -1, 0, false,
      false },
    { -1, -1, COMPUTER_TAB, false, "Top-Down View", CC_TYPE_TRIGGER, -1, -1, 0,
      false, false },
    { -1, -1, COMPUTER_TAB, false, "Target Padlock View", CC_TYPE_TRIGGER, -1,
      -1, 0, false, false }, // (Swifty) Toggle for VM_TRACK
...
const char* Joy_button_text_german[] = {
    ...
    "Knopf 6",   "Knopf 7",  "Knopf 8",    "Knopf 9",   "Knopf 10",
    "Knopf 11",  "Knopf 12", "Knopf 13",   "Knopf 14",  "Knopf 15",
    "Knopf 16",  "Knopf 17", "Knopf 18",   "Knopf 19",  "Knopf 20",
    "Knopf 21",  "Knopf 22", "Knopf 23",   "Knopf 24",  "Knopf 25",
    "Knopf 26",  "Knopf 27", "Knopf 28",   "Knopf 29",  "Knopf 30",
    "Knopf 31",  "Knopf 32", "Hut Hinten", "Hut Vorne", "Hut Links",
    "Hut Rechts"
};
...
const char* Joy_button_text_french[] = {
    ...
    "Bouton 13",          "Bouton 14",     "Bouton 15",      "Bouton 16",
    "Bouton 17",          "Bouton 18",     "Bouton 19",      "Bouton 20",
    "Bouton 21",          "Bouton 22",     "Bouton 23",      "Bouton 24",
    "Bouton 25",          "Bouton 26",     "Bouton 27",      "Bouton 28",
    "Bouton 29",          "Bouton 30",     "Bouton 31",      "Bouton 32",
...
const char* Joy_button_text_polish[] = {
    "Przyc.1",  "Przyc.2",  "Przyc.3",    "Przyc.4",         "Przyc.5",
    "Przyc.6",  "Przyc.7",  "Przyc.8",    "Przyc.9",         "Przyc.10",
    "Przyc.11", "Przyc.12", "Przyc.13",   "Przyc.14",        "Przyc.15",
    "Przyc.16", "Przyc.17", "Przyc.18",   "Przyc.19",        "Przyc.20",
    "Przyc.21", "Przyc.22", "Przyc.23",   "Przyc.24",        "Przyc.25",
    "Przyc.26", "Przyc.27", "Przyc.28",   "Przyc.29",        "Przyc.30",
    "Przyc.31", "Przyc.32", "Hat Ty\xB3", "Hat Prz\xF3\x64", "Hat Lewo",
    "Hat Prawo"
};
...
const char* Joy_button_text_english[] = {
    ...
    "Button 31", "Button 32", "Hat Back",  "Hat Forward", "Hat Left",
    "Hat Right"
};
...
void set_modifier_status () {
    ...
    for (i = 0; i < CCFG_MAX; i++) {
        if (Control_config[i].key_id < 0) continue;

        if (Control_config[i].key_id & KEY_ALTED) Alt_is_modifier = 1;
...
int translate_key_to_index (const char* key, bool find_override) {
    ...
    if (*key) {
        ...
        if (i == max_scan_codes) return -1;

        if (shift) index |= KEY_SHIFTED;
        if (alt) index |= KEY_ALTED;

        // convert scancode to Control_config index
        if (find_override) {
            for (i = 0; i < CCFG_MAX; i++) {
                if (!Control_config[i].disabled &&
                    Control_config[i].key_id == index) {
                    index = i;
                    break;
                }
            }
            ...
            for (i = 0; i < CCFG_MAX; i++) {
                if (!Control_config[i].disabled &&
                    Control_config[i].key_default == index) {
                    index = i;
                    break;
                }
            }
...
/*! Given the system default key 'key', return the current key that is bound to
 * that function. Both are 'key' and the return value are descriptive strings
 * that can be displayed directly to the user.  If 'key' isn't a real key, is
 * not normally bound to anything, or there is no key currently bound to the
...
char* translate_key (char* key) {
    ...
    if (key_code >= 0) { key_text = textify_scancode (key_code); }

    if (joy_code >= 0) { joy_text = Joy_button_text[joy_code]; }
...
// initialize common control config stuff - call at game startup after
...
void control_config_common_close () {
    ...
    for (auto ii = Control_config_presets.cbegin ();
         ii != Control_config_presets.cend (); ++ii) {
        delete[] * ii;
    }
}
...
/*! Helper function to LoadEnumsIntoMaps(), Loads the Keyboard
 * definitions/enumerations into mKeyNameToVal
 */
...
/*! Helper function to LoadEnumsIntoMaps(), Loads the Control Types
 * enumerations into mCCTypeNameToVal
 */
...
/*! Helper function to LoadEnumsIntoMaps(), Loads the Control Tabs enumerations
 * into mCCTabNameToVal
 */
...
/*! Loads the various control configuration maps to allow the parsing functions
 * to appropriately map string tokns to their associated enumerations. The
 * string tokens in the controlconfigdefaults.tbl match directly to their names
 * in the C++ code, such as "KEY_5" in the .tbl mapping to the #define KEY_5
 * value
 */
...
/**
 * @brief Parses controlconfigdefault.tbl, and overrides the default control
 * configuration for each valid entry in the .tbl
 */
void control_config_common_load_overrides () {
    LoadEnumsIntoMaps ();
    ...
    try {
        if (cf_exists_full ("controlconfigdefaults.tbl", CF_TYPE_TABLES)) {
            ...
            read_file_text_from_default (
                defaults_get_file ("controlconfigdefaults.tbl"));
        }
        ...
        while (optional_string ("#ControlConfigOverride")) {
            ...
            std::copy (
                Control_config, Control_config + CCFG_MAX + 1, cfg_preset);
            ...
            while (required_string_either ("#End", "$Bind Name:")) {
                ...
                const size_t cCntrlAryLength =
                    sizeof (Control_config) / sizeof (Control_config[0]);
                    ...
                    if (!strcmp (szTempBuffer, r_ccConfig.text)) {
                        ...
                        if (optional_string ("$Key Default:")) {
                            if (optional_string ("NONE")) {
                                ...
                                stuff_string (
                                    szTempBuffer, F_NAME, iBufferLength);
                                r_ccConfig.key_default =
                                    (short)mKeyNameToVal[szTempBuffer];
                            }
                        }
                        ...
                        if (optional_string ("$Key Mod Ctrl:")) {
                            stuff_int (&iTemp);
                            r_ccConfig.key_default |=
                                (iTemp == 1) ? KEY_CTRLED : 0;
                        }

                        if (optional_string ("$Category:")) {
                            stuff_string (szTempBuffer, F_NAME, iBufferLength);
                            r_ccConfig.tab =
                                (char)mCCTabNameToVal[szTempBuffer];
                        }
                        ...
                        if (optional_string ("$Type:")) {
                            stuff_string (szTempBuffer, F_NAME, iBufferLength);
                            r_ccConfig.type =
                                (char)mCCTypeNameToVal[szTempBuffer];
                        }
    ...
    if (!Control_config_presets.empty ()) {
        std::copy (
            Control_config_presets[0],
            Control_config_presets[0] + CCFG_MAX + 1, Control_config);
    }
}
